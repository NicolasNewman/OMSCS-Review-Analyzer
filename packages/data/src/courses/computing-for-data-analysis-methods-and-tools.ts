export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course is well-structured, with effective use of Jupyter notebooks and ample independent practice problems. Exams are open book and fair, allowing students to perform well if they prepare adequately. Office hours are highly beneficial for support.',
            con: 'The course can be quite challenging for those without prior Python experience, with superficial lectures and difficult exams that may not accommodate beginners satisfactorily.',
        },
        'spring 2024': {
            pro: 'The course is well-structured and challenging, providing a great gauge of Python experience. It includes useful supplemental resources like a Python bootcamp for beginners and offers flexibility in homework scheduling.',
            con: 'The course is not suitable for beginners without prior Python experience, and some concepts, like binary encoding and calculus, can be difficult. There is a lack of real-world examples in the lectures.',
        },
        'spring 2023': {
            pro: 'The course provides valuable practice in Python and real-life applications, with helpful homework examples and resources like past exams and office hours.',
            con: 'The TA responsiveness is lacking, the second half of the course introduces new, unexplained concepts, and the lecture quality is poor, making it challenging for beginners.',
        },
        'spring 2022': {
            pro: 'The course provides a smooth transition back into academic coursework, with well-organized homework notebooks and clear lecture videos, making it engaging for students who may need a refresher.',
            con: 'The course is primarily an introductory level class, which may not be beneficial for those with strong prior knowledge of Python, as much of the content will be review for them.',
        },
        'fall 2021': {
            pro: 'The course offers a well-structured introduction to Python and data analysis, with engaging materials and effective homework assignments. Many students found the notebooks helpful, and the content applicable in real-world scenarios, leading to improved Python skills.',
            con: 'The course is perceived as challenging, especially for those without strong Python and mathematical backgrounds. Some students reported high workloads, vague exam descriptions, and a lack of instructional support, which led to frustration and a sense of being underprepared.',
        },
        'spring 2021': {
            pro: 'The course is well-structured with high-quality notebooks, ample resources, generous tutoring, and interesting exam tasks that help develop Python skills.',
            con: 'The teaching style lacks depth, with minimal lecture instruction, poorly edited videos, vague homework questions, and some unresponsive TAs.',
        },
        'summer 2021': {
            pro: 'The course provides immediate applicability of concepts learned to real-world work, making it engaging and insightful.',
            con: 'The course may be difficult for those without prior knowledge of Python or Linear Algebra.',
        },
        'fall 2020': {
            pro: "The course is well-structured, with engaging content and interactive programming notebooks that cover a range of topics in Python and data analytics. Students find the instructors helpful, and many enjoy the homework and exam challenges, considering them fair and stimulating. There are ample resources for beginners, and the course is seen as improving students' programming skills significantly.",
            con: 'Some recorded videos are difficult to understand due to accents, and there are issues with TAs not responding to questions on Piazza. Many students feel the course exams are inconsistent with prior assignments and that the exam software adds unnecessary stress. Additionally, the downloading process for course files is regarded as cumbersome.',
        },
        'spring 2020': {
            pro: 'The course is well-structured, with excellent course materials, responsive TAs, and opportunities for students to succeed. Many learners feel comfortable with Python by the end and appreciate the thorough preparation of notebooks.',
            con: 'The exams can be stressful, especially with the timed proctored format, which some students find less forgiving. There are criticisms about the quality of lecture videos, outdated software tools, and issues with Piazza discussions being cluttered.',
        },
        'fall 2019': {
            pro: 'The course effectively develops programmatic thinking through a combination of homework and exams, with resources provided by a clear and understanding professor. It offers practical exposure to Python and various libraries, which students found engaging and challenging.',
            con: "The abrupt change in the final exam format due to cheating affected many students' grades negatively. The new timed format was difficult for those who performed better with longer, unproctored exams, leading to dissatisfaction among students.",
        },
        'fall 2018': {
            pro: 'The course has well-structured homework and exams that provide hands-on experience and maintain student engagement. The use of Jupyter Notebooks is praised, and many students felt the course significantly improved their programming skills in Python.',
            con: 'The lectures were often seen as lacking value and too concise, making it difficult for some students to fully comprehend the material. Additionally, there were complaints about the difficulty and length of exams, which some found to be overly challenging.',
        },
        'spring 2019': {
            pro: 'The course provides a strong foundation in Python and analytics, with manageable weekly homework praised for being straightforward. Many students found the TAs and peer support through forums helpful.',
            con: 'Exams are considered lengthy and challenging, often requiring excessive time to complete. Students with minimal programming experience may struggle significantly, and communication regarding course logistics and exam expectations could be improved.',
        },
        'spring 2018': {
            pro: 'The course is a well-structured introduction to Python with helpful homework assignments, high-quality lectures, effective auto-grading, and a supportive learning environment. Many students appreciated the ability to learn at their own pace with unlimited homework submissions and resources like Jupyter notebooks.',
            con: 'Students found the exams to be excessively lengthy and difficult compared to homework, leading to high stress levels. Feedback indicated a disconnect between homework and exam difficulty, with some students struggling significantly during exams despite good performance in assignments.',
        },
        'summer 2018': {
            pro: "Students appreciated the solid foundation in Python and its analytics libraries, as well as the supportive professor and TAs. The course's approach to testing algorithmic thinking was also well-received.",
            con: 'Some students found the exams to be lengthy and more challenging than homework, and there were occasional critiques about the quality of lecture videos.',
        },
        'fall 2017': {
            pro: "The course offers a gradual learning curve with real-world applications, a useful homework setup in Jupyter Notebooks, and a responsive instructor who adapted exam formats based on student feedback. Many found the course content enriching and appreciated the 'learn by doing' approach.",
            con: 'The course is challenging, particularly for those without prior Python experience, leading to a steep learning curve. Some reviews noted that the pacing was rushed towards the end, and there were concerns about class organization and timely responses from the instructors.',
        },
    },
};
