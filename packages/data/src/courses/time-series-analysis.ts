export default {
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: 'The course is well-structured and applicable, with a solid focus on the fundamentals of Time Series Analysis. The group project allows for exploration of advanced modeling techniques, and additional resources like PDFs and Jupyter Notebooks enhance learning.',
            con: 'There are issues with long and detailed lectures that can be overwhelming. Some previous feedback indicated mismanagement by TAs and less engaging video lectures. Overall, it lacks the quality of offerings found on platforms like Coursera.',
        },
        'fall 2022': {
            pro: 'The course allows students to engage in a research area of interest through a final project, with challenging yet fair homework and exams. Students found value in applying their knowledge during internships.',
            con: 'The course suffers from inconsistent responses from TAs, poor communication regarding instructions and deadlines, unupdated homework solutions, and a poorly designed project that adds little value.',
        },
        'spring 2022': {
            pro: 'The course initially started well and the professor offers extra credit for students helping improve the quality of the course.',
            con: "There are numerous errors in the answer keys and lecture materials, leading to confusion and anxiety among students; peer-graded assignments are seen as burdensome and unfair; lack of response from TA's and minimal class discussion hurt the learning experience.",
        },
        'fall 2021': {
            pro: 'Dr. Serban is responsive on Piazza and offers good content lessons in Time Series analysis, which provides a comprehensive understanding if completed successfully.',
            con: 'The course is extremely time-consuming and difficult, with ambiguous questions, unreliable TA support, and some errors in homework solutions.',
        },
        'spring 2020': {
            pro: 'The course provides a solid understanding of time series theory and prepares students well for exams with reasonable homework assignments and excellent TAs.',
            con: 'Lectures are described as not inspiring, and the course may be challenging for some students.',
        },
        'fall 2020': {
            pro: 'The course is heavy on practicality, with significant focus on problem-solving in R and interpreting graphs, making it reasonable for students to achieve good grades with some effort.',
            con: "Lectures are dense and boring, and the multiple choice portions of homeworks and exams contain nit-picky trick questions that don't reflect a true understanding of the material.",
        },
        'spring 2021': {
            pro: 'Some useful knowledge and tools for time series analysis (TSA) are gained, and access to starter R code aids practical analysis.',
            con: 'Lectures are boring and poorly structured, with ambiguous homework and exam questions, lack of continuity, and inadequate support from TAs, leading to a stressful and disorganized learning experience.',
        },
        'fall 2019': {
            pro: 'Some students found the course manageable and appreciated the helpful TA, with useful concepts taught regarding time series.',
            con: "Many students struggled with the exams, found the course material difficult to understand, and criticized the professor's teaching style and course structure.",
        },
        'spring 2019': {
            pro: 'The course covers a significant amount of time series material and is suitable for those with prior knowledge, making it a good starter course. The data examples are practical and resemble real-world applications, especially in finance or economics.',
            con: 'The course may not be engaging enough due to challenging theoretical components, and the instructor could improve by focusing on depth rather than breadth. Additionally, some material was not adequately covered in lectures, requiring students to seek external resources.',
        },
        'fall 2018': {
            pro: 'Real-world data sets were interesting and memorable, Dr. Serban provided tremendous help during office hours, and maintained a respectful and encouraging attitude towards students.',
            con: "Issues with subjectivity in early course content, excessive reliance on the 'iceberg' teaching method, midterm exam favored memorization over understanding, and miscommunication regarding assignment deadlines caused stress among students.",
        },
        'spring 2018': {
            pro: 'The course offers valuable material that can be applied in practice, and its challenging nature can lead to deeper learning if approached correctly.',
            con: 'The course presentation is criticized for being confusing and reliant on repetitive math equations, and the exams are seen as focused more on test-taking strategies than on mastering the material, with logistical issues during assessments.',
        },
        'summer 2018': {
            pro: 'N/A',
            con: "The course is difficult due to the professor's teaching style, which relies heavily on reading mathematical jargon with no clear explanations or real-world applications.",
        },
    },
};
