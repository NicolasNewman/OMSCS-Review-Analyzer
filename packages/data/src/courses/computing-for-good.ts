export default {
    ...
    reviewSummaries: {
        'spring 2022': {
            pro: 'Students have the opportunity to work on meaningful projects that can help non-profit organizations.',
            con: 'The project matching process is disorganized, there is excessive busy-work that detracts from the actual project, deadlines are inconvenient, and there is limited time to coordinate with partner organizations.',
        },
    },
};
