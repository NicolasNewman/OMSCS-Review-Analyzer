export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course is a good introduction for those with little financial knowledge, with helpful staff and well-structured assignments. Many found the financial concepts and projects engaging and well-designed.',
            con: 'Assignments have excessive and convoluted requirements which can lead to confusion and frustration. The course content may be outdated, and there are concerns about the clarity of exams and lecture quality.',
        },
        'spring 2024': {
            pro: 'The course offers well-organized content, interesting projects related to stock trading, and engaging lectures that provide a broad overview of machine learning concepts. Discussion forums and active TA support are also beneficial.',
            con: 'Exams and project report requirements are poorly structured, making them difficult to study for and execute. There are also complaints regarding the bureaucracy of the regrading process and issues with the quality and consistency of tutorial materials.',
        },
        'spring 2023': {
            pro: 'The course is a great introduction to the OMSCS program, providing valuable hands-on experience with machine learning and financial concepts. It features well-organized content, interesting projects, and responsive teaching assistants.',
            con: 'Assignments are often seen as disorganized and overly detailed, with delayed grading and unclear exam questions. The course content can feel superficial for those with prior experience, leading to a sense of wasted opportunity.',
        },
        'fall 2023': {
            pro: 'The course is a good introduction to machine learning, particularly in the context of trading, and has well-structured and interesting content. The TA support is responsive and helpful.',
            con: 'The course has inconsistencies in assignment difficulty, excessive detail in project requirements, and convoluted exam questions. Some content is outdated and the course does not adequately prepare students for practical applications in trading.',
        },
        'summer 2023': {
            pro: 'The course content is engaging and allows for deeper exploration; TAs are responsive and foster discussion.',
            con: 'Writing reports can be time-consuming, and feedback on assignments was initially slow.',
        },
        'fall 2022': {
            pro: 'The course is well-structured, featuring engaging projects that utilize Python libraries, and is supported by an excellent TA staff. It offers a good introduction to machine learning and finance, making it suitable for beginners or those looking for a lighter workload. Many found the class enjoyable and rewarding despite some challenges.',
            con: 'The course has unclear grading criteria, inconsistent video quality, and lengthy project descriptions that can be confusing. Some assignments are disproportionately weighted, and feedback from TAs is often not helpful. Additionally, the workload varies significantly, which can lead to uneven time commitments.',
        },
        'spring 2022': {
            pro: 'The course has engaging lecture videos by Professor Balch, and the TAs are very active and helpful, providing support on Ed forums and during office hours. Many students found it to be a decent introduction to machine learning and finance, with some interesting content, especially for those new to the field.',
            con: 'The course suffers from poorly organized and confusing project descriptions, long grading turnaround times, and a grading system that some found overly punitive for minor mistakes. Many students reported feelings of frustration over the complexity and lack of clarity in assignments, leading to significant time investment without commensurate learning outcomes.',
        },
        'summer 2022': {
            pro: 'Students appreciated the interesting course content related to stock investment and machine learning concepts, as well as useful lecture videos and decent project value.',
            con: 'The course faced criticism for time-consuming projects, subjective grading, outdated lectures, lack of instructor presence, and ambiguous assignment descriptions leading to confusion.',
        },
        'fall 2017': {
            pro: 'The course offers a solid introduction to machine learning, Python, and finance, with well-structured projects that are interesting and engaging. Feedback from multiple reviews indicates that lectures are clear and entertaining, and many students appreciated the strong guidance provided by the professor and TAs.',
            con: 'The course suffers from poor communication and management issues, including late finalization of assignments and confusing expectations. Many students expressed frustration over the use of Reddit for discussions, citing a lack of organization and timely responses. Additionally, there are concerns about the increasing difficulty of assignments and exams with no grading curve.',
        },
        'fall 2021': {
            pro: 'The course is well-structured with excellent lectures, a knowledgeable instructional staff, and a mix of interesting projects that provide a solid introduction to machine learning and finance concepts.',
            con: 'Assignments have lengthy and poorly organized instructions, grading can be slow and disproportionate, and there are concerns about the clarity and relevance of some course materials.',
        },
        'spring 2020': {
            pro: 'The course is well-managed with engaging material, fair exams, helpful TAs, and the ability to work ahead on assignments. Many students found the projects enjoyable and applicable to real-world scenarios, and the grading is perceived as generous.',
            con: "Some students felt the course was too easy and did not cover advanced topics as expected. The heavy emphasis on finance and the basic introduction to Python were seen as unnecessary by some, leading to complaints about the course's depth and rigor.",
        },
        'fall 2020': {
            pro: 'The course offers interesting material and good projects that help reinforce learning. Many students appreciated the well-designed lectures and found the exams straightforward. The TA office hours were also highlighted as a positive aspect.',
            con: 'Numerous complaints were made about the TAs being unhelpful or condescending, especially on Piazza, which was described as disorganized. Students felt overwhelmed by the number of projects, some with unclear requirements and strict report formats, leading to excessive time spent on paperwork rather than actual learning.',
        },
        'spring 2021': {
            pro: 'The course offers a thorough introduction to machine learning and stock markets, with well-structured projects and supportive teaching staff. Many found the content engaging and enjoyable, noting it as a strong foundation for coding.',
            con: "Several reviews highlight the course's uneven pace and ambiguous project descriptions, leading to confusion and frustration. Some experienced students felt it was much harder and more time-consuming than suggested, especially for those without a strong programming background.",
        },
        'summer 2021': {
            pro: 'The course provides a solid introduction to Python, machine learning, and finance, with informative lectures and helpful TAs. Students who completed the course reported significant learning about trading strategies and indicators, with practical coding projects that build on each other.',
            con: "The course suffers from disorganized and overly detailed project instructions, making it difficult for students to follow requirements, leading to potential point deductions. There's also frustration around the course platform, slow feedback from grading, and an overall bureaucratic feel due to the structure and management of the course.",
        },
        'summer 2020': {
            pro: 'The course is easy and informative, with generous grading, a predictable workload, and valuable content for those with a background in Python and finance. Many students appreciated the ability to work ahead on assignments and found the lectures clear, despite some being slower-paced.',
            con: 'Many reviews highlighted vague assignment instructions, inconsistent project difficulty, and grading issues, including overly strict rubrics. Some students also found the actual machine learning content lacking and reported condescending behavior from TAs.',
        },
        'fall 2019': {
            pro: 'The course is well-structured with clear expectations, enjoyable lectures, and engaging projects that effectively teach machine learning concepts applied to trading. Many students found it manageable and relatively easy to achieve a good grade.',
            con: 'Several students reported issues with the TAs being rude or unhelpful, and the course being perceived as superficial compared to more advanced courses. Some felt the assignments lacked depth and that the grading criteria could be overly strict or confusing.',
        },
        'spring 2017': {
            pro: 'Many reviews highlight the course as well-organized and engaging, with interesting projects and an enthusiastic professor, leading to a positive learning experience in both machine learning and finance.',
            con: 'Several reviewers pointed out issues with disorganization, frequent changes to assignments, and a challenging grading process that could lead to frustration, particularly towards the end of the course.',
        },
        'summer 2019': {
            pro: 'The course offers a gentle introduction to machine learning and Python, with engaging and informative lectures. TAs are praised for their responsiveness, and the projects are interesting and straightforward. Many students found the class enjoyable and beneficial for learning financial concepts and coding skills.',
            con: 'Dr. Joyner, the current instructor, provides minimal interaction beyond weekly announcements, and some students felt the course lacked depth in certain areas. Exams were perceived as a waste of time by some, and there were concerns about the strict project rubrics and hidden grading criteria.',
        },
        'spring 2019': {
            pro: 'The course is highly regarded as a great introduction to machine learning and finance, with engaging lectures and well-structured projects. Many found the workload manageable and the support from TAs sufficient.',
            con: 'There are significant complaints about the administration of the course, particularly regarding the TAs and grading processes. Issues include a lack of clarity in guidance, automated grading leading to harsh penalties for minor mistakes, and inconsistent communication from TAs.',
        },
        'summer 2018': {
            pro: 'The course is praised for being a gentle and engaging introduction to machine learning and finance, with supportive instructors and manageable projects. Many students found the material interesting and appreciated the individual projects and supportive online resources.',
            con: 'Critics highlight issues with finalizing assignments late, trivial exam questions, and an overall lack of depth in the material. Some students feel the course is too easy and does not prepare them for real-world applications, and that communication from the instructor could be improved.',
        },
        'summer 2017': {
            pro: 'The course is praised for being a good introduction to machine learning and finance, with an engaging professor and TAs. Many students appreciated the practical projects and found the course overall enjoyable and informative.',
            con: "Several students expressed that the course materials felt rushed, especially in the summer session, and some felt it was too easy or lacked depth. Concerns were raised about product placement and professor's demeanor.",
        },
        'fall 2018': {
            pro: 'The course offers a great introduction to Python and machine learning concepts, with engaging material and a supportive instructor. Most students found the assignments enjoyable, the projects interesting, and the grading fair. TAs and professor were very active and helpful.',
            con: 'Some students felt the course was too focused on trading at the expense of machine learning, and there were complaints about the quality of video lectures and late finalization of assignments. Exams were considered relatively easy, often relying on memorization.',
        },
        'spring 2018': {
            pro: 'The course is well-structured, engaging, and provides a strong introduction to machine learning, technical analysis, and Python using practical projects. TAs and Professor Balch are helpful and enthusiastic about the material, making the learning experience enjoyable.',
            con: 'The course can be disorganized at times, especially due to its large size, leading to challenges in communication and timely feedback on assignments. Some students found the grading process slow and the number of assignments to be overwhelming.',
        },
        'spring 2016': {
            pro: 'The course is engaging and well-structured, providing a solid introduction to machine learning and its applications in financial trading. Professor Balch and the TAs are highly responsive and supportive, contributing to a positive learning environment. Many students found the projects challenging yet rewarding, and the ramp-up in difficulty was generally well received.',
            con: 'The initial parts of the course may feel slow and overly focused on Python APIs, which some felt could be learned independently. The workload increases significantly toward the end, catching some students off guard. Additionally, the midterm exam format was criticized for being excessively reliant on memorization and not well aligned with course content.',
        },
        'fall 2016': {
            pro: 'Many positive aspects include it being a good introduction to machine learning, engaging lectures, and useful content. The professor is helpful and offers timely responses. The course successfully ties together Python, finance, and machine learning concepts.',
            con: 'Concerns include disorganization from the instructor, modification of project specifications without notification, and slow grading turnaround. Some students also found the workload, particularly the last three projects, to be challenging.',
        },
        'spring 2015': {
            pro: 'The course integrates pandas/numpy, finance, and ML algorithms effectively and features an enthusiastic and supportive professor.',
            con: 'The workload increases towards the end of the semester, and there may be a desire for a larger focus on the ML section.',
        },
        'fall 2015': {
            pro: 'The course provides a solid introduction to Python and Machine Learning, with well-structured assignments and an engaging instructor. It builds confidence in using tools like numpy and pandas and offers valuable insights into finance and trading.',
            con: 'The course starts off too easy and takes a long time to reach the Machine Learning content, which many students found disappointing. There is a desire for more depth in later sections and a faster pace overall.',
        },
    },
};
