export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course covers useful material, offers interesting group projects like creating a full-stack website, and is flexible to pair with other courses. Positive experiences were noted regarding the grading and responsiveness of course staff.',
            con: 'The course is disorganized with unclear assignment requirements, vague TA responses, and a heavy reliance on group projects, which can lead to significant workload variability depending on team composition.',
        },
        'summer 2024': {
            pro: 'Some reviewers noted that the professors and instructors are genuinely interested in student learning.',
            con: 'The course is poorly organized, with excessive focus on outdated UML concepts, inadequate communication of assignment requirements, lack of timely feedback, slow grading, and inconsistent grading practices.',
        },
        'spring 2023': {
            pro: 'Engaging group assignments and helpful office hours. Some assignments build off each other, allowing team collaboration.',
            con: 'Monotonous lectures that do not align with assignments. Poor communication from TAs, arbitrary grading, and frustrating quizzes with limited feedback.',
        },
        'fall 2023': {
            pro: 'Topics are interesting, quizzes and lectures are beneficial for learning, first assignments are easy and fun, and the course provides a valuable understanding of programming principles.',
            con: 'Too much focus on diagrams, class limits are disappointing, and some content may feel outdated.',
        },
        'summer 2023': {
            pro: 'The lectures and content are well-received and informative, with valuable lessons on different diagrams being particularly useful.',
            con: 'Timing for projects is poorly structured, with issues in grading, particularly from TAs, and some concepts being outdated.',
        },
        'summer 2022': {
            pro: 'Students noted the opportunity for individual learning, a structured format with various components (quizzes, assignments, participation), and mentioned that the professors and TAs provided good support and feedback.',
            con: 'Common complaints include mismanagement of the course, vague project instructions, late assignment feedback, excessive time required for practice quizzes, and tight deadlines for projects, particularly group work.',
        },
        'fall 2022': {
            pro: 'Some students found the instructional staff helpful and appreciated the manageable workload, particularly the chance to apply UML learnings practically. The exam was considered fair, and the grading turnaround for assignments was timely.',
            con: 'Many students criticized the course for being disorganized, with boring lectures, excessive emphasis on UML diagrams over actual software architecture, and poorly designed labs heavily reliant on LLVM, leading to confusion and frustration. The grading for assignments was also noted as slow.',
        },
        'spring 2022': {
            pro: 'The course serves as a good introduction to the OMSCS program and has enjoyable aspects; there are no exams.',
            con: 'The readings are lengthy and necessary, and the final group project is hard with insufficient information provided, leading to an imbalanced learning experience.',
        },
        'fall 2021': {
            pro: 'Some students found the group project rewarding when working with capable teammates, and some aspects of Java programming were viewed as straightforward.',
            con: 'The course received numerous negative comments regarding disorganized lectures, vague assignments, unresponsive TAs, poor group dynamics, and outdated content.',
        },
        'summer 2021': {
            pro: 'The course projects, particularly the group project, provided valuable learning experiences, and some students found the assignment structure and graded quizzes to be decent.',
            con: 'The lectures were widely criticized for being boring and repetitive, with many students frustrated by the quizzes and assignments that felt tedious and unhelpful. Grading was slow and TAs were often unresponsive, which added to the negative experience.',
        },
        'spring 2021': {
            pro: 'The course is perceived as very easy and may help set a direction for beginners in software architecture, with some interesting readings included.',
            con: 'The course is poorly organized, with ineffective lectures and a focus on outdated material. Many students find it boring and feel they are not incentivized to learn.',
        },
        'fall 2020': {
            pro: 'The course provides a good introduction to software architecture and design principles, particularly for those with little to no Java experience. Many students found it easy to pass and appreciated the supportive instructors and TAs.',
            con: 'The video lectures are generally considered poorly produced and not engaging, with a heavy reliance on UML which some students found outdated and not useful in practical terms. Project requirements were seen as frustrating by some, and there was a lack of grading and feedback for the final project.',
        },
        'summer 2020': {
            pro: 'The TAs are responsive and helpful, and the course can be an easy A for students who carefully choose their group and put in some effort.',
            con: 'The course focuses excessively on UML, lacks depth in software design patterns, and is generally considered a waste of time with minimal instructional value.',
        },
        'fall 2019': {
            pro: 'The course has a good structure with hands-on and reading/quiz tracks, and offers fair grading if students engage with the material.',
            con: 'Many reviews mention the course being disorganized, dull, and lacking in programming content; grading can be slow and feel subjective.',
        },
        'spring 2020': {
            pro: 'The course is well-structured and easy to pass, especially for those without rigorous software engineering experience. It provides useful insights into UML, design patterns, and software architecture. The teaching team is responsive and supportive, and the assignments are manageable.',
            con: "The course is deemed too focused on UML, with some content considered not very useful, especially for students with prior software engineering experience. There's a heavy reliance on group projects, which can be time-consuming.",
        },
        'fall 2018': {
            pro: 'The course is accessible for software developers and can be a good option to pair with more difficult classes. Offers valuable insights into UML and design patterns. The professor and TA are active and supportive on Piazza.',
            con: 'Assignments often do not align with lectures, with conflicting instructions and grading inconsistencies. Many students felt the course content was either repetitive or not beneficial, particularly for those already familiar with the material. Group project dynamics may lead to imbalanced workloads.',
        },
        'spring 2018': {
            pro: 'The course is a good introductory option for students, provides valuable group project experience, and helps consolidate existing knowledge in Software Architecture and Design.',
            con: 'There is a heavy emphasis on UML diagrams, which some find tedious and boring. The course can have unclear requirements, and grading can be slow.',
        },
        'summer 2018': {
            pro: 'Some students found the course easy with manageable workloads, interesting projects, and helpful instructor involvement such as weekly office hours and interesting readings.',
            con: 'Many students criticized the course for being outdated, unorganized, and lacking clear assignment requirements, as well as for inadequate feedback and support from TAs.',
        },
        'spring 2019': {
            pro: 'Several reviews appreciate the approachable instructors and TAs, interesting projects, and the depth of content on UML diagrams. Some found the course helpful for organizing and documenting software design concepts.',
            con: 'Many reviewers criticized the course for outdated material, vague assignment requirements, slow grading, and a lack of programming focus. Some expressed dissatisfaction with the overall value and questioned the quality of teaching and assessments.',
        },
        'fall 2017': {
            pro: 'The course provides a good introduction to UML, design patterns, and state machines. It is manageable and can be completed without difficulty if you have programming knowledge, especially in Java. The assignments are numerous but doable, and the TAs are active and helpful.',
            con: 'The course videos are often described as dry and boring. There is a significant amount of coding required, and some students feel that the topics covered are outdated. The quizzes do not reinforce concepts well, and grading can be slow.',
        },
        'summer 2019': {
            pro: 'The course is well organized and provides a detailed structure with various assignments and quizzes centered around Software Architecture and Design.',
            con: 'Group projects can lead to uneven workload distribution, resulting in some students feeling overwhelmed and drained.',
        },
        'summer 2016': {
            pro: 'The course offers significant learning opportunities, particularly in UML and software architecture, with a hands-on approach using the Gurobi API, and provides supportive resources such as active TAs and professor office hours.',
            con: 'The course is highly difficult, requires advanced Java skills not taught in class, has a slow grading process, lacks adequate teaching from the professor, and does not allow for grade curving.',
        },
        'spring 2017': {
            pro: 'The course has a clear structure, reasonable workload, and thorough materials, with active engagement from TAs and resources like LucidChart making tasks easier. It is a good refresher for those with a background in system design.',
            con: 'Some Udacity videos are lengthy and tedious, particularly the UML diagrams, and some lectures provide only brief discussions. The course may benefit from more modern architecture topics.',
        },
        'summer 2017': {
            pro: 'The course is well organized and prepared, with regular and informative office hours. It provides practical experience in building applications from the requirements stage to implementation.',
            con: 'Lectures are boring, with one instructor reading from a teleprompter. There are delays in getting responses to questions on Piazza, and the grading for the group project was unclear, as it was not disclosed to students.',
        },
        'fall 2016': {
            pro: 'The course includes well-structured projects that build upon each other, and many students found the group project aspect enjoyable and collaborative. It is a good option for those looking for real-world experience in software design and implementation, especially for those with some background in Java.',
            con: 'Feedback from TAs and instructors is slow, often taking weeks, and grading can be vague and inconsistent. Some students found the course content dry and not engaging, feeling that too much focus was placed on UML and diagrams rather than practical coding and design skills.',
        },
        'fall 2015': {
            pro: 'Interesting and rewarding course with valuable learning experiences and a good team environment.',
            con: 'Very time-consuming and requires a lot of work.',
        },
        'spring 2015': {
            pro: 'The course enhances domain knowledge and offers an interesting perspective on UML and OOAD, encouraging an open mind for better learning.',
            con: 'It requires a significant amount of work, varies in teaching styles, and is recommended to be taken alone.',
        },
        'spring 2016': {
            pro: 'The course offers a choice of team members, provides useful project experiences with real-world technologies, and has responsive instructors. It encourages collaboration and skill development, especially in Java and optimization with Gurobi.',
            con: 'Many students found the reliance on the poorly documented Gurobi framework frustrating. There were concerns about the organization of the course, irrelevant assignments, outdated lectures, and the heavy reliance on team-based projects that could hinder personal scheduling.',
        },
    },
};
