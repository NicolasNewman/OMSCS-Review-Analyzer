export default {
    ...
    reviews: [
        {
            ...
            review: 'Really learned a lot from this course from a theory to code implementation.\nHomework: A total of 6 homeworks which make up 70% of your grades. Homeworks are a good balance between theoretical questions (think why would we use this algorithm / derive this equation) and practical coding questions (write up the KMeans algorithm from scratch). Homeworks are generally tougher for the first 3 and subsequently gets slightly easier. Start your homeworks early because it really is a time-sink as you also have to present the homework in a report format. Marking is generally lenient\nProject: Project makes up the remaining 30%. In my opinion, the project seems easier than homeworks because you can use packages to solve the problem you have specified.\nPre-reqs needed: Linear Algebra and Multivariate calculus. Do not skimp on this because it definitely is needed for the homeworks in solving the theoretical questions.\nI will highly recommend this course because it really does provide the theoretical rigour as well as the difficulty from coding.',
            rating: 5,
            difficulty: 4,
            workload: 10,
        },
        {
            user: 'lfyPLYw7RL2qliLO1CLJng==',
            reviewDate: 'June 19, 2024',
            semester: 'spring 2024',
            review: "This course teaches machine learning, involving both theory and applications, mostly uses bishop's book.\n.\n\nHomework: Most homework has a small part of math proof / hand calculations (say about 20%), a part that you can do some sklearn stuffs, and occasionally will ask you to code down the algorithm. The questions had good quality, mostly clearly stated and the objectives are clear. Grading is lenient but fair. Typically it takes up one to two full days to finish it.\nProject: Another highlight of the course. You can pair up with others or do solo. A lot of flexibility, and a good place to apply thing learned in course.\nLecture: Very high quality lectures with enough math rigor. Professor Xie does a phenomenal explaining the ideas with using clear mathematical formulations. The way the topics are organized also demonstrates a significant amount of effort being put in designing this course.\nTAs: Phenomenal teaching team. Responsive and very helpful to questions, willing to give out additional materials.\n.\nFinal remark: In iCDA, you get to kind of know the ML landscape. In CDA, one sees more of the inner workings. I enjoyed this course a bunch, probably the most well-organized course in the program. Highly recommend it (at least if you have a solid undergraduate linear algebra, probability theory).\n",
            rating: 5,
            difficulty: 4,
            workload: 16,
        },
        ...
        {
            user: 'mprzBRYbbr58cGeRJhueGw==',
            reviewDate: 'April 28, 2023',
            semester: 'spring 2023',
            review: "Overview:\nI am in my final semester (other than the practicum) and this has been one of my two favorite classes in OMSA (along with Data Mining, IE-7406).  I would recommend this to EVERY OMSA student.  This class is the reason you want to go into Data Analytics and Data Science.\nMy Background:\nSo everyone knows where I am coming from....  I am only a marginal Python programmer and weak in probability/statistics, but I am very strong in calculus, linear algebra, and analytic modelling.\nCourse Layout:\n6 Homeworks - generally due every 2 weeks, and 1 Project due at the end of the semester.  NO Exams!\nPersonal Notes:\nI was originally intimidated by this class because it seemed to be a high level coding class where you are re-creating already developed models from scratch - and solving complex coding problems is distinctly not my strength.  While the building models from scratch is generally true, it turns out that most of the code you need is provided to you in the sample code examples.  Furthermore, after the first 2-3 homeworks, you are using generally using packages rather than recreating the wheel.  In fact, by the second half of the semester, I was only having to work on this class about every other week because I would be able to finish the lectures and the homework the first week and wouldn't have anything to do until the next set of lectures/homework was released at the end of the second week.\nOverall, this class has been much easier than I originally expected/feared and has turned out to be one of my favorite classes in the entire program.\nChallenges/Observations:\n\nThe grading is very lenient, so don't avoid this class because you don't think you can pass it.  It is almost impossible to get less than a B if you put a good faith effort in doing the homework and you turn all the assignments in.  Right now, I think the class average is about a 96.\nThe theoretical questions can be tough.  If you don't have a strong math background they will take a good bit of time.  I found that the statistics based questions generally took me several hours to research and answer (Google is a Godsend!).  For me, the proofs based on derivatives and integrals were not very difficult, however.\nIf you have experience using analytical models, the modeling questions are straightforward.  If you don't have a strong background in analytic modelling, I would recommend taking the Data Mining class first.  While most of the problems there are based in R rather than Python, that course is really an applied analytic modelling course. It will give you a GREAT background in what each type of model is doing and how it works.\nGet comfortable with linear algebra!  The first half of this course is converting linear algebra equations to Python code.  If you don't understand the linear algebra, it makes everything else that much more difficult.  Even though I have a good background in linear algebra, I did brush up on it before starting the class, and that review helped immensely.\nPick a project early!  I built on a project I started for IE 7406. That way, even though I had to convert the code from R to Python, I already had the foundation laid and could work on some more sophisticated aspects of the problem I could not get to in that class.  If you don't have something already handy, don't wait until the end of the class to pick a project.  This is also where having taking IE 7406 would help.  You learn MANY more modelling techniques in that course, so you will have a larger toolbox to choose from for your project.\nDo not plagarize/cheat!  The professor is very serious about this.  If you need to use some some small sections of code you find online to help finish your homework that is fine but provide attribution in your script!!!  There have been some people get in big trouble this term for plagarizing code.\nThere are tons of office hours - typically several per day.  Take advantage of them.  Even if you can't attend them in person, they are recorded so that you can listen to them later.   That is typically what I did.\nRead the ED discussions regularly.  If you are stuck on a homework, it is a given that a bunch of other people are stuck at the same place.  There were always helpful tips and hints in ED.  A lot of times people would post their graphical outputs as part of thier questions, and comparing your output to these would give a great indicator of whether your code was correct or not.\n\nBest of luck and enjoy this course!",
            rating: 5,
            difficulty: 3,
            workload: 14,
        },
        {
            user: 'eS/hfZfXrmyKAfuOqr5qng==',
            reviewDate: 'April 26, 2023',
            semester: 'spring 2023',
            review: 'Professors videos have low sound quality and her thoughts are often all over the place. A lot of the actual learning and understanding came from the TAs through ed discussion or the many office hours that you can attend and ask questions.',
            rating: 4,
            difficulty: 4,
            workload: 15,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 16, 2022',
            semester: 'fall 2021',
            review: 'This is a must for OMSA folks. Thoroughly enjoyed the content, homeworks, and project. The teaching team were fantastic. No background in maths nor stats but learnt a lot and managed to survive with an A.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: 'The course is front loaded, expect to spend 20+ hours if your programming/math is a bit weak the first few weeks. After that, it does ease up a bit. Found myself watching YouTube videos for more intuitive explanation before watching and diving into the lectures which are notation heavy. Professor seems very active on Piazza and hosts TA sessions.',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        {
            ...
            semester: 'fall 2020',
            review: "This was my third course in OMSA. Professor is very sincere in her efforts. She is active on piazza. She is one of very few professors who holds weekly office hours. All TAs have weekly office hours too. Basically there is at least one office hour every day. So it is easy to ask for help if you need to understand something immediately. Grading is fair and easy to get a A with some sincere efforts. Gives a good overview and understanding of many commonly used machine learning algorithms.\nHowever initial lectures are difficult to understand. Needs some initial efforts. It is much easier if you listen to Andrew Ng's lectures to understand the concepts.\nThere are 6 assignments  and a project. The first three assignments require you to implement model code from scratch ( cannot use libraries), so the first 3 assignments are more difficult than the last three.  Each assignment has mathematical concept questions as well as coding. She however gives demo codes with all the lectures which helps with the assignments. If you understand the demo codes it is easy to complete the assignments. She also gives homework explanation videos which helps with the assignments.\nProject can be done individually or in groups of 3. Choose your teammates wisely. Project was the most satisfying part of this class.",
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2020',
            review: 'Taking this class over the summer was difficult, because it was a lot more work than anticipated. Most of the time is spent on doing the homework, and the lectures were often too high-level.  The project was good, but I had a good team and we all split responsibilities evenly.\nI was hoping for a class to really get a deeper understanding of different AI/ML methods, but that was not the case. Just disappointed in how it turned out.',
            rating: 2,
            difficulty: 4,
            workload: 10,
        },
        {
            ...
            semester: 'summer 2020',
            review: 'Taking this course in the summer is very difficult. The assignments are graded very easily, but to adequately learn all the information it will take a significant amount of time. Great concepts though. Also, I received an A',
            rating: 4,
            difficulty: 5,
            workload: 25,
        },
        {
            ...
            semester: 'summer 2020',
            review: "\n\nDifficulty: The course content is relatively harder comparing to the introductory and basic courses. However, It's very easy to get an A. In fact, it is too easy. I doubt if the true performance can be differentiated by the grades.\n\n\nProject: could have been due earlier so that TAs have more time look into the details and give a mark that can truly reflect the quality of work.\n\n\nHomework: probably you will spend most of the time working on the homework rather than trying to get a deeper understanding of the course materials. The homework does help us understand the concepts to a certain extent.\n\n\nCourse Videos: There are a lot of theories rather than teaching the practicals, such as model selection, hyper parameter tuning. The notations used could be inconsistent sometimes and it's harder to understand them.\n\n\nOffice Hours: There are so many of them!!! Professor and each TA has one office hour every week. I didn't attend any due to time zone difference. Also don't feel the need to watch them later as I don't know which one to watch and most of the questions will be clarified in Piazza.\n\n\nOverall, taking this course in summer can be intense. I would recommend to take it in fall or spring to have a better pace and more time to grasp all the concepts. I would also recommend to spend more time on the project, as you are dealing with a real-life problem and you could use more time to solve all sorts of problems a data scientist could face.",
            rating: 4,
            difficulty: 3,
            workload: 4,
        },
        {
            ...
            semester: 'summer 2020',
            review: 'Its very easy to get an A in this course. Content is good and I definitely learned a lot about the math behind different ML techniques.',
            rating: 3,
            difficulty: 2,
            workload: 8,
        },
        {
            ...
            semester: 'summer 2020',
            review: "I enjoyed the course, but like others have said, some of the material is not presented in the best way. There's a lot of good content and I learned a lot, but most of what I learned came from exploration and readings on the internet.\nI found the homeworks really useful in cementing in my learning of the material and actually learning how the models/approaches worked. The lecture videos went in depth in the math behind the models, and sometimes too much so. In some places the notation was inconsistent and unclear, but ultimately those issues were smoothed out with announcements and explanations on Piazza.\nIn the summer session we had five homeworks and a final project, with each assignment due two weeks apart. Typically I would wait until the weekend a project was due and crank out ten hours of work in 2 or 3 days, but it definitely would've been more efficient to spread my effort across the two weeks we were given.\nThe TA's graded really easily and we got 3 one-week homework extensions (normally only 2), which made earning 80% of the grade relatively easy. The final project was pretty simple too and gave us freedom to pick a topic of our choosing. Didn't start on that until after homework 5, but it was released a few weeks into the semester so I imagine you could finish it really early if you wanted to.",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        {
            ...
            review: 'Take-home message: Excellent contents, good workload, and easy to get an A. You can learn fundamental machine learning algorithms by doing assignments, reading books, watching YouTube, asking Professors and TAs, not by watching lecture videos.\nContent:\nThis course covers lots of fundamental machine learning algorithms such as K-means, SVM, boosting algorithms. These algorithms concepts are always tested in interviews and you will benefit a lot by taking this course.\nWorkload:\nIt’s quite even spaced. This course has 7 biweekly assignments and 1 take-home final exam (open book, 10 days to finish).\nScoring:\nYou will get a high score (90+) if you put 8-hour efforts on this course.\nCourse overall\tpros:\n\n\nProfessor and TAs are very responsive on Piazza. The side effect is that you may spend 1-2 hours reading Piazza posts when homework is not clear.\n\n\nYou will get solutions to all assignments. Solutions are helpful because you do not get comprehensive assignment feedback by TA.\n\n\nYou will learn lots of math proof that pushes you to read books, ask TAs or search Google. Half of the assignments are math problems that are difficult for me but I can always find answers after several hours.\n\n\nCourse overall\tcons:\n\nLecture video teaches algorithms with lots of terms/math that is super difficult to understand. Basically you cannot learn algorithms by lecture videos. I highly recommend you use Piazza, Youtube, and books to learn these fundamental/popular algorithms.\n',
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        {
            ...
            semester: 'spring 2020',
            review: "My 8th class in the program. This was a good class for a survey of machine learning methods that goes into more detail than ISYE 6501 and 6040. It felt like a fusion of both classes, taking in about the level of algorithmic detail of 6040 and the modeling power of 6501.\nPros:\n\n\nNot an overwhelming workload even for your average OMSA student (learned coding through MOOCs, might be rusty/underqualified on their multivariate calculus, not really sure what a subspace is or what eigenvectors have to do with anything).\n\n\nMany practical topics covered with practical assignments I will likely reference in the future.\n\n\nTAs and Professor were incredibly patient with students who do not understand the prerequisite math needed to get through proofs which for me was very important. The professor was at her office hours every week, which I haven't seen in any other courses I've taken\n\n\nCons:\n\nLecture videos were not great. Prof Xie does have an accent and kind of reads of slides\n\nOverall, this class was great but it makes me wish I invested more learning the background math needed to truly grasp topics like optimization, MLE etc..",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'This was the first semester it was offered online so it did have some bugs….but overall not bad.  The TA’s did a great job and were very helpful.  Professor Xie (who has a heart of gold) is one of the few Professors in the program to have office hours and will work with the students to understand the concepts.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
    ...
    reviewSummaries: {
        'spring 2024':
            "The course effectively combines theoretical concepts with practical coding applications in machine learning, utilizing materials like Bishop's book. Students appreciate the quality and clarity of the homework assignments, which balance theoretical and practical elements, though early completion is advised due to their time-consuming nature. While some found the initial homeworks challenging, the project is seen as a more manageable aspect, offering flexibility for individual or group work. Lectures are well-organized and rigorous, supported by a responsive teaching team. However, some pre-requisite knowledge in linear algebra and calculus is essential. Overall, students highly recommend the course for its comprehensive approach to foundational machine learning principles, despite its inherent challenges.",
        'fall 2023':
            'The course offers a comprehensive exploration of machine learning algorithms, emphasizing practical coding alongside foundational mathematical concepts. Students appreciated the balance between theory and application, with the lectures being crucial for understanding and completing homework assignments, which are challenging yet educational. Some found the mathematical proofs difficult, especially those less comfortable with calculus, suggesting a desire for more hands-on exercises instead. While the grading system focuses on report quality over code accuracy, which can be frustrating, supportive TAs and a well-structured project helped enhance learning. Students recommended not co-taking this course with DataViz and advised strengthening foundational calculus knowledge beforehand. Overall, learners felt the course was demanding but rewarding, providing valuable skills and insights into machine learning.',
        'spring 2023':
            "The course has been well-received by students, with many highlighting it as a favorite due to its engaging content and practical applications in Data Analytics and Data Science. They appreciate the lenient grading system, which makes it accessible even for those with limited programming backgrounds. However, challenges arise from challenging theoretical questions, particularly for students lacking a strong math foundation. The course involves substantial use of linear algebra, and students recommend reviewing these concepts beforehand. While the professor's video quality is noted as a drawback, students found support through TAs, office hours, and online discussions, which enriched their learning experience. Overall, it is seen as a rewarding class that prepares students well for future work in the field.",
        'fall 2022':
            'The course is described as challenging yet engaging, with homework assignments likened to practical labs that provide a tangible sense of achievement. Many students appreciate the opportunity to apply their skills to real-world applications, such as image compression and face recognition. However, some reviewers express concerns about the heavy emphasis on mathematical theory, which they feel detracts from the professional focus of the degree and may not align with the needs of most students. Additionally, there are complaints about the clarity of homework instructions; students often struggle to understand the parameters and expected outcomes, leading to confusion and frustration before they can even start the assignments.',
        'spring 2022':
            'The course received high praise for its well-structured content and engaging delivery, with many students appreciating the knowledgeable instructors and interactive elements that enhanced their learning experience. Positive reviews highlighted the practical applications of the material and the supportive community among participants. However, some reviews pointed out areas for improvement, such as the pace being too fast for beginners and a lack of resources for deeper understanding. A few participants also expressed dissatisfaction with the limited feedback on assignments, suggesting a need for more personalized guidance. Overall, the course is viewed favorably, but adjustments could enhance the experience for all learners.',
        'fall 2021':
            'The course received mixed reviews, highlighting both its strengths and weaknesses. Many students praised the engaging content, responsive teaching team, and valuable insights gained into machine learning algorithms, especially emphasizing their improved understanding of mathematical concepts and practical applications. However, several complained about the demanding homework load and the assumption of a strong background in linear algebra and Python programming, which can leave less-prepared students struggling. There were also frustrations regarding the lecture structure, with longer sessions that made reviews difficult, and instances of contradictory information from TAs. Overall, while the course is seen as essential for those in OMSA, it may require a strong math foundation and better structural clarity to enhance the learning experience.',
        'summer 2020':
            'The course has received mixed reviews, highlighting both strengths and weaknesses. Many students appreciated the hands-on approach to machine learning, the helpful TAs, and the abundance of office hours, which provided support for challenging assignments. However, the workload during the summer session felt overwhelming for some, as they expected a deeper understanding of AI/ML methods but found the lectures overly high-level. While grading was deemed lenient, allowing many to easily achieve high grades, this led to concerns about differentiating true performance. Some noted that homework was essential for solidifying understanding, though the course content sometimes lacked clarity and practicality. Overall, students recommended taking the course during a regular semester for a better learning experience.',
        'summer 2021':
            'The course has notable strengths, such as engaging assignments, ample TA support, and a personable, captivating professor who offers weekly office hours. Grading is perceived as generous, rewarding hard work. However, its drawbacks include lengthy, unclear lectures filled with extraneous information and poor delivery, leading to student disengagement. Math derivations also pose challenges. The course structure, particularly in the summer, is criticized for having fewer, more demanding assignments, which may hinder learning. Students suggest that lectures could improve significantly by streamlining content and avoiding improvised delivery. Overall, while CDA excels in technical depth, DMSL is preferred for its systematic problem-solving approach and better learning experience.',
        'spring 2021':
            'The course offers a robust mix of advanced statistical learning and practical applications, striking a balance between theory and real-world implementation. Reviewers praise the clear instructions of challenging assignments and the engaging professor, who maintains excellent communication through office hours and online forums. However, criticisms arise regarding the quality of lecture materials, often relying on external resources for understanding. The emphasis on theory over practical application and a lack of feedback on the substantial final project are notable downsides. While students with strong backgrounds in Python and mathematics may thrive, others may find the demands overwhelming. Despite these drawbacks, many consider it one of the best courses in the OMSA program.',
        'fall 2020':
            "The course offers a deep theoretical understanding of machine learning, with challenging homework that includes implementing algorithms by hand. Many students appreciate Professor Xie's dedication, engagement on Piazza, and availability for office hours, which provides ample support. However, the initial lectures are often deemed difficult and not engaging, leading some to seek external resources for clarity. The workload averages around 20 hours per week, with early assignments being particularly tough but easing later on. While students praised the final project for its flexibility, frustrations arose from an abundance of reference materials and some disorganized TA support. Overall, the class is recommended for those serious about mastering ML, but initial hurdles may deter less committed learners.",
        'spring 2020':
            "The course offers valuable insights into fundamental machine learning algorithms like K-means and SVM, praised for its even workload and responsive instructors. Many students found success in achieving high scores with minimal effort, while assignments and practical applications provided a helpful review. However, the lecture videos were a significant drawback, often confusing due to heavy mathematical jargon and the professor's accent, leading some to seek external resources for understanding. The math-heavy assignments posed challenges, especially for those lacking a solid background, causing frustration despite accessible solutions. Overall, while the course is deemed beneficial for mastering concepts, it requires substantial self-guided learning beyond the lectures.",
        'fall 2019':
            'The course received overall positive feedback for its engaging layout, flexibility in programming languages, and the supportive role of Professor Xie and her TAs. Many students appreciated the open-book, take-home exams, and found the assignments challenging yet manageable. The lectures were considered helpful, though some students felt they could succeed without them. However, some mentioned that the online format faced initial bugs. While the course was praised for its conceptual focus and depth in machine learning, a few students desired more challenging content to enhance their learning experience. Overall, it was viewed as a valuable introduction to machine learning concepts, particularly for those willing to invest extra time in research and application.',
    },
};
