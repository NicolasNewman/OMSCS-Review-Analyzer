export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course provides a strong balance of theory and practical coding skills, high-quality lectures, and a supportive teaching team. Students find the assignments clear and challenging, with a good grading policy and flexibility in projects.',
            con: 'Some homeworks are reported to be tough, especially in the beginning, and the workload can be time-consuming. Prerequisites in mathematics are necessary.',
        },
        'fall 2023': {
            pro: 'The course offers a strong coverage of machine learning algorithms, balancing theory, math, and practical coding with good resources and engaging assignments. The project allows students to explore new datasets and models, enhancing learning experiences.',
            con: 'Students noted a lack of emphasis on code quality in grading, and the lengthy lectures can be cumbersome to navigate. Some struggled with the required mathematical background and found the grading feedback to be delayed.',
        },
        'spring 2023': {
            pro: 'The course is highly recommended for OMSA students, with lenient grading and valuable support through office hours and ED discussions. Most coding required is provided in examples, making it easier than expected.',
            con: "The professor's videos have low sound quality and can be disorganized, requiring students to rely on TAs for understanding. The theoretical questions may be challenging for those without a strong math background.",
        },
        'fall 2022': {
            pro: 'The course is challenging but interesting and engaging, with satisfying homework assignments that allow students to see practical applications of their work.',
            con: 'The course is heavy on mathematical theory which may not be valuable for most students, and some homework problems lack clear explanations.',
        },
        'spring 2022': {
            pro: 'The course was described as superb.',
            con: 'N/A',
        },
        'fall 2021': {
            pro: 'Students appreciated the depth of the material, the helpful teaching team, and the challenge it provided. Many felt their understanding of machine learning improved significantly, particularly in mathematical concepts and practical applications.',
            con: 'There were concerns about the class structure, including lengthy lectures without proper indexing, a lack of guidance for homework implementation, and contradictory information between TAs and course content. Additionally, the demanding workload for assignments was noted as a significant challenge.',
        },
        'summer 2020': {
            pro: 'The course covers interesting machine learning concepts and provides a good foundational understanding. There are many office hours available, and homework assignments are helpful in solidifying learning.',
            con: 'The course is overly lenient with grading, making it hard to gauge true understanding. Some students found the material presentation lacking, leading to difficulties in grasping essential concepts.',
        },
        'summer 2021': {
            pro: 'Interesting assignments, ample TA support, engaging professor, and generous grading.',
            con: 'Poor lecture quality, long and unclear presentations, and limited homework assignments in the summer.',
        },
        'spring 2021': {
            pro: 'The course provides a balanced mix of theory and practical applications, with clear and challenging assignments that enhance understanding. The professor is engaging and provides ample support through office hours and walkthrough videos.',
            con: 'The quality of the lecture videos is considered inferior, requiring reliance on external resources. There is a lack of feedback on the final project grading, and the homework may be overly focused on theory at times.',
        },
        'fall 2020': {
            pro: 'The course provides an in-depth understanding of machine learning algorithms, with engaging and supportive professors who actively participate in discussions and offer numerous office hours. The assignments encourage a strong grasp of both theory and practical implementation.',
            con: 'The course is front-loaded and challenging, particularly in the beginning, requiring significant time commitment (20+ hours per week). Some students found the lectures boring and the initial materials difficult to comprehend.',
        },
        'spring 2020': {
            pro: 'The course offers excellent content on fundamental machine learning algorithms, a well-balanced workload, and high responsiveness from the professor and TAs. Students appreciate the practical assignments and supportive resources like Piazza and Slack.',
            con: 'Lecture videos are difficult to understand due to poor presentation and transcription, and many students find they do not learn effectively from them. Homework is challenging and time-consuming, often requiring external resources for better understanding.',
        },
        'fall 2019': {
            pro: 'Students appreciated the helpfulness of Professor Xie and the TAs, along with the flexible course format and open-book exams. The course provided significant insights into machine learning concepts and encouraged practical implementation of algorithms.',
            con: 'Some students noted that the course was easier than expected, and the online format initially had bugs. A few mentioned that they might have learned more if the course were more challenging.',
        },
    },
};
