export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'Lenient grading and the ability to choose own groups for projects.',
            con: 'Lack of active engagement from the professor and TAs on Ed Discussion.',
        },
        'fall 2023': {
            pro: 'The course provides a guaranteed easy A and has generous grading rubrics, making it accessible for students to pass successfully. Some students found value in group work and the Arduino assignment was highlighted as enjoyable.',
            con: 'The course is criticized for poor organization, ineffective communication from TAs, unprofessionalism among instructors, and a lack of substantial learning content. Many reviews mention frustration with group projects and the course being more focused on busy work rather than meaningful education.',
        },
        'spring 2023': {
            pro: 'The subject matter is interesting, lectures are engaging, and the content is unique, offering multiple perspectives from different lecturers.',
            con: 'Major issues with team reliance for grading, inconsistent grading practices, confusing course structure between online and in-person formats, and frustrating assignments.',
        },
        'summer 2023': {
            pro: 'The course content is engaging, with a fun Arduino exercise and very helpful TAs. The video lectures are well-produced, featuring industry professionals, and grading is generous. The instructor is genuinely interested in student success.',
            con: 'The single Arduino assignment and the varied submission deadlines caused some confusion. Team selection was random and informal, and the organization of the Ed board was chaotic.',
        },
        'fall 2022': {
            pro: 'The course provides weekly meetings with a professor and opportunities for team interaction, which some students appreciated.',
            con: 'The course is poorly organized with tedious assignments, lack of feedback, unfair grading, and a frustrating group project experience, particularly with the use of Arduino.',
        },
        'spring 2022': {
            pro: 'The course has a very supportive professor and TAs who are engaged with students, providing ample attention and mentoring for projects.',
            con: 'The course lacks sufficient hands-on work and is perceived as busy work with a focus on high-level concepts rather than practical application.',
        },
    },
};
