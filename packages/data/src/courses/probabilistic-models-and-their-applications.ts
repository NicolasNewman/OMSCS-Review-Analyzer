export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course material is interesting and the professor and TAs are helpful and engaged. Many students appreciate the challenging nature of the content and the thorough reviews of fundamentals.',
            con: 'There is a significant gap between lecture content and homework/exam expectations. Exams are difficult with low average scores, and many students find the workload and grading system demanding and frustrating.',
        },
        'fall 2022': {
            pro: 'The professor is experienced and provides clear guidance, using the whiteboard effectively for teaching without relying on slides. The learning experience is described as smooth despite the challenging material.',
            con: 'The course is fairly challenging, which may not suit everyone.',
        },
        'summer 2020': {
            pro: 'The course is easy for those with a stats background or prior coursework.',
            con: 'N/A',
        },
    },
};
