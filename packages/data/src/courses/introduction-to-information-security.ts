export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course has an engaging CTF style, instant score feedback, and no lectures or exams, which can be rewarding. Students appreciate the insight it provides into using programming for system exploitation.',
            con: 'The course has unclear instructions, making projects take much longer than necessary, and emphasizes rules that hinder collaboration, which may frustrate students.',
        },
        'fall 2023': {
            pro: 'Some students found the course interesting and manageable for obtaining high grades, appreciating the hands-on, project-based approach and support from fellow students in Ed Discussions.',
            con: 'Many reviews highlighted a lack of meaningful instruction, ineffective TAs, vague project instructions, and an overall frustration with the course structure, with some feeling it taught them little about information security.',
        },
        'summer 2024': {
            pro: 'The course features well-crafted projects that are engaging and similar to puzzle-solving, providing immediate feedback through auto-grading.',
            con: "The heavy workload with 9 projects in a short timeframe, lack of collaboration, and varying levels of students' preparedness lead to confusion and feelings of being overwhelmed.",
        },
        'summer 2023': {
            pro: "The course offers engaging and enjoyable projects, primarily in a 'capture the flag' style, making it suitable for beginners in Information Security. It helps students develop a disciplined routine for managing coursework alongside other commitments.",
            con: 'There is a lack of connection between the lectures and the projects, leading to confusion about which lectures to watch. Some students also reported inconsistent support from TAs.',
        },
        'spring 2023': {
            pro: "The course features engaging and fun projects, allows unlimited re-submissions, and provides responsive TAs. It's a practical, project-based format that offers exposure to various topics in information security.",
            con: 'There is minimal instruction and guidance; many projects lack clarity and quality, especially the Machine Learning project. Students must be very self-driven, and some found the TA support inadequate and unhelpful.',
        },
        'summer 2022': {
            pro: 'The course offers a broad range of hands-on projects that cover key technologies and concepts in information security, providing a valuable learning experience for dedicated students.',
            con: 'Many students find lectures boring and ineffective, with a significant reliance on TAs for support, who may not adequately address content from the videos. Assignments can be challenging, and a hard grading curve places pressure on project performance to achieve high grades.',
        },
        'fall 2022': {
            pro: 'The course is engaging and hands-on, with well-crafted projects and a supportive online community. Many students found it interesting, manageable, and appreciated the lack of traditional exams.',
            con: 'There were complaints about the lack of instructional support from TAs, insufficient theoretical coverage, and that the course may be too easy for those with a strong cybersecurity background.',
        },
        'fall 2021': {
            pro: 'The course covers a wide breadth of information security topics, offers engaging projects, and has helpful TAs who are responsive and organized. Quizzes and exams are considered manageable for those familiar with the content, and project guidelines are clear for most assignments.',
            con: 'Many students find the course stressful due to poorly structured project instructions and vague grading criteria. There is criticism of TAs for being unhelpful, and some lectures are perceived as uninspiring. A significant focus on formatting and citation in assignments adds to the frustration for students.',
        },
        'spring 2022': {
            pro: 'Many students appreciated the interesting and varied projects, the support from TAs, and the diverse course content. Several found it manageable for beginners and a good introduction to information security.',
            con: 'Numerous reviews pointed to issues with unclear project instructions, dry lectures, and a challenging grading system that penalizes small errors. Some students felt overwhelmed by the breadth of information and experienced frustration with the course structure and TA responses.',
        },
        'spring 2021': {
            pro: 'Many students appreciate the projects for their practical relevance and challenge level. The TAs are often described as knowledgeable and helpful, particularly in providing guidance on projects. Quizzes are easy and serve as a good learning tool, and students find the course well-organized with comprehensive content.',
            con: 'A significant number of reviews criticize the instructor and TAs for being disengaged or unhelpful, especially in relation to project support. The course structure is noted to sometimes foster a stressful environment due to grading practices and communication issues. Some students found the lectures dry and not particularly useful for project completion, leading to a sense of frustration.',
        },
        'summer 2021': {
            pro: 'The course is well-organized and covers a variety of material, with many students appreciating the learning outcomes and the fun nature of the projects. TAs are seen as patient and helpful, and some students found the course to be insightful and enjoyable, despite the challenges.',
            con: "There are significant issues with grading inconsistencies, delayed feedback, poorly worded quizzes, and a lack of support from instructors. Some students feel the course is not challenging enough, and there is frustration regarding the TAs' communication style and the vague nature of assignment requirements.",
        },
        'fall 2020': {
            pro: 'The course offers a broad introduction to information security with engaging projects, helpful TAs, and many opportunities for extra credit. Students appreciate the sense of achievement from completing challenging projects and the supportive peer community.',
            con: 'The TAs are often unhelpful or difficult to communicate with, and many students find the lectures and textbook inadequate. There is confusion about grading strictness and exam preparedness, with a notable divide in student experiences based on background knowledge in computer science.',
        },
        'summer 2020': {
            pro: 'Some projects are interesting and rewarding, and the course can be manageable for those with a CS background. There are also positive comments about the helpfulness of TAs and the enjoyment of certain projects.',
            con: 'The course material is outdated and difficult to engage with, the instructor support is lacking, and grading appears inconsistent. Many reviews express frustration with the course structure and the unhelpfulness of the textbooks and TAs.',
        },
        'spring 2020': {
            pro: 'Many students found the coursework engaging and learned a lot, particularly enjoying the hands-on projects that provided practical knowledge in cybersecurity topics. Several TAs were described as helpful and responsive in offering assistance, especially on Slack and Piazza. Some learners noted that the projects were challenging yet rewarding and offered real-world applications.',
            con: "Numerous reviews pointed to issues with the instructors being largely absent or unhelpful, leading to frustrations with ambiguous grading, unclear project instructions, and a lack of guidance. Many students felt overwhelmed by the course's difficulty, especially without a strong programming background. Additionally, several noted the exams and quizzes were poorly structured, with a heavy reliance on memorization and lacking clarity.",
        },
        'fall 2019': {
            pro: 'The projects are enjoyable, engaging, and provide hands-on experience with security topics. Many students found the course material to be interesting and foundational, with some praising the TAs for their helpfulness and responsiveness on communication platforms like Slack.',
            con: 'The course suffers from poor lecture quality, inflexible TAs, slow grading, and poorly worded exams and quizzes that focus on rote memorization. Many students reported issues with the accessibility of course materials, especially textbooks, and a lack of support from the teaching staff.',
        },
        'summer 2019': {
            pro: 'The projects are varied, fun, and account for a significant portion of the grade, providing practical learning experiences. Some students appreciated the TAs for being helpful.',
            con: 'Lectures and course material are often described as dry and uninspiring. Quizzes and exams are frequently reported to have errors and ambiguities, leading to frustration among students. TAs and the course management received negative feedback for being unprofessional and unhelpful.',
        },
        'fall 2017': {
            pro: 'The course is described as interesting with great projects and a good introduction to security concepts. Many reviewers noted that the projects were engaging and applicable in real-world scenarios.',
            con: 'Critics mentioned issues with unclear instructions, a lack of professor engagement, and heavy reliance on the textbook. Some found the lectures dry and not very helpful, while others felt the quizzes and exams focused too much on rote memorization.',
        },
        'spring 2018': {
            pro: 'The course has engaging projects that help students learn effectively, with many reviewers appreciating their interesting and challenging nature. The workload is generally manageable and quizzes are easy, aiding successful completion.',
            con: 'Many students found the readings tedious and the exams poorly worded or overly specific, leading to frustration. There are complaints about the organizational aspects and instructor involvement, contributing to a lack of clear communication regarding course management.',
        },
        'fall 2018': {
            pro: 'The course is considered a good introductory class to cybersecurity with engaging projects, helpful TAs, and manageable materials. Most students found the projects to be fun and informative, providing practical experience.',
            con: 'Lectures are often viewed as boring or poorly delivered, with some reports of a lack of interaction from the professor. The quizzes and exams can be tricky, and project instructions may not always be clear, making some assignments more difficult.',
        },
        'fall 2016': {
            pro: 'The course features engaging projects that are both interesting and practical, an effective teaching approach, and manageable workload. Quizzes are open book and easy points, and the textbook provides comprehensive material.',
            con: 'Exams are closed book and can be tricky, leading to low averages despite not being hard conceptually. Some students found the grading confusing and the extra credit project structure problematic.',
        },
        'spring 2019': {
            pro: 'The projects are highlighted as the best aspect of the course, being engaging, well-designed, and providing substantial learning experiences. TAs are actively involved and helpful, especially on Slack, and quizzes are considered easy grade boosters.',
            con: "Exams can be frustrating due to poorly worded questions, and they don't seem to align well with the quizzes. Some students reported issues with ambiguous project requirements and found the course workload challenging without a solid programming background.",
        },
        'summer 2018': {
            pro: 'The course includes interesting and engaging projects that provide hands-on experience in information security topics like buffer overflows, malware analysis, and web vulnerabilities. The TAs are responsive and helpful, and the course provides a good overview of key security concepts.',
            con: 'Quizzes and exams are criticized for being poorly worded and for relying heavily on rote memorization from the textbook. The grading for projects can be overly strict, and the structure of the course may feel rushed during the summer semester. Additionally, the professor is largely absent from course interactions.',
        },
        'spring 2017': {
            pro: 'The course features enjoyable and engaging projects that enhance understanding of information security concepts. The exams and quizzes are manageable with proper preparation, and the textbook is considered helpful. The TAs are responsive and supportive.',
            con: 'There is a lack of instructor presence and support, causing organization issues. Some students found the course to be overly easy or filled with unnecessary busy work, making studying difficult due to unclear sources for exam questions.',
        },
        'summer 2017': {
            pro: 'The course offers a fun introduction to information security with interesting projects and a low workload. Many students found the lectures informative and enjoyable, making it a suitable choice for beginners.',
            con: 'Numerous reviews highlight issues with exams and quizzes being based on rote memorization, dry reading material, and disorganization from TAs. Some projects lack depth and students felt the course could serve primarily as a GPA booster.',
        },
        'fall 2015': {
            pro: 'The course includes interesting projects that help cement knowledge, and provides a significant amount of work that can enhance learning. Lectures are generally well-received and the course material is intriguing.',
            con: 'Poor TA support and issues with reference materials. The reading material is often considered boring and the exams require extensive reading of the entire book, which some found challenging.',
        },
        'summer 2016': {
            pro: 'The course is well-balanced and informative with enjoyable projects that are engaging and challenging, fostering a fun learning environment for students new to the field of computer security.',
            con: 'The lectures often lack depth, the course structure seems rushed, and there were significant issues with project clarity and TA communication, leading to frustration for some students.',
        },
        'spring 2016': {
            pro: 'The course includes interesting projects, covers relevant topics, and offers a light workload with options for extra credit. Many students found it enjoyable and engaging.',
            con: 'The course suffers from technical difficulties with projects, unclear presentations, poor quiz quality, and a heavy reliance on textbook content. Some feedback indicates issues with TAs and confusing instructions.',
        },
    },
};
