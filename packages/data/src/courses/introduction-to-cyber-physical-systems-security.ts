export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'Project 3 was highly praised for its content and learning opportunities, while Project 2 was noted for being quicker and interesting.',
            con: 'The course had a lack of depth in lectures, Project 1 was very time-consuming, and Project 4 was considered unhelpful and poorly designed.',
        },
        'fall 2023': {
            pro: 'The course covers important concepts in security and cyber physical systems.',
            con: 'The class is poorly run with unhelpful TAs, compatibility issues with M1 chip computers, and requires self-teaching of additional programs not covered in the prerequisites.',
        },
        'spring 2023': {
            pro: 'The exams are easy and manageable, with clear instructions for projects that help guide students.',
            con: 'Lectures are dry and repetitive, projects feel tedious and do not build on each other, overall course lacks depth and rigor.',
        },
        'fall 2022': {
            pro: 'Clear and repetitive lectures that provide a good survey of industrial control systems and threats. Students learned new concepts like functional block diagrams and found some presentations informative.',
            con: 'Low-quality exams with ambiguous questions that significantly impact grades. Lectures and projects diverge, causing confusion. Projects were tedious and time-consuming, with buggy course VM and no autograder.',
        },
        'summer 2021': {
            pro: 'The projects are engaging and interesting, providing a good learning experience. The use of trial and error is noted as an effective method for mastering the material.',
            con: 'Exams are decently challenging and may not align closely with the lectures, requiring additional reading of the text for thorough understanding.',
        },
        'spring 2021': {
            pro: 'The course has well-structured lectures that closely follow the textbook and includes enjoyable mini-projects.',
            con: 'The paper presentation assignment lacked clear organization and had issues with the sign-up process.',
        },
        'fall 2020': {
            pro: 'Students found the projects interesting and challenging, with some enjoying the hands-on aspect of the course. Many reported that the TAs were responsive and helpful.',
            con: 'The first two projects are described as overly time-consuming and tedious, with unclear requirements leading to grade penalties. The lectures were criticized for being poorly organized and fast-paced, with a lack of interaction from the professor.',
        },
        'fall 2019': {
            pro: 'The course is generally easy and offers interesting content with straightforward exams and the potential for fun projects, especially for those with a CS background. The supportive class environment and accessible teaching assistants were also appreciated.',
            con: 'The course lacks flexibility in scheduling and has issues with poorly documented software, leading to difficulties with projects. Some students felt the projects were disconnected from the material and grading practices were seen as unfair, especially regarding assignment deadlines and software bugs.',
        },
        'summer 2020': {
            pro: 'The course provides interesting content related to physical systems, particularly around grid security, and the TA assistance is viewed as helpful.',
            con: 'The course is seen as overly time-consuming, particularly the first two projects, with inconsistent grading, poor lecture engagement, and a lack of support in project execution. Many found the course structure frustrating and not recommended.',
        },
        'spring 2020': {
            pro: 'The course is well-structured, with supportive TAs and interesting projects that help students learn practical skills related to PLCs and security. Flexibility in workload is noted, with many finding the lectures and resources helpful. Extra credit opportunities are available.',
            con: 'Some projects are reported as being overly time-consuming and complex, particularly Project 1, which caused frustration for many students. The software used in projects is sometimes problematic, requiring high-end computers and lacking adequate documentation, leading to confusion and delays.',
        },
        'summer 2019': {
            pro: 'The course content is interesting and provides a unique perspective on cyber-physical systems, with rewarding projects that offer practical experiences in industrial programming and simulations. Many students found the projects enjoyable and engaging, and the overall workload is considered manageable, especially in a summer semester.',
            con: "The course suffers from disorganized project instructions and frequent changes in requirements, leading to confusion and grading errors. Many students reported issues with the TAs' responses and a lack of effective communication, as well as dry and tedious lecture content. The exams and assessments were critiqued for being straightforward but not necessarily reflective of the material covered.",
        },
        'spring 2019': {
            pro: 'The course is interesting and includes practical, interactive projects that help students learn effectively. The instructor and TAs are supportive, and the assignments are enjoyable, enhancing knowledge in the field.',
            con: 'Some students felt the course could delve deeper into topics, with a significant amount of workload concentrated on projects and the paper presentation. Certain projects were time-consuming and could involve frustrating tools.',
        },
        'summer 2018': {
            pro: 'The course is overall interesting and well-organized compared to previous semesters. Projects provide a good understanding of industrial systems, and the teaching assistant, Tohid, is highly praised for being passionate and helpful. The Piazza forum is well-organized and facilitates good communication, and extra credit is available.',
            con: 'The second project is seen as particularly challenging and poorly structured, leading to frustration. Some TAs have provided misleading information, and there are issues with hidden requirements. The pacing of the course is awkward, with a heavy workload concentrated towards the end, and grading can be harsh due to a lack of curving.',
        },
        'spring 2018': {
            pro: 'The course includes interesting and challenging projects, with helpful support from the professor and TAs.',
            con: 'The professor reads from the book without adding depth, the projects are unrelated to the curriculum, and tests are poorly worded and context-dependent.',
        },
        'fall 2018': {
            pro: 'The course offers engaging lectures, well-organized discussions, and challenging assignments that enhance understanding of CPS security. TAs provide good support, and the paper presentations expose students to various research topics.',
            con: 'Exams focus primarily on lectures with limited use of textbooks, and project feedback is minimal. Some project requirements are vague, while grading can be slow. The course may not present much new material for those with prior knowledge in the field.',
        },
        'fall 2017': {
            pro: 'The projects, once understood, are simple and can be completed quickly.',
            con: 'The subject matter is dull, lectures are unengaging, TAs/professors are combative, required books are unnecessary, projects are poorly designed, and exams have misleading wording.',
        },
        'summer 2017': {
            pro: 'The instructor is knowledgeable and likable, and the lectures are generally well-received. Some students found the material interesting and appreciated its relevance to cyber security.',
            con: 'The course suffers from a lack of engagement from instructors and TAs, unclear project guidelines, and poorly constructed exams that rely heavily on rote memorization. Many found the content broad and unfocused, leading to a less effective learning experience.',
        },
        'fall 2016': {
            pro: 'The course covers a wide range of interesting topics related to network security and industrial control systems. Projects are noted as the best part, despite being easy, and the teaching materials are deemed high quality and well-delivered. The instructor and TAs are responsive on Piazza, and the course stands alone well without prerequisites.',
            con: 'The testing format lacks partial credit, and some projects are perceived as too simple or not rigorous, which could lead to a less challenging experience. There are suggestions for increased homework and more substantial projects to better integrate practical skills with theoretical knowledge.',
        },
        'spring 2017': {
            pro: 'The class topic is interesting and the projects are good for learning about Industrial Control Systems.',
            con: 'The course has a limited number of gradable events, ambiguous midterm questions, poor project instructions, and inadequate support from the instructor, leading to a frustrating experience for students.',
        },
    },
};
