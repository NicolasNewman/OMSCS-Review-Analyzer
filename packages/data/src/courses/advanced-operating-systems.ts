export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course offers interesting and engaging projects, has a knowledgeable and passionate instructor, and exposes students to relevant industry material. Students appreciate the thought-provoking nature of the content and the opportunity for extra credit.',
            con: 'The course suffers from poor TA support, disorganization in course materials, and exams that focus heavily on memorization rather than understanding. There have been complaints about the clarity of assignment instructions and the late release of exam questions.',
        },
        'spring 2023': {
            pro: 'Kishore is a fantastic lecturer, the projects are relevant to the software industry, and the exams are generally straightforward.',
            con: 'The course requires a significant time commitment, lacks support, is more exam-heavy than project-heavy, and may be challenging for those without a strong OS background.',
        },
        'fall 2022': {
            pro: 'The projects are highly praised, providing a challenging yet educational experience, and the course content is described as fantastic with an enthusiastic instructor.',
            con: 'The workload is intense with overlapping deadlines, while communication and TA responsiveness are criticized as poor, and the exam format is considered frustrating and time-consuming.',
        },
        'spring 2022': {
            pro: 'The course features engaging and informative projects that help solidify understanding of complex concepts, and the professor is passionate and available for support during office hours.',
            con: 'The course is overwhelming due to the dense lecture content and difficult exams that often require specific phrasing, leading to frustrations with grading and a lack of clarity in project requirements.',
        },
        'fall 2020': {
            pro: 'The course offers engaging projects, knowledgeable TAs, and an invested professor who is passionate about teaching. Most students found the content relevant and appreciated the depth of information covered.',
            con: 'The course is considered bloated with excessive material, and many assignments felt like busy work. Students noted a heavy workload that may be overwhelming, especially for those lacking strong C/C++ skills.',
        },
        'fall 2021': {
            pro: 'The professor is engaging and passionate about teaching, with effective office hours and exam formats that encourage understanding of the material.',
            con: 'The course workload is extremely high and time-consuming, with dense lecture content and poorly organized projects that may frustrate students.',
        },
        'spring 2021': {
            pro: 'The course offers a comprehensive overview of systems research, featuring interesting projects and a dedicated professor. Many students appreciated the released exam questions, which helped alleviate study stress.',
            con: 'The course requires a significant time commitment (at least 20 hours per week) for optimal learning. Some students found the workload overwhelming, particularly with certain projects, and experienced frustrations with the project environment setup and the theoretical nature of the lectures.',
        },
        'spring 2020': {
            pro: 'The projects are generally interesting and rewarding, especially Projects 1 and 4, with a teaching team that is helpful and engaged. Prior knowledge in C/C++ is beneficial.',
            con: 'The course has an excessive workload with an overwhelming number of papers and long lectures, leading to a lack of deep understanding and disorganization in course materials.',
        },
        'fall 2019': {
            pro: 'The course offers high-quality content and challenging projects that enhance understanding, especially in C and C++. The professor is knowledgeable and engages well with students, with plenty of support available.',
            con: 'Exams focus heavily on rote memorization and are overwhelming in scope. The workload is significant, and many students struggled with the materials and the expectations of prior knowledge.',
        },
        'fall 2018': {
            pro: 'The course is well-structured and provides valuable learning opportunities, especially in distributed systems and C/C++ projects. The professor is knowledgeable and approachable, and many students found the projects engaging.',
            con: 'The workload is heavy and time-consuming, with dense lectures and numerous readings that can lead to information overload. Some students felt that the course design could be more focused and less reliant on memorization for exams.',
        },
        'spring 2019': {
            pro: 'The course provides a thorough understanding of systems engineering, has strong support from attentive TAs and the professor, and includes practical and valuable projects.',
            con: 'The course has a heavy workload with a lot of readings and difficult projects, making time management essential, and some project descriptions could be clearer.',
        },
        'fall 2017': {
            pro: 'The course is highly informative, covering a broad range of operating system principles with a focus on recent developments. Lectures are well-done, and projects offer significant learning opportunities despite their difficulty. The professor and TAs are responsive and helpful, with opportunities for grade improvement provided.',
            con: 'The course has a heavy workload with extensive reading materials and challenging projects that require strong C/C++ proficiency. Exams are difficult, mainly essay-based, and the grading for projects can take a long time.',
        },
        'spring 2018': {
            pro: 'The course is intense but valuable, with a lot of learning and projects that enhance coding skills, particularly in C and C++. The grading is curved, making it possible to achieve good marks if projects are well-executed.',
            con: 'The course is very difficult and time-consuming, requiring extensive reading and study, especially for exams which are challenging and require significant memorization.',
        },
        'summer 2018': {
            pro: 'Interesting and useful projects; fantastic lectures; engaging readings from foundational research papers.',
            con: 'Disliked the first project; heavy reading load.',
        },
        'spring 2017': {
            pro: 'The course is intriguing, relevant, and offers deep learning opportunities with brilliant lectures and challenging projects.',
            con: 'It is time-consuming and particularly difficult, especially for those without a background in C or C++, requiring substantial effort to debug and learn.',
        },
        'fall 2014': {
            pro: 'The course has good content and the ability to re-watch videos is appreciated.',
            con: 'The course is challenging, overwhelming for beginners, and requires extensive reading; some students struggled significantly with the material.',
        },
        'fall 2016': {
            pro: 'The course offers in-depth knowledge of low-level operating systems, is taught by a passionate professor, and has interesting projects that foster a solid understanding of the material despite requiring a significant time investment.',
            con: 'The course is very difficult, with dense materials, brutal exams, a steep requirement for C/C++ knowledge, and the need for Linux setup, which may pose challenges for beginners.',
        },
        'spring 2015': {
            pro: 'The course is demanding but rewarding, leading to positive outcomes such as achieving high grades.',
            con: 'N/A',
        },
        'spring 2016': {
            pro: 'The course has interesting material and programming assignments, with highly regarded professors and TAs. Students appreciate the depth of knowledge gained, especially in system internals, and recommend it for those willing to invest the time.',
            con: 'The course is time-consuming, requiring 20-30 hours per week, with a heavy reading load of scientific papers that some found tedious. There are reported issues with vague project instructions and challenges with the autograder, leading to potential information overload.',
        },
        'fall 2015': {
            pro: 'The course material is fascinating and projects are interesting and complex, providing valuable experience despite being challenging.',
            con: 'The course is extremely difficult, with a heavy workload, long and complicated lessons, and challenging exams that many students struggled with.',
        },
    },
};
