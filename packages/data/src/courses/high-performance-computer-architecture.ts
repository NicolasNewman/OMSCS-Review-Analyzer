export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'Some concepts are learned well; the TA and discussion board are active and helpful.',
            con: 'Course is difficult to focus on, consists of long lectures, time-consuming assignments, and challenging exams that differ significantly from practice materials.',
        },
        'fall 2023': {
            pro: 'Lectures are comprehensive and engaging, providing a strong understanding of processor operations. The TA, Nolan, is attentive and helpful, and grading is generally considered fair. The assignments are interesting and relevant to the material covered.',
            con: 'There is a high volume of content which may be overwhelming, and project submissions require formatting that can be problematic. Many grades are not disclosed until the end of the course, creating uncertainty. Some students found the midterm grading harsh and projects unrealistic.',
        },
        'spring 2024': {
            pro: 'The course has enthusiastic instruction, helpful office hours, and easy-to-understand lecture videos. The content covers valuable low-level concepts.',
            con: 'Quizzes and sample exams could be improved, with some content being irrelevant or tedious for the online format. Projects and assignments require careful attention, and a strong understanding of C++ is necessary.',
        },
        'spring 2023': {
            pro: 'Students appreciated the organized and high-quality lectures, the helpfulness of the TAs, and the comprehensive understanding of computer architecture gained from the course. The reasonable exam difficulty and support from the professor and TAs were also highlighted positively.',
            con: 'There were frequent complaints about the difficulty and vagueness of project descriptions, challenges associated with the SESC simulator, and issues with practice exam materials containing typos. Some students found projects to be trivial or not particularly useful.',
        },
        'summer 2023': {
            pro: 'Class is well run, lectures are clear, and TA provides helpful information. Overall, students feel they gained a lot from the class.',
            con: 'Class can feel dry, assignments have overly specific requirements, and tests are stressful despite being open book.',
        },
        'fall 2022': {
            pro: 'The course features outstanding lectures, engaging projects that enhance understanding, and a great connection between course material and exams. It offers in-depth knowledge of computer architecture and is well-structured, making it manageable for students with a CS background.',
            con: 'The workload can be heavy during exam preparation, lack of practice materials and unexpected exam questions can lead to stress. Some project instructions are unclear, and formatting issues in project documents can be frustrating.',
        },
        'spring 2022': {
            pro: 'Lectures are well-structured, enjoyable, and help build a strong understanding of modern processors. The instructor and TAs are highly praised, and projects provide opportunities to test understanding without being overly difficult.',
            con: 'Exams contain misleading true/false questions unrelated to course content, leading to confusion and frustration. Projects are considered boring and not very educational, with several errors noted in course materials that affect overall learning experience.',
        },
        'spring 2021': {
            pro: 'The course features excellent lectures and course material, engaging the students well. TAs provide timely and helpful responses, and the pace of the course allows for completing projects early.',
            con: 'Assignments are often filled with errors and lack clarity, requiring extensive corrective explanations. Projects do not provide much creative coding experience and grading turnaround is slow.',
        },
        'summer 2021': {
            pro: 'Professor Prvulovic offers a unique approach to teaching that extends knowledge beyond simple reinforcement, which some students find effective and interesting.',
            con: 'The quizzes can be jarring and may lower the confidence of students not prepared for an extended learning approach; exams are significantly weighted and require a high level of detail, which may be challenging for some.',
        },
        'fall 2020': {
            pro: 'Some students found the lectures clear and informative, with a solid understanding of CPU functionality gained. The head TA was also noted for being helpful and responsive.',
            con: 'The course suffered from significant disorganization, numerous errors in assignments and quizzes, slow grading, unclear project instructions, and a lack of engagement from the professor to improve the course.',
        },
        'summer 2019': {
            pro: 'The course offers interesting content on computer architecture, particularly for those with HPC experience. TAs, especially Nolan, are highly praised for their guidance. Many students find the learning rewarding despite the challenges.',
            con: 'Exams are challenging and grading takes a long time. The course has strict deadlines, requires significant effort, and projects can be difficult, especially for those unfamiliar with C++. The amount of coding involved in projects is less than expected.',
        },
        'summer 2020': {
            pro: 'The course offers a detailed curriculum on processor design, with well-made lectures and effective quizzes that reinforce understanding. The head TA, Nolan, is highly praised for his responsiveness and helpfulness, aiding students in comprehending complex material.',
            con: 'The course is time-intensive and has a dense content that requires significant effort to master. Exam questions can be ambiguous, leading to confusion, and grading is often seen as overly strict. Several reviewers noted a disconnect between projects and lecture content, contributing to a frustrating learning experience.',
        },
        'spring 2020': {
            pro: 'Students enjoyed the course for its interesting content and well-structured lectures; many found the professor engaging and knowledgeable, and highlighted the valuable learning experience provided by the projects and exams.',
            con: 'The course can be challenging for those without a strong background in C++ or computer architecture; some students mentioned the difficulty of the projects and the initial workload as overwhelming.',
        },
        'fall 2019': {
            pro: 'The course is well-structured with clear lectures, and students reported gaining a strong understanding of computer architecture, C++, and CPU processes. The projects, while time-consuming, are seen as rewarding and an excellent opportunity for learning, with much support offered by TAs, especially Nolan.',
            con: 'Many students struggled with the C++ projects due to their complexity and the lack of documentation in the codebase. The pacing of the class can be uneven, making it necessary to start projects early. Some students found the exams challenging, requiring thorough preparation.',
        },
        'spring 2019': {
            pro: 'The course is informative, covers many interesting concepts in modern computing, and has a highly praised TA (Nolan) who is very helpful. Projects are well-structured and aligned with lectures, and exams, while challenging, are considered fair.',
            con: "Exams and projects can be poorly run, with difficult and lengthy exams that don't always relate well to course materials. The professor is not active in providing support, and there are inconsistencies in grading and feedback, which can be frustrating.",
        },
        'summer 2018': {
            pro: 'Students found the course informative and well-organized, with enjoyable and relevant projects that enhanced understanding.',
            con: 'Exams were considered tough, especially due to the open book policy being restrictive for some students with online notes.',
        },
        'fall 2018': {
            pro: 'Great class, enjoyable experience, and an awesome TA.',
            con: 'N/A',
        },
        'spring 2018': {
            pro: 'The course offers meaningful lectures that are up to date, and the TAs, especially Nolan, are attentive and knowledgeable. Students learn a lot and find the grading generous.',
            con: 'Projects are tedious and time-consuming, with a long feedback loop, and the simulation code is poorly written, making it difficult to work with. Instructions for projects lack clarity.',
        },
        'fall 2016': {
            pro: 'The course covers interesting and dense material on computer architecture and optimizations, with well-structured lecture videos and fair grading, especially for those with a solid C++ background. Many students found it rewarding and learned significantly from it.',
            con: 'The course is challenging with a heavy workload, unclear grading progress, and some students found the exams focused excessively on rote problem-solving rather than concepts. The support from the instructor and timely grading also received criticism.',
        },
        'spring 2017': {
            pro: 'The course has well-done lectures and straightforward tests, and it goes in-depth into algorithms and CPU architecture design.',
            con: 'The projects are challenging due to an old and poorly documented simulator, which can be time-consuming.',
        },
        'fall 2015': {
            pro: 'The course videos are very good, covering many concepts, and the instructor explains abstract concepts clearly. Projects are helpful.',
            con: 'The course is not easy, and projects are not directly related to the course materials.',
        },
        'spring 2016': {
            pro: 'Enjoyable class with active support from the professor and TA; worthwhile despite its difficulty.',
            con: 'Poorly documented emulator with unpredictable behaviors; challenges in understanding expected lab results.',
        },
        'spring 2015': {
            pro: 'The course has excellent lectures, provides a lot of learning, and offers helpful real-world programming experience.',
            con: 'The course is extremely difficult, with hard tests and issues with project specifications.',
        },
    },
};
