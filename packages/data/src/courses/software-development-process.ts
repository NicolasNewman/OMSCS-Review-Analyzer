export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course is well-designed, with engaging lectures and an emphasis on practical skills like git, design process, and testing. It is particularly suitable for students with minimal CS background. The grading is fair, with generous extra credits and a solid group project experience.',
            con: 'Assignment 6 is heavily criticized for being poorly written and causing frustration among students due to ambiguous grading and lack of support from TAs. Overall grading is slow, particularly for non-autograder assignments, which can lead to dissatisfaction.',
        },
        'summer 2024': {
            pro: 'The course is considered easy and straightforward, especially for those without a strong background in computer science. It effectively teaches foundational concepts such as version control and the software development lifecycle. Many students report earning high grades, and the assignments are generally manageable.',
            con: 'Group project dynamics can be challenging due to random team assignments, and some students faced difficulties with group participation. Several reviewers noted that assignment requirements were sometimes misleading, and there were complaints about the secretive nature of TAs regarding assignments.',
        },
        'summer 2023': {
            pro: 'The instructor is great, lectures are well presented, and regular office hours are available. Some students found the course beneficial for understanding software development processes, especially for those without much collaborative experience.',
            con: 'Course material is considered basic and more suitable for undergraduates. There are significant issues with assignment workload imbalance, unclear grading criteria, confusing specifications, and the heavy weight of Assignment 6, which many students found problematic.',
        },
        'spring 2023': {
            pro: "The course is relatively easy and well-suited for those without a CS background, with assignments that many find rewarding and manageable. The lectures are helpful, and there's good access to the professor and TAs.",
            con: 'Assignment 6 is seen as overly challenging and heavily weighted, which can significantly impact grades. Also, the random grouping for projects may lead to imbalanced workloads, and some aspects of the course feel tedious and not very relevant, particularly for those with prior coding experience.',
        },
        'fall 2023': {
            pro: 'The course has a decent syllabus that provides significant learning for undergraduates and has assignments that mimic real software team dynamics. Many students find the individual and group projects manageable and emphasize the importance of documentation.',
            con: 'Grading issues are a major concern, with assignments perceived as unfairly difficult or poorly explained. There is criticism of the course structure, particularly regarding the lack of flexibility with assignment releases, experience level questions, and the performance of teaching assistants.',
        },
        'fall 2022': {
            pro: "The course is well-run, with great TAs and professors. It's helpful for beginners in software development and offers a good learning experience with Git collaboration and Agile development concepts. The content is generally straightforward, and some students enjoyed the group project and found value in learning new tools like JUnit.",
            con: 'Lectures can feel stale, and the assignments may vary significantly in difficulty, leaving some students overwhelmed. There is a lack of clear direction on certain projects, particularly regarding test case determination. Some students found TAs unhelpful, vague assignment requirements, and the grading system harsh, especially for critical assignments.',
        },
        'summer 2022': {
            pro: "The course provides a satisfying learning experience, with responsive instructors and manageable assignments for those who grasp the key concepts. It's considered easy for those with prior coding experience.",
            con: 'The course has excessive busy work in projects, particularly the group project, leading to frustration. Assignment 6 is criticized for being overly complicated and poorly aligned with prior knowledge, detracting from the overall learning experience.',
        },
        'spring 2022': {
            pro: 'Course is useful for those without a software engineering background. Engaging lectures, supportive professors and TAs, and valuable skills learned, particularly in Git and Java.',
            con: 'Content may be too high-level and lacks detailed practical materials. Group project dynamics can lead to unfair experiences, with individual projects being repetitive and lacking challenge, especially for those with prior coding experience.',
        },
        'fall 2021': {
            pro: 'The course offers valuable learning experiences for both beginners and those with some programming background, emphasizing best practices, collaboration, and hands-on projects. Many found the group project rewarding and enjoyed learning Git and Android development.',
            con: 'Grading is perceived as harsh and inconsistent, with inadequate feedback and vague instructions for assignments, particularly Assignment 6 and group projects. Some students felt the grading practices created unnecessary difficulty, leading to frustrations with TA evaluations.',
        },
        'summer 2021': {
            pro: 'The course is perceived as easy, with interesting content for beginners and a light workload that allows for pairing with other courses. Many assignments are auto-graded, and the quality of lectures and instructions is noted positively.',
            con: 'Group project experiences vary, leading to frustration with unproductive team members. Grades for non-auto-graded assignments take a long time to return, and some assignments later in the semester are considered challenging and time-consuming.',
        },
        'spring 2021': {
            pro: 'The course is well-organized, with responsive professors and TAs. Many assignments are auto-graded and practical, providing a good overview of software development processes. Involvement from the professor is highlighted positively, and the course is good for developers looking for a refresher.',
            con: 'Assignments can be tedious and the grading for major projects is slow to return. The course content may feel outdated for experienced developers, and some students reported challenges with the individual project and group dynamics.',
        },
        'fall 2020': {
            pro: 'The course is described as fun and engaging, with an amazing professor who is active and responsive. The absence of exams and straightforward assignments are also seen as positives. Many students appreciated the group project and found it rewarding, especially with supportive teammates. It offers a good refresher for those with some experience in software development.',
            con: 'Some students found the course content weak and unchallenging, particularly if they had prior experience. The group project can be problematic if team dynamics are poor, and there are complaints about a lack of detailed engagement on discussion forums. Overall, the course may not offer significant learning for seasoned developers.',
        },
        'summer 2020': {
            pro: 'The course is well-organized, has responsive and engaging instructors, and helpful assignments that improve Git, Java, and Android development skills. Many students find value in the foundational knowledge and hands-on projects offered, especially for those with little prior experience.',
            con: 'The course may be too easy or basic for experienced developers, leading to boredom. There are challenges with team projects due to varied time zones and the assignment weightings, particularly Assignment 5 being overly burdensome.',
        },
        'spring 2020': {
            pro: 'Fun and knowledgeable instructors, practical assignments without quizzes or exams, and a good introduction for beginners to Java and Android programming.',
            con: 'Long grading times, lack of clear rubrics and grading criteria, poor organization of Piazza forum, convoluted assignments, and difficulties with group projects.',
        },
        'fall 2017': {
            pro: 'The course serves as a good introduction to software development concepts, especially for those without extensive programming experience. Professor Orso is praised for his engaging lectures and helpful office hours. The weekly assignments and group projects provide valuable hands-on experience.',
            con: 'The course suffers from poor communication and ambiguity in assignments. Grading feedback is often late and inadequate, leading to frustration among students. Many comments highlight the ineffectiveness of TAs and the stressful scheduling of weekly deadlines, particularly colliding with other courses or personal commitments.',
        },
        'summer 2019': {
            pro: 'The course is designed to be easy, making it suitable for beginners or those familiar with Java. The professor and TAs are responsive and engaged, and the group project provides valuable hands-on experience with Android app development. Many students appreciated the straightforward assignments and the practical skills gained in software development processes.',
            con: 'Some materials are outdated, and there is a heavy emphasis on UML diagrams which some found unnecessary. The workload can feel rushed during the summer semester, with tight deadlines for multiple deliverables. Grading and feedback are often slow, which can be detrimental for assignments that build on one another.',
        },
        'fall 2019': {
            pro: 'The course is praised for providing a useful overview of tools like git and code testing, with engaging lectures from a passionate professor. The TAs are also noted as helpful.',
            con: 'Many negative aspects are highlighted, including last-minute assignment releases, lack of grading rubrics, and a slow pace with busy work. The course may be too easy for some students, particularly those in software development.',
        },
        'fall 2018': {
            pro: 'The course is well-suited for entry-level students and provides a good introduction to software development processes, as well as valuable hands-on experience with Android app development. The involvement of the professor and TAs in office hours and the course structure are frequently praised.',
            con: 'The grading is consistently criticized for being slow and overly harsh, with students often left uncertain about their performance for extended periods. The group project is flagged as a significant issue, with varied experiences depending on group dynamics, and some assignments are deemed repetitive or busy work.',
        },
        'summer 2018': {
            pro: 'The course is considered easy and straightforward, making it suitable for beginners. Some students appreciated the supportive professors and TAs, and found value in the group projects and knowledge about software development practices.',
            con: "Many reviews criticized the course for its lack of depth, slow grading, and insufficient feedback from TAs. The group projects were often seen as problematic, with some students feeling that they had to carry their teammates, and others expressed disappointment in the course's content and structure.",
        },
        'spring 2018': {
            pro: 'The course provides a good introduction to software engineering concepts, with helpful resources and responsive TAs. It covers essential skills like Git, Android app development, and unit testing, making it suitable for entry-level students.',
            con: 'Random group assignments can lead to unbalanced workloads, with some students feeling burdened by less active teammates. Grading can be slow and nit-picky, causing frustration, especially regarding minor mistakes.',
        },
        'spring 2019': {
            pro: 'The course is a good introductory option for students with a non-CS background, offering clear assignments and an engaging professor, along with a manageable workload for those new to software development.',
            con: 'The course may not provide enough value for students with prior experience in software development, and some found the content too basic and the grading distribution focused too heavily on documentation over coding.',
        },
        'fall 2015': {
            pro: 'The course provides a solid overview of software development, with good practices and an easy learning curve for those new to the field. It is accessible for beginners and allows for practice in key areas like Agile development and testing.',
            con: 'The effectiveness of the group project varies greatly depending on the team assigned. The grading criteria can be overly strict, and the course may be time-consuming for those lacking Java experience.',
        },
        'spring 2016': {
            pro: 'The course is well organized with helpful instructors and active office hours. It provides a good introduction to the OMSCS program and the software development process, and includes engaging projects.',
            con: 'Many reviews mention issues with inconsistent grading, lack of timely feedback on assignments, and group project challenges. Some experienced developers found the course too simple.',
        },
        'spring 2015': {
            pro: 'The course features engaging instructors, helpful teaching assistants, and provides a good overview of software engineering practices, including Agile and Scrum methodologies. Group projects are well-received, and the course offers valuable insights for remote collaboration.',
            con: 'The course may not provide new information for experienced software developers, and students should be proactive in addressing team member issues early on.',
        },
        'fall 2016': {
            pro: 'The course is seen as a good introduction to software development, with engaging lectures from Professor Orso and practical assignments that provide exposure to various tools and concepts. It is especially beneficial for non-programming background students, helping them catch up and gain confidence. Many reviewers noted the supportive TAs and positive group project experiences.',
            con: 'For students with prior software development experience, the course content may feel insufficient and overly easy. Group project collaboration can be challenging, particularly with unmotivated team members. There are complaints about slow grading turnaround and some assignments being perceived as busy work.',
        },
        'summer 2015': {
            pro: 'Easy foundation course for computing systems; good first class.',
            con: 'N/A',
        },
        'summer 2016': {
            pro: 'The course provides useful development methodologies, includes active involvement from the instructor and TAs, and offers a balanced approach between lectures and programming assignments. Students appreciate the opportunity to learn new techniques and the well-paced structure of the course.',
            con: 'Challenges include restrictions on working ahead, issues with group project dynamics, and inconsistencies in grading without a clear rubric. Some students found the class to be boring and struggled with unproductive team members, leading to increased workloads.',
        },
        'summer 2017': {
            pro: 'The course is well organized, clearly structured, and has interesting lectures. Instructors are active and responsive, and the group project offers valuable learning experiences, making it a good introduction to software development.',
            con: "The course can be overwhelming, especially in the summer with tight schedules for concurrent individual and group projects. Some assignments can feel trivial, and students noted a lack of engagement beyond standardized tasks. There's also criticism regarding the instructors' inflexibility and expectations for work-life balance.",
        },
        'spring 2017': {
            pro: 'The course is a good introductory class for new students or those without a programming background, with well-structured lectures and assignments. The professor and TAs are highly involved and supportive. Many found the projects interesting and challenging, along with valuable practice in software development processes like Git and unit testing.',
            con: 'Several experienced developers felt the course offered little new information and involved tedious assignments that were often seen as irrelevant to real-world applications. The group project was criticized for being dependent on team dynamics, and grading was noted as slow and inconsistent. Some respondents found the course unreasonably time-consuming and lacking in practical value.',
        },
        'summer 2014': {
            pro: 'The course provides exposure to current ideas in software development and Android programming, and it is taught by a knowledgeable and passionate instructor.',
            con: 'The workload is constant and can be challenging, especially for those who may struggle with group coordination or who have other commitments.',
        },
        'fall 2014': {
            pro: 'Good lectures and engaging professor; fun to create Android applications.',
            con: 'Course may not offer new information for those with significant programming background; challenges in remote collaboration.',
        },
    },
};
