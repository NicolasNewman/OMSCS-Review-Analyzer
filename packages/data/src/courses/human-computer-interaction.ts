export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course has interesting and relevant topics, high-quality videos, and is well-organized with clear grading rubrics.',
            con: 'The workload is extremely high, grading can be inconsistent, lack of personalized feedback, and some readings are tedious.',
        },
        'spring 2024': {
            pro: 'The course provides practical methods for developing interfaces, covers real-world applications of HCI, and teaches a user-centered perspective. High-quality lectures, clear assignments, and a well-structured format are also highlighted.',
            con: "Some Methods lectures were deemed unhelpful and not appropriate for a Master's level, with specific topics being viewed as basic. Peer feedback was found to be tedious and not beneficial.",
        },
        'fall 2023': {
            pro: "The course content is engaging and the lectures are interesting, with clear instructions and a well-organized structure. Many students appreciate Dr. Joyner's involvement and find the material eye-opening, particularly for those interested in design and HCI.",
            con: 'There is a significant amount of busywork, including numerous writing assignments, peer reviews, and group projects, which many students find overwhelming. Grading can be subjective and inconsistent, and some students report frustrations with the feedback process, as well as the excessive workload and repetitive nature of assignments.',
        },
        'spring 2023': {
            pro: 'The course offers a well-structured introduction to HCI with engaging lectures, creative assignments, and a clear design lifecycle, making it enjoyable and insightful, even for those without a background in front-end development.',
            con: 'The workload can be heavy, especially with a weekly 6-8 page paper and a group project, and the readings in the latter half of the course may feel excessive and unproductive.',
        },
        'summer 2023': {
            pro: 'The course features highly engaging lectures with excellent production quality, making the material memorable and easy to understand. The assignments are practical and the instructor is active and supportive.',
            con: 'The course requires extensive writing and reading, which can be overwhelming, especially with overlapping deadlines. Some students found the subject matter uninteresting and felt the workload was challenging to manage.',
        },
        'summer 2022': {
            pro: 'The course has excellent lecture videos, useful content for software engineers, and a well-prepared environment for students with prior experience. It potentially guarantees high grades through consistent performance on written assignments.',
            con: 'The course has a heavy workload with excessive reading and writing, inconsistent grading from TAs, and tedious weekly assignments that feel like busywork. Peer reviews and participation credits are also problematic, diminishing overall engagement.',
        },
        'fall 2022': {
            pro: "The course is well-structured with engaging lectures, a top-notch professor, and valuable content for those interested in HCI. Many students found it a good first class that provides a solid overview of the master's program. Students appreciated the reasonable grading and helpful rubrics for assignments.",
            con: 'The course involves a substantial amount of writing, which some students found overwhelming or unnecessary. Those lacking interest in HCI or strong writing skills may struggle with the workload and busywork, including weekly peer reviews and extensive reading.',
        },
        'spring 2022': {
            pro: 'The course is well-organized, provides necessary tools for success, and offers fair grading. Assignments are manageable with early planning, and the lectures are helpful and interesting. The instructor is supportive and cares about student success.',
            con: 'The course is writing heavy, which may be challenging for some students. There are weekly assignments, lectures, and readings to keep up with, which could be overwhelming.',
        },
        'fall 2021': {
            pro: 'The course features high-quality lectures and assignments that provide valuable insights into UI/UX and HCI concepts. Dr. Joyner is an engaging and responsive instructor, and the structured format helps students stay organized. Many find the course to be an easy A if they follow the guidelines and manage their time well.',
            con: 'The course has a heavy writing load, requiring students to produce multiple lengthy papers weekly, which can be tedious and overwhelming, especially for those not confident in their writing skills. There is a lack of programming content, which may deter those seeking more practical or coding-related experiences.',
        },
        'fall 2020': {
            pro: 'The course is well-organized with fantastic lectures and engaging material. Professor Joyner is passionate, responsive, and committed to online education, enhancing the learning experience. Students appreciate the real-world applications of the concepts and the manageable workload.',
            con: 'There is an overwhelming amount of writing required, with weekly 6-8 page papers and a lengthy final project. Some students found the readings excessive and not reflective of the exam content, leading to frustration. Lack of coding may also disappoint those looking for a more technical focus.',
        },
        'summer 2021': {
            pro: 'Many students found the course engaging and informative, appreciating the teaching style of Dr. Joyner, the structured lecture content, and the relevance of the assignments to real-world applications. The course helped them better understand Human-Computer Interaction principles and concepts.',
            con: 'The course has a heavy workload with numerous writing assignments, extensive readings, and challenging exams. Some students found the readings to be excessive and poorly structured, while others felt the peer feedback system was ineffective and the exams too reliant on specific details.',
        },
        'spring 2021': {
            pro: 'The course is well-structured, with engaging lectures and a strong emphasis on reading and writing, making it a valuable learning experience for understanding design principles and user-centered design.',
            con: 'The workload is heavy, requiring significant time for reading and writing, which may overwhelm some students, particularly those with less interest in writing.',
        },
        'spring 2020': {
            pro: 'The course covers practical skills such as needfinding and statistical analysis, and has an excellent instructor. Material is interesting with a focus on design practices.',
            con: 'High workload with extensive reading and writing requirements, unclear grading rubric, and ineffective peer reviews. Participation is mandatory and can feel unproductive.',
        },
        'summer 2020': {
            pro: 'The course material is engaging and well-structured, with highly engaging lectures by Dr. Joyner. It offers valuable insights into design thinking and human-computer interaction, making it a great class for those interested in these areas.',
            con: 'There is a significant amount of reading and writing required, with weekly assignments and tests that many found overwhelming. Some students felt that the reading materials were not always useful or were redundant, and the course may not be suitable for those with busy jobs.',
        },
        'summer 2018': {
            pro: 'The course is well-organized, engaging, and taught by an enthusiastic instructor, Dr. Joyner. It offers valuable insights into human-computer interaction and involves practical applications through extensive writing assignments and projects. Many students found it a refreshing break from coding-intensive courses, with interesting content and good support from TAs.',
            con: 'The workload is significant, involving a lot of reading and writing, which some students found overwhelming or tedious. There are constant assignments, and some students felt the assessments were overly focused on meeting technical criteria rather than assessing true understanding. The summer schedule was also cited as particularly intense due to its compressed nature.',
        },
        'fall 2018': {
            pro: 'The course is well-organized and provides meaningful assignments that enhance understanding of Human Computer Interaction concepts. The instructor is supportive and engaged, and students appreciate the open-book tests and the opportunity to learn valuable concepts related to design and user interaction.',
            con: 'The workload is significantly high with extensive writing and reading requirements, often described as busy work. Some students found the tests challenging, and the course can feel overwhelming, especially when paired with other classes.',
        },
        'fall 2019': {
            pro: 'The course is well-structured, easy to navigate, and features responsive professors and TAs. It offers valuable theoretical insights into human-computer interaction (HCI) without requiring coding skills.',
            con: 'There is an excessive workload with many lengthy writing assignments and required readings, making it challenging for non-native speakers. The peer feedback system and group projects can also be problematic, and the exams can be difficult despite being open book.',
        },
        'fall 2017': {
            pro: 'The course has engaging lectures, well-structured content, and practical assignments that are manageable. Many reviews highlight the instructor and TAs as supportive and responsive, and appreciate the flexibility in project topics. It promotes useful skills in HCI and software design principles, making it beneficial for both beginners and experienced professionals in the field.',
            con: 'The course involves significant writing with some considering the assignments to be busy work that does not enhance understanding of the material. Some students found the readings lengthy and challenging to digest, while others experienced a lack of coding, causing dissatisfaction among those with a programming background. Peer feedback was also seen as ineffective by some students.',
        },
        'summer 2019': {
            pro: 'The course is well-organized, with engaging lectures and enthusiastic instructors. It offers valuable insights into HCI, and allows for the practice of writing and communication skills without group projects during the summer semester.',
            con: 'There is an overwhelming amount of writing and reading, with weekly 8-page papers and difficult exams that require knowledge from numerous lengthy articles. The grading can be inconsistent depending on the TA, and participation activities may not provide meaningful feedback.',
        },
        'spring 2018': {
            pro: 'Highly engaging lectures and enthusiastic professor, well-organized course material, fair grading, enjoyable group project, opportunity to learn about HCI principles and methods.',
            con: 'Heavy workload with extensive writing assignments and readings, some reviews suggested that readings were dry and less valuable, difficulty balancing with other courses, potential overwhelming nature of consistent assignments.',
        },
        'spring 2019': {
            pro: 'The course is well-organized and engaging, with high-quality materials, supportive instructors, and immediate application of concepts. It fosters a discussion-based learning environment and effectively teaches important HCI concepts. Many students appreciated the challenge and found the assignments beneficial for learning.',
            con: 'The course requires significant writing and time, with a high workload that includes many assignments and group projects. Some students found the tests difficult and felt there was too much emphasis on reading without practical application.',
        },
        'summer 2017': {
            pro: 'The course material is interesting and well-presented, with engaging lectures from Dr. Joyner. It provides practical knowledge applicable to software development and product design. Assignments are generally straightforward and facilitate a good understanding of the design lifecycle.',
            con: 'The summer schedule feels rushed, creating stress due to tight deadlines and the need for external input on projects. There is a lack of breathing room, making the course workload seem unrealistic for summer, and the logistics of the projects can detract from the learning experience.',
        },
        'spring 2017': {
            pro: 'The course is well-structured and organized, featuring high-quality lectures and a fantastic professor. Assignments are prompt in grading and engaging, with a focus on human-computer interaction principles. Interactive and responsive class environment fostered by the professor and TAs.',
            con: 'Assignments can be overly strict, with deductions for not using specific keywords or phrasing, potentially hindering understanding. Some students felt rushed in completing projects or found the rapid lecture pace challenging.',
        },
        'fall 2016': {
            pro: 'The course materials are excellent, communication with the professor is great, and assignments are thought-provoking and interesting. The content is well-organized, and the workload is light, making it suitable for combining with another course.',
            con: 'Many assignments can be time-consuming, especially the final project. Some students found the assignments repetitive, as they often require writing 1200 words to answer four questions.',
        },
    },
};
