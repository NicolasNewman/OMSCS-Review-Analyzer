export default {
    ...
    reviews: [
        {
            user: 'PrFv+x7ZTJsWLcZhtBzGVw==',
            reviewDate: 'May 4, 2023',
            semester: 'spring 2023',
            review: "this course is the biggest waste of time. It has nothing to do with cybersecurity. you will learning nothing in this course. The first 2 homeworks are straightforward and not difficult. The last 2 homeworks are more challenging due to vague write ups. The first 2 projects deals with PID feedback controllers. Project 3 is using AADL, which is useless to learn, to edit files to complete a design model.\nThis course is not difficult material however the write up for the projects are terrible and leave tons of info out. I lost several points due to this and the TAs would not give points back.\nThe TAs run the course and are terrible. They answer questions very vaguely, office hours is a huge waste of time. The grading is poor, they take off a lot of points for minor errors, several students in spring 2023 had to drop this course because of that. The TAs also don't tell you why  you miss points. you just receive a grade and is it. I asked for clarification and was told 'This is a graduate course, we cannot give you the answer, you have to watch office hours for clarification.'\nOverall, don't take the course if you don't have to. For some reason this is required for OMSCY and it should not be.",
            rating: 1,
            difficulty: 2,
            workload: 7,
        },
        ...
        },
        {
            ...
            semester: 'fall 2022',
            review: "CPDA is a very mediocre course. The main shortcoming in my opinion is the uselessness of the lecture videos. I watched ~2 hours total of lecture content the entire semester (1 hour when I first started the course and another 1 hour during the take-home final exam) and I passed with a final grade of 95. The homework are very disconnected from these lectures.\nHonestly, most of the homeworks by themselves are actually interesting. The Robotarium project and the controls homeworks are stimulating enough, but as stated before there is zero connection between these homeworks and the lecture material.\nOne final gripe I have is for Project 3 with AADL. This project is complicated and totally useless as far as I can tell. The instructions are vague to the point where there's about 100 questions from students on Piazza asking the TAs to interpret each question for this project. AADL itself is an outdated language. The same concepts could be much better taught in a different system environment or just with conceptual questions.\nOverall, I would recommend this course to any students with the Computational Perception and Robotics specialization because it means you don't have to take Computer Vision (I took CPDA, Comp Photo, and AI for Robots). Especially for students who are worried about a high workload, this is the easier alternative. However, in terms of actual value and learning, this class is very below average.",
            rating: 2,
            difficulty: 2,
            workload: 8,
        },
        {
            ...
            semester: 'fall 2022',
            review: 'This is a required class for cyber physical OMSCY.  It made me change my concentration.  It was night & day from 8813, and I hear 6320/6347 are more like this one.  If you aren’t a math person, nope out of this & the concentration.\nI have enough math to get into the program & make A’s in all other classes - but this is too much for me personally.\nOne TA worked very hard & made the class more approachable.  Kudos to that person.',
            rating: 2,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "One of the best classes I've taken at Georgia Tech. Professors and TA are knowledgeable, friendly, and answer questions quickly. Assignments are interesting and varied. I finished the semester feeling I've learned a broad range of useful topics.",
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'April 20, 2018',
            semester: 'spring 2018',
            review: 'Just DO NOT take this course unless you do real-time embedded systems for a living. The first half of the course was ok. Once the second half started and Professor Jerome Hugues appeared, the misery started.  He does not teach you anything and seems cocky and arrogant. The assignments he gives have no explanations behind them anywhere and are based on the material so arcane and esoteric, that probably only 0.001% of the IT world uses. The responses he gives on Piazza are so confusing - you wish you never asked the questions in the first place. Just spare yourself and stay away from this course.',
            rating: 1,
            difficulty: 5,
            workload: 15,
        },
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: 'The first two homeworks are straightforward and not difficult.',
            con: 'The course content is not relevant to cybersecurity, homework and project descriptions are vague, the TAs are unhelpful, grading is harsh, and several students dropped the course due to these issues.',
        },
        'fall 2022': {
            pro: 'The course is noted for its interesting and relevant content, with well-designed projects and homework. Professors and TAs received positive feedback for their efforts. Some students found the lecture videos useful, especially when played at increased speed.',
            con: 'Several reviews criticize the course for mediocre lecture videos that are disconnected from the homework. The AADL project is described as complicated and vague, creating confusion among students. Additionally, issues with course management, poorly written assignments, and insufficient support from TAs were highlighted.',
        },
        'spring 2022': {
            pro: 'The course offers enjoyable projects, particularly Projects 1 and 2, which were well set up and engaging. The support from TAs and professors was noted to be timely and helpful, and the overall course load was manageable.',
            con: 'The lecture material often did not align with the assignments, leading to confusion. Assignments HW5 and Project 3 were described as difficult and nitpicky, with grading perceived as overly strict and not based on completion.',
        },
        'spring 2021': {
            pro: 'Some students found the course fun and rewarding, especially appreciating the real-life application of their code in the Robotarium and the support from engaged TAs and the instructor.',
            con: 'Many students criticized the course for its confusing and ambiguous instructions, disorganized content, and a lack of clear connections between lectures and assignments, leading to frustration and a perception of poor teaching quality.',
        },
        'fall 2020': {
            pro: 'The grading is generous and the TA involvement is high, making it easy to get questions answered. Some projects, like the robotarium project, are enjoyable.',
            con: 'The course structure is unclear, with lectures that are not useful and projects that are vague and confusing. Many students feel the projects lack coherence and relevance.',
        },
        'spring 2020': {
            pro: 'The course offers hands-on projects involving real-world simulations, particularly with robotics. Many students find the projects engaging and appreciate the practical aspects of learning Matlab and the Robotarium. Active Piazza discussions among students enhance the learning experience.',
            con: 'The course suffers from vague assignment instructions, especially in later projects. Many students find lectures unhelpful and feel that grading is slow and lacks clarity. The curriculum is perceived as poorly designed with little correlation between lecture content and assignments.',
        },
        'fall 2019': {
            pro: 'Generous grading and interesting lectures; strong professor involvement and engaging discussions in a small class setting.',
            con: 'Poorly designed homework and projects; slow grading with insufficient feedback; difficult-to-follow videos.',
        },
        'spring 2019': {
            pro: 'The course offers a comprehensive approach to cyber physical systems, covering a wide range of important topics and providing a solid foundational understanding. The instructors are active and supportive, making the material engaging.',
            con: 'The second half of the course feels disconnected from lectures and assignments, leading to a less enjoyable experience. Some project requirements may seem obscure.',
        },
        'summer 2018': {
            pro: 'The course is engaging and well-structured, with reasonable homework assignments and projects. The absence of exams and group projects reduces stress. The instructors and TA are responsive and helpful.',
            con: 'The course material can be overwhelming, with too much content and multiple videos in single slides, which may require better organization.',
        },
        'fall 2018': {
            pro: 'Knowledgeable and friendly professors and TA, interesting and varied assignments, and applicable lessons learned.',
            con: 'Class lectures lack practical knowledge, which some students struggle with; independent course sections and more follow-up courses would improve the experience.',
        },
        'spring 2018': {
            pro: 'The first half of the course, taught by Dr. Eric Feron, is considered enjoyable with well-defined assignments, and offers a decent elective experience.',
            con: 'The second half of the course, taught by Dr. Jérôme Hugues, is criticized for vague assignments, a language barrier, and an ineffective teaching style, leading to significant frustration for students.',
        },
        'fall 2017': {
            pro: 'The course offers interesting material focused on autonomous systems, with strong instructors and helpful TAs. It effectively introduces various fields within computer science, and hands-on assignments reinforce learning.',
            con: 'Students may struggle without a strong math and engineering background, as many concepts are not thoroughly explained in lectures. The course has a high barrier to understanding, with some scheduling issues noted.',
        },
    },
};
