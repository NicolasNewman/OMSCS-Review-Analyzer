export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            review: "I essentially picked my own project for my employer and wrote a thesis about it. I was able to get through the lectures in the first day, as they only track if the lectures were viewed. I submitted all work products timely, and never received any feedback. I ended up redacting (per my employer) a large portion of the final report and the entire set of references, and wasn't even asked why. I cannot fathom why GaTech thinks it is ok to charge twice as much for this class - I never spoke to staff nor faculty once the class started and have no idea if i learned anything.",
            rating: 1,
            difficulty: 1,
            workload: 4,
        },
