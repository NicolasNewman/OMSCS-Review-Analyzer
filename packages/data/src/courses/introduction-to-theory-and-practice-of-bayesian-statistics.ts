export default {
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: 'The TAs, especially Aaron, are extremely helpful and provide great resources like the GitHub repository. The course offers valuable information and tools.',
            con: 'The course lectures are considered unhelpful and vague, requiring significant time commitment for assignments, particularly in the first half.',
        },
        'fall 2023': {
            pro: 'The course material is engaging, and teaching assistants (particularly Aaron) are helpful and provide valuable supplementary resources. Many students appreciated the support from external resources and found the subject matter interesting.',
            con: 'The video lectures are poorly presented and often lack depth, making it necessary for students to engage in extensive self-study. Some students found it difficult to follow the course due to a lack of intuitive explanations and timely feedback on assignments.',
        },
        'fall 2022': {
            pro: 'TAs are highly praised for their helpfulness, and recorded office hours are a useful resource. The course material itself is interesting and provides freedom for a final project, along with the ability to refresh prior knowledge in calculus and probability.',
            con: "Lectures lack depth and detail, making it difficult to understand concepts. There's a lack of examples related to homework, making assignments challenging, and the use of outdated software adds to the frustration. Overall organization is poor, leading to student stress and confusion.",
        },
        'spring 2022': {
            pro: 'Good course for those interested in Bayesian Statistics; very helpful TAs; interesting projects; educational assignments; well-edited instructional videos; good knowledge foundation for ML track.',
            con: 'Some concepts not fully explained; high exam weight impacting overall grade; Gibbs Sampling algorithm insufficiently covered; issues with PyMC package making debugging challenging.',
        },
        'fall 2021': {
            pro: 'Helpful TAs, take-home exams, and supplemental materials contribute positively to the learning experience. Some students found the content on Bayesian statistics useful for their work.',
            con: 'Lectures are dense, filled with errors, and do not adequately explain the material, leading to confusion. Grading practices are criticized for being overly punitive and not reflective of student understanding, while reliance on outdated software like WinBUGS is seen as a drawback.',
        },
        'fall 2020': {
            pro: 'The course offers a good understanding of the math behind Bayesian statistics and MCMC, with helpful TAs and the flexibility to use various tools for assignments.',
            con: 'Lectures are poorly delivered, often just reading off slides, and concepts are not well explained. The course software is outdated, and many find self-study necessary to succeed.',
        },
        'spring 2021': {
            pro: 'The TAs, particularly Greg and Yuwei, received consistent praise for their support and dedication, helping students navigate the difficult content and assignments.',
            con: 'The course materials and lectures were often described as confusing and outdated, particularly the use of WinBUGS, making it challenging to grasp key concepts and prepare for exams.',
        },
        'spring 2020': {
            pro: 'The course is useful and offers a solid understanding of Bayesian statistics. Grading is lenient, and there are ample resources available for students, including open-book assessments and a supportive student community.',
            con: "The teaching style is challenging to follow, and the course material can be difficult without a strong math background. TA coverage and feedback are inadequate, leading to a reliance on external resources. The course's focus on outdated software like WinBUGS is criticized.",
        },
        'fall 2019': {
            pro: 'Covers basics of Bayesian methods with a good mix of theory and practical applications; light course load with clear lectures and plenty of support for assignments and exams.',
            con: 'Material is introductory and not very in-depth; reliance on outdated software (WinBUGS/OpenBUGS) for assignments; first half is quite theoretical and may be challenging for those without a strong statistics/math background.',
        },
        'summer 2018': {
            pro: 'The course is generally considered easy with lenient grading, supportive TAs and professors, and interesting material, especially if you have a math background.',
            con: 'The course suffers from slow feedback on assignments, a lack of detail in lectures, outdated tools, and difficulty with software, leading to confusion for some students.',
        },
        'spring 2019': {
            pro: 'The course covers powerful concepts in Bayesian inference and provides a lot of helpful examples, making it easier to complete assignments. High grades and extra credit opportunities are noted positively.',
            con: 'The theoretical explanations are often unclear, with some errors in handouts. The project lacks guidance, and there were issues with a wrong final exam version affecting fairness.',
        },
        'fall 2017': {
            pro: 'The grading is lenient, and take-home exams are easy; some students found later content more applicable.',
            con: 'Lecture videos are dry and focus on formulas without building intuition; initial content is overly mathematical.',
        },
    },
};
