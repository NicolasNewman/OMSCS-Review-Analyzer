export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course offers open-ended assignments that encourage curiosity and exploration, with supportive TAs and resources like beneficial FAQs. Many students found the course both fun and challenging, leading to valuable learning experiences.',
            con: 'The course is perceived as stressful and often lacks clarity, with grading being seen as ambiguous and reliant on a hidden rubric. Some felt the workload was excessive and that the lectures were not engaging, while others found the project requirements confusing.',
        },
        'spring 2024': {
            pro: 'The course covers interesting material, and the teaching staff is great, being hands-on and timely with grades.',
            con: 'The course is stressful due to bureaucratic rules, a lack of transparency in grading, excessive focus on paper writing over learning machine learning, and high workload for assignments.',
        },
        'fall 2023': {
            pro: "The course provides a deep exploration of machine learning algorithms, encourages critical thinking, and improves students' technical writing skills. Many former students expressed a sense of accomplishment and enhanced understanding of ML principles after completing assignments, especially when engaging with discussions and supplemental materials.",
            con: "The course is criticized for its ambiguity in assignments, lack of clear grading rubrics, outdated lectures, and long turnarounds on feedback. Many reviews mention a 'grade lottery' phenomenon, where students feel that grading is inconsistent and subjective. Additionally, the heavy workload and unclear expectations contribute to student frustration and burnout.",
        },
        'spring 2023': {
            pro: 'Many students reported that the course provides a rigorous foundation in machine learning, challenges their analytical skills, and prepares them for practical applications. The TAs were generally seen as helpful, and despite some confusion, students felt they learned significantly from the assignments, which require detailed analysis and justification. Several users mentioned strong improvements in understanding the concepts and real-world applications post-course.',
            con: "The course was criticized for vague assignment descriptions, excessive workload, and unclear grading criteria. Many students found the lectures outdated and unengaging, with a distracting banter style that hindered understanding. Grading was often viewed as harsh and inconsistent, with some students feeling demotivated by the instructors' tone in responses. The overall execution of the course materials and structure was seen as flawed by numerous reviewers.",
        },
        'fall 2022': {
            pro: 'The course covers a vast range of machine learning topics, provides valuable practical experience through open-ended assignments, and features knowledgeable professors and supportive TAs. Many students appreciated the deep critical thinking required and the opportunity to work with real datasets, which enhanced their learning experience.',
            con: 'The course is unstructured and stressful, with vague assignment instructions and a high level of difficulty in both assignments and exams. Many students expressed frustration over grading subjectivity and lack of clear rubrics, leading to confusion and high workload which may not align with their expectations of a typical ML course.',
        },
        'spring 2022': {
            pro: 'The course features engaging lectures from world experts, encourages analytical thinking and experimentation in assignments, and has a supportive community with active office hours and resources available for students. Many students report being able to earn good grades with sufficient effort.',
            con: 'The assignments are often vague, with unclear grading standards and a lack of guidance, leading to significant stress and confusion among students. Many express frustration with the open-ended nature of projects and the slow feedback on assignments, contributing to a feeling of chaos in the course structure.',
        },
        'fall 2020': {
            pro: 'The course covers a wide range of machine learning topics and provides hands-on experience with practical assignments, which can be beneficial for learning if approached correctly. Some students report enjoying the exams and the overall lecture dynamic.',
            con: 'The grading criteria are perceived as vague and inconsistent, leading to frustration among students regarding assignment evaluations. Many reviews indicate the workload is excessive for the unclear expectations, resulting in a high drop rate and discouragement towards the subject matter.',
        },
        'fall 2021': {
            pro: 'The course offers a pragmatic approach, focusing on analysis over coding, and the lectures are generally well-presented, providing useful insights and fostering understanding.',
            con: 'The course is seen as excessively difficult with subjective grading, vague assignment prompts, and inadequate feedback from TAs, leading to frustration and a struggle to learn effectively.',
        },
        'spring 2021': {
            pro: 'The course provides a broad overview of machine learning techniques and emphasizes real-world applications. Many students find the assignments learning-intensive, allowing for exploration and hands-on experience, especially if office hours are utilized. The TAs and professors are active and engaged, providing support during the process.',
            con: 'The course is considered overly demanding, with a heavy workload and vague assignment requirements, leading to confusion and frustration among students. Grading is often viewed as arbitrary and not reflective of the effort put in, with lectures criticized for being dull and non-informative.',
        },
        'summer 2021': {
            pro: 'N/A',
            con: "Course arrangement is strange, with open-ended assignments that are rigid in grading. Instructors' expectations are unclear, leading to frustration. Additionally, sarcasm from the professor creates a toxic learning environment.",
        },
        'fall 2018': {
            pro: 'The course is challenging but rewarding, with engaging and informative lectures by Professors Isbell and Littman. Many students found the material interesting and appreciated the flexibility in assignments. The generous grading curve allowed most students to achieve satisfactory grades, and the open-ended nature of projects promoted exploration and critical thinking.',
            con: "The course suffers from ambiguous assignment expectations, a perceived lack of depth in lecture content, and inconsistent grading among TAs. Some students reported a negative perception of the instructor's attitude towards students and felt the course did not adequately cover foundational ML concepts or provide necessary mathematical rigor.",
        },
        'spring 2019': {
            pro: 'The course is well-structured with excellent lectures that emphasize conceptual understanding and practical application of machine learning methods. Many students found the content rewarding, and the curve allows for relatively high grades for those who put in effort.',
            con: 'The course has a high workload with lengthy assignments and exams that students found to be challenging. Grading is often seen as inconsistent and subjective due to varying TA assessments and lack of clear rubrics.',
        },
        'summer 2020': {
            pro: 'Workload is very manageable.',
            con: 'Not much different from undergrad ML courses; perceived as not very difficult.',
        },
        'spring 2020': {
            pro: 'The course provides significant learning opportunities, with a well-structured curriculum that includes various algorithms in machine learning. Many students find the lectures engaging and the exams to be a fair assessment of their understanding. The extensive office hours and supportive TAs help students clarify doubts.',
            con: 'Grading is often considered arbitrary and inconsistent, with vague feedback that lacks depth. Many students report frustrations with the assignments being poorly explained and the required effort not aligning with the grades received. The course is viewed as time-consuming, with some feeling it caters poorly to diverse learning needs.',
        },
        'fall 2019': {
            pro: 'The course offers a broad overview of machine learning concepts and emphasizes theoretical understanding alongside practical application. Lectures are interactive and entertaining, and there is a generous grading curve that benefits most students.',
            con: 'The course is poorly structured with vague assignment instructions and subjective grading based on TAs, leading to significant inconsistencies in feedback and grades. Many students expressed frustration with the lack of transparency and effective support from TAs and the professor.',
        },
        'spring 2018': {
            pro: 'The course is well-structured with engaging and knowledgeable professors, interesting projects that encourage independent exploration, and a strong emphasis on analysis rather than coding. Many students felt they learned a lot and appreciated the active involvement of the professors and TAs.',
            con: 'The course is extremely demanding and time-consuming, with vague assignment guidelines and unclear rubrics leading to frustration. Many students reported difficulties with exams and felt that the lack of feedback negatively impacted their learning.',
        },
        'summer 2018': {
            pro: 'Some students found the lectures interesting and appreciated learning new topics, although comprehension was limited. Individual work was emphasized and assignments provided practical ML experience working on real datasets.',
            con: 'Numerous complaints about the course content being poorly structured, overly long lectures with little substance, unhelpful faculty interactions, lack of clear assignment guidelines, and bullying behavior from the professor. Many students felt unprepared and undervalued their learning experience.',
        },
        'fall 2017': {
            pro: 'The course provides a broad overview of machine learning topics, is taught by knowledgeable and engaging professors, and is rewarding despite its challenges. Many students praised the flexibility in choosing programming languages and datasets for assignments, as well as the generous grading curve, which helps alleviate stress around harsh grades.',
            con: 'The course is reported to be very challenging with ambiguous assignments that lack clear grading rubrics, leading to confusion and frustration for students. Additionally, grading is described as harsh and subjective, with some reviewers expressing concerns about limited feedback from TAs and the difficulty of exams.',
        },
        'spring 2016': {
            pro: 'The course offers a good introduction to machine learning, engaging lectures, and knowledgeable professors, providing foundational knowledge and hands-on experience with projects. Many students felt they learned a lot and found the assignments challenging yet manageable with the right approach.',
            con: 'The course has a high workload, requires strong mathematics background, and can be tedious with projects lacking clear guidance. Some reviews mentioned poorly designed assignments and concerns over grading fairness.',
        },
        'spring 2017': {
            pro: 'Engaging and informative lectures, fun videos, and a good introduction to machine learning principles. High level of professor involvement and support on platforms like Piazza and Slack. The course is rewarding for those who dedicate time to understand the material deeply.',
            con: 'Grading can be inconsistent and nonsensical, with poor feedback on assignments and exams. The grading criteria are often vague and may lead to confusion. Projects are open-ended but can be difficult due to hidden expectations and a lack of clear guidelines.',
        },
        'spring 2015': {
            pro: 'The course features excellent class videos, seasoned instructors, and rewarding content. Projects enhance material understanding and are thorough when followed with clear instructions.',
            con: 'The course is very challenging and time-consuming, with some students finding it poorly designed for teaching machine learning concepts. Issues with dataset selection and unclear explanations hamper learning.',
        },
        'fall 2015': {
            pro: 'The course is rewarding and provides interesting lectures, with an active Piazza community that supports students. Many found the material valuable and applicable to their work.',
            con: 'The course has a huge workload and is considered difficult, with vague lectures, poorly defined assignments, and a lack of structure in projects. Some students found the assessments challenging and the projects time-consuming.',
        },
        'fall 2016': {
            pro: 'The course is highly educational, well-structured, and covers the fundamentals of machine learning. Lectures are engaging, and assignments solidify knowledge, making it a rewarding experience overall.',
            con: 'Assignments are extremely challenging and time-consuming, and grading criteria are unclear. Interaction with instructors and TAs is minimal, and the midterm is considered very difficult.',
        },
        'fall 2014': {
            pro: 'The course provides a comprehensive introduction to machine learning, with engaging lectures and open-ended projects that enhance learning. It fosters collaboration among students and offers opportunities for extra credit.',
            con: 'The course is very challenging with a heavy workload, unclear homework expectations, and difficult assessments that may discourage some students.',
        },
    },
};
