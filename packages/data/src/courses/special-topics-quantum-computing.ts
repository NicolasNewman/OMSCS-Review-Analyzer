export default {
    ...
    reviews: [
        {
            user: 'Z+qbctrp68tdvtte5W/XCA==',
            reviewDate: 'July 31, 2024',
            semester: 'summer 2024',
            review: "Idk who said that this course was easy, but trust me it is not.  It was my first omscs course and coming from a very heavy math background I thought it'd be easy. Well I didn't take into account that assignments have little to no instructions other then bang your head against the wall, and I also I had no idea that exams were not at all what assignments were.\nI feel like between exams and projects I was doing 2 different classes. Apparently in non-summer semesters they had homework problems, but they refused to share it with us. I think that did us a big disservice.\nYes you have unlimited attempts on the quizzes and also paper reviews are an easy 4-5/5 points. But this class was far from easy or clear.",
            rating: 2,
            difficulty: 5,
            workload: 16,
        },
        ...
        {
            user: 'pvGlr6T30NlNMDGvFDpTtQ==',
            reviewDate: 'July 1, 2024',
            semester: 'summer 2023',
            review: "This is for the ongoing Summer '24 session. I just couldn't hold it. I hope it helps some uncertain folks to make a decision.\nCourse content is organized fine. Labs are decent so far. You need to be able to figure out some stuff by your own in those labs as auto grader outputs are not detailed and TAs won't hold your hand throughout the whole lab, which is a good thing IMHO.\nStuff I wish this course had:\n\n\nMore depth and more examples in module videos: I am watching IBM qiskit lectures end-to-end to close the gaps. That should tell you enough. Lecture videos in this course are too short for the subject matter. It's more like a refresher for those who are familiar with the subject.\n\n\nBetter exam prep: Not sure if instruction team is aware but having big portions of final grade coming from midterm and final AND not having a curve on top of not having extra credit assignments (except +5pts from practice exam) is quite stressful. We had a list of exercises posted on Ed. I worked on them but some of them were ridiculously hard. Exam was nowhere near those practice questions and I felt like I wasted my prep time on hard questions for nothing.\n\n\nBetter paper review guidelines: I feel like we are reviewing the papers for the sake of reviewing, not learning.\n\n\nLonger TA replies: TA replies on Ed are short as if they are taxed by the number of words they have in their replies :) A fellow student replies longer than actual TAs. Maybe that's by design. This is my final course in the program and I'm used to the opposite.\n\n\nMore TA activity on Sundays: There are 9 TA/IAs listed in the syllabus but only a few of them reply to posts on Ed. On most Sundays, it's radio silence until after an assignment deadline is passed. Given this program is online and people usually work on their assignments over the weekends, it would help A LOT if at least some TAs are active on Ed on Sundays.\n\n\nTo be fair, I haven't joined to any office hours so far but my experience in this program has been that Ed/Piazza are the primary means of communication with the instruction team.\nOh and, polish your linear algebra. Fundamental stuff like matrix multiplications, tensor products, inner/outer products; nothing hardcore. It would also help a lot if you study Dirac notation and get comfortable with it before taking this course.",
            rating: 3,
            difficulty: 3,
            workload: 10,
        },
        {
            user: 'yPtZkyTj9RhRZkXax/euBg==',
            reviewDate: 'June 2, 2024',
            semester: 'spring 2024',
            review: 'Vague instructions, almost no coding examples, extremely fast paced and a lot of information to digest. I recommend an Intro to Quantum Computing before taking this course.',
            rating: 1,
            difficulty: 5,
            workload: 20,
        },
        {
            ...
            semester: 'spring 2024',
            review: "My favorite course thus far. Great into to quantum computing.\nI think a few things could've been explained a bit better and I wrote a blog post:\nhttps://medium.com/@david.bai/quantum-computing-gates-and-phase-82d0a1e9ef5c\nalso i wrote out bascially almost all the qiskit you need to know for the course here:\nhttps://github.com/gitgud/cs8803-O13-visuals/blob/main/qiskit_basics.ipynb",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        {
            user: 'TzxJsOV4uErwPa6Z7rMOxQ==',
            reviewDate: 'May 5, 2024',
            semester: 'spring 2023',
            review: "Took it in Spring 2024.\nOverall, very good course.\nPros:\n\nGood coverage of all quantum computing topics.\nLabs and problems are tightly connected with the course material.\nFair exams provide good coverage of all material across all modules.\nThey are challenging; you must thoroughly understand all homework questions.\n\nCons:\nLectures are too concise. For the first half of the course, you are required to read the textbook. (Thomas Wong's book is actually much better.) It tooks much more time (~ 20 hours) for the first half. The second half tooks much less time (~ 8 hours )\nTAs:\nI don't want to blame them, but they are often unhelpful in answering questions related to the course materials, and their answers can be more confusing. This is completely different from the Head TA of HPCA (Nolan is great).\nIn conclusion, it is a great course with relatively new materials and good coverage of all topics. The TAs are very responsive. They are helpful in terms of learning, but they answer logistical questions promptly.",
            rating: 5,
            difficulty: 3,
            workload: 14,
        },
