export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course is well-organized, comprehensive, and provides a solid introduction to operating systems, with clear lectures and helpful resources. Many students found the projects enjoyable and a good way to apply what they learned in practical scenarios. There is a supportive Slack community that enhances the learning experience, and a generous grading curve helps students succeed.',
            con: 'The course has significant issues with project documentation, which many students found vague and frustrating. Some teaching assistants were reported as condescending, impacting the ability to seek help. The exams are considered very challenging, with some feeling they carry too much weight relative to the workload of projects.',
        },
        'spring 2024': {
            pro: 'The course effectively teaches core Operating Systems concepts with rewarding and well-designed projects, alongside a helpful Slack community for support.',
            con: 'Lecture content is often unorganized and contains numerous errors; exams are trivia-heavy and do not effectively test understanding. TAs are generally unresponsive.',
        },
        'summer 2023': {
            pro: 'The course is rewarding and covers many essential programming concepts, such as threads and cloud infrastructure, making it suitable for those looking to strengthen their CS background; helpful TAs and generous grading curve are also noted.',
            con: 'The course is extremely challenging, especially for those without a background in C or other programming languages; students advise dedicating significant time for projects and warn against pairing the course with others due to its intensity.',
        },
        'spring 2023': {
            pro: 'The course is well-organized, offers valuable projects that enhance programming and problem-solving skills, and has a generous grading curve. Lectures are well-structured and informative.',
            con: 'The course is challenging, particularly for students with little knowledge of C or Unix. Exams are difficult, with some content not covered in lectures, and preparation can be taxing.',
        },
        'fall 2022': {
            pro: 'The course has well-organized lectures, excellent material, and challenging projects that enhance understanding of operating systems concepts. Many students report significant learning and satisfaction, even those with non-CS backgrounds, and appreciate the active community for support.',
            con: "Several students found the projects time-consuming with vague specifications that led to frustration. There is a consensus that prior knowledge in C is crucial, and the grading scheme can be overly reliant on automated testing, potentially affecting students' scores despite project completeness.",
        },
        'summer 2022': {
            pro: 'The course has useful content, well-designed projects, and competent lectures, which help students learn about operating systems effectively. Many found the experience increases their interest in advanced topics and the generous grading curve was appreciated.',
            con: 'The course is very demanding, particularly during summer sessions with a compressed schedule. Many students struggled with vague project descriptions, time constraints, and the challenging nature of debugging and exam performance.',
        },
        'spring 2022': {
            pro: 'The course offers great depth of content, engaging projects that reinforce C/C++ skills, and a supportive Slack community where students can interact and help each other.',
            con: 'There is a significant lack of quality support from instructors and TAs, with vague project expectations, insufficient feedback, and issues with the correctness of lecture materials.',
        },
        'fall 2021': {
            pro: 'The course effectively covers fundamental concepts of Operating Systems, with challenging and rewarding projects that enhance practical understanding. Lectures are generally well-organized and provide a solid foundation for the material.',
            con: 'The projects can be vague and the grading process can be complicated, particularly with the use of Gradescope. Exams are perceived as disconnected from project work, requiring extensive memorization and can feel overwhelming due to a wide range of material.',
        },
        'fall 2020': {
            pro: 'The course is well-organized with excellent lectures, challenging projects that provide a lot of knowledge, and supportive TAs. Many reviewers found the content useful and enriching for their careers.',
            con: 'Projects are very time-consuming, and exams are seen as disproportionately weighted and not comprehensive, leading to frustration among some students.',
        },
        'spring 2021': {
            pro: 'The course features clear lectures, valuable projects that enhance programming skills, an active and supportive Slack channel, and responsive instructors and TAs, making it engaging for students.',
            con: 'The course has a heavy workload with too much material, projects can be extremely challenging often leading to frustration due to unclear documentation, and TAs may provide uneven support.',
        },
        'summer 2021': {
            pro: 'The course is engaging and well-structured, with a supportive professor and challenging projects that enhance understanding. It serves as good preparation for advanced courses.',
            con: 'The workload can be overwhelming, especially in a compressed time frame like summer. The exams and projects require significant prior knowledge, especially in C/C++, which can hinder those without a strong background.',
        },
        'spring 2019': {
            pro: 'The course offers a wide range of interesting and informative lecture content, challenging yet rewarding assignments, and excellent support from TAs and the professor. Many students appreciated the vibrant community on platforms like Slack and Piazza, and found the projects to significantly enhance their learning experience.',
            con: "Some students faced issues with a specific TA who was perceived as rude and condescending. There were complaints about the project's hidden/undocumented requirements and poorly written assignment documents, with some reviewers feeling the course materials did not fully align with the projects.",
        },
        'fall 2018': {
            pro: 'The course is well-organized, with engaging lectures and responsive professors and TAs. Students appreciate the helpfulness of TAs and the challenging yet rewarding projects that enhance learning.',
            con: 'The course is considered difficult, especially for those without a strong foundation in C programming. Many students reported a heavy workload and time-consuming projects that can lead to stress.',
        },
        'summer 2020': {
            pro: 'Many students found the course challenging yet rewarding, with valuable projects that enhance knowledge in operating systems and programming. TA support is praised, and the course has a generous grading curve.',
            con: 'The course is very demanding and requires prior knowledge of C and operating systems; many students struggled with the pace and the volume of material covered. There are criticisms about the exams being overly focused on memorization and the disconnect between project work and lecture content.',
        },
        'spring 2020': {
            pro: 'The course offers a comprehensive overview of operating system concepts, well-structured projects, and responsive teaching staff. Many students found the projects challenging yet rewarding, and the lectures informative and engaging.',
            con: 'The course has high workload and time demands, especially concerning projects and exams. Some students reported vague project instructions and difficulties if lacking C programming experience. Grading speed was also noted as slow due to class size.',
        },
        'fall 2019': {
            pro: 'Many students felt the projects were engaging and provided a solid understanding of C programming, memory management, and multithreading concepts. TAs were noted as generally helpful, and the course material was considered interesting and beneficial for software engineers.',
            con: "Several reviewers noted the course's expectations may exceed what is reasonable for students without sufficient background in C/C++. The grading and TA interactions were often criticized, with reports of condescending attitudes and unclear project instructions leading to frustration.",
        },
        'spring 2018': {
            pro: 'The course is well-organized with great lectures, and the TAs are active and helpful. Many students found the projects challenging yet rewarding, with ample learning opportunities in operating systems concepts and C programming. The instructor is highly regarded for her involvement and support.',
            con: 'The projects can be extremely difficult, especially for those unfamiliar with C, leading to significant time commitments and potential frustration. Some students felt that the grading was heavily weighted towards exams, and TAs were often perceived as condescending when responding to questions.',
        },
        'summer 2016': {
            pro: 'The course offers a comprehensive understanding of OS concepts and C programming, with supportive instructors and TAs, and generous grading curves that benefit students.',
            con: 'Assignments are time-consuming and the autograder can be problematic, causing frustration among students; the exams are also considered tricky and often focus on minutia.',
        },
        'summer 2019': {
            pro: 'The course offers interesting material on operating systems, engaging lectures, and valuable projects that enhance understanding of low-level programming concepts like multi-threading and inter-process communication. The TAs are helpful, and Slack channels foster good communication among students.',
            con: 'The course is very demanding, particularly in the summer semester, with a significant amount of material and time-consuming projects. Exam formats are criticized for being tricky and poorly aligned with the lecture content, and some students found the papers dull and unhelpful.',
        },
        'summer 2018': {
            pro: 'The course is well-structured with engaging lectures, helpful TAs, and provides insightful projects that enhance understanding of operating systems. Many found it valuable for practicing C programming and improving their grasp of OS concepts.',
            con: 'Project instructions were often vague, making them time-consuming and frustrating to complete. The projects also relied heavily on multi-threading and did not sufficiently reinforce core OS theory, leading to complaints about their educational value.',
        },
        'fall 2016': {
            pro: 'The course is well-organized, with clear lectures and helpful projects that cover important OS fundamentals. The active community on Slack and Piazza provides substantial support, and the projects enhance understanding of the material, especially with C programming.',
            con: 'Students must have prior C experience, or they may struggle significantly. The workload can be intense, and some students found the exams challenging and poorly phrased, leading to anxiety and confusion.',
        },
        'fall 2017': {
            pro: 'The course is well-structured with engaging lectures and helpful TAs. Projects are interesting, relevant, and provide a good introduction to operating systems. The instructor is responsive and maintains an active presence on Piazza and Slack, facilitating a supportive learning environment.',
            con: 'Many students found the exams tricky and challenging, with some questions vague or overly complicated. A strong background in C programming is necessary, and the projects are time-consuming, potentially leading to frustration for those less familiar with the language.',
        },
        'spring 2016': {
            pro: 'The course is well-organized and taught, with excellent and responsive instructors. Lectures are polished and engaging, and projects are challenging yet rewarding, helping to solidify learning. Active Piazza discussions facilitate student interaction and support.',
            con: 'A firm understanding of C is essential; students without sufficient background may struggle significantly with projects and course content. Some found the projects to be time-consuming and the grading system difficult to navigate, with the autograder being unhelpful at times. Lectures can be overly lengthy and contain off-topic discussions.',
        },
        'spring 2017': {
            pro: 'The course is well organized and run, with engaging lectures and helpful TAs. Students report learning a lot and finding projects appropriately challenging, especially those with a C background.',
            con: 'The first project is particularly frustrating for those without a strong C background, and some project instructions are confusing. Lectures are delivered quickly, which can be difficult to follow, and some aspects of the course material are seen as vague.',
        },
        'summer 2017': {
            pro: 'The course serves as a good introduction to C and operating system fundamentals, with helpful TAs and supportive peers. The lectures are excellent and projects are interesting.',
            con: 'The course demands a significant time commitment and has tricky exams. It covers many topics superficially, and grading for projects is slow.',
        },
        'spring 2015': {
            pro: 'The course offers appropriate breadth and depth on operating systems, with excellent instruction and well-managed exams and assignments. The opportunity to read seminal papers is highlighted as a key benefit.',
            con: 'The projects, particularly Project 1, are considered very time-consuming and challenging, with extra requirements that may not be relevant to the course content. A strong prior knowledge of C is necessary for success.',
        },
        'fall 2015': {
            pro: 'Very interesting topics and well-organized lectures.',
            con: 'Lectures are too theoretical and abstract, making them hard to understand; projects are frustrating and challenging, leading to incomplete submissions.',
        },
        'fall 2014': {
            pro: 'The lectures are well done, and the professor is knowledgeable. Projects are challenging but provide a good learning experience, and grading is fair.',
            con: "The projects are difficult, and it's recommended to have a familiarity with C beforehand. The class is very challenging and may be difficult to take alongside another course.",
        },
        'summer 2015': {
            pro: 'The class is fantastic with excellent videos and covers fundamental topics. The projects are useful for writing concurrent code.',
            con: 'N/A',
        },
    },
};
