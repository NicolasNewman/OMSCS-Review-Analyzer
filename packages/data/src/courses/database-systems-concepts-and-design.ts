export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course offers a manageable workload, good support from the TA, and an enjoyable project experience, particularly with the ability to choose tech stacks.',
            con: 'The course content is basic and does not meet the expectations for advanced learning; exams are mismatched with lecture content, and grading is stringent with little chance for rounding up scores.',
        },
        'fall 2023': {
            pro: 'The course is valuable for beginners, offering informative lectures and hands-on experience with practical applications such as full stack development. The project allows for learning new frameworks and enhances collaborative skills.',
            con: 'The course lacks structure, discourages certain SQL practices, and is poorly supported by TAs. Many students found the exams challenging with misleading questions, and some experienced frustration with team dynamics.',
        },
        'summer 2024': {
            pro: 'The material learned throughout the course was interesting and enjoyable.',
            con: "Grading is extremely harsh with a class average of D on the final exam and no accommodations made for students' personal circumstances. There is little to no flexibility in grading and timelines.",
        },
        'spring 2023': {
            pro: 'Some students found the course manageable and suitable for those with little database knowledge, citing opportunities for learning and supportive peer groups.',
            con: 'Many reviews criticized the outdated content, lack of effective instruction and practice opportunities, unhelpful TAs, and difficult exams that did not align with the course material.',
        },
        'summer 2023': {
            pro: "The course provides a solid understanding of database fundamentals and features informative lectures, particularly on theoretical components. Some students found their teams supportive and the professor's videos helpful.",
            con: 'Many students criticized the course for its challenging exams, poorly managed projects, and rude TAs. Additionally, the accelerated pace and lack of extra credit make it difficult for students to succeed.',
        },
        'fall 2022': {
            pro: 'The course covers fundamental knowledge of databases with well-structured material, making it suitable for students without a CS background. Some students enjoyed the project, especially new technologies like node.js and React.',
            con: 'The course lacks coverage of modern database technologies and relevant topics such as indexing and performance. The exams are considered poorly aligned with lectures, vague project requirements lead to confusion, and TAs receive criticism for being unhelpful and unclear.',
        },
        'summer 2022': {
            pro: 'The course provides a thorough understanding of relational databases, SQL, and full stack development, with effective lecture videos and a valuable group project experience.',
            con: 'Lacks exposure to NoSQL databases, has strict grading with challenging exams, and the content needs more polish, including issues with exam materials and formatting.',
        },
        'spring 2022': {
            pro: 'Some students found the course enjoyable and well-structured, with good lecture videos and a solid textbook that covers fundamental principles of databases. The project provided practical experience in full-stack development.',
            con: 'Many reviews highlighted outdated content, poorly defined projects, tricky exams, and a grading policy that lacks flexibility. Several students expressed frustration with TAs and the overall management of the course.',
        },
        'fall 2021': {
            pro: 'The course provides valuable knowledge about databases, specifically SQL, and presents a major project that offers practical experience. Many students report learning a lot, especially if they form effective groups.',
            con: 'Exams are considered very difficult and poorly worded, making it hard for students to achieve high scores. The teaching assistants (TAs) reportedly have a rude demeanor and are unhelpful, contributing to a toxic learning environment. Group projects often suffer from issues with free riders, leading to an unfair workload distribution.',
        },
        'summer 2021': {
            pro: 'The course offers comprehensive coverage of database basics and SQL, with helpful TAs and a supportive lecturer. Many students found value in the learning experience and reported being able to complete SQL challenges effectively.',
            con: 'The grading system is strict with no curves, leading to difficulties in achieving high scores. Exams are described as tricky and challenging, and many students felt the course materials, particularly the textbook, were not helpful for exam preparation.',
        },
        'spring 2021': {
            pro: 'Lecture videos are informative and staff, including the professor and TAs, are responsive and supportive. Many students found the course enjoyable and beneficial for learning key database concepts.',
            con: 'Exams are heavily weighted, with unclear wording that can confuse students, especially non-native English speakers. The technology and course material are considered outdated, and grading criteria for projects are seen as vague and inconsistent.',
        },
        'fall 2020': {
            pro: 'Some students found the course material interesting and the workload manageable, especially if they had a good group. Lectures were described as concise and well-made, with the professor actively participating in office hours.',
            con: 'Many students criticized the exams as overly tricky and poorly worded, often leading to unfair grading due to negative marking. There were concerns about the project grading, unclear feedback from TAs, and the overall challenge of the course being excessively high for a foundational subject.',
        },
        'spring 2019': {
            pro: 'Students appreciated the freedom to choose web frameworks for projects and noted the potential skills learned in practical teamwork. Additionally, some found the course enlightening and felt they learned SQL and PHP.',
            con: 'The course faced criticism for outdated materials, difficult and confusing exams, inconsistent grading policies, and logistical issues. Many felt the content was either not useful or overly complicated, and the focus on theoretical topics over practical applications was a common complaint.',
        },
        'fall 2019': {
            pro: 'The lecture content includes helpful metaphors and visual examples for beginners in relational databases, making some concepts easier to understand.',
            con: 'The course is overly complicated, outdated, and not suitable for those with prior knowledge of SQL. It also has poor organization, convoluted exam formats, and unhelpful teaching staff.',
        },
        'summer 2020': {
            pro: 'Positive aspects include a good sense of humor from the professor, helpful TAs, and engaging hands-on projects that provide exposure to database design and implementation.',
            con: 'Negative aspects include poorly structured exams and projects, antagonistic TAs, unclear grading criteria, a requirement for a costly textbook, and a focus on intricate rules over effective learning.',
        },
        'spring 2020': {
            pro: 'Some students found the course to be a good introduction to database concepts, with well-structured lectures and knowledgeable TAs. Many highlighted the importance of the lecture materials and textbook, praising the clarity of instruction.',
            con: 'Numerous reviews criticized the course for outdated material, poorly defined project requirements, and combative TAs. Students noted tricky exam questions and expressed frustration over unclear specifications, as well as a lack of practical applicability in their careers.',
        },
        'summer 2019': {
            pro: 'The project allows for practical application of concepts and is a well-structured learning experience, and the video lectures are well-produced.',
            con: 'The course content is outdated, with a heavy focus on basic relational databases and minimal discussion of NoSQL. Instructors and TAs are unprofessional, unhelpful, and the exam policies are unnecessarily strict, resulting in a stressful learning environment.',
        },
        'fall 2018': {
            pro: 'The group project was well-received, offering practical experience and valuable learning opportunities for many students, especially those with less prior knowledge of databases. The lectures were also noted as being engaging and informative.',
            con: 'Numerous reviews criticized the course for its overly difficult exams, outdated material, lack of clear grading standards, and poor organization, leading to frustration among students. The reliance on group projects was also a concern, particularly if team dynamics were unbalanced.',
        },
        'summer 2018': {
            pro: 'The course provides a thorough theoretical coverage of databases and is a good introduction for students with limited prior experience. The group projects help integrate practical application of learned concepts, and there are responsive TAs to assist students.',
            con: 'The course suffers from poorly worded exams that test obscure details, ambiguity in project requirements, and a lack of modern concepts such as NoSQL databases. The heavy reliance on group projects can create stress, especially if team dynamics are not favorable.',
        },
        'fall 2016': {
            pro: 'Professor Leo Mark is well-regarded for his lectures, and the class offers a solid introduction to relational databases for beginners. The group project helps in practical application, and many students found the exams manageable.',
            con: 'The course is heavy on theoretical concepts with limited practical application, lacking coverage of advanced topics like NoSQL or distributed databases. Many experienced students found the material too easy or the workload disproportionate, especially concerning the group project.',
        },
        'spring 2018': {
            pro: 'The course is suitable for beginners, offers flexibility in project application stacks, and features helpful TAs and professors. Some students found the project enjoyable and a good way to apply learned concepts.',
            con: 'The course is considered basic for graduate level, lacks depth in key areas like locking and transactions, and has a heavy dependence on group project dynamics, which can lead to unequal workloads. The organization and clarity of concepts have been criticized.',
        },
        'spring 2017': {
            pro: 'The course is well-organized, with effective instructors and TAs. Many found the lectures engaging and the material useful for practical applications, especially if you have prior experience with databases.',
            con: 'The group project can be stressful, especially if team members are uncooperative, leading to imbalanced workloads. Exams are considered tricky and involve rote memorization, with a heavy reading load from the textbook.',
        },
        'fall 2017': {
            pro: 'The course is beginner-friendly, provides a fun group project, and covers basic concepts useful for those without a formal CS background. Exams, while tricky, are manageable and open-book, allowing for a lighter experience for new learners.',
            con: 'The course material is outdated and focuses too heavily on web development rather than database concepts. Many students found the project poorly defined with inconsistent grading and a lack of instructor responsiveness, leading to confusion and frustration.',
        },
        'summer 2017': {
            pro: 'The course is challenging yet enjoyable, and the assignments and tests are straightforward with good practice materials. Students appreciated the TAs and the active involvement of the professor.',
            con: 'There are significant issues with course management, including inconsistent grading, unclear guidelines, unprofessional behavior from TAs, and a heavy focus on irrelevant material, particularly in the final project.',
        },
        'spring 2016': {
            pro: 'Students appreciated the helpful TAs and the hands-on group project, which mimicked real-world scenarios. Many found the course layout to be interesting and industry-oriented.',
            con: 'The course was criticized for being too basic, lacking depth in advanced topics, and having unbalanced grading with a strong emphasis on exams. Several students expressed frustration over group projects without peer evaluations and inconsistencies in exam quality and difficulty.',
        },
    },
};
