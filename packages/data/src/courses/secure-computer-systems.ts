export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course covers a wide range of topics, including data privacy and k-anonymity.',
            con: 'Many concepts felt theoretical and irrelevant, quizzes were ambiguous, lectures were dry, and projects were tedious. The focus on obscure topics and lack of practical application diminished the overall value.',
        },
        'spring 2023': {
            pro: 'The course includes interesting content on operating systems and platform security, with engaging projects that are relevant to real-world applications. The professor is active and holds weekly office hours.',
            con: 'The course grading is heavily tilted towards exams and quizzes, which are often confusing and poorly worded. The lectures are dull, and many topics serve as a review for those with a security background, leading to a lack of engagement.',
        },
        'fall 2022': {
            pro: 'Students appreciated the engaging lectures, knowledgeable instructor, and the interesting projects that helped solidify programming concepts in C and Python. The availability of office hours and supportive TAs were also highlighted positively.',
            con: 'The course was noted to be challenging with heavy exam weight, requiring significant preparation. The quizzes were found to be difficult and the projects, especially the final, were time-consuming and demanding.',
        },
        'summer 2021': {
            pro: 'The professor and TAs are engaged and helpful. The projects are enjoyable and offer a valuable learning experience.',
            con: 'Exams and quizzes are challenging, poorly worded, and carry significant weight in the final grade. The compressed summer schedule increases difficulty and workload.',
        },
        'fall 2021': {
            pro: 'The course is well-run with an involved professor, outstanding TA support, and weekly Q&A classes for better understanding.',
            con: 'It is a demanding course, which may be challenging for some students.',
        },
        'spring 2021': {
            pro: 'The course has practical projects that help in learning programming concepts. The instructor and TAs are highly involved and supportive.',
            con: 'The course includes an excessive amount of reading research papers, quizzes are tricky, and the grading can be unclear or stressful. The pedagogy may not fit all learning styles.',
        },
        'fall 2020': {
            pro: 'The course is enjoyable, particularly the technical deep dives, and is considered more relaxed with more spare time due to overlapping material from previous courses.',
            con: 'The final project is demanding in terms of polish for only 10% of the grade, and the course offers less coding experience, focusing more on quizzes and exams.',
        },
        'summer 2020': {
            pro: 'The TAs are helpful and respectful, quizzes are manageable, and tests effectively assess understanding without requiring rote memorization.',
            con: 'Some quizzes were poorly worded, and unclear communication regarding project options was noted.',
        },
        'spring 2020': {
            pro: 'The course provides a good understanding of securing computer systems, with engaging projects that enhance learning. The professor and TAs are supportive and provide useful resources and timely grading.',
            con: 'Some course materials are outdated and the quizzes and exams can be challenging, requiring significant study time and understanding of the material.',
        },
        'fall 2019': {
            pro: 'Lectures are well done, covering material effectively. The professor and TAs are supportive and responsive, with ample office hours for help. The projects, especially the last one, provide good learning opportunities.',
            con: 'Quizzes are deemed frustrating and ambiguous, significantly affecting grades. The course workload can ramp up too quickly, and some students found the lecture content boring or slow-paced.',
        },
        'summer 2019': {
            pro: 'The course emphasizes hands-on projects which are valued by some students.',
            con: 'Quizzes and lectures are seen as largely ineffective, and many projects are criticized for poor instructions and excessive difficulty.',
        },
    },
};
