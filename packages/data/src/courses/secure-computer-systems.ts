export default {
    ...
    reviewSummaries: {
        'fall 2023':
            'The course offers a diverse exploration of topics, including valuable insights into data privacy and k-anonymity. However, many students found that approximately half the content was overly theoretical and disconnected from real-world application, leading to extensive memorization of syntax and frameworks. The focus on obscure concepts, like keystroke timing for authentication, neglected crucial subjects such as public key cryptography, potentially misleading students about security methods. Quizzes and tests lacked clarity, requiring highly specific responses, while lectures were described as dry and projects mundane. Although some succeeded academically, the overall sentiment is one of disappointment, with many unable to recommend the course for genuine learning or practical relevance.',
        'spring 2023':
            "The course has a mix of strengths and weaknesses. On the positive side, many students found the content on operating systems and platform security engaging, particularly in modules 3, 4, 11, and 12. Projects, especially the ones focusing on memory protection and zero trust architectures, were enjoyable, albeit somewhat tedious. The professor's active involvement and frequent office hours were also appreciated. Conversely, the grading structure was criticized as heavily skewed, with 60% of the grade based on two exams that featured tricky and vague questions, making them frustrating. Lectures were deemed dull and hard to follow, contributing to a sense of disconnected learning. Overall, while the course covers interesting material, its presentation and assessment methods left much to be desired.",
        'fall 2022':
            "The course received mixed reviews, balancing enthusiasm and challenge. Students praised Dr. Ahamad's engaging lectures and availability, highlighting the practical and theoretical content underlined by interesting project work, particularly Project 4. While initially overwhelming, especially with quizzes and exams making up 60% of the grade, learners found value in focusing on lecture comprehension. However, many noted the demanding nature of the quizzes and the substantial time commitment for projects, especially the final one. The course's grading system offered some leniency, with dropped quiz and project grades, and a generous curve benefitting those who struggled. Overall, students enjoyed the learning experience despite the challenges, indicating it was both rewarding and educational.",
        'summer 2021':
            'Overall, the course received mixed reviews, highlighting both its challenges and benefits. Many students found the material intriguing yet difficult, especially during the compressed summer schedule, which intensified the workload. Quizzes and exams were frequently criticized for being tough, often including ambiguous or tricky questions that could disproportionately affect grades. Conversely, students appreciated the engaging projects, with several mentioning they were enjoyable and well-supported by the enthusiastic professor and TAs. Some felt the grading distribution favored quizzes too heavily, and while the projects counted for a smaller percentage of the final grade, they were seen as valuable learning experiences. Ultimately, while some students thrived in the course, others struggled with the dense theoretical content and fast pace.',
        'fall 2021':
            'The course receives positive feedback for being one of the best in the Cybersecurity program, with an involved professor and outstanding TAs who provide helpful feedback. Weekly Q&A sessions enhance understanding of quizzes and exams. The grading structure is favorable, as the lowest project and quiz grades are dropped, making it easier to secure at least a B. However, the course is demanding and aligns with the expectations of a graduate-level class, indicating a challenging workload. Overall, while the support and structure are appreciated, the intensity of the coursework may be a concern for some students.',
        'spring 2021':
            "The course received mixed reviews from students. On the positive side, many appreciated its practical projects and effective support from the instructor and TAs, highlighting the relevance of certain topics and their application to real-world scenarios. However, numerous students found the heavy reading load of research papers and the structure of quizzes and exams burdensome, citing tricky questions and vague wording. The professor's teaching style was criticized for being abstract and confusing at times, leading to an overall perception of the course as overly difficult and not particularly valuable for career advancement. While some students enjoyed the deep dives into complex topics, others felt it was a time-consuming stress test more than a beneficial educational experience.",
        'fall 2020':
            'The course offers a manageable workload, particularly for those with prior experience in computer science, featuring engaging technical deep dives into various topics. The first three-quarters are relatively straightforward, focusing on quizzes and exams rather than extensive projects, allowing for more free time. However, the final project demands significant effort and polish for just a small percentage of the overall grade, which some students found time-consuming. While the course lacks in-depth coding experience compared to similar classes, it covers intriguing material related to certificates and authentication. Overall, students appreciated the relaxed pace but noted a potential lack of technical growth for those seeking rigorous coding challenges.',
        'summer 2020':
            'Overall, the course received positive feedback, particularly for its supportive teaching assistants who are described as kind and helpful, regardless of the questions asked. The quizzes were generally acceptable, though some were poorly worded, yet TAs welcomed constructive feedback. Students appreciated the short-answer format of tests, which encouraged a deeper understanding of the material rather than rote memorization. An optional third project created some confusion, but the ability to drop the lowest project score was a plus. However, there were suggestions to improve the course, such as speeding up lecture videos. Despite a few minor drawbacks, students were enthusiastic, with one expressing a strong desire to retake the course.',
        'spring 2020':
            "The course received generally favorable reviews, highlighting a solid structure and engaging content. Many students praised the realistic and educational fourth project, though they acknowledged it was time-consuming and challenging. Weekly quizzes were considered difficult, with a median score of 8/10, but the lowest score was dropped, alleviating some pressure. The exams were challenging as well, emphasizing the need for a strong grasp of the material. Students appreciated Professor Ahamad's dedication and the support from TAs, who were responsive and fair in grading. However, some noted that certain class materials felt outdated and that the course demands could require significant weekly time commitment, ranging from 10 to 15 hours. Overall, the course was deemed valuable despite its challenges.",
        'fall 2019':
            'The reviews for this course highlight both positive and negative aspects. On the positive side, many students appreciated the well-structured lectures, helpful professors, and proactive TAs, noting that the learning environment facilitated engagement. The project workload was described as manageable, with some projects providing valuable hands-on experience. However, recurring criticisms focused on the quizzes, which were seen as ambiguous and disproportionately weighted—comprising 30% of the overall grade—which contributed to student frustration. Several students found the lectures dull and felt a lack of depth in the teaching materials, with some suggesting better integration of applied concepts. Overall, while the course has potential, it suffers from issues that need to be addressed for future iterations.',
        'summer 2019':
            'The course is primarily focused on projects, which some students prefer, but the quality of instruction is a significant drawback. While quizzes are open-book and minimally impactful on grades, many find lectures unhelpful and opt to search for answers during quizzes instead. Two out of five projects are criticized for their poor instructions, causing frustration as students struggle to understand the requirements. Starting projects early is strongly advised, especially for those unfamiliar with essential coding languages like JavaScript, HTML, and DOM. Overall, students appreciate the project concepts but are disappointed with the guidance and clarity provided.',
    },
};
