export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'N/A',
            con: 'Poor instruction quality, vague assignment documentation, slow VMs, unresponsive TAs, lack of original content, and overall disorganization, leading to frustration and a feeling of wasted time.',
        },
        'summer 2023': {
            pro: 'Students found the course interesting and reported learning critical skills in network security. The projects were considered engaging, and quizzes were easy if lectures were attended.',
            con: 'The final project was particularly challenging and poorly defined, leading to frustration. Lectures were short and insufficient for understanding the material, relying heavily on white papers instead. There were also technical issues with accessing course materials.',
        },
        'spring 2023': {
            pro: 'The course features hands-on assignments that allow students to experience exploiting network vulnerabilities, and many projects are interesting and engaging.',
            con: 'There is a frequent lack of instruction and clarity in assignment directions, dated lectures with outdated information, and quiz questions are poorly written, leading to potential confusion and grade drops.',
        },
        'spring 2022': {
            pro: 'The course provides a fun and informative introduction to Network Security topics, with enjoyable projects related to penetration testing, malware analysis, and intrusion detection. The quizzes and exam are easy to prepare for, and the TAs are helpful.',
            con: 'The lectures lack engagement and depth, and some projects may require significant time investment, which can be challenging for students without prior experience in security concepts or programming.',
        },
        'summer 2022': {
            pro: 'The course covers a broad set of network security topics and includes fun projects that enhance learning.',
            con: 'There is no autograder for projects, which can lead to mistakes that affect grades.',
        },
        'fall 2021': {
            pro: 'The course is well-structured, project-based, and engaging with fair grading. Students found the projects enjoyable and the TAs helpful. It is also suited for those interested in network security.',
            con: 'The professor is noted as being absent, which some students found detracted from the experience. Additionally, the course may be perceived as tough for some.',
        },
        'spring 2021': {
            pro: 'The course offers a broad overview of security concepts and has interesting, well-designed projects. Reviewers found the content valuable, and the TAs provided excellent support.',
            con: 'Many students found the course challenging, particularly with projects that required strong coding skills in JavaScript and Python. Some felt the course content was somewhat dry and the projects overwhelming.',
        },
        'summer 2021': {
            pro: 'Overall positive feedback on the course material, hands-on approach, supportive TAs, and manageable projects that are well-structured.',
            con: 'Lectures can sometimes be difficult to follow, and the course provides only a broad overview without delving deeply into topics.',
        },
        'fall 2020': {
            pro: 'Most reviews highlight the interesting project work, particularly in malware analysis and network security applications. Many students found the projects engaging and well-structured, contributing significantly to their overall understanding of cybersecurity.',
            con: 'Numerous reviews mention the lack of depth in course content, with some students struggling due to insufficient support from TAs and the disconnect between lecture materials and project requirements. Quizzes were also criticized for being poorly worded and not effectively testing knowledge.',
        },
        'spring 2020': {
            pro: 'Course is well-structured around interesting projects, which are the main focus of the grading, and provides a solid introduction to graduate school for those with prior information security knowledge.',
            con: 'Quizzes and exams are poorly designed and difficult, with lectures and project materials often being outdated or irrelevant. Project instructions can be confusing and inadequately communicated.',
        },
        'summer 2020': {
            pro: 'Students appreciated the course content and identified the projects as the most enjoyable aspect, providing valuable learning opportunities and a good grading structure. TAs received positive feedback for their support.',
            con: 'Many reviews highlighted outdated lectures, unclear project instructions, and ambiguities in grading. Concerns about the quizzes being non-substantive and a lack of professor engagement throughout the semester were also noted.',
        },
        'fall 2019': {
            pro: 'The course content and material are interesting and well-structured, especially the lectures which transmit knowledge effectively.',
            con: 'Poor delivery and organization of the course materials, especially the project write-ups, which are often ambiguous, filled with errors, and present challenges that detract from learning.',
        },
        'fall 2017': {
            pro: 'The projects are insightful, fun, and interesting, providing a good learning experience, especially for those new to security.',
            con: 'Lectures are fast-paced and shallow, with poor connection to projects, ambiguous quizzes, frequent issues with project instructions, and inconsistent grading by TAs.',
        },
        'summer 2017': {
            pro: 'The course features interesting projects that cover a variety of topics in network security, and several students expressed that they learned a good bit despite the challenges. The course materials can provide valuable exposure to real-world scenarios in cybersecurity.',
            con: 'The course suffers from poor professor involvement, shallow and unorganized lectures, frustrating project requirements, and inconsistent grading standards. Many students found the need to heavily rely on TAs and Piazza for clarification, and the projects often had poorly written instructions leading to confusion.',
        },
        'spring 2019': {
            pro: 'The course contains interesting topics and enjoyable projects, and many students appreciated the interactive nature of the class.',
            con: 'The course was perceived as difficult and lacked direction, with confusing projects and inadequate support from TAs; many found the quizzes and final exam extremely challenging.',
        },
        'summer 2018': {
            pro: 'Interesting projects that cover a broad range of network security topics and provide hands-on experience.',
            con: 'Poorly defined project requirements, slow grading and TA responses, heavy reading load, quizzes with misleading questions, and lack of organization and support from the professor.',
        },
        'summer 2019': {
            pro: 'The five projects were interesting and well-managed, and TAs were helpful and active. Extra credit was available for providing feedback.',
            con: 'Quiz and exam questions were sometimes ambiguous. Canvas access was revoked without notice, and there was no opportunity to review final exam questions.',
        },
        'spring 2018': {
            pro: 'The course covers a lot of interesting topics and includes engaging projects that provide real-world learning opportunities. Students reported learning valuable concepts and skills in network security, and the TAs were proactive in answering questions at times.',
            con: 'The course is poorly structured with shallow lectures, confusing project requirements, and a lack of instructor engagement. Many students found the TAs to be rude and unhelpful, leading to difficulties with grading and communication. Projects often required excessive time investment, and grading inconsistencies were common.',
        },
        'fall 2018': {
            pro: 'The course covers interesting topics in network security, and students felt they learned new terms and concepts. Assignments were well-explained and had an appropriate difficulty level, with an active Piazza community.',
            con: 'The course is poorly designed with an absence of instructor guidance, vague lectures that do not align with project requirements, confusing quizzes, and a lack of support during challenging projects. Many students reported frustration and difficulty in managing requirements.',
        },
        'fall 2016': {
            pro: 'The course features interesting projects, a manageable workload, and opportunities for extra credit. Many students found the content relevant and beneficial for their future careers in security.',
            con: 'The course suffered from disorganization, vague assignment instructions, and some pacing issues. Many found it too easy, especially those with prior experience in the field.',
        },
        'spring 2017': {
            pro: 'The course covers interesting and relevant topics in cybersecurity, provides hands-on experience, and has helpful TAs. Many students reported learning a lot and found the projects engaging, with some appreciating the opportunity to explore various security concepts in depth.',
            con: 'The course is disorganized, with unclear instructions and unresponsive instructors. Many assignments require excessive time to complete, leading to frustration among students. Some found the lectures and materials lacking in quality and cohesiveness, and there are concerns about academic integrity violations in Piazza discussions.',
        },
    },
};
