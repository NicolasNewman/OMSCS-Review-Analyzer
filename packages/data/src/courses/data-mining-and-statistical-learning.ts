export default {
    ...
    reviewSummaries: {
        'fall 2022':
            'The course received significant criticism for its lackluster delivery and ineffective teaching methods. Many students expressed disappointment, particularly with the lectures, which were often described as simply reading poor-quality slides filled with unexplained notations and complex math formulas without context. Homework assignments failed to reflect real-world data challenges, consisting of overly simplified datasets with repetitive tasks that did not facilitate meaningful learning. Office hours were also deemed unhelpful, as TAs struggled to clarify basic concepts. Although quizzes were easy to pass, they did not foster a solid understanding of the material. Overall, students felt that the course did not meet their expectations and would not recommend it to others seeking valuable practical knowledge.',
        'fall 2021':
            'The course offers an engaging concept with a variety of modeling techniques and practical applications, particularly in R, enhancing technical writing skills through report assignments. However, execution is criticized for unhelpful lectures where the professor mostly reads slides, leading many to rely on notes instead. Essential concerns arise with peer grading, deemed inconsistent and unfair, heavily influencing overall grades, particularly in the final weeks. While some students appreciated the responsive instructor and collaborative group projects, others felt the structure downplayed deeper learning and mathematical rigor, urging reliance on provided code. Despite these drawbacks, the class remains accessible for those seeking an easy grade rather than a comprehensive understanding of the material.',
        'spring 2022':
            "The course received mixed feedback from students, highlighting both strengths and weaknesses. Many praised its practical focus on modeling techniques and the emphasis on report writing, which is essential for data scientists. Students appreciated the absence of traditional exams, favoring quizzes and a take-home final project instead, along with a hands-on group project. However, critiques were directed at the lectures, which some found unengaging, as the instructor often read from slides without offering substantial teaching. While the homework assignments were described as interesting, several students felt they didn't learn much from the lectures. Overall, some students found the course to be enjoyable and valuable, while others regarded it as lacking depth in instruction.",
        'spring 2021':
            'The course received mixed reviews, highlighting both positive and negative experiences. Many students appreciated the engaging lectures and supportive instructors, praising the clear explanations and the relevance of the topics covered. The workload was described as manageable, with straightforward assignments and helpful sample code provided. However, some found the peer grading system frustrating, noting a lack of accountability among peers and inconsistencies in feedback quality. While the initial content was accessible, several students noted that the course became increasingly math-intensive, which could be challenging for some. Overall, students felt the course effectively enhanced their understanding of data science concepts, though experiences varied based on individual effort and background.',
    },
};
