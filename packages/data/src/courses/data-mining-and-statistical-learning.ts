export default {
    ...
    reviewSummaries: {
        'fall 2022': {
            pro: 'N/A',
            con: 'The course fails to meet expectations, with lectures that lack depth and clarity, poorly explained math concepts, irrelevant homework assignments with overly clean datasets, and inadequate support from TAs.',
        },
        'fall 2021': {
            pro: 'The course offers a fun concept with a practical application of modeling techniques, good support from the instructor, and an opportunity to improve technical writing through report assignments.',
            con: 'The execution of the lectures is poor, peer grading is inconsistent and unfair, and there is a lack of depth in the material, with too much emphasis placed on the final assessment.',
        },
        'spring 2022': {
            pro: 'The course offers a strong focus on practical applications, communication skills, and provides valuable opportunities to work on projects with datasets of choice. It has well-organized material and supportive teaching staff.',
            con: "Lectures are criticized for being ineffective, with some students feeling they didn't learn much. The course was considered too easy by some, and there was feedback about the starter code being in R.",
        },
        'spring 2021': {
            pro: 'The course offers a well-structured learning experience with supportive professors and TAs. Students appreciated the engaging projects, the flexibility in assignment submissions (using R or Python), and the focus on relevant topics in data science.',
            con: 'Some students found peer grading frustrating due to inconsistencies in effort and feedback from peers, and there might be a lack of accountability for those who do not perform peer reviews.',
        },
    },
};
