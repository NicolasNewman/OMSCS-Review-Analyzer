export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            review: 'The course was easy and recommended while taking 1 more course together. It will defintely help you in research later on but not very interesting to me . You will get an A by doing fair hardwork',
            rating: 3,
            difficulty: 1,
            workload: 10,
        },
        ...
        },
        {
            ...
            review: "This is my favorite course so far. I'm 4 courses in and I liked this one so much that I took the HCI class after it, which has a somewhat similar format and the same professor. This course is often called the mini-Phd and it definitely felt that way so if you're into the academic side then this is the class for you.",
            rating: 5,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: 'You can choose whatever project related to Educational technology. A lot of writing, and your grade relies on the TA.',
            rating: 3,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: 'It is up to you how much you will work here. I chose a relatively big project, and I did it alone. It was a nice experience, but a lot of work.',
            rating: 4,
            difficulty: 4,
            workload: 30,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 6, 2019',
            semester: 'fall 2018',
            review: 'I would say this course is the worst course in OMSCS program, maybe the worst cs course in the world. The course is useless if you want to pursue a career in CS, the homework is all about writing and just waste your time. I would suggest OMSCS terminate any course designed by David Joyner, since it will have a negative effect on the reputation of cs program.',
            rating: 1,
            difficulty: 3,
            workload: 15,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 5, 2019',
            semester: 'fall 2018',
            review: "Totally a trash. TA doesnt know a thing and you will receive a random score depending on TA's mood. Format, format, format. It is basically the only important thing for this class",
            rating: 1,
            difficulty: 1,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2018',
            review: 'I took it fall/2018. This course is a research track course, so we need to find ideas of what you want to contribute in educational field. I took a development track in my research, so I had to develop small prototype. If you choose development track, it is good to setup the framework beforehand.\nOverall this course has a lot of reading and the writing, which is consumable.\nI personally loved class, because this was only class where I can apply my creativity.',
            rating: 5,
            difficulty: 3,
            workload: 9,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'This course is tough especially if you do not have an idea of the project you are going to work beforehand. This was my case, so I took the first three weeks to decide what was going to be my project so I was in a little disadvantage.\nOnce you know the project is very straightforward. It is not difficult at all just a very heavy workload.',
            rating: 4,
            difficulty: 4,
            workload: 30,
        },
        ...
        },
        {
            ...
            review: 'This course is pretty much a self study. You research a topic for the first half of the course, and then create a project to work on for the second half of the course. This project can be done in groups of your choosing.',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'August 6, 2018',
            semester: 'summer 2018',
            review: 'If you are the type of person that needs instructions week in week out then this course would probably not be a good fit. I think individuals are also more likely to achieve more out of this class if you had a broad idea of what you wanted to work on coming into the course. From the get go you are pretty much working on the initial stages of your final project up until submission at the end of the semester.',
            rating: 3,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: 'Had the option of working with team or individual, I selected to work as individual and although the research was, well, it was research, the outcome and process of creating a research project was fun.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "Very self driven class. The entire class is working towards a single project and presentation at the end of the semester. The video content is very limited and is essentially just a tour of the course catalog and what the different categories are.\nThe class is certainly what you make of it, the instructors aren't really looking over your shoulder. I'm sure they would be helpful if you asked them direct questions, but they didn't seem to have much input for any given weekly checkin.\nIt'd be great if there was some way to encourage more group participation, the peer feedback is a great tool, but working directly with classmates would allow teams to have cooler and larger-scoped projects.",
            rating: 3,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: "One of my favorite classes. It's the first course where could throw your efforts into something you find super interesting. The entire course is focused around a project you get to choose. The professor is highly engaged.",
            rating: 5,
            difficulty: 3,
            workload: 30,
        },
        {
            ...
            semester: 'summer 2017',
            review: 'I loved this class. Choose a project (content, development, or research) that you are truly interested in and the semester will fly by. Ask questions of your TA/mentor, they seem genuinely there to help. It is difficult to assign a number of work hours per week. Some weeks only required a few hours of research and peer feedback, however other weeks required many more hours to pull an assignment together (especially the final project deliverable). Almost everything is self-paced, so be sure to have your calendar out and set reasonable milestones at the start of the project. Dr. Joyner and the TAs were fantastic.',
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        {
            ...
            reviewDate: 'August 11, 2017',
            semester: 'summer 2017',
            review: "This is a great course after you have some experience in OMSCS. I've seen wonderful projects ranging from instant messaging APP to second language study software. The tutor is helpful all the time and the progress is very much self-paced. You will like it a lot!\nI also saw in this class people recorded podcasts about wine or wrote about gender in IT. It seems to me that you can do whatever you want in the class.",
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'summer 2017',
            review: 'This course was a fun course, I would recommend to anyone who is interested in working on a project/projects. That said, it involves is a lot of writing but it gets all connected to the end project and you will appreciate it in the end when you see the results of your hard work in the end. Dr Joyner is great, the class was well organized and documentation is spectacular, second to none.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2017',
            review: 'Great class. You pick your project and develop it during the semester, alone or as a team. Instructors and classmates offer support and feedback. Dr Joyner is fantastic.',
            rating: 5,
            difficulty: 2,
            workload: 21,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: "A class that rewards hard work and is really oriented around you persuing something you're interested it. This was a very different type of class - only one week of lectures and the rest of it were projects. Probably shouldn't be taken your first semester or two.",
            rating: 5,
            difficulty: 3,
            workload: 12,
        },
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course is self-paced, offers flexibility, and is highly regarded for its value and interest. Students appreciated the range of research topics available and the supportive mentor relationship, which contributes to a great learning experience.',
            con: 'The project opportunities can feel unclear or poorly communicated, with some students experiencing a lack of responsiveness regarding project selections. Additionally, some projects were seen as low-effort, leading to concerns about grading standards.',
        },
        'summer 2024': {
            pro: 'The course allows students to work on projects they are passionate about, provides clear weekly action items, and has valuable peer feedback. It is highly recommended for learning academic research and translating it into a final product.',
            con: 'There is a risk of being paired with an inadequate TA, which can negatively affect the experience, and the course could benefit from additional external mentors.',
        },
        'fall 2023': {
            pro: 'The course offers valuable skills in academic research, peer review, and project presentation, with a well-structured workload that eases after the initial intensive writing phase.',
            con: 'Some students experienced poor mentor support, an inactive forum for collaboration, and felt they could have achieved the same learning outcomes independently.',
        },
        'spring 2023': {
            pro: 'The course is highly praised, especially for those considering a PhD, and offers multiple tracks for research, development, or content creation.',
            con: "Negative reviews are attributed to the student's own shortcomings rather than the course itself.",
        },
        'fall 2022': {
            pro: 'The course is rewarding with excellent mentorship and enjoyable project work, resulting in a valuable final product for professional portfolios.',
            con: 'The initial workload is very high, requiring significant time commitment, and may be challenging to combine with other courses.',
        },
        'summer 2022': {
            pro: 'Students appreciate the freedom to pursue their own projects and receive guidance tailored to their goals, leading to successful outcomes.',
            con: 'Mentor effectiveness varies, with some students reporting mentors as hit or miss.',
        },
        'spring 2021': {
            pro: 'The course is easy and offers a good opportunity for self-driven research, particularly enjoyable for those interested in educational technology.',
            con: 'Lack of interaction with the instructor and potentially unhelpful TA/mentor can hinder the experience; effort is required to gain knowledge.',
        },
        'summer 2021': {
            pro: 'The course allows for the pursuit of personal projects related to education, providing opportunities for CV enhancement and skill development. The initial research and writing exercises are enjoyable, and there is flexibility in project selection.',
            con: "Mentorship quality is inconsistent, with some students reporting unhelpful or uninformed mentors, leading to frustrations and extra work. The course's lack of interaction, with minimal communication among peers, creates a sense of isolation.",
        },
        'fall 2020': {
            pro: 'The course allows for independent research on a student-chosen topic, and offers an excellent learning experience in finding and analyzing research papers, alongside developing a final project.',
            con: 'Feedback from mentors can be inconsistent and unresponsive, leading to frustration, especially if paired with an unsupportive mentor. The early assignments are also noted to be time-consuming and potentially tedious.',
        },
        'fall 2019': {
            pro: 'The course allows for independent research on a chosen topic, involves practical project work, and has a manageable workload with good curriculum. The instructor, Joyner, is noted for his care for students and well-structured classes.',
            con: 'The TA mentoring may be inconsistent, with issues such as delayed responses and subpar grading practices detracting from the experience.',
        },
        'summer 2020': {
            pro: 'The course is self-driven, allowing students to choose their projects and focus on areas of interest. Clear rubrics and goals help guide research and writing, and it is designed so that students can achieve an A with consistent effort.',
            con: 'The course involves an overwhelming amount of writing and research, with a heavy workload that can be particularly intense during summer sessions. The peer-review requirements are high, and many students found the quality of peer-reviewed papers frustratingly low.',
        },
        'spring 2020': {
            pro: 'The course imparts valuable non-traditional skills such as effective communication, research methodologies, and writing research papers, with empathetic mentorship from Dr. Joyner.',
            con: 'The mentorship quality is inconsistent, with some TAs providing unhelpful and subjective feedback, leading to frustrating grading experiences.',
        },
        'spring 2019': {
            pro: "Students appreciated the course's focus on independent projects, flexibility in topic selection, and explicit grading criteria, leading to a self-driven experience. Many found it beneficial for research skills and enjoyed its academic rigor.",
            con: "Some students found early assignments overwhelming and bore a grueling workload, particularly regarding citations. Concerns were raised about inconsistent grading by TAs, as well as complaints regarding the course's management and subjective feedback.",
        },
        'summer 2019': {
            pro: 'The course offers a structured approach to exploring academic literature and allows for the development of a project of personal interest, with supportive mentors and a peer feedback system that enhances learning experiences.',
            con: 'The course requires a high level of self-motivation and can lead to heavy workloads and sleepless nights due to extensive writing assignments, and experiences with TAs may vary.',
        },
        'fall 2018': {
            pro: 'The course offers an open-ended format that allows for creativity and self-directed projects, with a supportive professor and TAs. It is beneficial for self-starters and those interested in Educational Technology, promoting active engagement and writing skills.',
            con: 'Grading can be inconsistent and dependent on individual TAs, with a lack of clear expectations. Some students felt the course lacked structure and utility for career advancement in CS, leading to frustration.',
        },
        'summer 2018': {
            pro: "Students appreciated the unique and individual-oriented nature of the course, the opportunity to work on personal projects, and the significant learning related to academic writing and research. Dr. Joyner's teaching style and engagement were highly praised, making the course feel well-run and supportive.",
            con: 'Peer feedback requirements were seen as burdensome, and some students found the mentor support inadequate. The course workload was intense, especially towards the end, leading to potential frustration for those not already well-prepared or confident in their chosen projects.',
        },
        'spring 2018': {
            pro: 'The course is well-run, organized, and offers a meaningful project experience, allowing students to explore their interests and potentially continue their work post-semester. The professor and TAs, though variable in effectiveness, contribute positively to the course structure.',
            con: 'The course can be challenging for students without a clear project idea beforehand. It also has a heavy workload, and some may feel the TA support lacks depth.',
        },
        'summer 2017': {
            pro: 'The course is well-structured and allows for a high degree of flexibility, enabling students to choose projects that genuinely interest them. Dr. Joyner and TAs are highly praised for their support, and the self-paced nature of the course is appreciated, allowing for in-depth exploration of topics.',
            con: 'The course is largely self-driven and may be challenging for those preferring a more structured environment. The workload can vary significantly, leading to some students underestimating the time commitment, especially during a compressed summer semester.',
        },
        'fall 2017': {
            pro: 'The course is well-organized, self-paced, and encourages independent learning. Many found it beneficial for developing project management skills, conducting research, and receiving constructive peer feedback. The instructor and mentors are praised for their effective communication and support.',
            con: 'Some students mentioned challenges with managing time effectively, especially for the final project, and felt that more group participation opportunities could enhance the experience. A few reviews noted that the initial phase of selecting a project could be overwhelming.',
        },
        'fall 2016': {
            pro: 'The course allows students to pursue topics of personal interest through project-based learning, with a highly engaged instructor providing support. Overall, students appreciate the flexibility and potential for deep exploration in their projects.',
            con: 'Some students find the structure of the course challenging, noting an excessive number of essays and ineffective peer reviews. There are concerns about grading finesse and the effectiveness of less structured projects undertaken by peers.',
        },
        'spring 2017': {
            pro: 'The course allows for self-directed learning and exploration of personal interests through either a research or development track, fostering creativity and passion projects. The instructor is supportive and responsive, and there is potential for significant academic output, such as publishable papers.',
            con: 'The course demands a self-motivated approach, which can lead to variability in workload and stress, especially if students are balancing other commitments. Additionally, the quality of mentorship can be inconsistent, and some peer feedback may not be very useful.',
        },
        'spring 2016': {
            pro: 'The course is flexible, allowing students to choose their own projects and explore topics related to Educational Technology. Mentorship is provided, and students can improve their ideas with guidance. Those who have a clear project idea or previous research skills find the class rewarding.',
            con: 'Students without a defined project or strong project management skills may struggle, especially in the beginning. The peer review process can be overwhelming for some, and maintaining focus is crucial to achieving a high grade.',
        },
    },
};
