export default {
    ...
    reviewSummaries: {
        'fall 2022': {
            pro: 'Interesting subject with doable and engaging projects; recorded materials are good.',
            con: 'Instructors are unavailable for office hours and unresponsive to emails; slow grade return and lack of TA support.',
        },
        'spring 2021': {
            pro: 'Students appreciated the exposure to new attack channels, reasonable workload, and practical, engaging projects.',
            con: 'N/A',
        },
    },
};
