export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            review: 'The tears of nerds like us keep the population at large safe.',
            rating: 3,
            difficulty: 4,
            workload: 7,
        },
        ...
        },
        {
            ...
            semester: 'fall 2022',
            review: "I didn't get much of this course. It consists of many mathematical proofs, abstract concepts, and probabilities. I have put a heavy effort into this class, but in the end, I didn't feel satisfied with the amount of effort compared to the knowledge that I learned.",
            rating: 2,
            difficulty: 4,
            workload: 25,
        },
        {
            ...
            semester: 'fall 2022',
            review: 'Coming into the course, I had no background in discrete math or algorithms/writing mathematical proofs, so I definitely struggled. The material can be quite unclear sometimes and dry, but if one is willing to put in the effort to learn coming from a background such as myself, it is very much possible to still achieve an A/B in this class. In a way, I wish there were more examples given in the course on how to write proofs/practice problems as well as clearer instruction in the videos at times, but overall I still learned a lot and had a great experience in the course.',
            rating: 3,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 'K8HKYv5r562jiGY0Flzobg==',
            reviewDate: 'November 13, 2022',
            semester: 'fall 2022',
            review: "Annoying, boring course. Work load is pretty significant with long homeworks and with gotcha-filled quizzes weekly. TA's seem to be first timers/have never run the course before so there are constant glitches and bugs, grading takes forever. Professor is fairly good, but it doesn't make up for the constant barrage of gotcha questions you'll need to endure.",
            rating: 1,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: "Brilliant stuff! I have long forgotten how to do mathematical proofs, and I am happy this course forced me to refresh that knowledge.\nLectures are great and dive deep enough to give just the right amount of information you could expect from a graduate course. Find a way to download them and watch at an increased speed as the videos seem to be a bit too slow. However, the expect to adjust the speed as you go as sometimes the content is very dense. I had to re-watch some part multiple times.\nThe course has official extended notes and fantastic unofficial George's notes. You can use both of them on the exams! Expect the exams to be a mixture of quizzes and essay questions where you are expected to do some mathematical proofs. They are not to be afraid of  as homeworks and corresponding office hours set you up for success.\nI learned a great deal on this course. It is one of the rare occasions when I could not go to bed before I figure out some finite number theory tricks that feels like magic.",
            rating: 5,
            difficulty: 4,
            workload: 12,
        },
        {
            ...
            semester: 'spring 2022',
            review: '8th/9th class taken with CN (AI4R, HPCA, IIS, GIOS, SAD, iHPC, AI)',
            rating: 4,
            difficulty: 5,
            workload: 100,
        },
        {
            ...
            review: 'I\'m putting in this review a year after I took this class because I am in GA now and Applied Cryptography is the ONLY class that prepared me for GA (for reference, I\'m in OMSCS - ML track). Not in content (except for the RSA unit), but in the structure of the course and the "proof" nature of the problems, and the fact that you just need to memorize some methods and be able to apply them to future situations. That is invaluable in GA right now. So definitely take this class! Put in the work and by the time you get to GA, you will be glad you did!',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'The lectures are really boring and outdated. It is very theory-based. The grading process is EXTREMELY slow and sometimes can take up to one month. Choose another course if you do not like writing proofs throughout the semester.',
            rating: 1,
            difficulty: 4,
            workload: 20,
        },
        {
            ...
            review: 'Badly taught course, should be named Magic and Philosophy of Cryptography. Do not expect much from the lectures. Homeworks are very time consuming, the only reason some people get good grades is because they find the solutions in internet. You will need to read 5 different books 1000 pages each in order to start understanding some of the concepts they want you to apply on exam or in homeworks. Not recommended.',
            rating: 1,
            difficulty: 4,
            workload: 50,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: "I'm not sure what to think about this class. The setup hasn't change from previous reviews, so I won't repeat all that. I didn't find this class hard, per se, but it is purposefully set up to be tricky and I fell for a lot of the tricks. The exams are hard because they're timed, but if I had even a day to think about it, they'd be almost easy! The grading curve is hard to handle because you never quite know where you stand. The prof says she used an excel function to calculate cutoffs. She does say that the curve usually ends up being 61 - 80 as a B and 81+ as an A. If I calculated my own score correctly, I ended with 83% and I got the A, so the approximate cutoffs are probably pretty close, but no one will confirm. I do want to note that after the midterm she calculated the curve and at that time I was a solid B, so just know that there is still room to move up during the second half.\nAlso, strangely, at the end of the semester, the prof and TAs just disappeared and stopped answering questions on Piazza (this happened once during the semester, too, where everyone just disappeared for a week and the students were all wondering what was going on). During the semester there are office hours to go over solutions, and all quiz answers are unlocked so you can see the correct answers, but not with the final. I guess I'll never know what I  got wrong. So much for learning from my mistakes.\nAgain, I'm not sure how I feel overall about this course. It wasn't as hard as some reviews will lead you to believe (though I hope the guy who says this is harder than GA is right!) but it's certainly tricky. And there's a lot to do. I took this with another class and mostly neglected the other class (which was a bummer because that one was more interesting). This wasn't part of my specilization, so when I was in the thick of it I definitly wondered why I would sign up for this in the first place, but now that it's over, I guess I'm glad I did. It was definitely interesting if you can get over the frustrating. And now that it's over, I do feel like I learned a lot.",
            rating: 3,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: "I would recommend Applied Crypto. I enjoyed the class though I'm a bit biased as the cryptography concepts covered are quite relevant to my work. Though the class does have a good bit of theory and math, I think it is also quite practical. The content also seems to be pretty up to date with the current state of the art. One of the TAs for the course has put out notes that are SUPER helpful and make digesting the material and writing exams much more pleasant.",
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'spring 2020',
            review: 'The instruction and course material in this class are so far below what I experienced throughout this program it is almost laughable. The funniest part is this is not applied crypto in any way. Zero. It is total theory and mathematical proofs. I love math. I hate this course.\nTo say the instructors are "standoff"-ish is put very politely. Did I say laughable? I meant infuriating.\nI would say avoid this course but as it is required I would suggest taking it over summer to get it over with as quickly as possible. Good luck!',
            rating: 1,
            difficulty: 5,
            workload: 20,
        },
