export default {
    ...
    reviews: [
        {
            user: '5ay3Qq60XSe2KK3VgvNJGQ==',
            reviewDate: 'August 23, 2024',
            semester: 'summer 2024',
            review: "I thought this course was excellent. The material was interesting, the video lessons clear, the assignments enjoyable, and the TAs helpful. It's hard to imagine how an online course could be better.",
            rating: 5,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 't7u0m0cOWvHAoSzQgpzUqw==',
            reviewDate: 'August 7, 2024',
            semester: 'summer 2024',
            review: 'This is the worst course I have ever taken. The instructor and TAs are unprofessional, and the course is not useful at all. They changed many scores without any reason and gave the worst scores. No one responds to your questions if you send an email. Everything about this course was bad. Do not waste your time.',
            rating: 1,
            difficulty: 3,
            workload: 10,
        },
        {
            user: 'erIST4vceSRSmEIkNQU1IQ==',
            reviewDate: 'July 24, 2024',
            semester: 'summer 2024',
            review: "I enjoyed this class. I have a background in mathematics, and am in OMSA so while the maths and proofs were pretty easy, I at times found the coding elements of this class more challenging than an OMSCS student might have. I'd never used the networkX package before, but found it common-sensical and VERY well-documented. I spent maybe more time than most on homework assignments, but I found them engaging, interesting and novel compared to what else I've encountered in OMSA. Also on that, HW weeks were much more involved than non-HW weeks, despite having two lessons' material to review in non-HW weeks.\nTA interaction on Ed Discussion was mixed. The TAs worked very hard to have HW2 graded prior to the class withdraw deadline, giving students a better idea of their standing in class. That is awesome. But I tended to do homework on the weekends, and I don't recall there being many (if any) office hours scheduled for the weekends. Students sometimes asked questions on Ed Discussion for TA help, and they'd sometimes stay 'Unresolved' for days, often the weekend before HW was due. These are challenges of asynchronous learning, and I think because this isn't a 'core' class in any program, they may struggle to have TAs on call as it were.\nThat said, the homeworks make up 65% of your grade, and at least in the summer semester, the lowest HW grade is dropped (as well as your lowest two quiz scores of 14), so it's nice in that a couple very poor showings won't ruin your entire grade. I'd take this class again.",
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2023',
            review: "This is my first course in the program and I truly enjoyed the contents. I highly recommend this course to anyone interested in data science and ML.\nFor those who don't have a CS or math background (like myself), ensure you understand all the questions in the prerequisite test before you sign up for the class. You don't need to know all the answers, but you should at least be able to figure out the answers after reading some wiki articles. (This is essentially a math class for me!)\nThe course is quite tough for me because I don't have a math background, but it was also one of the most intellectually satisfying classes I have taken.\nMost TAs are really great and patient, except two who selfdom reply to questions on Ed Forum. Thankfully, these two TAs also tend to grade very leniently lol",
            rating: 5,
            difficulty: 4,
            workload: 10,
        },
        {
            user: 'w1iKInaZlhWHxhBh8cNKNA==',
            reviewDate: 'December 6, 2023',
            semester: 'fall 2023',
            review: 'The concept of network science is great, I was so excited about this course and hoping to learn from this course so I can apply it in different application.\nThis is Network Statistics course, machine learning on networks was mentioned briefly in last week without proper practicing.\npoor lecture explanation, no videos for lectures, just text to read which is a copy/paste from the textbook.\nTAs grade assignments based on final result only, they focus on cosmetic issues like graph axis title, legend rather than the understanding of the concepts.\nThis course has a potential to become more interesting and more practical but unfortunately the way they structured this course made it extremely boring and useless.',
            rating: 1,
            difficulty: 3,
            workload: 12,
        },
        {
            user: 'lq2i70VEyEPs6A7BHVOefw==',
            reviewDate: 'November 22, 2023',
            semester: 'fall 2023',
            review: "This was hands down the worst class i've taken so far into the program. TA's are unresponsive and take ages to release grades - we just got our grades for A3 it was due over a month ago...\nTopics are really uninteresting first 2.5 modules are foundational and necessary and somewhat interesting, but then after that its just so.... boring? The final module is on GNN which in an ideal class would be 50% to 70% of the class focus but all you get is one quiz on it - no idea why this class is part of the ML track if thats the case highly recommended you take something else in the meantime.",
            rating: 1,
            difficulty: 3,
            workload: 12,
        },
        {
            user: 'D+ZjqG9NaPgWzNxW/1xZ1g==',
            reviewDate: 'November 22, 2023',
            semester: 'fall 2023',
            review: "This is probably one of the worst courses I've taken at GT. I was initially excited to take a class in Network Science, but after taking this course, not so much.\nThe class is structured such that there are no formal lectures that cover the material. Instead, you're given a bunch of slides on canvas that barely contain any useful material. To help fill in the huge gaps from the slides, you have required reading from various sources. After each section then there are the awful quizzes. Do you like confusing multipart multiple-choice questions that require you to read the questions multiple times? If so, this course is for you!\nAbout the only redeeming thing about this course is the projects, but even then, you're going to be using a lot of matplotlib.\nFinally, to top it off, the TA's and Prof are non-existent. Need a question answered on the forum? Good luck, but don't you dare collaborate with fellow students!\nI am legit angry I wasted my time, money and energy on this course.",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        ...
        {
            user: 'Dahkq1w6VLVYACKuKJ+Lug==',
            reviewDate: 'September 28, 2022',
            semester: 'spring 2022',
            review: 'It is relatively easier course. The TAs are very helpful and they conduct lot of office hours to clarify all the doubts. The material is awesome, I liked the fact that the material has lot of reading material along with videos, in my experience reading material is very helpful in solving quizzes which are due every week.\nThere are no exams, projects are easy to follow given the instructions. I expected some machine learning part but that is very limited.',
            rating: 4,
            difficulty: 2,
            workload: 10,
        },
        {
            ...
            review: 'As previous comment indicated, the course effort can varies (ranging from 10 to 20+ hours) depends on yourself..\nThe grading is generous in general.\nTo really learn a lot, you need to take initiative to go through the additional paper/material provided.\nThe material is difficult.  It is relative new field and definitely interesting!\nThe reading style lecture is kind of nice from my perspective after watching video lecture at 1.5x for 8 courses...\nI would recommend anyone like data analytics to explore this course..\nIt definitely give a different perspective to you..',
            rating: 5,
            difficulty: 5,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: 'not a fan of the all reading no video bit. It was manageable, but not a very good learning experience. Quizzes were very frustrated. It seems the more time I put on the materials the lower grade I got. Very hard to get full points. Projects were ok, but not very interesting. Grading was a bit slow and there was no formal regrading process.',
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
    ...
    reviewSummaries: {
        'summer 2024':
            "The course received a mix of feedback from students. Many praised the engaging material, clear video lessons, enjoyable assignments, and supportive TAs, considering it one of the best online courses available. Conversely, some students expressed dissatisfaction, calling it the worst course they've taken, citing unprofessional TAs, arbitrary score changes, and poor communication from instructors. One student highlighted the challenges of coding assignments compared to their mathematics background, appreciating the well-documented resources despite spending extra time on homework. However, TA availability was inconsistent, particularly on weekends, leading to unresolved questions. Overall, while some found the grading system accommodating, others experienced significant frustration, recommending caution for prospective students.",
        'fall 2023':
            "The course offers valuable insights into network science, making it a useful introduction for interested students. Many reviewers found the subject matter engaging but criticized the course's structure and TA responsiveness. Quizzes were generally fair but often contained ambiguous questions. Although the assignments were straightforward and grading was mostly fair, some TAs were overly nitpicky. The lack of formal lectures, reliance on text-based material, and absence of timely feedback left students feeling unprepared and frustrated. Additionally, while the mathematical content was appreciated, some felt the course remained too superficial. Overall, it has potential but requires significant improvements in engagement and support for a better learning experience.",
        'summer 2023':
            'The course receives mixed reviews, with students appreciating its straightforward structure, manageable workload, and engaging content on network analysis and power law dynamics. Many found the quizzes and projects reasonable, often leading to an easy A. However, criticisms highlight issues like vague assignment wording, understaffed TAs, and an absent professor who only held one office hour late in the session. The fast-paced summer schedule added stress, particularly with numerous quizzes and projects requiring extensive time commitment. While some expressed satisfaction with TA support, others noted their inconsistency and delays in grading. Overall, while the course offers valuable content, improved communication and instructor presence would enhance the experience significantly.',
        'spring 2023':
            'The reviews for the course reveal a mixed experience among students. On the positive side, many found the material fascinating, with a thorough curriculum and excellent TA support, especially for Jupyter Notebook assignments. The quizzes, though challenging, were seen as fair and manageable, especially with open-book access. However, significant negatives included the heavy workload, with students spending excessive hours on assignments and struggling with unclear instructions and math-heavy lectures. Some felt the quizzes were tricky to the point of confusion, and several voiced dissatisfaction with the overall course organization, stating it felt disconnected and overly focused on statistical analysis rather than practical applications of network science. Overall, the course seems well-suited for disciplined learners but potentially overwhelming for others.',
        'spring 2022':
            'The course on Network Science offers a solid foundation in network theory, benefiting from a consistent pace, helpful TAs, and a focus on reading materials that enhance understanding. Many students appreciate the structure and support, including ample office hours and generous grading practices. However, some critiques highlight that homework lacks real-world application and the final section on machine learning feels underdeveloped. Weekly quizzes can be overly detailed and challenging, leading to frustration. While the course involves significant mathematical concepts, it manages to provide a multifaceted view across disciplines. Overall, it is seen as a manageable introduction to the topic, but students should ensure they are well-prepared to thrive in its rigorous environment.',
        'fall 2022':
            'Reviews for the math course reveal a clear divide in audience suitability. It excels for those passionate about mathematics, formula derivations, and statistics, particularly in a focused, text-heavy format. Positive aspects include well-designed quizzes, open-book policies, and high-quality assignments in Jupyter notebooks. However, many students express frustration, noting the lack of hands-on engineering content and a heavy emphasis on theoretical topics like disease propagation, which they found boring. Critics emphasize the absence of video resources and an insufficient connection to practical applications in software development or AI. Overall, the course is recommended only for those deeply interested in theoretical mathematics rather than engineering or applied data science.',
        'summer 2022':
            'The course offers a flexible effort requirement, varying from 10 to over 20 hours based on personal initiative. Grading is generally generous, but to gain a thorough understanding, students must actively engage with supplemental materials. While the subject matter is challenging due to its novelty, many find it engaging and worthwhile. The reading-style lectures are appreciated, especially after the pace of video lectures. Overall, the course is highly recommended for those interested in data analytics, as it provides a fresh perspective, though students should be prepared for difficult material and the need for proactive learning.',
        'fall 2021':
            "Overall, the course on network science has been met with mixed reviews. On the positive side, students appreciate the well-structured content and practical assignments that provide real-world applications, along with rigorous theoretical lessons. Many find the quizzes stimulating, prompting deep thinking. However, criticisms arise regarding the lack of thorough explanations in videos and vague assignments that often rely on peer forums for clarification. The workload varies significantly depending on individual commitment, but many feel it's less demanding than core courses. Several students also pointed out that the course could benefit from more critical thinking projects and a final project integrating machine learning concepts. Overall, while fascinating, the course seems better suited for those with a strong background in stats and machine learning.",
        'summer 2021':
            "The course on network science, taught by Prof. Dovrolis, has garnered mixed reviews. Many students praised the professor's enthusiasm, involvement, and helpfulness, along with the engaging material, particularly in applications of graph theory. The TA support was mostly solid, though some students noted inconsistencies in Piazza responses and occasional ambiguities in assignments and quizzes. Challenges arose from difficult, sometimes ambiguously worded quizzes that stressed minutiae over broader concepts, leading to frustration; students felt crammed for time, especially during the summer semester's fast pace. While the programming assignments were generally considered manageable, they required careful reading of requirements. Overall, students appreciated the intellectually stimulating content, but felt significant prior knowledge in mathematics and programming was essential for success.",
        'spring 2021':
            "The course on network science receives mixed feedback from students. Positively, many find the content engaging and relevant, with practical applications across various types of networks. The quizzes and projects, though challenging, are considered beneficial for reinforcing knowledge, and the instructor and TAs are praised for their support. However, numerous reviewers express frustration about the lack of video lectures, the heavy reliance on reading materials, and the vague wording of project instructions. Many students felt that the quizzes were ambiguous and difficult despite extensive studying. The overall structure, while clear, is perceived as needing improvement, especially given the course's inaugural semester. The consensus indicates that, with adjustments, this course could become a valuable addition to the curriculum.",
    },
};
