export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course material was interesting, video lessons were clear, assignments were enjoyable, and TAs were helpful. Engaging homework assignments were appreciated, and the grading structure allows for some leniency.',
            con: 'The course had unprofessional staff, unhelpful communication, and inconsistency in grading. TA availability was limited, leading to unresolved questions and challenges in asynchronous learning.',
        },
        'fall 2023': {
            pro: 'The course content is interesting and provides a good introduction to network science. The assignments and quizzes are generally manageable, with no exams and straightforward grading for the most part.',
            con: 'The course suffers from delayed TA responses and unresponsive professors, with quizzes having ambiguous questions and a lack of depth in certain topics. Some students found the structure of the course poorly organized and the assignments lacking in practical applications.',
        },
        'summer 2023': {
            pro: 'The course is described as manageable and entertaining, with a strong focus on network analysis and helpful TAs. Many found it to be an easy A and appreciated the lectures on important concepts in graph theory.',
            con: 'Negative aspects include confusing assignment wording, understaffed TAs, absent professor, and a lack of timely feedback. The pace of the summer session was also criticized, along with the limited interaction with the professor.',
        },
        'spring 2023': {
            pro: 'The course covers fascinating material and has a thorough curriculum with excellent TAs. It provides a good grasp of Network Science applications, particularly in areas like epidemiology.',
            con: 'The course is time-consuming with tricky quizzes and unclear assignment instructions. The lectures are heavy on mathematical derivations, often difficult to follow, leading to frustration for students.',
        },
        'spring 2022': {
            pro: 'The course has a consistent pace, helpful TAs, and a strong theoretical background with ample reading material that aids in quizzes.',
            con: "The homework lacks real-world connection, quizzes are tedious, and there's limited machine learning content despite its mention.",
        },
        'fall 2022': {
            pro: 'The quizzes are great, open book/notes, and the assignments are well-designed Jupyter notebooks.',
            con: 'The course is heavily text-based with minimal video content, focused more on math and statistics than on engineering or software development topics.',
        },
        'summer 2022': {
            pro: 'Generous grading and interesting, new field material; courses encourage initiative and exploration.',
            con: 'Course effort varies widely, and material can be difficult.',
        },
        'fall 2021': {
            pro: 'The course is well-structured, provides practical assignments, and covers a fascinating area of computer science. Many found it informative and engaging with rigorous theoretical content.',
            con: 'There is a lack of clarity in assignments and lecture materials, with many relying on student discussions for help. Some assignments were poorly written, and the content was often not well explained in videos.',
        },
        'summer 2021': {
            pro: 'Prof. Dovrolis is highly involved, enthusiastic, and supportive, with engaging course material and helpful TAs. The programming projects and course content are generally interesting and relevant to real-world applications.',
            con: 'Quizzes are often perceived as overly difficult and confusing, with ambiguous wording. The workload can be intense, particularly during the summer session, and some students found the course materials and assignments challenging to navigate.',
        },
        'spring 2021': {
            pro: 'The course content is interesting and covers a wide range of topics in network science. Students find the projects engaging and the TAs and professor to be helpful and enthusiastic. The material is well-structured and allows for significant learning, particularly if the student is motivated.',
            con: 'Many students find the lack of video content frustrating, as the course heavily relies on reading materials. Quizzes are challenging, and some assignments are poorly worded, leading to confusion. Feedback on projects is often slow, and there is a perception that the course is not fully ready for online delivery.',
        },
    },
};
