export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            review: "My Background: B.S. in CS from a reputable university. 4 YOE as a SWE. I've taken CS 7646 and 6310. I found CS 7646 was good preparation for this course, but consider CS 7646 more difficult than this one in many ways.\nCourse Performance: Safe 'A'.\nRecommended Background: Have Python experience before taking this course as its first projects require OOP Python from the get go with no build up. Know your graph algorithms - especially breadth-first search. There are courses on edX by Georgia Tech that can provide the required Python background for this course if you don't have prior experience.\nTips to Do Well in the Course:\n1.) To get full participation points when reviewing classmates' papers, use the grading rubric for the assignment to structure your response.\n2.) Write your project journals based off of the grading rubric for time efficiency and to ensure you cover all required items.\n3.) Scoring well on the final project's performance section will take way more effort than other assignments. Accept that your grade is going to take a hit on the final project and ensure you do well on all assignments before the final project.\n4.) For mini-projects you don't necessarily need to worry too much about efficiency. Try a simple, brute force approach first then seek to optimize your solution.\n5.) Take page-numbered notes during the lectures and organize them by a table of contents. Reference those notes and ctrl-f search the transcripts of the video lessons for exams for any questions you're unsure on. The timing of the exams was nice and not intensely pressured like many OMSCS courses.\n6.) Do Peer Feedback tasks and do them early. You get 3 times as many points for doing them early. Try to do as many as possible in the beginning of the course to frontload the workload for the course as much as you can.\n7.) Prioritize doing extra peer feedback tasks for the RPM project so you can learn from your classmate's approaches. Keep a google doc of notes of things you learn from your classmates that you may want to incorporate.\n8.) Participate in the EdDiscussions in ways that are enjoyable for you. For me that was answering classmates' questions and participating in the Wednesday Debates.\n9.) Pay attention to JDF format! Ensure your margins and font size are correct. They mostly care grade-wise if you're using margins or font sizes that allow you to write more than other students. Create a Google Doc template that follows JDF format and make a copy of this before each assignment to efficiently ensure you follow the required report format.\n10.) Monitor EdDiscussions. The course is set up to be very collaborative. Learn from your classmates and their posts.\nCourse Thoughts:\nThe course material is very interesting. Knowledge-based AI is more intuitive in that you can understand how an agent arrives at its answers. This course provides interesting methodologies to allow your agents (programs) to learn that differ from machine learning. The course feels like it supplements an algorithms course in that it explores problem-solving strategies and gives a more intuitive language to algorithms than I had encountered before.\nThe course is well-organized and the expectations are clear. The course has a demanding workload, but I would not say it's overly difficult as some of the posts here state. Start your assignments early and do not procrastinate. All course material and assignments are available from day one.\nCourse Critique:\n1.) The homework assignments are busy work. Their material is already covered by the mini-projects. I think the level of work for the course is appropriate except for these homework assignments.\n2.) The course project revolving around Raven's Progressive Matrices (RPM) is really interesting! Unfortunately, the need to learn vision processing to apply the course concepts encourages much easier, gimmicky strategies that do much better. I think this course could be greatly improved if the vision processing necessary to create conceptual models and analogical mappings of the RPM problems was taught as part of the course. This would help students that want to take that approach to apply the concepts from the course more. Otherwise, the concepts from the course get rather disconnected from the final project through the use of DPR, IPR, and case recording which score extremely well but don't really apply course concepts. Meanwhile, actual vision processing based strategies applying the course concepts require way more work and don't perform as well.",
            rating: 4,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 'sriKQMcJ2p6HVPM/lkANFw==',
            reviewDate: 'July 30, 2024',
            semester: 'summer 2024',
            review: "The semester long project was very rewarding and fun to work on - but it was worth very little of your total grade. 7.5% for the report, 7.5% for the actual code. Getting 90-100 percent on coding assignments didn't take much effort (and were fun!), but the written reports accompanying the homework assignments are graded according to a rubric that is ---not--- 1:1 to the assignment instructions.\nMake sure to read the report rubrics and title sections/bold phrases exactly as they appear in the rubric. <---------\nIf you do the first few assignments without realizing this, you will lose a good percent of your grade. Especially in Summer - you will be turning in multiple assignments before you get your first batch of grades. Given written reports (outside the final report) are 47.5% of your grade, getting 2-3 bad grades without realizing this can significantly impact your grade and make it unnecessarily difficult.\nYou don't really need any pre-reqs for this course - know some basic Python and you're okay - this is a good intro course.\ntl;dr\nI recommend the course and found the content fun and rewarding, but be aware that the project and tests are not the most important grade-wise.",
            rating: 3,
            difficulty: 3,
            workload: 15,
        },
        {
            ...
            semester: 'summer 2024',
            review: 'The lectures are enjoyable and thought provoking, but not very informative and very abstract. it doesnt map to algorithms most of the time. The negatives here are as follows, the course provides no exxtra value than watching the  videos on youtube or without actually enrolling to the course. There are no office hours , tutorials nor TA engagment like other courses, grading is alway super late, and feedback is a few words so not helpful to learn from TA correction. Also course load is way more than the learning value as you have to write and review alot, which doesnt help the learning process as much as they portray it. This course relies on the fact that class participation is graded so that people help each other rather than TAs supportting which in my view didnt work much. Its easy to get an A if you put the effort although effort does weight well aganist the amount of learning. Last nitpick is you re betteroff implementing most projects from you prior algorithm knowledge than trying to implement philosphies in lecture and after just attempt to link them together which is also disappointing somewhat since course knowledge is not needed for any of the project even the final ravens project. for final project go for simple pixel and image difference approaches saves you so much effort and time from trying to apply course shape relationships and will get you a higher grade.',
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        {
            user: '8KnyeiIGQWsSiiZILHJ79g==',
            reviewDate: 'July 23, 2024',
            semester: 'summer 2024',
            review: 'Horrible class....the concepts are good but the staff is absolutely abysmal. Students are setup for failure. It is quite evident in almost every GT OMSCS class. You can literally see students crying and complaining but the staff takes no interest and just says "Yeah well thats the standard of GT". They are right... bad teaching is a standard at GT. Students are setup for failure here....Dont do OMSCS. Go to a school that cares about your mental health.  So many better schools like UT Austin, Purdue etc. where they actually care about what matters and not stupid stuff.',
            rating: 1,
            difficulty: 5,
            workload: 40,
        },
        {
            ...
            reviewDate: 'June 27, 2024',
            semester: 'summer 2023',
            review: 'Review #2 Summer 2024\nlearned nothing, forced to see psychotherapist 3 times, chiropractors 5 times. Dropped\nOne question: Why do I want to read the garbage other people has written using chatgpt 3x or 6x every week?',
            rating: 1,
            difficulty: 5,
            workload: 30,
        },
        {
            user: 'w9iGYiqFBOv9Fi4z2Wt8FA==',
            reviewDate: 'June 20, 2024',
            semester: 'spring 2024',
            review: "Took it as my first course while working full time. I do have a decent amount of experience in software but not with Python, which is the language we used for all of our projects in this class. wrapping up with python and getting familiar with some of the libraries look some time but was not the main problem. This course has ALOT of weekly tasks which makes it a very difficult first class. On top of trying to get back into school, especially an online school, and learning how to use Python to deliver the projects which one is due almost every week, we had to write 5 page papers weekly, do at least 3 peer reviews, watch 2-3 lessons that were sort of boring, midterm, final, and a very difficult final project which we gradually build during the whole class timeline that hold a pretty big chunk of the overall grade .I had a 90% and it dropped to 86% because the TA gave me a super low grade on the paper, although I had been receiving mostly A's on all my papers.\nIts a good class, but I wouldn't suggest it as the first class due to overload of assignments due per week.",
            rating: 3,
            difficulty: 5,
            workload: 20,
        },
        {
            ...
            semester: 'summer 2023',
            review: 'Feels like another crappy course so far',
            rating: 1,
            difficulty: 5,
            workload: 20,
        },
        {
            user: 'H8UW4Q96wlD9inQqa+Oe+w==',
            reviewDate: 'May 31, 2024',
            semester: 'spring 2024',
            review: "This was my first course in OMSCS, I thought it was a solid introduction and ramped me up well. I had a solid professional background in software going in (undergrad in CS, SWE full-time) and found the coding assignments provided reasonable value and were very approachable.\nThe most valuable part of the course was the context of AI, the introduction to and histories of the topic, and the approach of development for various solutions. The term-long project can be daunting at first, but was a fun challenge by the end of the term - it's very approachable if you build cleanly from the start and meet the milestones as recommended.\nThere was a fair amount of writing, probably 50-60 total pages of reporting in JDF throughout the course. This was my first time using the format and it's quite approachable. The rubrics for these assignments were very refined and it was easy to get full marks by referring to the rubric and assignment description - they explicitly state what they're looking for.\nLastly, the staff were extremely helpful and very organized. In contrast to some other courses, they're on another level in terms of successful course management.",
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'summer 2023',
            review: "This is not a Joyner class. This class was recorded when he was still a PhD student. KBAI lectures easily violate every single thing taught in HCI.\nCons\n\nBoring, repetitive, pointless lectures.\nPoor assignments and projects.\nYou can hardcode through the assignments and RPM and call it 'Learning by Recording Cases'\n\nPros\n\nIt is easy to get an A with minimal effort.\nCoding: Using Pillow or OpenCV (for image manipulation). Implementing BFS/DFS/A* algorithms.\n\nTake this course if you are looking for low-effort easy A.",
            rating: 2,
            difficulty: 2,
            workload: 5,
        },
        {
            user: 'YcRCrpL/0MAbjrBk0BQjiA==',
            reviewDate: 'December 17, 2023',
            semester: 'fall 2023',
            review: "Worst class I have taken in OMSA (10 taken). Very time demanding, but not at all rigorous. Curriculum is extremely high-level and you will learn nothing that can actually be put into practice. Math for non-majors vibes. Nonetheless you will be drowning in busy work with weekly deliverables that always have a written report component and often have a code-based component as well.\nTAs are also drowning having to grade this so they just quickly check off the rubric. If you do the same, you'll get 100 even if your quality of work is terrible. Tip: always overfit the visible autograder data as you will not be penalized. You can even hardcode it - just call it case-based reasoning.\nThere are homeworks, mini-projects, a major project with four milestone deliverables, exams, and a complicated engagement process all at once. None of these are well executed. Easy A it you do the assignments, but you will work hard and learn nothing. I advise strongly against taking this class.",
            rating: 1,
            difficulty: 3,
            workload: 18,
        },
        {
            ...
            semester: 'fall 2023',
            review: "I don't have a CS or engineering background and I found this class to be really easy and will finish with a high A. The programming assignments are nothing harder than a LC medium at best and the writing assignments, while a waste of time, provide free points so long as you follow the rubric.\nI would note that the role of TAs in this course is not great. Here, the TAs are there for operational support, not to clarify questions about lecture content. This is pretty annoying since the lectures are very dated with poor audio and incorrect/incoherent captions. However, outside of name dropping a few lecture concepts here and there for the writing assignments, they aren't really needed since the exams are open book.\nThe class average on the exams were around an 80%. I think this is heavily skewed to the left due to some really bad performers. Do note, that some of the exam questions were very poorly worded. This led to a lot of non-native English speakers to struggle.",
            rating: 3,
            difficulty: 1,
            workload: 8,
        },
        {
            user: 'ZexEWQ7ZxYse5rRX3UGGsw==',
            reviewDate: 'December 15, 2023',
            semester: 'fall 2023',
            review: "The content is interesting from a historical perspective and to add flavor and depth to some of the challenges still currently facing modern connectionist AI (e.g. commonsense reasoning, planning, logic). It seems unlikely that these techniques will prove the key to AGI, but you never know, and having more tools in one's toolset is always a good thing.\nThis semester had a clusterfuck around peer review, Dr. Goel was largely absent from participation, and the TA staff was okay at best.\nYou also need to follow the rubrics to the letter to get a good grade. But once you do that, the rest is up to you. This class epitomizes the concept of you get out what you put in.\nYou can sleep through the class and not apply a single concept from the lectures and brute force solve the mini-projects and use trivial heuristics to solve RPM and you can still get an A. Or you can spend some time digesting the lectures and reading the extra material to really feel the sense of where these topics can go.\nI enjoyed the material a lot, so the class was a net positive for me.",
            rating: 4,
            difficulty: 2,
            workload: 15,
        },
        {
            user: 'M1tKWAQmDe/GVdhtZdjGSg==',
            reviewDate: 'December 13, 2023',
            semester: 'fall 2023',
            review: "I can't recommend this class. This is my 9th class and it's one of the worst. I took HCI from Joyner and it was amazing, I thought this would be similar and it's complete polar opposite.\nI think you can see what this class use to be like and the elements are still there, but while the class has been updated, it hasn't culled away any of the content in 3+ years. It really is a constant barrage of assignments and things to do and its every single week. There is no break. Not even for Thanksgiving or for GT's fall break, and I know it's online but every Fall class I have taken before this gave some sort of breathing room.\nThis is the standard week for this class: 2-3 hour lecture videos. 3 peer review (which is graded by a computer and they swear it's not based on word count but it is), office hours, a coding assignment (some really small but most are very involved 300+ lines)  and a 5-page paper explaining your code. And to top it off you have to participate in the discussion board to receive participation points.\nAdditionally, you will get nickel and dimed on points for the rubric that the TA won't follow. I seriously had multiple custom deductions on assignments which at that point why even use a rubric. You can submit a regrade request but it's not as easy as just requesting it, you have to submit a doctoral thesis with a 3 page paper explaining why you got points taken off (and they swear that the TAs are not subjective, but again, they are)\nThe project is also terrible. In theory it sounds like a good idea, but the project literally comes down to more graphic analysis then it does AI. For the most part, everyone has the same idea of how to do things, but everyone's process is different. The exemplary examples they have are chosen based on what how well put together the paper looks but it's just for looks. Looking at some of the examples for help doesn't work because there are so many errors on them that you could find yourself coding in circles.\nTLDR: Skip this class unless you have a lot of free time on your hands and even then I would skip. Unless they cull away some of the fat and let the students breathe for a little bit this class is not worth it.",
            rating: 1,
            difficulty: 4,
            workload: 18,
        },
        {
            ...
            reviewDate: 'December 13, 2023',
            semester: 'fall 2023',
            review: "Grade: currently right on A/B border, might get a B.\nLectures: usually interesting, sometimes slow with the examples they walk through.  The lectures would really benefit from some good code examples.  Everything is presented very abstractly and translating what they present into actual usable code is a pretty huge challenge most of the time.\nMini projects: usually not too bad, I usually solved these with algorithms I didn't learn in the course, because they don't really present many algorithms, mostly just abstract framework.\nRavens Project: Very hard, I thought this was an interesting project to think through, but they don't give you any magical easy way to approach it in the lectures.  I learned a lot about opencv/image processing.  Get started early, I kept expecting the lectures to give me some a ha moment on how to approach these problems, but there is no easy solution (except farming gradescope which some students figured out how to do and shared it on the forum, pretty disappointed about this actually, they said they will fix this issue next semester).  To get an A you are probably going to end up with a brute force agent with miles of if statements, unless you think up something clever,  I ended up using a nearest neighbor approach which wasn't bad to code and worked well enough to get a 75/96.\nTests: Awful, open everything, but trying to find jargon specific to the class which you can't find in the text book and it might just be stated briefly in a lecture video.  Best way to study I think is to just watch the lectures over and over and take good notes.\nThis class feels hard for the wrong reasons:\n-getting nitpicked on writing assignment points,\n-tests that don't really reflect actual problem solving skills, mostly just understanding jargon.\n\nravens project is really hard and a fun challenge, but if some students figure out a gradescope farm you will be working your ass of while they get perfect scores for a hour or two of work (I didn't do this technique because it seemed like a complete waste of my time, not learning anything by doing this)\n-10% participation grade which is no cake walk to get, need to reliably do peer reviews by Tuesdays and comment on the forum a lot.\n",
            rating: 3,
            difficulty: 4,
            workload: 12,
        },
        {
            user: 'CJsHkG9iRi7KVP3msEBxlg==',
            reviewDate: 'December 13, 2023',
            semester: 'fall 2023',
            review: "Lectures: Interesting concepts in classical AI. Well-presented materials.\nAssignments: The assignments are similar in format to Harvard's CS50 AI course, but more challenging (No starter code is provided, but you have the freedom to choose any methods you prefer). Overall, they were interesting and well-connected to the lectures (if you choose to use the methods introduced in the lectures).\nFinal project: 70% of my time was spent on the final project because I really enjoyed the project. Most people spent much less time and still did well.\nGrading: Depends on your luck. Different TAs have different expectations. If you are assigned to a TA who interprets the rubric differently, you will get points deducted. This was what made this course stressful to a lot of people (You will find your heart beating at 150bpm whenever they release the grades).\nOverall, this is a well-designed course for someone new to classical AI. The course was enjoyable but I would recommend against taking the class because you can just watch the lecture videos online and do the assignments yourself. This would save you from unnecessary stress. (I give it a rating of 1 not because the quality was bad, but because I think there is really no need to enroll in the class.)",
            rating: 1,
            difficulty: 1,
            workload: 22,
        },
        {
            user: '2eEQQot0U7f1Fk2pKkCFxg==',
            reviewDate: 'December 8, 2023',
            semester: 'fall 2023',
            review: "This is an easy class if you have already taken AI. I even think you probably don't need to take it at all if you are in the ML track. If you're looking for a side class accompanying some big classes, or just looking to graduate, I would recommend it. Otherwise, I'd say you'll learn nothing.\nSome tips:\n\nFor the RPM project, you have 3 milestones to work towards before submitting the final report. For each milestone performance score, even you could get 100% grade by solving half of the test problems, I still strongly encourage you to get them all if possible. That will save you a lot of effort on the final stage.\nAlso for the RPM, make sure you come up with a way to effectively determine if two images are the same in the early milestones. Some images look the same, but in pixel-by-pixel they vary. This semester we have observed students using several ways, but none of them seem to work neatly. Most students are using a threshold.\nFor each writings, just refer to the rubric. The rubric is comprehensive and clear. And that's the best part of this class.\n",
            rating: 4,
            difficulty: 2,
            workload: 4,
        },
        {
            ...
            semester: 'fall 2023',
            review: "I agree with all the reviews posted so far from the Fall 2023 class. Although previous semesters had some positive and some negative reviews, I'm not surprised to see only negative reviews from this semester.\nPros:\nAssignments are easy to understand. Assignments can be worked on ahead of time. This course was really flexible in terms of scheduling. Work load is dispersed quite evenly throughout the semester (some of the final assignments are easier but at that point you should be working on your final project)\nCons:\nGrading can be quite subjective due to the nature of essays. The course videos appear related to the assignments, but they are related in superficial ways. Two snafus during the course lead to large disruptions in learning.\nThis class really needs the help of an involved professor. The lack of an involved professor made this course seem like a circus.",
            rating: 2,
            difficulty: 2,
            workload: 12,
        },
        {
            user: 'paO+vEvs0e9ZVK4/2VgLog==',
            reviewDate: 'December 2, 2023',
            semester: 'fall 2023',
            review: 'KBAI Review\nTL;DR I am a Mech Eng and Software Eng and I learned absolutely nothing worth anything in this course. You basically spend the whole semester solving problems each week using whatever algorithm you want but call it an “Agent”. The material is outdated and I am shocked that this is allowed in the curriculum of a top 10 graduate CS program.\nI’d recommend for - students who have no/little software background and want an easy start and can tolerate material that will likely be irrelavent if you want to do anything with AI as well as students who just want an easy A to get MS credentials. Or if you like structured learning environments and want to pay to practice solving problems that you could just do on your own.\nI’d NOT recommend for - students who genuinely want to learn something relavent in the AI space and can’t tolerate wasting your time having to memorize and regurgitate outdated information so you can pass exams.\n———DETAILED RATINGS----\nOrganization: Excellent\nThe organization and responsiveness of the TAs is excellent. At no point in the course was I stressed out because I awas unclear about something or left wondering for days/weeks. When tweaks were made, they were clearly communicated. (Unfortunately, however, you only have to get a B in a course to be a TA so many of them are not particularly knowledgeable. They are basically just glorified grading tools. Don’t ask them a sophisticated question about….idk equivalent problem representations…. or they will break and take points away for non-conformity lmao)\nGrading: Fair\nThere was nothing unreasonable or unexpected grading-wise if you know how to read the rubric and check the boxes.\nWorkload: Way too much busy work\nI probably work a bit slower than average and with the exception of the first assignment or two everything I did for this class felt like torturous busy work. I think to give us a break whey made the last few assignments easier and maybe some people appreciated that but I felt it was just more mindless work…I’d have preferred an actual dropped assignment or something so I can focus on research for a week and forget about class work.\n(Note - I can’t say anything about the workload compared to other OMSCS courses as this is my first one)\nMaterial: Outdated and irrelevant in the AI space\nThis was the main frustration for me in this course. I do not care (more than I have to for survival) about social credibilitly. I care about learning and my efforts and research helping the world. This classes wasted 4 months of my time (hyperbole acknowledged) solving weekly problems I don’t care about and watching 25 lectures that made me want to break my monitors. Whats hilarious is that if you used the methods we “learned” in class on the assignments, it would have made the assignments harder to do then just using simple heuristics and search algs.\nA much more appropriate name for this course would be "Ancient AI", "Applied Algorithms", "Narrow AI", “Techniques for Dumb Robots”, ...¯_(ツ)_/¯\nThere are two intellectually distasteful things in this class for me 1) you have to learn the KBAI rebranding of existing concepts you already learn far more broadly and efficiently in other classes (ie. algorithms and data structures) and 2) the whole class is about various static algorithms that people have come up with in the past to solve AI problems that have produce terriblly narrow and non-extensible AI systems like those terrible phone robots that you have to get past to talk to real people about your problem. Sure, these systems work for some narrow applications but they are just static algorithms, not AI. Or like your Roomba….basically algorithms for dumb, narrow “AI".\nThere are enough actually challanging problems in the world that require understanding complex processes and so in a top tier program making students waste their time memorizing KBAI\'s rebranding of things they a) already know by another name or b) can learn in algorithms classes more efficiently is truly yuck.\nIn short, this class is a waste of brain space because its basically a rebranding of things you should already know if you take, math and other fundamental CS courses. If you want cognition, take a neuroscience or another course. Not this. Otherwise just math, algorithms, and a minimal degree of introspection regarding how your own brain works is all you need to know everything in this class.\nOne additional TIP because I like a level playing field for those who still decide to take this class after my glowing review:\nI (foolishly) completed my final project using IPR/DPR and a few little image processing techniques….but come to find out you can get 100% by just hardcoding all of the solutions and calling it "learning by recording cases” even though YOU are the one learning…not your socalled “agent". facepalm\n———\nContext:\nBackground: Mech Eng and Software Eng\nFall’23 - KBAI: A',
            rating: 1,
            difficulty: 1,
            workload: 16,
        },
        {
            ...
            semester: 'fall 2023',
            review: 'This was a strange course. At first, I was excited for the challenge and learning something far different than anything else in OMSA. But I\'ve had several issues with the course. It\'s a very "busy" course - frankly just too much.\nMany of the assignments seem to provide little learning value for me. Many of the mini-projects were a form of space-searches. The RPM project also seems promising, and I\'d like to have focused more on it, but I just got a little bit burnt-out on the amount of coursework. I think people typically will say "deal with it, you\'re getting a GaTech degree, etc..." but in reality, less is more. People only have so much bandwidth, and additional assignments are diminishing (if not negative) returns.\nOutside of this, the course had a weird focus on catching cheaters. Much of the class was accused of cheating at one point on peer reviews (strangely). The teaching staff continued to double-down on this accusation, until they realized their errors, and retracted it. It was a very strange event overall.\nNot sure I would recommend this course without significant modifications.',
            rating: 2,
            difficulty: 3,
            workload: 16,
        },
        {
            ...
            semester: 'fall 2023',
            review: 'Avoid this class if possible. So MUCH tedious and useless work. I honestly have learned little about AI. My writing probably has improved, after having to write a journal for every single coding assignment and every milestone of the semester long project. The midterm was like a reading comprehension exam with confusing words.',
            rating: 2,
            difficulty: 2,
            workload: 12,
        },
        {
            ...
            reviewDate: 'November 14, 2023',
            semester: 'fall 2023',
            review: "There is no AI in this course. All the randomly selected puzzles are to be solved by 'so-called' AI agents. There are many Mini-projects, Homework, and MileStones. For each assignment, you have to write ~4-5 pages of report (weekly), and that is too much for a course that is not AI. Each assignment is different and shallow in terms of learning. The course lectures are outdated and not useful nowadays. The grading is done by AI mostly, and I did not see a single comment on my submissions. The course will take a lot of time, and you will gain almost zero knowledge about AI. It is good for high-school kids, but not for MSc students in CS! I forgot to say that participation is mandatory and you have to write peer-review for others' assignments. This feedback takes so much time, and they are useless. I would call it 'abusing' student to assess submissions and grading based on their feedback reports (may save costs!). 10% for participation is insane, and there is no fun there.",
            rating: 1,
            difficulty: 4,
            workload: 20,
        },
        {
            user: 'ViQ0MAhqIk8zZadGZ6QAWw==',
            reviewDate: 'October 4, 2023',
            semester: 'fall 2023',
            review: "I would only recommend taking this as your first course in OMSCS. Taking this in my last semester makes the tedious projects and boring lectures mind-numbing. There are non-stop peer review assignments, an unnecessary amount of papers and generally uninteresting content. I've worked way harder in classes like ML, RL or DL and had a blast. AI4R and Game AI are similar in workload and far more interesting.",
            rating: 2,
            difficulty: 2,
            workload: 10,
        },
        {
            user: 'A+tPab0Hk4DbA+nSHoXpJQ==',
            reviewDate: 'September 24, 2023',
            semester: 'fall 2023',
            review: "I'm not a fan of the peer feedback thing - I came here to write this. I hope my grade isn't dependant on the other students.\nI wish lectures were more relevant to the assignments.\nI'm not learning anything that will be used outside of this course (and if I will, I've already learned it in undergrad) - and I work in reasearch, I think it's a more specific Data Structures/Algorithms course.\nThis class is busy work and basic problem solving that is beng used for publications. It's underwater basket weaving - but you don't have goggles and assignments are due every week.",
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        {
            ...
            reviewDate: 'August 21, 2023',
            semester: 'summer 2023',
            review: 'This was my second semester and I picked HCI in the first sem. I received an A in this course over the Summer of 2023.\nLecture Videos:\nThe lecture videos were very abstract and left a room for a lot of thinking. I wish I could have the time during the summer to think about these abstract topics and apply these concepts in the Mini Projects and RPM Projects. But summer being very condensed it was not at all possible to do this. Most of my mini-projects were brute force approaches to solve the problem.\nIf you really want to apply these concepts, I would recommend a spring / fall semester as it is not possible in the Summer. I had to work 1-2 weeks ahead to keep up with the pace of the course.\nAssignments:\nThe course has 3 different types of assignment running parallel: The Mini Projects, the Homeworks and the RPM project.\nAll the assignments were easy with well layed out rubrics which helps to answer the questions. I lost marks mostly in Homework 2 and 3 as a lot of room to answer was left upon us Students, the lectures did not help much here.\nExams:\nExams were open book and easy. I have no complaints.\nOverall:\nI came in with little to no Python knowledge and was easily able to pick up the materials and RPM project on the go with lots of Google Searches, etc. This course is an easy course, I learnt a lot about Knowledge Based AI but I am not happy that I could not apply the concepts I wanted to for the RPM projects. I look forward to do this during my downtime.\nI wish they could condense the course in the Summer so we can apply the concepts learnt and not rush through the semester. I would recommend picking this during Fall/Spring as unlike other courses, no assignments/homeworks have been dropped.',
            rating: 5,
            difficulty: 3,
            workload: 19,
        },
        {
            user: '2mbR2IFqzmJyu68V3CjyZw==',
            reviewDate: 'August 13, 2023',
            semester: 'summer 2023',
            review: "It is my 1st course in OMSCS. And I regret deeply for didn't take the time to check out reviews here and watch some videos of this useless course before paying for it.\nMy opinions:\n\nvideos are very useless, taking about concepts in a way like a daily conversation anyone can come up in school. In the end, teach students bascially nothing if not to take exams 1 & 2.\ntoo much writing, feel like a course for MBA student. too much writing for homework, min-project, RPM. too time consuming.\nJoyner's file format is a joke. Joyner is also a terribel teacher, trying to connect everything in the lecture to RPM, which makes zero sense.\nserious questions questioning lecture videos/notes don't get answers from teaching team. I suppose they trap themselves with poorly prepared notes and videos.\n\nOverall, just don't take this one unless you are required to do so.",
            rating: 1,
            difficulty: 1,
            workload: 8,
        },
        {
            ...
            semester: 'summer 2023',
            review: 'Overall, I didn\'t learn as much as I wanted to in this course. It was alright, but not what I hoped for. Most projects could be brute forced, a lot of writing that seemed fairly pointless, Joyner Peer Feedback which was almost always useless forms of "good job" from fellow classmates. I will say I really appreciated everything being unlocked right away, I powered through lectures and assignments usually being 3-4 weeks ahead of schedule on work. Taking this class in the summer was pretty manageable. I got basically 100 on all mini projects and homeworks. 94/110 on Exam 1 and 92/110 on Exam 2 and 64/96 for the semester long final project with 50/50 on the final project writeup. This secured a solid A for me. If you know python, you are probably fine for the class, as you see even a meh score on the final project doesn\'t drag you down too much. Just stay up to date on the schedule (or work ahead). I wish there was slightly more challenging homework that really required application of AI rather than brute force algorithms that you pitch as AI in your reports. Literally with any approach you take, just follow the rubric and drop some keywords and you score full points. The Artificial Intelligence course in OMSCS is much harder but much more informative in terms of AI techniques and approaches. I expected more from this class, but oh well, it was an easy enough A for me.',
            rating: 4,
            difficulty: 3,
            workload: 8,
        },
        {
            user: 'C17orAyBtVbxMT3SftseFw==',
            reviewDate: 'August 6, 2023',
            semester: 'summer 2023',
            review: 'I\'m reviewing this class after receiving an "A" grade for the Summer 2023 term. Overall I had a positive experience with this course.\n\n\nThis class could very easily be renamed "Applied Computer Vision" or "Applied Algorithms" considering the main RPM project, and mini-projects, respectively. The lectures do not go into any detail about OpenCV / Pillow / NumPy, so expect a very "hands-on" style deep-dive into these topics. The class also expects a decent familiarity with Python and about good programming principles in general.\n\n\nYou probably shouldn\'t take this course during the summer. While it\'s possible to get an A, it will probably interfere with your life more than you want it to, and you will not have as much time to grasp the concepts in the lectures. Many of the assignments will feel rushed, and there are some weeks where both a homework / mini-project / exam is due the same week as as an RPM milestone; this is not ideal.\n\n\nDr. Joyner, as usual, does an amazing job at administering the course, and allows students many opportunities for grade improvement. As is usual with his courses, expect the extra work of giving Peer Feedback every week. You will also find yourself looking on the EdStem forums a lot for this course, not only for the extra participation threads, but also for the assignments themselves (more on that later).\n\n\nThe weakest point of this class is the lectures. Dr. Ashok Goel was the initial creator of the course, and Dr. Joyner is a co-host of the lectures. The lecture material does not really help while doing the assignments. Most of the material is very conceptual, and only a few of the lectures series have a real, technical description of an algorithm you should use on an assignment. I found this disappointing because the lectures became a chore every week. Instead of learning the material I would later apply in an assignment, it felt like I was learning the theory for the sake of learning the theory.\n\n\nMy recommendation to the course maintainers was for them to drop somewhere between 33 - 40% of the lecture videos, and with that remaining space, create new lecture videos which focus on implementation. The course covers so many topics that it does feel a bit overwhelming. Those videos in the 33 - 40% felt to me like topics which I only needed to know for the exams, and nothing else. It would be nice if the course could give some basic ideas / tutorials on computer vision fundamentals, and about how actually useful parts of the course material can be implemented in code.',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        {
            user: 'QOt+OECo7JhCuBoS7jz0nA==',
            reviewDate: 'August 3, 2023',
            semester: 'summer 2023',
            review: "This was a great course. the content is well organized and Dr. Joyner goes above and beyond on helping the students stay on track by sharing and posting on ed lessons the week announcements.\nThe concepts of the class are not hard to understand but do require you to pay attention and think about them.\nThe interaction on the forum was really good and it really helps to figure out details on the projects.\nThere is a primary project that you build during the semester and 5 mini projects. All the material is available on day 1 so you can work ahead but there are weekly discussions on the topics assigned for the current week.\nAll of the projects can be built based on the material from the class, at least conceptually. in practice, you will need some knowledge of Python but nothing that you can't learn as you take the course.\nThe main project involves image processing but is very light and you could even go ahead without it. PIL and OpenCV will be your friends.",
            rating: 5,
            difficulty: 4,
            workload: 16,
        },
        {
            ...
            semester: 'summer 2023',
            review: 'Overall, this is a good course. The coding assignments are fun and they’re not too tough if you have any Python experience. The exams are open note and all multiple-selection T/F type questions, so it’s not too stressful. The material is pretty basic. So, if this is an early course in the program, you’ll get eased into some material. But if it’s later course, you might be a little bored.\nBiggest downside is that there’s a LOT of writing. Way too much writing. Writing about your code. Shorter writing prompts based on course material. Write about other student’s assignments. Just way too much writing. If you can’t pump out 5-8 pages of writing easily, you’re going to have a bad time.',
            rating: 4,
            difficulty: 2,
            workload: 18,
        },
        {
            user: 'zTJ8T+Gj/4Ug02bYkrIqGw==',
            reviewDate: 'August 1, 2023',
            semester: 'spring 2023',
            review: "This class was not very difficult.  What I liked is that Dr. Joyner opened up all the assignments (even the midterm/final exam) at the beginning of the semester.  This allows students to get a head start on assignments.  I highly recommend to get a good 1 assignment ahead so you don't need to get stressed out.\nThere is a new assignment to do every week, so as long as you've got reasonable time management skills, you'll do fine.\nIn addition, get ALL the participation points you can, it can easily drag down your grade if you slack off on doing it.",
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        {
            user: 'wL7yMD5D3KVB3wA+m+xXlA==',
            reviewDate: 'June 12, 2023',
            semester: 'spring 2023',
            review: "David Joiner & Ashok Goel are great instructors for the class! The workload isn't too bad and there's no group projects (thank god, lol)",
            rating: 4,
            difficulty: 3,
            workload: 13,
        },
        {
            user: 'CU+6kBgOqN1KD7ZDImMi9A==',
            reviewDate: 'June 7, 2023',
            semester: 'spring 2023',
            review: "This is an amazing introductory course in the program that I wish I had taken as my first OMSCS course. Lectures are engaging and easy to understand. I paired this class with AIES and was easily able to get an A. Good mix of programming and writing.\nI went into this course with zero \"AI\" experience and was surprised at how digestable and easily understandable everything was. The hardest portion of this class is the semester long project but I thought it was a really fun assignment.\nI understand that writing the papers can be annoying, but they are actually really simple to write and easy As (as long as you follow the syllabus).\nDr. Joyner is so good at crafting these courses that are challenging and engaging while also fostering a sense of community through Ed Discussion. He actually cares whether you learn something from a course which I can't say about other courses I've taken in OMSCS (AIES, Global Entrepreneurship).\nDon't be intimidated by the title! If I can do it, I promise you can\nPros:\n\n\nThe programming assignments are somewhat challenging but extremely doable. The lectures give you everything you need to solve the projects. If you're stuck you can also check Ed Discussion where someone will definitely have posted a high-level description of the solution (this helped me so much!)\n\n\nLectures are really engaging (as long as you haven't fallen behind and are binging them)\n\n\nHelpful student engagement and discussion in Ed Discussion\n\n\nCons:\n\nWhile I really enjoyed the semster long project, it kind of felt like there was the \"one way\" to do it with IPR/DPR. I know that's not true, but it really felt that way. I wish the lectures and the RPM problems were closer to each other.\n",
            rating: 4,
            difficulty: 3,
            workload: 12,
        },
        {
            user: 'JAxCrWgIR8adOXDV05M+tA==',
            reviewDate: 'May 17, 2023',
            semester: 'spring 2023',
            review: "Background: BS degree in civil engineering with ~2 years of development experience. KBAI was my second course in the program after HCI.\nAs mentioned in this course, there are basically four schools of AI: designing agents that (1) think optimally, (2) act optimally, (3) think like humans, or (4) act like humans. Knowledge-Based Artificial Intelligence is focused on (3) - how can we design AI agents that think like humans? With that in mind, this course has significant overlap with cognitive science and philosophy in an effort to understand how humans think. The lectures fly at a pretty high level, but I found them interesting and thought-provoking. Many folks mention the writing assignments as a drawback to this course, but it's to be expected in a Joyner course and I think it's perfectly reasonable for graduate-level coursework. A lot of the writing is focused on communicating your problem solving approach for homework assignments, which I consider to be an essential skill. It doesn't really matter how slick your algorithms are if you can't explain to anyone how they work.\nOverall, I would recommend taking KBAI. I didn't have any prior experience with AI, so this was a nice introduction to the field. You'll definitely improve your Python skills, and you'll get your feet wet with rudimentary NLP and computer vision. I really enjoyed the semester-long RPM project because I got to learn more about NumPy and OpenCV.\nWith that said, I will agree with a prior comment about how KBAI feels like the \"underwater basket weaving\" of AI. Throughout the semester I couldn't quite get past the fact that it all felt too high level and simplistic. It was a very unique time to take this course because it happened smack in the middle of the ChatGPT explosion, and so I couldn't escape the feeling that the little logic problems presented in the assignments fall short of what \"real AI\" looks like. If you're looking to dive deep into algorithms, AI or ML might be a better choice.",
            rating: 4,
            difficulty: 3,
            workload: 13,
        },
        {
            ...
            semester: 'spring 2023',
            review: "I thoroughly enjoyed how KBAI combines writing and programming to create a well-informed understanding of AI at a high level. The course is structured around three major assignment types: Mini-Projects that leverage a particular AI strategy to solve programming problems in Python; written assignments that require analysis of AI topics and their application to real-world scenarios; and a semester-long project on using Python to engage in image transformation detection for solving Raven's Progressive Matrices. These assignments rotated weekly, which I felt was helpful in ensuring that I didn't get burnt out on a particular topic.\nI found myself extremely overwhelmed by KBAI at the start of the course but eventually found a groove that made the workload manageable. The first Mini-Project was significantly more difficult for me to complete than any other assignment - I ended up with a 50-something on GradeScope and seriously contemplated withdrawing from the course only 2 or 3 weeks in. That said, once I better understood the requirements for each of the Mini-Projects and major project milestones, the work became almost trivial. Prior knowledge of Python is a major plus that will help you significantly throughout this course.\nMany reviewers of this course have branded its lecture videos as a distraction from the actual course content, and generally I tend to agree. The lectures cover various problem-solving and knowledge topics at a high level but never provide details on how they could be implemented in a programming environment; I found some lectures to be more useful than others in terms of guiding me toward solutions. Knowledge of the lecture video content is only truly necessary for the written Homework assignments and the 2 exams.\nThe real secret to success in this course lies in community participation: go-getter students are very eager to share how they completed particular assignments or problems, allowing you to skip over the process of deliberating how to solve such problems and instead focus on implementation. I highly recommend lurking around Ed if you are stuck on something.\nThis course rewards those who are either: a) willing to dedicate significant hours to coming up with original solutions; or b) clever at making most of the resources offered to them and not obsessing over a perfect score. You can easily maintain a high grade by being deliberate about which assignments you're capable of getting a 100 on and letting these pad some of your lower-performing code submissions. I finished with a mid-90s final grade despite earning a 76/100 on my final project's performance.",
            rating: 4,
            difficulty: 2,
            workload: 12,
        },
        {
            user: '71mtit++6oWQpVDyILLbjA==',
            reviewDate: 'May 9, 2023',
            semester: 'spring 2023',
            review: "Background:\nThis is my first course in the OMSCS program. I have a BS in Computer Engineering and most of my programming experience is in C#/.NET. Took a 5-6 year break from school and currently work as a Software Developer professionally.\nOverall:\nThis course is a great introductory course for those who took a long break from undergrad or for those who want to get better at programming without taking a deep dive into highly complex topics. All the mini-projects and main project require you to use Python. From my personal experience, I took most of the time (for the first month) trying to understand how to set up Python and getting used to the differences in syntax compared to C#. Also, an initial lack of knowledge in NumPy, PIL, and OpenCV libraries, which are essential for the Final project, significantly increased development time for the Project Milestones. Although the Homeworks are basically long essays, I found them to be the least time consuming assignments of the course. I struggled in this course initially because a lot of the mini-projects required knowledge in different data structures, which I lacked, and had to play catch up to eventually get an A in the course. Mini-Project 2 and 3 were the most difficult assignments, based on my experience, so do not get discouraged if you score low on those.\nTips:\n• Use the course forum if you feel like you are struggling in the programming assignments. (The other students in the course are very helpful and give great advice)\n• Try to write additional peer feedbacks if you don't plan to be active in the forum. (I found I had to play catch up towards the end of the semester for my participation points)\n• Play around with the Python libraries that are used for the RPM project when you have free time. (It will help lower development time for your project)\n• Focus on the rubric for the assignments rather than longevity.\nWhat I got out of the course:\n• I improved on my Python programming\n• Learned different ways to approach problems\n• Better understanding of the importance of planning\n• Better awareness of time requirements for a Graduate course\nI would definitely recommend this course as an introductory course for the OMSCS program based on the overall good experience I had.",
            rating: 4,
            difficulty: 4,
            workload: 14,
        },
        {
            ...
            semester: 'spring 2023',
            review: "I really enjoyed this class, I love a Joyner class in general. Lecture material is interesting and the projects are all just the right amount of hard. You have to think and put in effort but none took more than maybe 5 hours for the week. There is a paper due with every project, but they take no time to write up and do not have to be anything crazy to get full points. Feel like I learned a lot and wasn't stressed over this class. I really looked forward to working on the course project (there are weeks set aside just to work on the overall project).",
            rating: 4,
            difficulty: 2,
            workload: 8,
        },
        {
            user: 'SBM5hSPk0ab6sFPaDrTVUQ==',
            reviewDate: 'April 30, 2023',
            semester: 'spring 2023',
            review: "My first course in the OMSCS program, my background is BS in mechanical engineering and I have been a working professional for 8 years. My CS background is limited, and my work does not use python.\nWith that being said, a great first course! I enjoyed the jumpstart into programming in python, and the class has a great discussion forum that is very lively. I had to get used to the flow, you typically have to write ~4 pages a week on homework, and have to work on creating a working code that is submitted to be graded.\nThe beginning of the course did require a lot of work, the first coding project took me 15 hours to complete but only because my programming was rusty and needed to get up to speed. After that initial kick I got the hang of it, and really enjoyed how goofy some of the project was. I will say after each exam I felt like I didn't learn much about KBAI as some of the definitions were hard to pick up from the lessons. This course to me was more about the enjoyment I got from the homework, mini-projects, and final.\nHighly recommend to anyone who is in a similar boat and wants to dive in. Be warned, I did say 13 hours a week, but in the beginning I did have some 20-25 hour weeks, but towards the end I had some 4-5 hour weeks to balance it out. And yes I am a nerd and kept track of all my time, the actual average was 12.3 hours, but decided to round up to be on the safe side if someone is trying to plan out a semester workload.",
            rating: 4,
            difficulty: 3,
            workload: 13,
        },
        {
            ...
            semester: 'spring 2023',
            review: "I love this class! It's my first class and a great transition to the program. The projects are so much fun and really improve my coding skills. Students on the forum are always there to share ideas and tips and help each other. It's surprising how friendly the classroom environment is despite being online. The TAs who post on the forum are nice and professional, even when people post angry complaints.\nThe biggest complaint I've seen is the writing. There's writing every week. Personally, I don't think it's that bad since the required JDF format has big margins. Just make sure you hit the rubric and be clear with your thoughts.\nAlthough the lectures focus more on the theories, which seems to be a masters-level thing, you can tell the professors put in a lot of thoughts to  incorporate the materials in the assignments.\nThe RPM project is my favorite part of the class. It's so rewarding to see it come together by the end of the semester. The discussions on the forum on various approaches and testing make it feel like you are working as a team.\nEverything's available at the start of the semester which is really nice for working ahead. Lastly, this class is very organized as it's one of Dr. Joyner's class. It just makes your life so much easier when everything's clear.",
            rating: 5,
            difficulty: 3,
            workload: 12,
        },
        {
            user: 'v4LR6S9MkbR3pgWZGbgr7Q==',
            reviewDate: 'April 12, 2023',
            semester: 'spring 2023',
            review: "I just finished the final exam.  It is open book/note/lecture/everything, but I realized how little I learned in this class.\nPros:\nEverything is released right away.  All assignments are online, so you can get started whenever you want (barring those assignments changing for the next semester).\nProfessor is active in the forums but that should be the norm, not a pro.\nLots of graded assignments to cushion the blow if you do poorly on something.\nCons:\nLectures are just high level and hand wavy.  Examples that are abstract to the point of being absurd.  \"Suppose a robot wants to buy a cup of coffee\".  That stuff is just laughable. This content has nothing to do with the mini-projects or RPM.  MPs can almost be solved with a search algorithm (BFS), other MPs you can just hack something together.\nYou can get 70% performance on RPM with affine model, DPR/IPR hacks and a look up table.  No reason to go beyond that since you'll lose only a couple points on your final grade.\n80% is the average success rate for students on RPM performance, rarely anyone gets 100%.  So your grade is penalized by virtue of tackling the problem.  80% performance should be 100% of that part of the grade.\nSome of the homework questions were tangential and not with-in the scope of the class.  But it is easy busy work to pad your grade, so maybe a pro.\nCognitive Science is just pseudo-philosophy.  Unfortunately, this class is just that with a sprinkling of AI and not the other way around.  KBAI feels like the underwater basket weaving of AI.  Maybe interesting to think about (if that is your thing) but completely useless in the real world.\nMy $0.02:\nThis class failed since it didn't teach me anything.  That is what I learned on the final exam.  Just topics that you watch a video for, take some notes and you'll probably forget a week or two after the semester is done.  I wish this class showed some actual application to the real world.  How does KBAI tie into Chat GPT? Does Boston Dynamics implement KBAI into their robots?  Those kinds of things.\nI recommend checking out the course page and see if this is something of interest before you register.  It is an easy class to get a B and fulfill the Interactive Intelligence specialization requirement, but kind of a waste of time when you could be learning something useful or that would apply to your future career.  I feel like I left AI having learned new skills but I leave KBAI wondering if I should have just taken ML instead.",
            rating: 2,
            difficulty: 2,
            workload: 15,
        },
        {
            user: 'IJogf93Efwuq4RZeTrroVA==',
            reviewDate: 'April 12, 2023',
            semester: 'spring 2023',
            review: "Pros: -The videos of this class are absolutely the best. They're short and sweet but you'll also learn a lot from them, I felt they're changing the way I think.\n-Exams are reasonable, not too hard, not too difficult for someone watched all the lectures.\nCons: Pretty much everything else :)\n-Every single week you have to write a journal, but the issue isn't in writing them as much as how they get graded. During the whole semester, so many students complained on ED that they didn't get graded fairly which is kind of true, your grade depends on how nice the TA is and they're all subjective so it's hard to argue against it. For some reason the professor didn't get engage in any of those threads.\n-TAs are there to review those journals, they're rarely engaged in anything would truly help the students.\n-The projects are silly and you don't need AI to solve them, they're all solvable through brute force, in fact, I haven't seen anyone else in the class solving them in a different way based on the journals which I had to review during the peer review process.\nLong story short, take that class if you don't have other options, otherwise, watch the videos of the class on your own, they're available online for everyone.",
            rating: 2,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            review: 'I review each aspect of this class in detail here, in this 5 min video\nhttps://youtu.be/mCsmaXxZL60\nCheers!',
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        {
            user: 'mIk9ODXqlIUCHcHB5PIMdw==',
            reviewDate: 'December 12, 2022',
            semester: 'fall 2022',
            review: "Before I begin my review, I should let you know that I am not in the OMSCS program. I am in the C-track (Computational Data Analytics) for the OMSA program and took this course because C-track students have to take 2 CS courses for the program. This course got one of the better reviews of the ten CS course options listed for the C-track electives, so I decided to take this course. I'm disclosing this to let you know that I do not come from a pure CS background like most people that take this class, just to give you a heads-up.\nNow for the review. To put it simply, this class just has way too much going on. I knew going into this class that there would be a decent amount of writing because a lot of the reviews on here mentioned it. But what most of those reviews don't mention is EXACTLY how much writing there is, which is what I am going to tell you right now so that you know. Don't say I didn't warn you.\nExcluding the 2 exams, there are 13 assignments in total for this course, with all of them requiring a write-up. Here are the page total requirements for the assignments:\n\n5 papers for a semester-long coding project: 5 pages per paper for the first 4, and then up to 10 pages for the 5th one.\n5 papers for 5 different coding mini-projects: Up to 4 pages per paper\n3 papers for 3 different theory-based homework assignments based on lecture material: Up to 6 pages per paper (4 pages recommended)\n\nIn total, I did roughly 65 pages of paper writing for this course. I should note that not every page was all text. You are asked on some papers to include figures/diagrams, which can take up at least half of a page a lot of the time. But there was definitely more text than figures in my papers.\nA paper is due every week, first thing Monday morning. And THEN you have to give peer feedback to 3 different students' papers that are randomly assigned to you for each of the 13 assignments. And the peer feedbacks that you submit are graded. If a student's paper meets all of the rubric's expectations and is really good, you can't simply write \"This was a great submission and it met all of the expectations. Great job!\" You will get a bad grade for that. You have to go into great detail and write in paragraphs why that student's submission was really good in order to get a good grade on your feedback, which I thought was redundant busy-work.\nAll of this writing makes it incredibly easy to fall behind on the lecture videos, which are fairly interesting but they're only helpful for the exams in my opinion. I thought there was a pretty big disconnect between the lecture material and the coding assignments for this course. They were incredibly high-level \"whiteboard\" explanations that didn't really give any good algorithm breakdowns or coding whatsoever. I literally didn't use any of the concepts covered in the course for the semester-long project because the project was too big and complex for any of these concepts to be applicable. And this seemed to be the class consensus based on discussions in the class forum. I would encourage you to pay attention to the discussions in the class forum because students share methods that they implemented in their mini-projects and semester-long project that really helped them out, and I found that to be pretty useful.\nThere's also no starter code for any of the coding assignments in this class - I didn't find this to be a big deal seeing as it is a grad-level CS course, but I figured I would just let you know this ahead of time as well.\nThe one good thing about this class is that because there are so many assignments in the course, everything is weighted pretty evenly and lightly. So doing really poorly on one assignment is not gonna affect your grade that much. I got roughly 60% on the semester-long project for this course and I'm either going to barely get an A or easily get a B in the course.\nIn terms of coding, I would say it is on the easier side for OMSCS students (it's all in Python, by the way). But my final advice to you regarding this course is this: if you are not required to take this course for your program, you need to SERIOUSLY consider whether you are willing to do a ton of excessive writing - between assignment write-ups, peer feedback, and coding - for a 4-month period. Because that's what you're gonna spend the vast majority of time doing in this course.",
            rating: 1,
            difficulty: 4,
            workload: 20,
        },
        {
            user: '7IdZ6iwCLVyY305YF5nhDA==',
            reviewDate: 'November 14, 2022',
            semester: 'spring 2022',
            review: "Knowledge-Based AI was my second/third course only after AI. I would like to say what I really loved about KBAI. The course material was easy to understand and digest. The projects were pretty great and while we had to think about them, they weren't that difficult to solve or submit. The TAs were really generous and helped out a lot. For an online student, the best tool that we used was Ed Discussions and Peer Feedback, as these were a semblance of actually interacting with the class. The students were extremely helpful and may be due to participation points, were really supportive throughout.\nThere was not much I didn't like, but I would definitely say that this was a time-consuming class. Weekly Projects, Reports, and Submissions without any breaks were extremely exhausting. Even if I missed one week, I would lose a grade. Not saying that a Masters's Course should be any less rigorous but this is something the student should expect from this class.\nThe only reason for bumping difficulty from 3 to 4 is to keep it aligned with the strict time-bound activities we need to perform. Overall I had the most fun in this class and would recommend students to take this class.",
            rating: 5,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            semester: 'fall 2022',
            review: "I'm taking this as a first OMSCS course, with 2 STEM degrees, some undergraduate CS coursework, and a functional (but rusty) grasp of python.\nNoting that folks of widely ranging backgrounds take this course, I'd like to address some common criticisms.\n\nThere is too much writing.\nThere is an assignment due basically every Sunday midnight (except exam weeks). Nearly every assignment is 50% Gradescope performance and 50% write up. If you bomb an assignment, it's not the end of the world.\n\nThe write-ups are really not bad, and very manageable for graduate level coursework. Maybe 3-4 hrs spread over the week.\n\nUse a latex template (Overleaf is very easy) from the beginning.\nStick to the posted rubric.\nMake plots / tables as you do the projects. You'll find yourself hitting the page limit in basically every write-up.\nDon't wait till Sunday to write it or you'll hate every moment.\nThe peer reviews on your write up are actually quite motivating.\n\n\n\nThey don't teach you how to program.\nYeah, not really. This isn't a programming class, it's a graduate-level classical AI course. They cover a range of topics on a high level, then toss you interesting projects to get your hands dirty. The discussion forums offer plenty of help if you're struggling. (there is usually an easy way to complete a project, but it's fun to try some exotic stuff out).\n\n\nThis is all outdated anyway.\nI never understand this take. A survey of classical AI techniques is going to broaden your understanding of the field and give you a wider base of approaches to apply to future problems.\n\n\nThere isn't a clear 1:1 relation from classical AI to modern data-driven approaches. But if you really can't fathom how to use anything but deep learning to solve problems, you're part of the problem.\nTo wrap up:\nIf you're here to learn and want a good class to sink your teeth into (that isn't going to absolutely kill you); you're in the right place.\nIf you're here to get in and get out, well, its not crazy hard and you can get by with just skimming the lectures. You might actually enjoy it, so be careful of that.\nThe class felt a little front loaded. It's progression and organization are great, but they jump right into it with the first project. If you're not comfortable programming you'll have to learn quickly.\nYou'll have to be pragmatic with your time to get projects finished. Get a basic, working version submitted early before scaling it up.\nI absolutely recommend this class. But don't take it if:\n\n\nYou don't have at least a functional knowledge of python or object oriented programming. Learning this right before the class is going to be a hard sell unless you're comfortable in similar languages.\n\n\nYou want a theory class. This is basically all projects and not much math.\n\n",
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        {
            user: 'BWYOWLQN/EfIJBSyM83LGA==',
            reviewDate: 'October 9, 2022',
            semester: 'fall 2022',
            review: "Just took the first exam of the semester. I'm taking this class with a background in computer science, while also balancing a full-time job and a supportive family. It's my first class in the program too.\nLet's start with the negatives of the class. First, speaking as a writer, there is a LOT of writing. Heed this warning. You will be programming a lot, AND writing a lot, AND reviewing people's writing a lot. This is a class that demands 50% of your energy for writing + reading and 50% for programming. If you're okay with this, then that's awesome. If not, then you should consider a class that doesn't require you to write so extensively. I think I've written about 30 pages worth of stuff by now, and it's been only a month.\nThe second thing, which is more serious--there have been a LOT of criticisms regarding how, despite a large number of our assignments requiring us to program extensively, there are very little to no programmatic algorithms introduced to us in the class. Which is a little awkward, considering many people recommend KBAI as a first class for people--in this sense, it's probably better as a second-semester class.\nThere's sooo many people who say \"This is grad school. Don't expect to be spoonfed anything.\" but this criticism isn't coming from people who want to be spoonfed. It's coming from people who want, literally, perhaps a page from Russel & Norvig or a link to some reference for generic pseudocode and programmatic explanations. There are absolutely NO guidelines at all on how to program some of the algorithms presented in the course! I would be incredibly surprised if you could prove me wrong on this!\nI personally have had to do the added research of perusing Russell and Norvig, as well as the optional readings from our Winston textbook and studying relevant data structures that may outline how to approach the assignment, in order to get an A.\nIf you take this, PLEASE be aware that you will not receive any help from the lectures themselves on how to approach programming assignments, much less learning Python! I use Python at my job on the regular, and I cannot imagine taking this course if you've never used Python!\nAs for the positives, there are many. Perhaps as a result of writing all of these reports, if you take this as a first class into the program, you will have set up a good process + environment for writing papers in the future. All of the assignments are given to you at the start of the semester, so you can plan ahead as needed. TAs are incredibly responsive; exams are fair. Programming exercises, if you know how to program beforehand at least, illuminate the concepts in the lecture very well. They are also very flexible exercises--you aren't being shoehorned into a very specific technique or method in order to get 100%.\nI just don't know if these positives can outweigh this HUGE, GLARING negative point. I think it wouldn't be so serious if the course instructors themselves emphasized that it would be very, very important to have prior understanding of Python and a basic grasp of data structures, or suggest as optional reading some more technical papers that outline a programmatic approach to some of the algorithms from lecture, or at the very least a few chapters from the AI textbook by Russell and Norvig.\nI struggled to get a grasp for the class at the beginning of the semester because of how lost I felt for our first programming assignment, but I was able to figure things out by reading a lot more and doing my own research, so I'm much more comfortable now. But there are still a lot of students I've seen in the discussion forums and in our peer reviews who are struggling with completing the programming exercises because they are very genuinely lost, and it's hard to blame them.",
            rating: 4,
            difficulty: 4,
            workload: 15,
        },
        {
            user: '7tWp0/tvApjYBN8jUeMYBw==',
            reviewDate: 'October 9, 2022',
            semester: 'fall 2022',
            review: 'this was my first class in the program and what a fantastic class to kick things off with. Very interesting and extremely well structured and enjoyable. Dr. Joyner remains my favorite humans in the program and I highly recommend the class to anyone looking to get an understanding of AI and practical coding. Thank you Dr. Joyner for making my life easier and doing a good job structuring your classes so well',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        {
            user: 'Y1SPMsEBOM8xa+gjCWAxMw==',
            reviewDate: 'September 18, 2022',
            semester: 'fall 2022',
            review: "Nightmare.\n\nLike said in the other reviews, this course teaches a very out-of-date concept. I don't think anyone is really using this techniques in the industry.\nMaybe because of the lack of real knowledge in this course,  it has lots of tedious homework. For example, in Homework 1 Question 2, it asks to read some European Regulations, and how it applies to general AI, etc. which is completely irrelevant to the course. (More like an ethical course topic)\nAgain, maybe because of the boredom of this course, it asks to complete weekly reports and so-called peer feedback.\n\nOverall, this is a very tedious course teaching useless content. It has a public website (Google it). I highly recommend you read the website before taking this course.",
            rating: 1,
            difficulty: 3,
            workload: 20,
        },
        {
            ...
            semester: 'spring 2022',
            review: "Positives-\n\nWell run, organised\nWas my first course, so good warm up to the rest of the degree\nEverything is thrown open on day one, so you can plan the course as per your pace\nGood projects to pick up python programming fluency\nYou can score well, possibly an A, if you just follow the instructions. Major chunk of the marks is reports for the projects which are easily to do if you just follow the grid.\n\nNegatives-\n\nCourse is not relevant to modern day AI, or something which will help you at work (or secure a new job)\nRe-stressing again on the above negative, very theoretical and intuitive topics discussed in the course, not directly applicable in your programming\nAlthough the projects are good at building fluency and logic, they are general programming challenges and independent of the course lectures to a certain extent. You can use common sense, any algorithm, or force the course topics into the projects but this is reinforces my above contention that the topics are not relevant to modern programming\nEvery week or so a paper is due, can find it a bit too much\nExams tested less of conceptual learning and were more focussed on command over English language to decipher the 'tricky worded' questions\n",
            rating: 2,
            difficulty: 2,
            workload: 13,
        },
        {
            user: 'zUrN/pXcrShtibFvUgnPfg==',
            reviewDate: 'August 19, 2022',
            semester: 'summer 2022',
            review: 'This course was great for learning about topics used in KBAI, but you do not have to code most of the topics and can get away with doing simple solutions for the projects. If you are someone who can only learn topics by coding them, this class might not help you to learn. The test cases for the projects are fairly simple so your code can be inefficient and use basic search instead of the topics taught in the class. The workload is a lot compared to other classes. There is often a coding assignment, report about the coding assignment, homework essays, and lectures to complete during the week. There are also exams, which are thankfully open notes, and a semester-long project that will require a lot of time to complete. I would say this class is not difficult but tedious and an unnecessary amount of work to learn the topics. Overall, I would recommend taking this class if it satisfies a requirement but finding an easier class if you do not have a lot of time during the week for assignments.',
            rating: 4,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 7, 2022',
            semester: 'spring 2022',
            review: 'Pros-\n\nInteractive course, keeps you engaged\nVery well structured and organised, Dr Joyner is an expert in online education!\nGreat community support, you will not have to struggle alone\nProgramming projects are interesting (if you like Python programming)\nThought process and logic of KBAI would help you refine your programming logic and style\nYou can pace the course as per your convenience, everything is thrown open in the very beginning.\n\nCons-\n\nNot a cakewalk or easy course to get an A\nAtleast one report is due every week\nYou have to spend substantial hours for report writing, peer reviews and programming\nProgramming projects are not beginner level and will be steep if you are new to programming or not fluent in algorithms.\nKBAI school of AI is a bit outdated and doesnt see high usage/deployment in modern day programming.\n\nSummary-\nThis is not an easy A course as provided by some reviewers, first 1-2 months of the course can be overwhelming and you must be ready to dedicate time and efforts to overcome that. After this the course becomes relatively easier to handle.\nHowever course is well organised and well designed and if you are willing to give your time, be active in the forums, you will be able to well. Unlike some courses, efforts will ensure you a high performance in the course and Dr Joyner expertise in online education is amply reflected in the course.',
            rating: 4,
            difficulty: 3,
            workload: 17,
        },
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: "Really interesting course that teachings you valuable building blocks. Good amount of paper writing. Lectures videos are the best of any course I've taken. Projects are good, just make sure you watch the relevant lessons first. Work on the PRM project early if possible.",
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 16, 2021',
            semester: 'fall 2021',
            review: 'The class included 1 major project with 4 milestones and a final, 3 written homeworks, 2 exams, 5 independent projects. No surprises. By the way, a useful class if you consider doing Phd and need to show examples of your writing since there will be a report for every coding assignment. You will learn how knowledge is used to make functional AI. For example, language processing, computer vision tasks. No group projects. In terms of workload intense because new stuff needs to be done and delivered every week.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: 'The best class I had so far.\nIt gives a deep and realistic introduction to many topics, with a very interesting explanation.\nProfessor Goel gives a very nice explanation, you will end up thinking "he must be a lovely person", and Professor Joyner is always great.\nI loved the mini-projects, I know many people haven\'t done it in that way, but I applied directly what learned in the class**, and it was awesome.\n** some peer feedbacks pointed that out.\nI was afraid of these peer-feedbacks, but it was a great experience, almost all the time I felt they were fair and objective, and I could learn a lot from many mates.\nOnly drawback: the final project demands some Computer Vision knowledge: I spent more hours in that than in the KBAI part itself.\nMake sure you check the class forum, look for advice about how to approach this project (specially CV part), READ the papers related to that before starting the implementation (I think deliverable 2).\nAs mentioned, this final project is divided into deliverables, a bad design choice at D-2 might push you to refactor the whole solution in following deliverables, loosing a considerable amount of time in that instead of in the final solution.\nStill, with a lot of hard work, I got an A.\nI absolutely recommend this topic.',
            rating: 5,
            difficulty: 3,
            workload: 14,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'October 20, 2021',
            semester: 'fall 2021',
            review: "This course is difficult.  If you don't have knowledge about AI or Python, you will either fail or drop out with a W.  KBAI used to be a bit easier back in the day, but they have revamped the course adding more assignments.",
            rating: 1,
            difficulty: 5,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: "Pretty easy course if you've already taken AI (CS-6601)\nYou'll have to write and read a lot of papers during the semester which wasn't very fun but it's not hard.\nThe assignments were all doable and are released early if you want to do them ahead of time.\nTests are open book/notes/internet",
            rating: 3,
            difficulty: 2,
            workload: 10,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'April 13, 2021',
            semester: 'spring 2021',
            review: "This may be a good course if you're really interested about AI or trying to take lecture materials and apply them in a very abstract way to a problem you're woefully underprepared to handle.\nLectures\nThese are actually the best part of the class. They are concise and relatively clear. They cover a broad range of topics and do drill into enough detail to get a solid idea of the principles.\nExams\nThese aren't difficult to pass but hard to ace. If you've paid attention and written some notes about the lectures you should be fine.\nHomeworks\nThese are just essays. You are expected to look up a topic and write a few pages about it. They're not bad but they're also not as engaging as some of the other assignments in this course. To me they felt a bit shallow and really should have been more of a discussion of sorts instead of a written paper.\nMini Projects\nThese are, hands down, the best assignments in the course. These are setup to give you the opportunity to actually practice the lessons learned in the lectures. They are modeled or sometimes complete copies from the lectures. These have been a lot of fun and the most engaging. I WISH the final project was more like these, or just a bigger version of one of these.\nRPM project\nThis is going to be your bane of existence in this class. This is the final project and it's absolute garbage. As others have pointed out, this is really the professor's attempt to crowd source solutions to the RPM problems and see what novel solutions student's can come up with. The problem is that there isn't enough time dedicated to try any novel approach. There is just enough time to get the easiest solution working, so everyone ends up finding the paper about IPR/DPR and implementing that. Even if you wanted to try something else since you're allowed to use Pillows and OpenCV, the course then shifts from AI to more image processing. Some image course really should either be a prereq or the students should be given some tools/wrappers for those libraries to allow them to focus on the AI aspects instead of wasting all their time with just the image processing aspect.\nSummary\nThe course might be better for some, but I enrolled in an AI course and with how much of the grade is dependent on the final project it feels more like an image processing class. The experience has honestly been the 2nd worse of my OMS career and I can't recommend this class in good faith unless you have already taken an image processing class or are prepared to find previous RPM papers and copy their efforts.",
            rating: 2,
            difficulty: 4,
            workload: 10,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'June 8, 2020',
            semester: 'summer 2020',
            review: "Too much busy work for not much learning. 10% of the grade for participation is huuuge. Forcing participation points like this results in a contrived conversations/endeavours that have no soul. I'd rather encourage students to participate for the joy of participating not forcefully to rake up freaking points.\nAnd writing. Omg ! They explicitly demand a certain number of pages in your assignment. What is this? An english composition course? Might as well start grading by the number of pages.\nProjects and lecture videos are cool though.\nThis course has potential but needs a make over.",
            rating: 3,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 4, 2020',
            semester: 'spring 2020',
            review: 'This is a very easy course. Although my AI agent was among the top-scored, I feel I learned nothing much from the project. I should have taken the more challenging AI course instead. For anyone who wants a challenge and really learn something, not just for the sake of credits and grades, I would not recommend this course.',
            rating: 2,
            difficulty: 1,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'spring 2020',
            review: 'I applaud Dr. Joyner for the compassionate way he handled the COVID-19 impact on the student population. It was amazing to see the level of empathy he has for the students. We all know how awesome of an instructor he is already, and it was very nice to see his level of understanding, sincerity, and patience in dealing with students who are going through an unprecedented time.\nNow regarding the practical knowledge of the class itself, I am not sure how to relate it to future classes or at work. Learning Pillow APIs, Image Manipulation, etc were good to learn, however, OpenCV has far more applicability than Pillow in my opinion. I also felt the knowledge is too abstract. From a coding perspective, I found it to be pretty easy.\nThe RPM project was the brightest part. The exams were the least likable part. The exam questions were like parsing grammar and words. Amount of writing in this class is intense. I wrote a total of 65 pages in JDF format for this class. However, I can write quickly so for many of the homework I was able to knock them out over a weekend.\nThis class has a lot of potential to be far better if it could be re-tweaked to have more coding assignments, add an NLP project, and getting rid of the exams.\nTips:\n\nStart with visual approach from P1. Developing a good set of visual heuristics in P1 can help make rest of the project deliverables fairly straightforward with parameter tuning for each problem sets.\nLearn Affine transformations (from the research paper), DPR, IPR, logical operations (OR, AND, XOR, INVERTED XOR), and connected components labelling. These should be good enough to pass all the tests in the projects.\nUse numpy for everything.\nUse overleaf to make JDF super easy to use. Also use lucidcharts or draw.io for diagrams/charts.\nAlso make sure that you have at least 6+ submissions for each project to get continuous improvement grades in the projects.\n',
            rating: 3,
            difficulty: 3,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'Heavy disconnect between lectures and the project. But individually lectures are interesting. Home works are heavy on reading papers and writing.',
            rating: 3,
            difficulty: 3,
            workload: 17,
        },
        {
            ...
            semester: 'spring 2019',
            review: 'This is a very good subject if you are new to OMSCS, Programming. It give ample time to learn coding python. This include 30% theory - assignments which include some web browsing, lecture analysis and mostly writing journal like skills. Need to take care of format of the document and proper references is all time requirement. Very interactive class and enthusiastic instructor.',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'This should not be a CS class, it is a humanities class with some aspects of CS. I did not learn anything from taking this course. You will be made to write long reports on pointless philosophical stuff. The lectures are pretty abstract and do not go into the depth of any topic. The homework and projects are almost completely unrelated to the lectures. The only positive about this course is that it is very easy to get an A.\nMy expectation from this course was to learn how to create intelligent AI agents. This course turned out to be completely useless in this regard.',
            rating: 1,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: 'Good course and lecture material. Lecturers were engaged with the students via Piazza.',
            rating: 4,
            difficulty: 3,
            workload: 6,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'A lot of busy work and the lectures feel pretty disconnected from the project. That said, the project is kind of fun.\nBe prepared for a good amount of writing!',
            rating: 2,
            difficulty: 3,
            workload: 15,
        },
        {
            ...
            semester: 'summer 2019',
            review: "This course goes over artificial intelligence and the techniques used to design it. The course has 3 HWs (with multiple sections), 3 Projects, and 3 Exams. The workload is easy to manage and it is very easy to work ahead if you need to.\nPros:\n\neasy to work ahead\nvery interesting information\nsome programming but not ONLY programming\n\nCons:\n\nyou don't actually get to build real AI systems\n\nNeeded knowledge:\n\neither Java or Python\n\nHighly recommend this course for a first or early course.\nTo see my full review on the course, check out my youtube channel: https://www.youtube.com/watch?v=wqOIhHa8TbI",
            rating: 5,
            difficulty: 2,
            workload: 6,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "It was my first course in the program along with RL. All the concepts you learn are very applicable if you happen to design an AI system. But, the course gives all the information at the surface level. You will need to google up for more details on the topics covered.\nThe class has 3 Homeworks, 3 Projects and 3 Exams. The Homeworks are document-writeups on either recent trends in AI and questions framed from the lecture. For projects, we had Raven's Matrices, but I heard they are experimenting with other projects. The Homeworks and Projects are tedious but give you a new angle for thinking than the usual implementation thought process.\nOverall, liked the class, learned​ a lot of new things but, ended up hungry for deep info.",
            rating: 5,
            difficulty: 2,
            workload: 15,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'July 18, 2019',
            semester: 'summer 2019',
            review: "The content of this course just isn't relevant to anything I can imagine working on outside of academia. Some may find it interesting, but at a practical level any of the other AI/ML courses offered are far more likely to give you what you're looking for if you're at all like me.",
            rating: 2,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            review: 'This was my first and favorite class. The material was interesting, and the projects challenging. I loved the open-ended nature of the projects. The written assignments prompted me to think of some projects that were interesting enough to put on my for-real implementation backlog.',
            rating: 5,
            difficulty: 4,
            workload: 16,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 6, 2019',
            semester: 'spring 2019',
            review: "This is my first course and I loved it, mostly because of my interest in this subject and the project.\nPrerequisites in my opinion,\n\nYou need an interest in AI more specifically human-like or general purpose AI, else you might get frustrated soon.\nAll 3 projects will run fast, you really need to be comfortable with Python(Numpy) or Java.\nIf you have not taken CV already you might need to quickly read some paper and be able to implement them.  But this should be perfectly fine as long as you are comfortable with the chosen language.\nYou really need to surf a lot online to do the 3 assignments.   Like, read very fast, summarize and present the ideas in 2 pages along with your own opinion.\nYou should be able to take brilliant notes and keep them handy for the exams.  The 3 exams are the weirdest I've ever taken.  Good understanding of the concepts taught in the lecture is a must to crack the exams.\n\nWhat I liked?\nDefinitely, I liked the theories that were taught in this course.  It is a fuel to your thoughts and imagination, you will learn concepts that you can apply to any AI problem, the problem is it will NOT be as easy as it sounds and you might feel they are too abstract.\nThe project is interesting, you will most probably enjoy the project itself with the journals and peer reviews.  On the other side, they don't necessarily relate to the theories you learn in this class.  You can use them for the project but eventually, you will find easier ways to get the agent working that will drive you away from the course materials.\nIf you want to get an A, you can do it with minimal work.  I did more just because I am interested in this track.",
            rating: 5,
            difficulty: 3,
            workload: 13,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'This class helped me get into understanding very basics of creating a program that can to a degree understand context and think for itself. The lectures were completely useless and not helpful at all for someone who has no background in ML/AI. Lectures were very high-level and interesting but did not go over any implementation or guidelines for what should be done in the projects (which is majority of your grade). There were 3-4 other written essays that were somewhat relevant to what was taught in lectures (easily BS-able). Good class if you have a basic understanding of ML/AI.',
            rating: 4,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "The concepts were interesting to me. I liked how learning was primarily via the lectures as opposed to a book. I didn't think the projects were super conducive to learning the concepts in the course. My investment in this course was very sporadic. Some weeks I wouldn't put any time into it and other weeks I'd be working on a project for the whole weekend. But the effort required is manageable, especially if begin working early, little by little. I highly recommend summarizing each lecture at the end (as they suggest) as it helps you solidify what you've learned and it is useful for reviewing the material before taking the test.\nScript for lectures: http://www.coursedocs.org/gatech/cs7637/index.html",
            rating: 4,
            difficulty: 3,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: 'Very well thought out class. There are a total of 3 homeworks, each about 8-10 pages long, and 3 projects. I found the last project to be very time consuming, much more so than any of the other projects and homeworks.\nAll the assignments are clear with almost no ambiguity and this class truly sets the standard for an online class.\nOverall, the material is interesting, the professor and TAs are very engaged on piazza and the class is manageable.\nStay ahead of the lectures and projects.',
            rating: 4,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: "Definitely not a course I would have taken if I could have helped it. The lecture material is wholly unhelpful for the project and you're graded based on the performance of your project compared to your peers, which varies wildly based on the KBAI techniques that you use. I scraped by with an A from being ahead of the curve in the early stages.",
            rating: 2,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: "KBAI is like a good game: You can have a lot of fun on the main quest (get raw points re-implementing the CV-focused known path), or a lot of fun on side quests (implement something else entirely and loosely tie it back to lecture content), and there's no way to lose.",
            rating: 5,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            review: 'The course was well organized and let me work ahead. KBAI offered projects and coding to make the concepts concrete and applicable. Cannot recommend it highly enough. You do have to work ahead some as the assignments were uneven in complexity at least from my perspective. Some just seemed easy to do and others required struggling to get them to work. This may have been my lack of background in robotics. The extra project work was worth doing.',
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: "Well organized with great communication between instructors and students. I would have appreciated more direction in the projects and more practical examples in the lectures. I felt the alternate chatbot projects were harder, more interesting, and more applicable to the course material.\nThere is a non-trivial amount of writing in the course. Three assignments, two exams, and peer feedback were entirely writing. The three projects have a coding component and a writing component.\nThis was Dr. Goel's last semester teaching this course.",
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "Great class. Professors Goel and Joyner are obviously extremely interested in the topic matter and it shines through in the incredibly well constructed lecture videos. The class is rigorous enough to make you feel like you're really learning, but not so challenging or time consuming that you have to give up other aspects of your life.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "KBAI was my first course and i must say it is very well prepared, all TA's and professor was very helpful throughout the course. Classes were organized in proper way along with active discussion among your peers. Initially everyone was suppose to do same project but later on students provide an option to work on other project based on their performance in first project. With this class there is lot of writing which consume a lot of time but there is an opportunity to get your writing published if it is unique and innovative. Though there are many concepts taught in the class about AI, but it was very hard to implement the same in practical life. To start with your program its a good course and one can easily learn python which is highly recommended to finish your project, Good Luck!!!",
            rating: 4,
            difficulty: 2,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: 'Like many have said, this course is a very high-level view of a broad set of AI concepts. Good writing skills (with diagrams) are key to achieving high scores, as all assignments, projects, and exams are in writing. The project is very interesting and challenging, and all assignments and projects are released at the beginning of the semester so it is possible to front-load the project and finish it early.',
            rating: 4,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2016',
            review: "It was okay, but David Joyner was awesome. The content is a little light, compared to other courses, but you learn a decent amount. It probably would be best to take this before ML or AI, although it probably won't prepare you much for those.",
            rating: 3,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: 'First, you will get stressed because of the project and writings especially if you are not familiar to coding. But at the end, you will learn a lot and discover yourself as a very creative human being.\nLot of fun if you are ready to enjoy and love challenges!',
            rating: 5,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'March 20, 2017',
            semester: 'fall 2015',
            review: 'Best class ever!! Everyone in OMSCS should take this course.',
            rating: 5,
            difficulty: 4,
            workload: 25,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'January 10, 2017',
            semester: 'fall 2016',
            review: "\nBe prepared to write. (Images/Charts and obviously making sense gets you good grades)\nPython (numpy/pillow) libraries are your lifeline. If you have used them life can become easy.\nRPM problem's can be daunting and you may eventually get overwhelmed. Nonetheless, a really interesting course.\nProfessor Ashok and TA's are really active in Piazza.\n\nReally enjoyed it.",
            rating: 4,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: "Video lectures - presented at a high level. You watch them for an hour and feel none the wiser for it, and they definitely do not prepare you for assignments/project. I found that if you want to learn the subject, it is a much better use of your time to review the 'optional' reading.\nProject - Based on solving the RPM problems, split into 3 iterations. Students are given very little constructive feedback between iterations. Submission results in Bonnie give very little feedback as well - some students were getting timeouts, memory errors, other errors - but system returns nothing specific and TAs were not helpful on Piazza. The real complexity of this project is not KBAI - it is Computer Vision (they don't allow you to use CV libs yet it's not listed as a prerequisite)\nAssignments - I actually like writing, so these I enjoyed. It is a lot of writing, and I found that looking at the Winston book really helped me learn the concepts. At first I thought just watching lectures would be enough, but the lectures don't actually teach you anything of substance to answer these assignment questions.\nMidterm/Final - Essentially a more advanced version of the assignments. Our questions were about chatbots, and a metacognition component that could explain our RPM agent's decisions. Fun if you like writing, and they definitely chose good subjects.\nThe tragic thing is that this course has so much potential, as the subject matter IS interesting and all over the news. You saw the excitement at the beginning of the semester on Piazza in the active discussions. Those fizzled pretty fast.\nI do hope to improve the course offering they 1) eliminate RPM as a project and replace it with something that actually uses/teaches the kbai concepts 2) redo the lectures to actually teach the material (with proper level of detail)",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: "I started this class, loving it. The project was addicting and I was competitive with myself as well as others to get the best score. In this class, you will implement an agent to take an IQ test called the Raven's Progressive Matrices test. You will be given two sets of problems to learn from, one graded and the other not. There will be two similar sets of questions that you'll get when submitted to the autograder, here to, one graded, one not.\nThen came the writing, there is a lot of writing in this class. Three project reflections, three assignments on nothing related to the class, a midterm and a final. Totally 15, 000+ words on the minimum, and if you want to secure a good grade, at least 20, 000.\nThis not only became a drain, but a bother to complete.\nThe lectures had little to do with the class, and the depth was nonexistent. I feel that I learned little, while just enjoying the programming and creativity.\nHowever, the TAs were lenient in grading and very understanding. As a whole, we started to somewhat complain that our midterm and final essays were high level architectures with little value, so they offered an alt-final, where students could develop their midterm NLP chatbot design into a real program, I can't image many other teachers agreeing to offer a second final for students who didn't feel they were learning enough. This really shows the type of education that GT is offering, as well as this class.\nI hope they sort out the kinks in this class, it has the potential to be a great class.",
            rating: 3,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'The course is really interesting. The assignments I liked a lot, how they were related to the classes. But the projects it seemed to me that lacked the applicability of the concepts learned in class. It is not complicated but the worload is big.',
            rating: 4,
            difficulty: 3,
            workload: 25,
        },
        {
            ...
            reviewDate: 'December 5, 2016',
            semester: 'fall 2016',
            review: 'A lot of reviewers talk about the practicality of it, however I thought the syllabus was really clear. The lectures were meant to be at a 1000 foot level, but there was enough follow up resources in T-square (resource section) to continue learning about each area. I also rented the recommended book from Amazon, and this enhanced the class for me as well. You get as much as you put in with this class.',
            rating: 5,
            difficulty: 4,
            workload: 18,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: "A really great course with fun lectures and fantastic projects. The exams did a great job of making us synthesize what we'd learned. I actually enjoyed them. :)",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'August 11, 2016',
            semester: 'summer 2016',
            review: "This is the only course in OMSCS which I found disappointing so far. Instructor and TA are great and helpful. However, I didn't felt I learnt anything much. Main reasons being:\n\nLectures give interesting overview but they lack the depth compared to other courses that I took in previous semesters.\nIn project work, visual approach is mandatory by the end and it involves mostly ad-hoc heuristics for RPM problems rather than any widely applicable AI algorithms. So you don't get hands on practice of learnt concepts. However, in textual approach I was able to implement some general technique based on learnt concepts, avoiding most hard coding or ad-hoc heuristics.\nAssignments are just essays about possible applications of techniques. So you again lack hands-on exposure.\nWith 3 projects (with reflection write-up), assignments and peer feedback, it felt more like busy work.\n",
            rating: 1,
            difficulty: 2,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: 'This is a fun class with a very active professor (Ashok Goel). However, some of the material is covered at a superficial level only (no implementable algorithms) and the project can be very demanding. But overall, it was a nice course.',
            rating: 4,
            difficulty: 3,
            workload: 15,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'June 30, 2016',
            semester: 'spring 2016',
            review: "I'm in the camp of dissatisfied people. Be aware that this is not an AI course, this is rather an introductory knowledge-representation course. The course is not hard and you can make it fun but it is up to you.\nThe lectures are mere overview of the topics, my undergrad AI course gave me much deeper knowledge on AI. You're on your own discovering the topics; lots of readings are presented so you can dig deeper if you'd like. Which is nice. But I would go as far as don't even waste your time watching lectures if the title sounds familiar to you - for example there is a lecture on classification but it does not go into any mathematical or implementation detail whatsoever. If you've taken an AI, ML or CV class before (or you've read a few pages on wikipedia about statistical classification), you already know more than it is presented in the class.\nWritten assignment are fine, they are short and as the class doesn't, neither are you required to go into technical details. The grading of the papers is a bit of a lottery, depends a lot on the reviewer. I got points taken away for totally contradicting reasons between two assignments.\nThe coding homework is fun but barely has anything to do with the class materials. Turns out you better off implementing stuff on your own (hardcoding lots of stuff) and later claim that this for cycle is 'learning by recording cases' and those if conditionals are 'decision trees' or whatever.\nSo all in all interesting ideas are presented, coding can be fun (but time consuming if you're not good at Python), the papers are not hard and grading is generous but there is no connection between these. Requirements are not always clear and you never really know where you at performance-wise which caused frustration for some. You can easily get a B or A in this class with very small effort - papers can be done in an hour or two, you can skim through videos quickly and the 3 programming assignments can be done during a weekend. Rest of it is up to you.",
            rating: 2,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: "I really can't understand why so many people enjoyed this class. It seemed like we were being encouraged to be creative by having deliberately ambiguous assignment descriptions. Yet, when I put my own spin on things, my grades didn't come out well. I felt like I was guessing at requirements, and was extremely uncomfortable writing my essays as a result. In the end, I had a sense of what the TAs look for (though it's hit-or-miss depending on who you get), and I wrote to that. Beware if you have a different thought than what's accepted!\nThe word count in the assignments is a lie. You need to double or triple it, add about six or seven diagrams and probably some pseudo-code. I got burned on the first reflection because it was too short and I didn't understand what they were looking for.\nThe class was hard because in a sense, the ideas were too simple. I didn't feel like I was learning anything and so I didn't even know what I could write about.\nI didn't like Dr. Goel. He didn't seem respectful of the fact that I was having difficulty understanding what the requirements were. I felt like I was guessing, and he would just disagree when I attempted an idea (but not give me any clues as to how to continue). It seemed lazy, like he didn't actually want to think about my problem--but then, why even respond?\nThe TAs were fine, and helped me out with some of the issues I had. Their feedback on my assignments was insufficient, but they actually helped me with some of my questions and seemed to care about how well my Raven's solutions were going.\nIn the end, I was disappointed and I think I may have wasted four months banging my head against the wall, trying to find meaning in a class that just doesn't have any.",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            review: "This was easily one of the best courses I've ever taken! The concepts in the lectures are explained very well, the time requirement for the lectures isn't insane, and David Joyner and the TAs were extremely helpful. The writing assignments are thought provoking and not at all overwhelming. The Ravens Matrices project is definitely hard, but you have all semester to work on it, and after you get the basics of it set up it's actually a lot of fun. I think this was the most enjoyable course so far.",
            rating: 5,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2015',
            review: 'I thought this class was very professionally constructed (the video lectures, etc. ) It covers a wide breadth of KB AI topics, and you go through them fairly quickly. The projects were challenging yet doable. I was really thankful that the instructor provided all of the course slides, notes, past exams on T-Square. I also found the peer feedback system very useful - it was great see other students approaches, and getting comments on your papers. Like others have stated, you have to write quite a bit in this class. Overall this is exactly what I had hoped for in this graduate program - excellent quality and quite challenging.',
            rating: -1,
            difficulty: 4,
            workload: 14,
        },
        {
            ...
            semester: 'summer 2015',
            review: "Enjoyed the course. Learnt the theory behind AI agents. The overall structure in developing the agent from one level to another was really interesting. Don't miss the lectures since you will learn the lot of terminologies and concepts in designing an agent.",
            rating: -1,
            difficulty: 3,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 11, 2015',
            semester: 'spring 2015',
            review: "Very engaging course with really good interactive lectures. It's important to build a good foundation from your first assignment and limit having to completely re-factor your project code. There were also a few additional assignments that were a bit time consuming, but helped to reinforce the material.",
            rating: -1,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2015',
            review: "A bit of a challenge, but very rewarding. I wish there was a bit more variety in the programming assignments, and there is a lot more writing than I expected. One key for all of the writing assignments (including the project reflections) is to include lots of examples and state your assumptions.\nTA's and professor are all very involved and want to interact with students, which makes the course more enjoyable.",
            rating: -1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'summer 2015',
            review: 'Really interesting class, a lot of fun. Basically spending a whole class on a puzzle you just want to perfect.',
            rating: -1,
            difficulty: 3,
            workload: 12,
        },
        {
            ...
            semester: 'fall 2014',
            review: 'This class was not extremely challenging, but it was a lot of fun and I learned a great deal. Dr. Goel was a great instructor and our TA, David Joyner, were absolutely wonderful and very responsive on the forums. The projects were of very reasonable difficulty while still providing many learning opportunities.',
            rating: -1,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'This class is definitely fun. You get to build an AI Agent to solve some IQ problems. I thought the IQ problems solving was to be done theoretically only when I skimmed through the syllabus. Turn out the agent (written in Python or Java, your choice) really runs and you are given grades based on the number of correct answers.',
            rating: -1,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: "This class is fantiastic. The programing assignments do take some work, but they aren't impossible.",
            rating: -1,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'This is a lovely lovely AI class. The projects are great. The homeworks give you a lot of freedom on how to cover several topics. The teaching team is AWESOME. Dave Joyner (the TA), was nominated for a big TA distinction.',
            rating: -1,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: "This has been the most awesome OMSCS course thus far, very challenging with lots of JAVA (or Python) programming. In the first project you'll be pulling your hair off, after that things 'click' and that's when the fun begins. I learned a lot from this course.",
            rating: -1,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: "Best designed class I've ever taken, undergraduate or graduate. Lessons are incredibly well done with banter between Ashok and David, Piazza is RIDICULOUSLY active, assignments are relatively short and can be completed in 4-6 hours, but happen every week. Keeping up with the material is key. The projects are challenging, but the grading is sufficient that deliberate effort over 2-3 weeks, 5-8 hours a time, is enough to get an A or B, assuming you are already thoroughly competent in Python or Java.",
            rating: -1,
            difficulty: 4,
            workload: 4,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'summer 2015',
            review: "This was a well-run course and if you are at all interested in AI it is a must-take. Grading of written assignments seemed somewhat arbitrary but the curve is generous; it would be very difficult not to earn at least a B if you do all the assignments. The projects aren't terribly difficult and I actually found them to be a lot of fun. One thing I really enjoyed is that when I did the projects I could see the progress I was making in the form of the number of questions my agent was getting correct.",
            rating: -1,
            difficulty: 3,
            workload: 5,
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'This class is not that difficult but it is very time consuming. You will definite learn. There are written assignements EVERY WEEK even the weeks that you have a programming assignment which can take a couple of days to code, you have to make a report about your program. So plan for many hours. Other than that I personally love the class and the instructors are some of the best I ever had. They are very passionate for what they do and they do put a lot of work into each lesson, forum post, etc. Take it, you will be in for a ride.',
            rating: -1,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'spring 2015',
            review: 'Professors are really good. but there is a disconnect between what is taught in video lectures vs the grading. The grading is heavyly based upon the assignments. The lectures only provides a very high level conceptual overview and were little helpful in doing the assignments. Even if you are good in Java or Python, you may still be struggling in doing the assignments.',
            rating: -1,
            difficulty: 5,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'spring 2015',
            review: "This is a well run class and the instructors and professor are very involved. The syllabus was clearly articulated and it was easy to know what was expected. That said, I feel like I didn't learn that much especially considering the amount of work I put in. Nothing was very difficult, but it was very time consuming. I'd venture that you could put in much less work and still do well. The programming projects are interesting, but become repetitive. As alluded to above, if you have some algorithmic development under your belt, you can do better than average without even thinking about a KBAI algorithm. There was a ton of writing for the class. I think I will hit 80 pages of turned in essays/design reports/exams. This semester there were 5 1000 word essays, 4 1500 word design reports, and 2 ~2500 word exams. However, I think you'd be hard pressed to cover the questions in the depth required by the rubric at those lengths; I was usually at least double the suggested length. Mostly these assignments are rehashing lecture material at a high level. I think this course would have been much better had they selected 3-4 topics and gone in depth on each with a tailored project.",
            rating: -1,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'summer 2015',
            review: "If you integrate all the comments above, I think you'll have a fairly accurate view of the course. The main negatives for some people were the amount of writing required (which I actually liked), the relative shallowness of topic coverage in the lectures, and the disconnect between lecture material and the projects. For me those were greatly outweighed by the interesting material, the fun of the projects, and the teaching ability of the instructors. I was enormously impressed by the responsive and productive communication between everyone, instructors and students alike. This was my 7th OMSCS course, and it felt more like a community than any other I've taken (the runner-up was 6475 last semester). The piazza forums are always active and helpful, and I enjoyed the small but chatty hipchat group. A few people complained about all the peer feedback, but I thought it was great to see what others were doing and to get feedback on my own work.",
            rating: -1,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'I loved this class. The TA is the best!! The lectures are great. The programming projects take up most of your time. No prereqs needed.',
            rating: -1,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'summer 2015',
            review: 'Very time-consuming. Lots of writing, but definitely helpful when organizing thoughts and ideas. Project is very challenging but very rewarding as well. Extremely well-run.',
            rating: -1,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'This is my first OMSCS class. I recommend it. This class has time-consuming programming projects for the perfectionist. In order to solve all the problems, I had to sometimes spend 25+ hours just on the coding portion. However, to get an A, you do not to do this much work. The lectures and topics are easy to grasp. The midterm and final are take home. The TA and Professor are very involved: I personally met with the TA during office hours a few times. The projects are partially auto-graded which makes for predictable grading. The weekly essays all have the same, predefined rubric, so you can know what your grade is going to be if you apply yourself.',
            rating: -1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: "If you have basic knowledge of AI and feel comfortable programming in either Java or Python, this class isn't that hard. It's the best executed/managed class so far in my 3rd semester in this program. The teaching is great in conveying difficult concepts into practical examples. Like many already stated, the TA (David Joyner) is amazing. Highly recommended course!",
            rating: -1,
            difficulty: 4,
            workload: 10,
        },
    ...
    reviewSummaries: {
        'spring 2024':
            'Reviews for the course present a stark contrast in experiences. Many students found the workload overwhelming, particularly noting a high volume of assignments, tedious reports, and extensive peer reviews that detracted from actual learning. Common complaints included lengthy lectures with minimal substance and a confusing exam format. Some assignments and projects were considered enjoyable but largely irrelevant to the course content. Conversely, a few students appreciated the course structure, particularly those with a solid programming background. They found the coding assignments valuable and manageable, while the instructors received praise for their organization and support. Overall, the consensus leans toward a recommendation against taking the course due to its perceived lack of practical learning and excessive busywork.',
        'summer 2024':
            "The course offers interesting content on knowledge-based AI, though some students find the workload disproportionately high compared to the learning value. Positive feedback emphasizes clear organization and engaging project work, especially the semester-long Raven's Progressive Matrices project, despite its low grade weight. However, many reviews criticize the lack of support, such as no office hours or active TA involvement, and point out that homework often feels redundant. Participation is stressed for grading, leading to a collaborative yet sometimes frustrating environment. Multiple reviewers mention grading inconsistencies, particularly regarding written reports and rubric adherence. Overall, while students appreciate the course’s insights, dissatisfaction with staff support and perceived excessive busywork dampens their experience.",
        'summer 2023':
            'The course has garnered mixed reviews from students. Many praised its easy grading, claiming that minimal effort can secure an A, especially with some Python knowledge. The lectures were noted as boring and repetitive, lacking practical application for assignments, which felt rushed during the summer term. Several students expressed frustration with excessive writing requirements, deeming much of it pointless. While the project structure was appreciated, the heavy reliance on brute force methods left some feeling dissatisfied with their learning. Positive remarks highlighted the support from Dr. Joyner, and the availability of all materials upfront. However, multiple reviewers recommended avoiding the summer session to better engage with the concepts. Overall, the course may suit those seeking an easy A rather than deep learning.',
        'fall 2023':
            'The course received mixed reviews, highlighting both strengths and weaknesses. Positively, many students appreciated the structured format, interesting lectures, and the well-organized assignments that could be tackled ahead of time. Some found it accessible, especially for beginners, with manageable workloads that allowed for achieving high grades. Conversely, numerous criticisms emerged regarding excessive busywork, including frequent writing assignments and peer reviews that students deemed time-consuming and often irrelevant. Several reviews pointed out that the material felt outdated and lacked practical applications, leading to feelings of frustration and burnout. Additionally, inconsistent grading standards and peer review practices were sources of contention, with many agreeing that the course felt like it could benefit from a more engaged instructional approach. Overall, prospective students are advised to consider their experience and goals carefully.',
        'spring 2023':
            'The course, taught by Dr. Joyner, receives mixed reviews. Positive aspects include manageable workload, engaging lectures, and the flexibility of all assignments being available at the start. Students appreciate the community support on Ed Discussion and find the programming challenges rewarding, particularly the semester-long project. Many report improved Python skills and a welcoming environment. However, criticisms focus on the high volume of writing assignments, which some see as busywork rather than meaningful. Additionally, the course content is perceived as lacking real-world applicability, with some assignments feeling disconnected from practical AI concepts. Overall, students recommend the course for beginners but caution that it might not adequately prepare them for more advanced applications in AI.',
        'fall 2022':
            "The KBAI course has garnered mixed reviews from students, with many praising its teaching quality and engaging content, particularly the connections drawn between human cognition and AI. The course offers valuable programming practice and a supportive community forum, reflecting the professor's dedication to student success. However, several reviews highlighted significant drawbacks, primarily the extensive writing requirements, with some students feeling overwhelmed by the volume of papers and peer reviews. The course content was criticized for being outdated and lacking practical coding guidance, making it challenging for those without a strong programming background. While some found the pacing manageable and appreciated the flexibility to work ahead, others cautioned that the course may not suit those expecting a purely theoretical approach to AI.",
        'spring 2022':
            'The Knowledge-Based AI course is well-organized with digestible material and engaging projects, praised for helping students build programming fluency, especially in Python. Many students found the support from TAs and forums beneficial for collaboration. However, criticisms arose regarding the heavy workload; frequent assignments and lengthy reports proved exhausting, with some feeling the course content is outdated and less applicable to modern AI. Weekly papers and vague exam questions added to the frustration for non-native speakers. While the course challenges newcomers to coding and supports growth, potential enrollees should be aware of its demanding nature, making it ideal for motivated students ready to invest significant time and effort in their learning.',
        'summer 2022':
            "The course offers valuable insights into KBAI topics but lacks a strong emphasis on coding, allowing for simple solutions instead. Students who prefer hands-on coding may find it inadequate for true learning. Project test cases are straightforward, leading to inefficient coding practices. The workload is relatively heavy, with weekly assignments, reports, essays, lectures, exams, and a demanding semester project, making the class feel tedious. While not difficult, the extensive assignments may overwhelm those with limited time. Overall, it's recommended for fulfilling requirements, but others should seek lighter alternatives if pressed for time.",
        'fall 2021':
            "The course has received mixed reviews, with some students appreciating its organization and the engaging subject matter, particularly those with an interest in AI's ethical implications. Many found the workload intense, especially regarding writing assignments, which can require up to 10 pages weekly. Coding projects were generally seen as manageable, but some students struggled to connect lecture material to practical applications, leading to frustration. While several students earned A grades, they noted the significant time commitment necessary, particularly at the beginning. Conversely, those lacking a strong background in AI or Python reported difficulty and stress, with some even withdrawing. Overall, the course provides valuable insights but demands considerable effort, particularly in writing and research.",
        'spring 2021':
            'The course received mixed reviews from students. Positively, many appreciated the well-structured format, engaging mini-projects, and supportive professors, particularly praising Professors Joyner and Goel. Students found the introductory materials useful and enjoyed the coding aspects, while the flexibility in problem-solving was seen as a plus. However, criticism arose regarding the heavy workload, particularly with weekly deliverables and extensive writing assignments, which some found tedious. The semester-long RPM project also drew frustration due to its perceived disconnect from course lectures and challenges related to image processing. Overall, while the course offers valuable insights into AI, some felt it lacked depth, especially in applying course concepts effectively.',
        'spring 2019':
            "The course is received positively for its engaging lectures and enthusiastic instructors, particularly Prof. Joyner. Many appreciate the theory-heavy content and its relevance to AI design, alongside the fun and challenging projects, notably solving Raven’s Progressive Matrices. However, students also note the course's substantial workload, including lengthy homework and projects that often feel disconnected from lectures. Some students criticize the lack of practical application in the material and the theoretical focus, making the course less applicable to real-world scenarios. Additionally, issues with grading rubrics, peer reviews, and slow TA responses have been highlighted. Despite mixed feelings about the workload and abstract topics, many still found value in the course for anyone genuinely interested in AI.",
        'fall 2020':
            "The course has received mixed reviews, highlighting both strengths and weaknesses. Positive feedback includes its superb organization, engaging lectures, and rich cross-disciplinary content that stimulates deep thinking about cognitive science and AI ethics. Many found the semester-long Raven's Progressive Matrices (RPM) project challenging yet rewarding. However, criticisms focus on slow, superficial lectures that lack depth, repetitive homework assignments, and an overemphasis on report writing rather than practical programming skills. Some students noted the projects felt disjointed from lecture material and that peer reviews were tedious. Improvements are anticipated for future semesters, including more relevant programming exercises that could enhance coherence and enjoyment. Overall, the course is seen as a solid introduction to AI, particularly for those new to the field.",
        'summer 2021':
            "The KBAI course has received mixed reviews, revealing both positive and negative aspects. Many students appreciate the mini-projects, citing their creativity and open-ended nature, while others found the workload overwhelming, especially during the compressed summer semester. The exams, comprised of true/false questions, were criticized for being tedious and difficult to prepare for due to their open-book format. Some felt grading was inconsistent, particularly with TAs being overly strict. Students expressed disappointment with the philosophical nature of lectures and a lack of practical application, feeling some assignments required unnecessary filler. However, others found value in the course foundation and praised the instructional team, particularly highlighting TA assistance. Overall, it's considered an easy introductory course with significant time demands.",
        'fall 2019':
            "The course received mixed reviews from students. Positively, many found the lectures engaging and well-structured, noting the effectiveness of David Joyner's teaching style and the ability to study through various formats. The projects were generally seen as valuable practice, despite a disconnect from lecture material, with some finding the writing requirements manageable. However, numerous students criticized the course for its heavy focus on theoretical concepts at the expense of practical programming skills. Many felt that the assignments and projects lacked relevance to real-world applications of AI. Overall, while some students enjoyed the course as a broad introduction to AI concepts, others expressed dissatisfaction with the lack of depth and utility in the content.",
        'summer 2020':
            'Overall, the KBAI course offers a mix of positive and negative experiences. Many students appreciated the engaging video lectures and that the material is presented in a clear manner, making it accessible for those not from a computer science background. However, a common complaint is that the lectures often do not align with project requirements, leading to frustration. The heavy writing assignments and focus on participation points were viewed as excessive and distracting, with some students feeling the courses featured busy work rather than meaningful learning. Assignments often included philosophical questions, which some found irrelevant. Additionally, the use of outdated libraries for projects caused concern. Despite these issues, several students noted improvements in their programming skills and found value in the AI concepts taught. Overall, the course has potential but requires better organization.',
        'spring 2020':
            "The KBAI course, taught by Prof. Joyner, offers a solid introduction to AI and its connection to human cognition, featuring engaging lectures and a structured format. Many students appreciate the active support from TAs and the professor, alongside the free eBook and comprehensive coding projects. However, the course's emphasis on extensive writing assignments—totaling up to 65 pages—can be overwhelming, with some feeling the material is too abstract and not easily applicable to projects. Difficult exams with tricky wording add to the challenge. While some students find the course easy and less enriching, others express it as a valuable experience with potential for improvement through more hands-on coding assignments. Overall, opinions vary, reflecting a mixture of satisfaction and critique.",
        'summer 2019':
            "The course on Knowledge-Based AI (KBAI) has garnered mixed reviews. Positively, some students found the lectures interesting and well-structured, highlighting engaging discussions on ethical dilemmas and a manageable workload. The project, which involves solving Raven's Progressive Matrices, was also viewed as enjoyable by some. However, numerous students criticized the course for being high-level and disconnected from practical applications, feeling it was more about philosophy than concrete AI techniques. The heavy writing demands were noted as both tedious and busywork, leading to frustrations over unclear grading rubrics and lack of direct support from instructors. Overall, while some appreciated its content, many felt it did not meet expectations for a graduate-level course focused on AI.",
        'spring 2018':
            "The course has received a mix of positive and negative feedback. Many students appreciate the engaging lectures and the challenging yet interesting projects focused on developing AI systems, particularly for solving Raven's Progressive Matrices. Professors and TAs are praised for their responsiveness and support. However, a significant volume of writing assignments can be overwhelming, especially for those less skilled in technical writing, as grades heavily depend on clarity and diagrams. While some find the course content outdated compared to modern AI practices, others believe it provides foundational knowledge. Issues with exam clarity and grading criteria have also been reported, causing frustration among students. Overall, it's a well-structured course with valuable learning opportunities but demands considerable effort and writing.",
        'summer 2018':
            "The course received mixed reviews, highlighting Dr. Joyner's engaging teaching style and comprehensive content, making it a favorite among students. Many praised the active Piazza forum and supportive TAs. However, critiques included abstract lectures that made it challenging to connect theory with projects, leading to a feeling of self-research necessity. The exams required rote memorization, which did not appeal to everyone. Writing-heavy assignments were enjoyable for some, but daunting for those less inclined. The project, while interesting, seemed to lack cohesive guidance, although some appreciated the chance to work ahead. Overall, students appreciated the effort required for success and anticipated future improvements, especially regarding project focus.",
        'summer 2016':
            "The course received mixed reviews, with many praising its effective teaching and engaging projects, particularly focused on Ravens' Progressive Matrices. Students appreciated the flexibility in choosing topics and the unique peer review assignments that fostered collaboration. However, several felt the course material was overly high-level, lacking depth and hands-on experience with implemented concepts, which led to frustration with the writing-heavy assignments. While some found the generous grading to be a positive aspect, others resented the busy work and perceived inconsistency in feedback. David Joyner, the instructor, was widely liked, but opinions on the overall learning experience varied, suggesting that students might benefit more if they waited to take this course early in their OMSCS journey.",
        'summer 2017':
            'The course received positive feedback for its engaging material and challenging projects, making it a favorite among students. Many appreciated the open-ended nature of the assignments, which encouraged creativity and critical thinking. However, the feedback does not mention any specific negative aspects, suggesting a largely favorable experience. Overall, students found the course to be inspiring and beneficial, leading them to consider future implementations of their projects.',
        'fall 2018':
            'The course has received mixed reviews, with students appreciating the lack of group projects and the ability to work ahead on assignments, which many found manageable if tackled early on. Projects were deemed fun and engaging, although they required significant writing and time investment. Some students enjoyed the theoretical exploration of AI concepts, while others felt the exams were overly focused on regurgitating lecture content rather than demonstrating understanding. The instructor and TAs received praise for their responsiveness and support. However, there was frustration regarding the time-consuming nature of assignments and the disconnect between theoretical content and practical application. Overall, it is seen as a good introductory course, especially for those new to the program.',
        'fall 2016':
            'The course on Knowledge-Based AI offers a blend of positive and negative experiences. Many reviewers appreciate the well-organized structure, engaging professors, and helpful TAs, highlighting the interesting lecture topics and encouragement for exploration. However, numerous critiques emerge regarding the disconnect between lecture content and project requirements, specifically the tedious Ravens Progressive Matrices project, which feels repetitive and lacks practical application of learned concepts. The writing workload is substantial, with multiple essays required, leading some to feel overwhelmed. While those with a solid programming background may thrive, beginners in ML/AI may find the course challenging and underwhelming in its practical utility. Overall, the course shows promise but needs improvements in content alignment and project relevance.',
        'fall 2017':
            'The course received mixed feedback from students. Positive aspects include the enthusiastic and responsive professors and TAs, clear class rules, and well-structured lectures that facilitate engagement. Many found the alternate chatbot project more rewarding than the main visual IQ test project, citing its practicality and industry relevance. However, critiques focused on the outdated lecture material, disconnect between theory and assignments, and heavy emphasis on writing assignments, with some students feeling overwhelmed by the workload. Peer feedback was acknowledged as both beneficial and frustrating. Overall, while the course is seen as a solid introduction to the OMSCS program, many felt it lacks direct applicability to real-world AI scenarios and requires significant time commitment.',
        'spring 2015':
            'The course received mixed reviews, with some students praising its organization and hands-on projects that solidified concepts, describing it as highly recommendable. However, others felt discouraged, citing superficial lectures that lacked depth and engagement, which left them feeling unprepared for real-world applications. While some appreciated the support from staff, they criticized the uneven assignment complexity and trivial feedback on written work. The readings were deemed overwhelming, and one student found the project unremarkable, feeling it lacked broader application. Overall, while the course may suit some as an elective, others left feeling disheartened and questioning its educational value.',
        'spring 2017':
            'The course has garnered mixed reviews, highlighting both its strengths and weaknesses. Positively, many appreciated the engaging lectures, supportive instructors, and interesting project on Ravens Progressive Matrices. The challenging and high workload was noted, with some enjoying the extensive writing assignments while others found them tedious and overwhelming, leading to “writer’s fatigue.” Although the course material was seen as thought-provoking, some felt it lacked concrete details and direct application to projects, which became repetitive. The feedback culture was unique but polarized, leaving room for improvement. Overall, while some students thrived and found the experience rewarding, others wished for more structure and clarity in assignments and project guidance.',
        'spring 2016':
            'The course received mixed reviews, with many praising the engaging lectures and active instructor, Dr. Goel, who fosters a supportive learning environment. Positive feedback highlighted the interesting projects and the effective synthesis of learning through exams and assignments. However, some students felt the projects lacked clarity and connection to the lecture material, making it challenging to apply learned concepts effectively. Several reviewers expressed that the course was more about introductory knowledge representation than in-depth AI, with superficial coverage of topics. Others noted the heavy workload, especially with coding tasks, and the vagueness of assignment requirements, leading to frustration. Overall, while many found the course rewarding and enjoyable, concerns regarding project depth and grading consistency were prevalent.',
        'fall 2015':
            'The course KBAI receives high praise for its engaging content, organization, and passionate instructors who are responsive to student needs. Many students find it illuminating, revealing the algorithmic nature of AI while offering enjoyable projects that encourage creativity. However, some critiques point to the heavy workload, with regular assignments and extensive paper writing. While some students feel this focus on theory limits the applicability of skills learned, others appreciate the foundational understanding it provides. The projects can be challenging but are manageable if approached wisely. Overall, KBAI is recommended as a valuable contrast to more technical courses, albeit some students may find it less suited to their preferences, particularly those from math-heavy backgrounds.',
        'summer 2015':
            'The course received high praise for its engaging structure and supportive teaching staff, with many students finding the lectures well-explained and the assignments thought-provoking yet manageable. The Ravens Matrices project, while challenging, was considered enjoyable once the basics were mastered. Students appreciated the interactive elements, including peer reviews, which fostered a collaborative learning environment. However, some found the extensive writing demanding, leading to frustration in subsequent courses. Despite its perceived ease, many felt compelled to fully engage with the material as it presented intriguing puzzles and challenges. Overall, the course was seen as a valuable and memorable experience, though the writing workload was a notable concern for a few students.',
    },
};
