export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'Some found value in the coding assignments and enjoyed the context of AI and historical approaches. A few mini-projects were considered fun, and the course staff were noted as helpful and organized.',
            con: 'Many reviews indicated an overwhelming workload, poorly structured lectures, and a lack of practical learning. Students expressed frustration with tedious writing tasks, arbitrary grading, and a general feeling of wasted time.',
        },
        'summer 2024': {
            pro: 'The course material is interesting and well-organized, with clear expectations. Many found the semester-long project rewarding and enjoyable, with a good level of alignment with their prior knowledge.',
            con: 'Numerous issues with course grading and support were noted, including busy work in assignments, lack of valuable feedback, no office hours, and late grading. The staff was criticized for being unsupportive, leading to student frustration.',
        },
        'summer 2023': {
            pro: 'The course is easy to pass with minimal effort, with well-organized content and enjoyable coding projects, especially for those familiar with Python. Open book exams and immediate access to materials facilitate working ahead.',
            con: 'The lectures are boring and lack depth, focusing too much on abstract concepts without practical application. There is excessive writing required for assignments, making the course feel time-consuming and frustrating.',
        },
        'fall 2023': {
            pro: 'The course is well-structured with accessible lectures, interesting content, and a flexible workload that allows for early completion of assignments. Some students found the material engaging, especially in terms of historical perspectives.',
            con: 'The course is heavily criticized for tedious and excessive busy work, lack of challenging material, poorly executed assignments, and subjective grading processes. Many reviews mention outdated content, confusing exams, and overwhelming peer review requirements that detract from the learning experience.',
        },
        'spring 2023': {
            pro: 'The course provides a well-structured introduction to AI, with engaging lectures and supportive community participation through discussion forums. Students appreciate the manageable workload, the ability to work ahead on assignments, and the combination of programming and writing tasks that enhance their skills.',
            con: 'Many reviews criticize the course for its heavy emphasis on writing assignments, which some find tedious and disconnected from the practical aspects of AI. Additionally, the lectures are described as high-level and not sufficiently relevant to assignments, leading to a perception that the course lacks depth and real-world applicability.',
        },
        'fall 2022': {
            pro: 'The course is well-structured and taught by a dedicated professor. Students appreciate the level of learning, community support, and improvement in programming skills, particularly in Python. Many find the projects engaging and valuable for their resumes, with opportunities to work ahead.',
            con: 'The course requires extensive writing and programming, which can be overwhelming. Some students noted outdated content and a disconnect between lecture material and coding assignments. Grading inconsistencies and the need for prior programming experience were also highlighted as issues.',
        },
        'spring 2022': {
            pro: 'The course is well-structured, engaging, with interesting lectures and supportive TAs. Projects enhance programming skills and are manageable if instructions are followed. The learning community is active and beneficial.',
            con: 'The course has a heavy workload with extensive projects and frequent written assignments, which can be time-consuming. Many students find exam questions vague, and content may not be directly applicable to modern AI programming.',
        },
        'summer 2022': {
            pro: 'The course is good for learning about KBAI topics.',
            con: 'The workload is high and the assignments are tedious; coding requirements are minimal.',
        },
        'fall 2021': {
            pro: 'The course is well-organized, provides a great overview of AI, and has interesting projects. Many students found it to be a good first class with supportive forums and professors. Easy to request extensions and opportunities for extra credit.',
            con: 'The workload is intense, with substantial writing requirements and projects that can be overwhelming, especially for those without a strong programming background. Some students found the course to be stressful and demanding, leading to withdrawal.',
        },
        'spring 2021': {
            pro: 'The course is well-organized and offers a realistic introduction to KBAI topics, has engaging mini-projects, and allows for generous grading with ample opportunities for extra credit. Many students found the professors to be supportive and liked the open-book exams.',
            con: 'Some lectures were found to be boring and not very informative; several students noted the RPM project felt disconnected from the course content and was challenging without prior knowledge of image processing. The peer feedback requirement was considered tedious, and students found the written assignments somewhat shallow or time-consuming.',
        },
        'spring 2019': {
            pro: 'The course has a well-structured layout, engaging lecturers, and interesting projects that allow for creativity and self-learning. It is particularly beneficial for those with an interest in AI and provides a good introduction to foundational concepts.',
            con: 'The course may be too theoretical, lacking practical applicability in current AI fields. It has a heavy writing workload with extensive homework and projects that some find tedious, and there are concerns over the relevance of the content.',
        },
        'fall 2020': {
            pro: 'The course offers engaging lectures, good TA support, and clear organization. Many students found the course material interesting, especially from cognitive and philosophical perspectives. Homework assignments were often thought-provoking and relevant to ethical issues in AI. The semester-long projects provided a great first-hand experience and were noted as challenging but fun.',
            con: 'Many found the lectures slow and not adequately motivating, with a lack of depth in certain topics. The homework assignments varied in quality, with some repetitive and dull. The programming exercises were seen as tedious, and there were complaints about the peer review process being labor-intensive. Some students felt the course materials had not evolved significantly over time and lacked coherence.',
        },
        'summer 2021': {
            pro: 'Many students found the mini-projects interesting and appreciated their open-ended nature. The course provides a solid introductory framework for knowledge-based approaches to AI and offers a manageable pace with content available throughout the semester.',
            con: 'Several reviews mentioned the excessive workload, especially during the condensed summer semester, with multiple deliverables weekly and exams being tedious true/false format without feedback on missed questions. Grading inconsistencies and compulsory peer feedback systems were also criticized.',
        },
        'fall 2019': {
            pro: 'The course includes high-quality lectures, open-book exams, and a manageable workload with ample time for projects and assignments. Many found the projects engaging and appreciated the opportunity for peer interaction.',
            con: 'There is a significant disconnect between the lectures and projects, leading to feelings of frustration and wasted time. Many students noted the heavy writing and theoretical focus, with some feeling they did not learn practical AI skills.',
        },
        'summer 2020': {
            pro: 'The course is well-organized, with clear video lectures that are enjoyable and engaging. Students felt they learned about AI, distinguishing it from machine learning, and some found the projects and assignments stimulating despite the workload.',
            con: 'Many reviewers criticized the course for having outdated content, excessive busy work, and unclear assignment requirements, causing frustration. The emphasis on participation points and lengthy writing assignments was also seen as overwhelming and counterproductive to actual learning.',
        },
        'spring 2020': {
            pro: 'The course is well-structured, featuring good video lectures, an active professor, and supportive TAs. Most reviewers found the content interesting, and many appreciated the hands-on projects and the opportunity to engage in various types of assignments.',
            con: 'Several reviewers noted a disconnect between course material and projects, excessive writing requirements, and the antiquated nature of some content. Difficulties were mentioned regarding the exams and the lack of deep learning from the projects.',
        },
        'summer 2019': {
            pro: 'Some students found the course well-structured and the lectures interesting, emphasizing philosophical discussions and ethical dilemmas related to AI. They appreciated the ease of managing the workload and the engagement of the instructor and TAs.',
            con: 'Many reviewers criticized the course for being disconnected from practical AI applications, providing a high-level overview without depth, and requiring excessive writing. Several felt it was busywork with little useful content, and some reported that projects were not aligned with lecture material.',
        },
        'spring 2018': {
            pro: 'The course is well-organized, with engaging professors and interesting projects that promote critical thinking. TAs and instructors are responsive and provide a supportive learning environment. The material is thought-provoking, especially in relation to AI and ethical issues, and students appreciate the flexibility in project choices.',
            con: 'The course involves a significant amount of writing, which can be overwhelming, especially for those not strong in essay-writing. Projects may feel disconnected from the lectures, and there are concerns about the grading criteria, especially concerning ambiguous rubrics and inconsistencies in exam questions.',
        },
        'summer 2018': {
            pro: 'Dr. Joyner is highly praised as a caring and engaging professor, with interesting course content, active Piazza discussions, and supportive TAs. The course includes interesting projects and plenty of additional resources for deeper learning.',
            con: 'Lectures were considered abstract and difficult to follow, with vague project guidance. The heavy writing load may not be suitable for everyone, and the exams were described as largely rote memorization.',
        },
        'summer 2016': {
            pro: 'The course is well-presented with effective teaching, interesting projects, and supportive instructors and TAs. Students appreciated the freedom to choose topics, the enjoyable projects, and generous grading.',
            con: 'Many students found the lectures lightweight and lacking depth, with a focus on writing assignments over hands-on learning. The grading was perceived as inconsistent, and the projects sometimes felt tedious and constrained, leading to dissatisfaction with actual learning outcomes.',
        },
        'summer 2017': {
            pro: 'The material was interesting and the projects were challenging with an open-ended nature that encouraged creativity.',
            con: 'N/A',
        },
        'fall 2018': {
            pro: 'The course has no group projects, allows early work on assignments, and features engaging lectures and fun projects. The instructor and TAs are responsive and supportive, with clear syllabi and manageable workload.',
            con: 'The course involves extensive writing and time-consuming assignments, alongside tests that feel superficial. The programming component is minimal, potentially leading to frustration.',
        },
        'fall 2016': {
            pro: 'The course is well-organized with active involvement from the professor and TAs; it offers interesting lecture topics and a competitive project environment. Many students appreciated the opportunity to experiment and engage with the material even though the course required substantial writing.',
            con: 'Lectures are often high-level and not directly applicable to projects, which center on solving Ravens Progressive Matrices. There is a heavy writing workload, and many students felt the projects lacked relevance to the class material. Some found the course content shallow and expressed frustration with insufficient feedback on assignments.',
        },
        'fall 2017': {
            pro: 'The course is well-organized, with enthusiastic and helpful professors and TAs. Students found the alternate projects engaging and enjoyed the writing assignments as a way to deepen understanding of course concepts. The structure is good for new OMSCS students, and the grading is considered generous.',
            con: 'Many reviews noted the course material felt dated and lacked practical application. There is a heavy emphasis on writing, which may overwhelm those who dislike it. Some students felt the projects did not connect well to the lectures, leading to a disconnect between theory and practice.',
        },
        'spring 2015': {
            pro: 'The course was well organized, offered projects and coding to make concepts concrete, and had strong support from staff.',
            con: 'Lectures lacked detail, written assignments provided trivial feedback, readings were overwhelming, and the project felt pointless.',
        },
        'spring 2017': {
            pro: "The course is well organized with supportive instructors and TAs, interesting content, and engaging projects, particularly the iterative project solving Ravens Progressive Matrices. There's an openness to feedback and alternative project options which can enhance learning.",
            con: 'The course involves a high workload with a lot of writing, which can be tedious and overwhelming. The projects may feel repetitive, and some students found the course content too high level, lacking concrete details and guidance.',
        },
        'spring 2016': {
            pro: 'The course features engaging lectures, challenging projects, and an active instructor who is responsive to student queries. Many students found the content interesting and the material well-structured, effectively fostering their coding skills and understanding of AI concepts.',
            con: 'Several reviews highlight a lack of depth in the lecture material, with some feeling that assignments and projects are not closely aligned with the concepts taught. The grading of written assignments is often perceived as inconsistent, with unclear requirements leading to confusion among students.',
        },
        'fall 2015': {
            pro: 'The course is well-organized, engaging, and encourages creativity with challenging projects. Instructors and TAs are supportive, providing valuable feedback. It offers a unique perspective on AI, particularly with minimal training data.',
            con: 'The course may be overly theoretical with a heavy emphasis on writing, potentially leading to a lack of applicable skills for some students. It can be time-consuming with frequent assignments and projects.',
        },
        'summer 2015': {
            pro: 'The course is well-structured, with clear explanations and helpful instructors. It offers engaging writing assignments and promotes interaction among students.',
            con: 'The course has a significant amount of writing, which may be overwhelming for some students.',
        },
    },
};
