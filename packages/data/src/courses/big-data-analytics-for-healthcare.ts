export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The final project was highlighted as the best part of the class, providing valuable learning experiences about deep learning algorithms, data processing, and SQL. Lectures were generally concise and some served as good reviews for those with prior background.',
            con: 'Homework assignments were criticized for being tedious and ambiguously directed, causing extra workload. The course content felt lacking in substance regarding Big Data, with some participants feeling they learned more about Machine Learning instead.',
        },
        'spring 2023': {
            pro: 'Students enjoyed the engaging content and found assignments like Pyspark projects, Scala implementations, and deep learning tasks with Pytorch to be exciting and beneficial for their learning.',
            con: 'Students noted that the course is challenging and requires prior knowledge in programming and data handling, which can be overwhelming for those not well-versed in the necessary skills.',
        },
        'fall 2022': {
            pro: 'The course design is liked, and TAs are helpful. The homework is described as exciting.',
            con: 'Homework is weighted heavily (50%) and is time-consuming; starting it late can lead to significant point deductions.',
        },
        'spring 2022': {
            pro: 'The course material is interesting and assignments are engaging, especially for experienced data analysts. Labs are helpful for practical learning.',
            con: "The teaching staff's clarity is poor, causing confusion. There are frequent bugs in homework, and environment setup can be challenging. Poor homework instructions and mistakes hinder understanding.",
        },
        'fall 2021': {
            pro: 'The course offers a comprehensive overview of big data tools, hands-on programming experience, and valuable insights into healthcare applications, making it a good introductory course for those entering the field.',
            con: 'Lectures are often dry and not engaging, some technologies used are outdated, and the workload can be significant, making it challenging to manage alongside other courses.',
        },
        'spring 2021': {
            pro: 'The course covers a variety of technologies and provides valuable hands-on experience, particularly with Hadoop, Scala, and PyTorch. Many students enjoyed the final project for its exploratory nature and some found the course content valuable and informative.',
            con: 'The course is challenging, particularly for those without prior experience in the included technologies. Many students found Scala difficult to work with, the lectures not very useful for completing assignments, and the final exam disconnected from the coursework.',
        },
        'fall 2020': {
            pro: 'The course offers valuable exposure to big data and machine learning concepts and technologies, with effective long assignments that facilitate learning. The final project, while team-based, contributed positively to the overall experience, and many found the course enjoyable and less work than anticipated.',
            con: 'The course can be time-consuming, with inconsistent workload and some superficial coverage of topics. The final exam was criticized for being focused on memorization rather than reflecting course content, and some reviews indicate a lack of depth in understanding key subjects.',
        },
        'spring 2020': {
            pro: 'The course offers practical skills applicable to machine learning jobs and covers a wide range of topics, including Hadoop, Spark, Scala, Python, and deep learning. Many students found the TAs helpful and reported that the workload was manageable with proper time management. Several reviews highlighted the value of the final project and the learning achieved during the course.',
            con: 'The course is time-consuming, with some students estimating they spent 30-100 hours on assignments. Some reviewers noted issues with group projects due to team members dropping out or contributing little. There were complaints about the quality of the lecture videos and grading consistency, with some finding TAs too lenient.',
        },
        'fall 2019': {
            pro: 'Course covers a wide range of technologies and assignments introduce new tools effectively. TAs are helpful and group projects are interesting.',
            con: 'Lectures are shallow and outdated, making it hard to learn practical implementations. Homeworks have restrictive requirements that hinder model validity, and course tools and techniques are depreciated.',
        },
        'spring 2018': {
            pro: 'The course provides hands-on experience with data science and big data tools, interesting healthcare-related projects, and has a well-structured homework progression. TAs are generally responsive and an automated environment supports homework tasks.',
            con: 'The course has an extremely heavy workload, inconsistent grading experiences, poor professor involvement, outdated tools, difficult environment setup, and lacks adequate feedback on assignments.',
        },
        'spring 2019': {
            pro: 'The course is hands-on with engaging projects, offers a breadth of experience in big data and machine learning topics, and has active TAs and a supportive community on Piazza.',
            con: 'The workload is intense and time-consuming, particularly for beginners not familiar with languages like Scala, Python, and SQL. Homework assignments can be challenging and may require significant troubleshooting.',
        },
        'fall 2018': {
            pro: 'The course provides a practical overview of various technologies in the big data field, with helpful labs for environment setup. Many students felt a sense of achievement after completing projects and enjoyed the learning experience overall.',
            con: 'The workload is heavy and time-consuming, with projects requiring significant understanding of the technologies. Inconsistency in TA and professor support was noted, which may leave students feeling overwhelmed and struggling for help.',
        },
        'fall 2017': {
            pro: 'The course provides great practical experience in big data technologies and covers important topics like Hive, Pig, Spark, and PyTorch. Students appreciate the value of the homework assignments and the insights gained from the group project.',
            con: 'The course suffers from poor communication and support from the teaching staff. Many students reported issues with the setup and clarity of homework instructions, inadequate testing scripts, and a lack of interaction with the professor, leading to frustration with grading and pacing.',
        },
        'spring 2017': {
            pro: 'Students mention that the course offers significant learning opportunities and exposure to various technologies, especially for those with a relevant background. Completing the labs before the semester can aid in managing the course workload.',
            con: 'Many reviews highlight issues with class structure, including a lack of meaningful instruction from the professor and TA, excessive homework hours, and technical difficulties with the tools required for assignments. Some students found the course overall to be overwhelming and poorly supported.',
        },
        'summer 2018': {
            pro: 'Useful introduction to data analysis and understanding of spark and big data pipelines.',
            con: 'Assignments are tough and time-consuming, particularly for those unfamiliar with key tools; videos are not helpful.',
        },
        'fall 2016': {
            pro: 'The course is highly rewarding for those dedicated to learning big data technologies, with students reporting substantial learning and rigorous content.',
            con: 'The course lacks coherence and clear instructional goals, relying heavily on self-learning, leading to confusion and frustration among students.',
        },
        'spring 2016': {
            pro: 'The course offers hands-on exposure to big data technologies, practical experience in health-related data analysis, and a supportive community through Piazza. Many reviews acknowledge the depth of learning gained from dealing with real-world tools like Hadoop and Spark, as well as the helpfulness of TAs and the professor.',
            con: 'The course is extremely time-consuming with heavy workloads, often requiring over 40 hours per week. Many students report vague instructions, disorganization, and insufficient teaching materials, leading to confusion and frustration. There are also mentions of steep prerequisites and the need for self-directed learning, which may hinder those without strong foundational knowledge.',
        },
        'spring 2015': {
            pro: 'Learned a lot, very interesting and rewarding, with valuable practical experience; extra credit opportunities.',
            con: 'Difficult and very time-consuming, with little information in lectures and a preference for a hands-on learning approach that may not suit everyone.',
        },
    },
};
