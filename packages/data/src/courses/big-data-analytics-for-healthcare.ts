export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: 'The instructions for homework are poorly designed. There are quite some mistakes there and the TAs seem to have difficult time understanding our questions as well. I will update as the class progresses.',
            rating: 1,
            difficulty: 4,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: "In the end, I can't say I know much about either big data or health analytics. You touch many technologies at a very superficial level. Some practical tips can be read here",
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'spring 2020',
            review: "Wow, what a class. It was tough but you learn soo much. I felt like I actually learned skills that I could apply to a real job and real data analysis. There's an emphasis on Spark, Scala, and distributed large scale data analysis. It was tough. I had to relearn the chain rule and try to understand stochastic gradient descent but it was quite a great course. Personally, I felt that the Andrew Ng videos were excellent in help me understand quite a few of the concepts taught in the course.",
            rating: 5,
            difficulty: 5,
            workload: 38,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'This was a tough class, but it was fair in my opinion. Definitely get started on things as soon as you can as they usually take longer than expected. The assignments are released on a schedule so you cannot work ahead. TAs are good. Lectures were pretty good though you definitely learn more from the projects and the labs. Note you can look at labs now at http://www.sunlab.org/teaching/cse6250/fall2019/env/ The group project was interesting.\nThe one part I did not love is they tried an exam this semester. Some of the questions were good, but some seemed more like trivia where you could narrow it down to two options by knowing the material but then just had to guess.\nSmall amount of extra credit offered for placing high on in class Kaggle competitions.',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            review: '\nIt will be good if the the course are revised with more updated version of tools, e.g. using scala v2 with dataframe instead of scala v1 with RDD\nI am lucky that I toke the course early, and heard that they now even add one more exam to it. The workload seems has now gone from very heavy to insane....\nThis course is famous for it workload, and difficulties.  Make sure that you are well prepared before taking it, better in the middle or later half of the program.\nGroup project for group at most 4 people. Definitely helpful if can form reliable groups in advance.\n\n5 individual assignment + 1 group project.',
            rating: 4,
            difficulty: 4,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "This class was a firehose. Most of my learning and time spent was through completing the homework rather than through the lectures. A successful student would do the following 2 things:\n\n\nStart homework immediately when it is released and work on it every waking hour until complete -- do not wait until last weekend or it's too late\n\n\nRead every post and reply on Piazza -- there are often hints or ideas that can save hours and hours of troubleshooting\n\n\nI did each of the above, and I was still awake past midnight each time an assignment was due.\nThis was an amazing first class for me as it gave me the breadth of experience with topics I was hoping to learn:\n\nbig data technologies like Spark, Hive, Pig, and Hadoop\nmachine learning and pandas\ndeep learning with neural networks\n\nOverall, it was a great experience, and I would recommend the class for someone with both the time and the interest.",
            rating: 5,
            difficulty: 5,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "Really active TAs but homework assignments are really time consuming.  One could get ahead by doing all the sunlab tutorials and getting your environments setup.   http://www.sunlab.org/teaching/cse6250/spring2019/env/\nThere's no environment to upload and test that your code runs so it's pretty frustrating when you find out your code didn't run.\nOverall a good class after taking ML if you have the time.",
            rating: 4,
            difficulty: 5,
            workload: 30,
        },
        {
            ...
            semester: 'fall 2017',
            review: 'This course was amazing! Contrary to what was stated in some of the reviews, the assignments were well prepared and the docker image given really helped the environment setup. I honestly dont remember struggling that much to setup my environment (except Spark in IntelliJ, but that is also not that bad). In this course, you will learn most of the big buzzwords in Big Data such as Hive, Pig, Spark, SparkML, and PyTorch. You will learn even more if your group project used other frameworks (my team used combination of PySpark, Tensorflow, and Keras).\nTo succeed in this course:\n\nBe ready to invest huge amount of time in group project which includes writing the proposal, draft, final paper, presentation slides and videos.\nYou should be comfortable in creating quick prototype and analyze the results directly.\nIt is beneficial to have a pro-active mindset so it is easier to allocate the task as you might find yourself lost if your group move at a faster phase.\nIt is also important to decide your research objective early and stick to it. The TA grades you more on how you utilize the big data stack and less on how accurate or advanced your algorithm are (At least they did for my group). After all, it is only a 2-month research project.\n\nOverall, I think it is one of the must-take course in OMSCS',
            rating: 5,
            difficulty: 5,
            workload: 30,
        },
        {
            ...
            review: 'Cool class, but there was a lot of issues with setup.',
            rating: 4,
            difficulty: 5,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'I would not recommend this as a first course.',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: 'This is the most "practical" course I\'ve taken so far ( out of 9 ). It is very harsh at the beginning if you\'re not well prepared ( to meet the pre-req ). I had some experience with hadoop, mapreduce and piglatin before, thus the first 2 homework were not that bad. But learning scala and spark within 2 weeks was brutal. TA, professor and especially classmates are very helpful. The second half of the course is about project. I did learn a lot for writing and coding. It is also almost self-paced which made life much easier if compared to the first half. It is a very useful course if you plan to learn big data and use the related tools. But be prepared it is not an easy one.',
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: 'This class will require you to learn and work on the problem with all time that you have. You also need to work with the TA and professor to clarify a lot of issue in the assignment. The assignment is well-structured but misses a lot of information. There is so much research that you have to do in each assignment. Strongly recommend to take this class by itself. You will learn a lot at the end of the course.',
            rating: -1,
            difficulty: 5,
            workload: 50,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: "For me, this is the single hardest class I have taken in the program (it is my 10th). The material is very difficult and the assignments have unclear directions. You can get stuck on something for 10 hours that is only worth 5% of a project, but completing that is required to proceed onto other part of the projects. I have spent 30 hours on each of the first two projects and wasn't able to get a B on either. The teaching team is very responsive on Piazza but it can be difficult to find answers there because it seems a lot of students are struggling.",
            rating: -1,
            difficulty: 5,
            workload: 30,
        },
    ...
    reviewSummaries: {
        'fall 2023':
            'The course underwent significant changes, making it more manageable with under 10 hours of work per week, yet some students felt it lacked depth in Big Data concepts, focusing more on data wrangling with Spark, NumPy, and Pandas. While the final project on replicating a research paper provided valuable learning experiences in specific algorithms and data processing, some students found the homework assignments tedious and poorly communicated, leading to frustration. Lectures were generally concise, offering good overviews for those with prior machine learning experience. Grading was seen as generous, but the workload was considered high, causing stress among some participants. Overall, students gained more insights into Machine Learning rather than the intended Big Data focus.',
        'spring 2023':
            "The course provides a rigorous introduction to machine learning and data mining in healthcare, requiring prior knowledge in programming languages like Scala, Python, and Java, as well as familiarity with SQL and ETL processes. While many students enjoyed the assignments—especially those involving Pyspark and PyTorch—some found the workload overwhelming without sufficient prerequisites. The collaborative yet challenging environment promotes deep learning through practical applications like predictive modeling and clustering, although students noted debugging in Scala could be difficult. Overall, the hands-on projects were engaging and insightful, but success hinges on prior technical expertise to keep up with the course's fast pace.",
        'fall 2022':
            'The course received positive feedback for its engaging content and supportive teaching assistants, particularly appealing to those in health-related fields. Reviewers appreciated the course design, which facilitated learning. However, caution is advised regarding the homework, which comprises 50% of the grade and can be time-consuming, with one reviewer losing points for procrastination. A suggestion to familiarize oneself with programming tools like Python, PyTorch, Scala, and Spark was emphasized. Overall, while the course can lead to strong grades, students should manage their time effectively to avoid pitfalls in assignments.',
        'spring 2022':
            'The course offers intriguing material and engaging assignments, particularly beneficial for those with a solid background in machine learning and programming. Experienced data analysts find value in its comprehensive coverage and practical labs using tools like Hadoop and Spark. However, the class is marred by significant issues, including poor communication from the teaching staff, unclear homework instructions, and frequent errors in the auto-grader. Many students faced overwhelming challenges with setup, particularly on Mac systems, leading to excessive hours spent on assignments. Additionally, those with limited experience may feel left behind, especially concerning the demanding final project that requires deep learning knowledge. Overall, while the course has potential, a teaching overhaul is necessary for improvement.',
        'fall 2021':
            "The BD4H course offers a challenging but rewarding experience, especially for those with coding experience. Reviewers noted a heavy workload, requiring 15-16 hours a week, and emphasized the importance of a strong background in ML, Scala, and healthcare concepts for success. While some found the lecture style dry and unengaging, others appreciated the comprehensive overview of big data tools and hands-on programming opportunities. Assignments are generally manageable but time-consuming, and group projects can enhance the learning experience, assuming a good team dynamic. Feedback on grading varied, with some praising its leniency. Overall, students gained valuable insights into healthcare applications of ML, but the course's rigorous pace may challenge those balancing multiple commitments.",
        'spring 2021':
            'The course received mixed reviews, with many acknowledging its rigorous content and valuable exposure to technologies like Hadoop, Scala, and PyTorch, which proved beneficial for industry readiness. Students with prior experience in Python and machine learning found the initial assignments manageable, while those without struggled significantly. The workload was intense, particularly with homework and final projects, leading to a demanding semester for many. However, frequent complaints arose regarding the utility of lectures, which seemed disconnected from assignments, as well as the challenging final exam that felt irrelevant. The predominant frustration centered around Scala, deemed outdated and cumbersome, suggesting an upgrade to more relevant frameworks like PySpark. Overall, while the course offered robust learning opportunities, it highlighted significant areas for improvement in organization and curriculum relevance.',
        'fall 2020':
            "The reviews reflect a mix of experiences in the OMSCS course, highlighting both its time-intensive nature and its educational value. Many students found the assignments demanding, often requiring 30 hours a week, leading to feelings of frustration due to excessive debugging rather than genuine learning. However, those invested in machine learning and data science recognized the course's potential, appreciating the deep understanding it provided on neural networks and practical exposure to big data tools like Spark and Pig. The course's theoretical and practical balance, alongside lenient grading on projects, garnered positive feedback despite superficial coverage of some topics. Overall, it is deemed beneficial for students focused on ML, though not universally recommended for those unsure about entering the field.",
        'spring 2020':
            'The course receives mixed reviews, highlighting both its strengths and weaknesses. On the positive side, students appreciate the practical skills acquired, especially in big data technologies like Spark and Scala, which are valuable for future job prospects. Many find the TAs responsive and helpful, making the learning experience smoother. However, the workload is intense, with students reporting significant time commitments for homework and group projects, often exceeding 30 hours each week. Some feel the course is not as difficult as advertised but rather time-consuming. Concerns include inconsistent grading, lectures that are sometimes irrelevant, and project team dynamics that can lead to unbalanced contributions. Overall, those with prior experience in programming and machine learning find it manageable and enriching.',
        'fall 2019':
            'The course received mixed reviews, highlighting both its challenging nature and significant flaws. Positively, students appreciated the fair grading, good teaching assistants, and an interesting group project, with lectures offering a solid conceptual foundation, albeit lacking practical "how-to" guidance. However, criticisms centered around outdated labs and tools, superficial lecture content, and a disorganized Piazza discussion forum. Many found the homework assignments mechanical and restrictive, compromising model integrity, and voiced dissatisfaction with the new exam format which felt like trivia. Overall, while the course covers a wide array of technologies, students expected more effective learning and implementation practices to align with current industry standards. Suggestions for improvement included updating technology and focusing on practical applications.',
        'spring 2018':
            'The course offers hands-on experience with big data tools and a focus on data science practices, particularly in healthcare-related problems, but students faced considerable challenges. Reviews highlight an overloaded workload with substantial time demands, often leading to feelings of frustration and burnout. While some found value in the group projects and real-world applications, the auto-grading system and inconsistent feedback from TAs undermined the learning experience. The course materials are outdated, relying on older versions of tools like Spark, which some felt limited practical learning. Additionally, the presence of the professor was notably lacking, contributing to a sense of disconnect. Overall, while the project component was well-received, many reviewers suggested that the course needs significant revisions for better structure and support.',
        'spring 2019':
            'The course received mixed reviews, highlighting both its strengths and challenges. On the positive side, students appreciated its hands-on approach, effective team projects, and the breadth of topics covered, including big data and machine learning. Many learners valued the opportunity to apply theoretical knowledge practically, enhancing their skillsets significantly. However, some criticized the course\'s intensive workload, describing it as a "firehose" of information, where homework consumed most of their learning time. Students suggested starting assignments early and staying actively engaged on Piazza to succeed. Those unfamiliar with Python, Scala, or SQL felt overwhelmed, particularly struggling with Scala assignments. Despite the challenges, many found the course rewarding and beneficial for their careers in data science and machine learning.',
        'fall 2018':
            'The course offers an extensive overview of various big data technologies, including Python, Hadoop, and Deep Learning, through five challenging projects and a final group project. While it lacks exams and aligns poorly with lecture content, students appreciate the practical learning experience, particularly for those pursuing data science. However, the workload is significant; projects require considerable time investment and a strong grasp of the technologies involved. Many students noted inconsistent support from TAs and the professor, causing frustration. Although some enjoyed the course overall and found value in the hands-on projects, the demanding nature of the work and group project dynamics presented a challenge, making it a mixed experience.',
        'fall 2017':
            'The course on Big Data is both praised for its content and criticized for execution. Reviewers highlight the valuable exposure to key technologies like Hive, Spark, and PyTorch, stressing the importance of a proactive approach and teamwork for the extensive group project. However, many students found the class to be fast-paced and noted that self-study is essential, as lectures often lacked depth. Problems included ineffective communication from the teaching staff and inadequate homework testing procedures, leading to confusion and grade discrepancies. While some TAs were helpful, others were disengaged, and the overall instructional quality was deemed lacking. Despite these challenges, students felt the course was a worthwhile experience that significantly boosted their confidence with big data technologies.',
        'spring 2017':
            'The course received mixed reviews, with students highlighting both valuable learning opportunities and significant challenges. On the positive side, many acknowledged that despite its difficulty, the class provides extensive knowledge in technologies like Scala, Spark, and various data manipulation tools, with a rewarding project component. Some found self-learning beneficial, particularly those with prior experience in related fields. However, numerous complaints arose concerning inadequate instructor support, unresponsive TAs, and a lack of meaningful guidance, making self-study essential and frustrating. Many students felt that the coursework was overly time-consuming, likening it to a full-time job, which deterred some from completing the class. Overall, this course may suit determined learners with a strong background in data science, while beginners could struggle without significant support.',
        'summer 2018':
            'The course provides a solid introduction to data analysis, helping learners understand concepts like Spark and big data pipelines. However, many students find the assignments challenging and time-consuming, particularly for those lacking experience with pandas, numpy, or the Spark API, often resorting to Stack Overflow for assistance. Additionally, some participants feel the video content lacks utility, making it less helpful in understanding course material. Overall, while the course is beneficial for beginners, it may pose difficulties for those unfamiliar with the necessary tools and concepts.',
        'fall 2016':
            'The course has drawn mixed reviews, highlighting both its challenges and learning opportunities. Critics note a lack of structured instruction, emphasizing the heavy reliance on self-learning, with many feeling that coursework is disconnected from lectures and that assignments are confusing and cumbersome to complete. Grading inconsistencies, particularly in the open-ended project, have left some students frustrated. Conversely, supporters praise the course as a rigorous and rewarding experience that demands hard work, claiming they gained substantial knowledge in big data technologies. The intensity of assignments has been both daunting and enlightening, while the final project allows for creativity, albeit with high expectations for originality. Success requires strong dedication and passion, as many students struggled to keep up.',
        'spring 2016':
            'The course offers a rigorous, hands-on experience with big data tools, particularly in a health context, which many students find rewarding despite its challenges. Positive aspects include exposure to current technologies, helpful TAs, and a collaborative community. However, the overwhelming workload—often exceeding 40 hours weekly—and disorganization are significant drawbacks. Many felt unprepared for assignments, which require strong backgrounds in programming and mathematics, with unclear directions leading to confusion. While the lectures provide minimal support, learning primarily occurs through self-directed study and practical assignments. Overall, while the course has the potential to be valuable, significant improvements in structure and communication are needed for future iterations.',
        'spring 2015':
            "The course offers an enriching learning experience, with students noting significant knowledge gains, particularly in handling big data tools. However, it is also challenging and time-consuming, requiring careful time management, especially for the four intensive homework assignments in the first half. While grading appears lenient, some students struggled to complete all tasks, though ample extra credit opportunities can boost final scores. The lectures lack depth, favoring hands-on labs that may not suit everyone’s learning style, as some prefer a more structured approach. Overall, it's recommended for those interested in the subject, but should ideally be taken alongside a less demanding course due to its rigor.",
    },
};
