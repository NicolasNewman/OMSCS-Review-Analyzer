    ...
    reviews: [
        {
            ...
            semester: 'fall 2023',
            review: 'I love the teaching team. So fun, great course that can be useful when you thinking about developing your next big ideas.',
            rating: 5,
            difficulty: 2,
            workload: 8,
        },
        {
            ...
            review: 'Highly recommend. The course is designed to be efficient in the sense that it teaches you a lot with very little workload. Especially useful for people thinking about being the founder of a startup since most things are taught from that perspective.\nWeek with highest workload took me 6.5 hours, while I was able to completely ignore the course a couple of other weeks.',
            rating: 5,
            difficulty: 2,
            workload: 2,
        },
        ...
        {
            user: '8AxDzE3RxkCU+WRxTiSsqA==',
            reviewDate: 'April 20, 2024',
            semester: 'fall 2023',
            review: "This is a wonderful class that will definitely bring you practical insights for your next venture. On top of Digital Marketing, AI Ethics, these are the classes that bring real value to my business, instead of coding, coding, writing papers for the sake of doing it.  It is more efficient if you take it in addition with another course during Fall or Spring. Why take those 3 easy classes alone during the summer?\nThere are two projects: business acquisition and code analysis, don't fake them, do the research. Do it seriously, you will be fine. The lecture quizzes are fine too, as long as you watched them. They are well done.",
            rating: 5,
            difficulty: 2,
            workload: 3,
        },
        {
            user: 'UuztNb7E+SDCxLpV7Dd3Kw==',
            reviewDate: 'January 2, 2024',
            semester: 'fall 2023',
            review: "Not sure if this class has changed in recent semester, but I'd say the workload was around 10 hours/week. Leaving this review to balance out the 2 hour ones.  I'd say its similar to taken Computer Networks, ML4T, and InfoSec in terms of workload.\nStill a great class. I learned a lot and I felt like there was enough material where one could dive in and spend extra time if needed. I'd only recommend if you are interested in the topic though as I dont think this class would really be helpful in a traditional SWE career. If you are looking for an easy class, there are just as easy classes that are helpful.\nI took it because i'm interested in the field and it was great",
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2022',
            review: "It was interesting but very surface level info. The quizzes were extremely easy and the projects were pretty leniently graded. I'm not sure this warrants 3 credits towards a Masters degree unfortunately, it felt like an undergrad elective.",
            rating: 2,
            difficulty: 1,
            workload: 2,
        },
