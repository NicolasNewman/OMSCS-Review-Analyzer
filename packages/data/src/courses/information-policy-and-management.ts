export default {
    ...
    reviews: [
        {
            user: 'CwTaaXrgnDjbnrSWEj842w==',
            reviewDate: 'May 31, 2024',
            semester: 'summer 2023',
            review: "This course should not be harder but it has been made harder purposely, not sure why. Quizzes are open ended, closed book and proctored and need to answer in 50 or less words. On top of these, TAs deducts points left and right commenting that it's not correct and it should be from the slides no. X.\nThere are some discussions and for that you have to read and write a lot. Reading and writing is good but quizzes are made tough and especially grading. TAs take their own time to respond to questions. There was no review after 2021, it may be because it needs your GT ID. I thought of reviewing it so that at least teaching members get the correct feedback and work on improving this couse.",
            rating: 2,
            difficulty: 5,
            workload: 7,
        },
        {
            ...
            review: 'nice class, interesting homeworks. Easy to get an A. People that complain it was boring - idk what they expect from an university course, academia has a specific mindset, probably they got a bad grade and complain',
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
