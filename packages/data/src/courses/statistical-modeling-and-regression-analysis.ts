export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course provides great content on regression, with a well-organized lecture structure and ample code examples that help students understand the material and implement models effectively.',
            con: "The exams are poorly designed, often perceived as trick questions, and do not reflect students' actual knowledge. Many students found issues with the coding exam and expressed disappointment with the grading system.",
        },
        'spring 2024': {
            pro: 'Covers the basics of regression analysis.',
            con: 'Assignments and exams rely too much on English comprehension and do not adequately assess understanding of regression analysis; grading lacks transparency and there are issues with the exam format and content.',
        },
        'fall 2023': {
            pro: "Many students found the course clear and effective, particularly praising Dr. Serban's approach to difficult material. The structure of the assignments and flexibility with quizzes were helpful for some learners.",
            con: 'Some criticized the testing methods as outdated and not conducive to real learning, emphasizing that the quizzes relied too heavily on rote memory.',
        },
        'spring 2023': {
            pro: 'Covers important topics for Regression and has a simple difficulty level if supplemental materials are used.',
            con: 'Poor course material and lectures, emphasis on memorization of obscure information, misleading exam questions, and lack of effective teaching support.',
        },
        'fall 2022': {
            pro: "Some students found the course's structured layout helpful for learning and appreciated the coding sections. They highlighted Dr. Serban's clear teaching style and the usefulness of lecture materials for understanding regression analysis.",
            con: 'Many reviews criticized the course for numerous mistakes in video lectures, unclear exam questions, and an inadequate representation of important analytics topics. The exams were described as disconnected from the course content, often relying on tricky wording and testing minor details rather than overarching concepts.',
        },
        'summer 2022': {
            pro: 'The class is valuable for understanding regression analysis, with homework that reinforces lectures and fair exams.',
            con: 'Lectures are delivered too quickly and lack engagement, with poor sound quality in videos and unhelpful TA responses.',
        },
        'spring 2022': {
            pro: 'The course has a good pacing, fair exam questions, and a manageable coding section, along with knowledgeable TAs. Many students felt the content was familiar and that they could achieve high grades with reasonable effort.',
            con: 'Several reviews criticized the poor quality of lecture videos, the wording of multiple-choice questions, and the length of coding sections. Many found the exams poorly written and not a true reflection of their understanding of the material.',
        },
        'fall 2021': {
            pro: 'Some students found the course content relevant to regression topics and appreciated the coding assignments, highlighting its usefulness for those interested in corporate data science.',
            con: 'Many reviews criticized the lecture materials for being poorly structured, difficult to follow, and filled with trick questions on exams, making it hard for students to learn effectively.',
        },
        'spring 2021': {
            pro: 'The course material is interesting and offers hands-on practice with real-world applications. The coding homeworks are helpful for learning, and the TAs are responsive and knowledgeable. Many students felt they learned a lot despite some flaws.',
            con: "Lectures are tedious and often lack clarity, with poor PowerPoint slides that contain errors. There is little interaction from the professor, and the exams may not effectively assess understanding of core concepts. Some students found the course too easy at times and criticized the questions' alignment with the material covered.",
        },
        'summer 2021': {
            pro: 'The course content is well designed with real-world examples, and it offers a reasonable workload, allowing for learning in practical applications of regression analysis. Students appreciated the helpful TAs and the structured assignments.',
            con: 'Lectures are monotonous with poor sound quality, and the presentation style can be mentally exhausting. Some students found the multiple-choice questions tricky, and the course may not be suitable for those without prior statistics experience.',
        },
        'summer 2020': {
            pro: 'The course is well-structured with responsive TAs and good assignments that facilitate learning regression concepts. Students appreciated the clear organization of resources and support from instructors.',
            con: 'Lecture quality is poor, with many reviewers noting that the professor reads from a script and lacks engaging presentation skills. Exams can be tricky and account for a large percentage of the final grade.',
        },
        'fall 2020': {
            pro: 'The course offers in-depth knowledge of regression concepts with hands-on R experience, useful lectures, and helpful TAs. It has been described as a must-take for aspiring data scientists.',
            con: 'The audio quality of some lectures is poor, and the exam structure has been criticized for unclear question phrasing and excessive weight on exams relative to homework.',
        },
        'spring 2020': {
            pro: 'The course offers a strong focus on regression analysis with practical examples and useful skills. TAs were generally helpful and the course content enhanced understanding of key concepts.',
            con: 'The course suffers from poor lecture quality, unstructured office hours, tricky exam questions, errors in course materials, and confusing communications. Some students found the syllabus and exam content misleading.',
        },
        'fall 2017': {
            pro: 'Students gained a solid understanding of regression analysis and model evaluation, leaving the course with valuable knowledge despite initial challenges.',
            con: 'The course faced logistical issues and bugs during its first online offering, with confusing exam and homework wording, as well as video presentation style needing improvement.',
        },
        'fall 2019': {
            pro: 'Course content is important for data scientists; good balance between math, stats, and applications; easy to score an A; exceptional TA.',
            con: 'Lectures and materials contain numerous mistakes; unclear homework and exam questions; not enjoyable; considered a waste of time for serious learners.',
        },
        'summer 2019': {
            pro: 'Students appreciated the TAs for being helpful and responsive, found the course material relevant, and enjoyed the schedule that allowed for a balanced workload. Some also found the lecture transcripts clear and useful for reference.',
            con: 'Many students criticized the quality of the lecture videos, the use of True/False and multiple-choice questions that were seen as misleading and not reflective of true understanding, and a lack of clarity in the teaching and assessments.',
        },
        'spring 2019': {
            pro: 'Students found the course challenging but informative. Some appreciated the opportunities for discussion and collaboration, and a few noted significant progress in analytical and coding skills. The structure of the course, combining lectures with hands-on coding in R, was seen as beneficial by certain students.',
            con: 'There were widespread complaints regarding unclear instructions, poorly worded questions, lack of timely responses from TAs, and ineffective lecture delivery. The final exam was particularly criticized for being unreasonably lengthy and confusing, with many students unable to complete it. Repetitive homework and poorly designed assessments also detracted from the learning experience.',
        },
        'fall 2018': {
            pro: 'Material is presented clearly with real-world examples that enhance understanding. Dr. Serban is supportive and provides helpful weekly office hours. The course covers useful topics like regression, and the workload is manageable.',
            con: 'Lectures sometimes lack coherence, and grading can be inconsistent due to peer assessments. The proctored exams are lengthy and poorly managed, leading to a need for breaks. There are numerous typos in lecture materials, and students often find themselves relying on outside resources due to confusing homework and exams.',
        },
        'spring 2018': {
            pro: 'The course offers a solid grounding in regression and practical applications in R, with manageable workload and clear structure, making it suitable for beginners.',
            con: 'The course suffers from poor video editing, unclear communication, ambiguous quiz questions, and multiple typos in assignments, leading to frustration among students.',
        },
        'summer 2018': {
            pro: 'Some students appreciated the detailed teaching of theory and model assumptions, and noted that the course covers useful and varied regression techniques beyond linear regression.',
            con: 'Many students criticized the course for poor organization, errors in the material, unclear homework questions, inadequate support from TAs, and an overly difficult final exam that felt disconnected from course content.',
        },
    },
};
