export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            reviewDate: 'July 21, 2024',
            semester: 'spring 2024',
            review: "Heavy Math, Lot of coding. If you are new to deep learning or AI.\nLearning curve will be high. It works with other courses too. DON'T TRUST SOME RANDOM 5+ year experienced SWE/MLE says its easy class.\nYeah NLP is now worth to take for all specializations because of GPT HYPE. I don't trust cynical people say its just stochastic parrot. If we think about Electric Vehicle last 10 years. People make same repatory(Its not worth to make EV and difficult to commercialize it).\nAssignments, projects, reading papers for final project. It's not easy at ALL. Everything you learn from this course will give you strong benefit.\nKeep in mind always try hard.",
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course is well-developed and avoids outdated content, with an extensive amount of material provided; the initial videos by the professor are highly regarded.',
            con: 'The course material is overly extensive with minimal testing, quizzes are tricky, and the latter half of the video content is considered boring and less useful.',
        },
        'spring 2024': {
            pro: 'The explanation of Professor Riedl in lectures is highly praised, and the course provides strong benefits from the content learned.',
            con: 'Assignments are perceived as too easy, requiring minimal time commitment, leading to a lack of deep knowledge gained; overall course rigor is questioned.',
        },
        'fall 2023': {
            pro: 'The course features strong lectures by Prof. Riedl, particularly in explaining complex NLP concepts, and offers a balanced workload that supports understanding through practical application. The homework assignments are generally manageable, and the exams allow for open resources, aiding the learning process.',
            con: 'Homework assignments and projects are criticized for being too easy and not effectively reinforcing lecture material. Some lectures by guest instructors are of lower quality, and there are issues with TA responsiveness and grading speed, along with confusion related to homework instructions.',
        },
    },
};
