export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course is well-organized, engaging, and features fun and challenging projects. The TAs and professors are helpful and knowledgeable, providing valuable support during office hours and tutorials. Many students found the course enjoyable and a good introduction to the program.',
            con: 'Some students found certain topics, like the last lecture series, challenging or the lectures too surface-level. There is a desire for inclusion of more modern techniques, such as computer vision or deep learning.',
        },
        'fall 2023': {
            pro: 'The course is well-structured with engaging lectures and interesting projects that enhance learning. Many students reported enjoying the content, finding the workload reasonable, and benefiting from supportive TAs. It offers a good mix of practical and theoretical knowledge, and is recommended as an introductory course.',
            con: 'Lectures are seen as outdated, and some students found the project requirements overly challenging, particularly for those less experienced in programming. There are concerns about the adequacy of lecture materials for exam preparation and a perceived lack of depth in content.',
        },
        'summer 2024': {
            pro: 'The course is well-organized and the TAs are responsive, providing helpful tutorial videos. Projects can be completed faster than expected if focused, and exams are deemed fair.',
            con: 'Assignments are challenging and lectures are outdated, with a focus on niche topics that may not be applicable in real-world scenarios. Lack of practical examples and insufficient guidance led to frustration.',
        },
        'spring 2023': {
            pro: 'Some tutorials, particularly by TA Chris, are highly praised for their clarity and helpfulness. The projects are considered fun, and the grading system is described as generous.,',
            con: 'Many students find the lectures inadequate and challenging, with a lack of support from TAs. Some report significant difficulty with exams and projects, leading to feelings of stress and disappointment.',
        },
        'summer 2023': {
            pro: 'The course provides a good overview of state estimation and control algorithms, with excellent projects and positive feedback on project structure and clarity. Grading is prompt and the exams test intuition effectively. Various projects allow flexibility in scheduling, and graphical testing environments enhance engagement.',
            con: 'Some negative aspects include a perceived lack of depth in the theoretical lectures and the time-consuming nature of handling edge cases in projects. Additionally, the integration of real hardware for extra credit was challenging, and students might find the probability concepts difficult without prior background.',
        },
        'summer 2022': {
            pro: 'The course has interesting content and is suitable for students with a strong math background.',
            con: 'It is very time-consuming and requires significant commitment, especially for those struggling with math and signal processing.',
        },
        'fall 2022': {
            pro: 'The course is well-structured with helpful TAs, and many students appreciate the engaging content and thorough project design. Tutorials, especially by Chris, are highlighted as beneficial, and there is an overall sense of community in the Ed Discussion forums.',
            con: 'Some students find the lecture material outdated and lacking mathematical rigor. Tuning during projects can be tedious and time-consuming, and there are concerns about the clarity and updates of assignments over time.',
        },
        'spring 2022': {
            pro: 'The course is considered a good starter for robotics, features interesting projects with visualizations, and has responsive teaching staff, especially helpful lecture videos by Dr. Thrun and TAs.',
            con: 'The course requires substantial time for parameter tuning, lacks adequate foundational concepts in robotics, and can be overwhelming for those without a strong math or AI background.',
        },
        'fall 2021': {
            pro: 'Students generally found the instruction team to be helpful and responsive, and appreciated the structure of the course with the ability to work ahead. Many enjoyed the practical projects and the course content, even if some noted it was outdated.',
            con: 'There were widespread concerns about the quality of the teaching staff, particularly the professor and TAs, with complaints about inadequate support and outdated materials. The projects were seen as time-consuming, and some felt the grading and expectations were unbalanced, leading to frustration.',
        },
        'summer 2021': {
            pro: 'Overall, the course is well-organized with engaging projects, good support from TAs, and suitable for students with a coding background. Many found the projects interesting and enjoyed the challenge they provided.',
            con: 'Some students criticized outdated lecture content, lack of comprehensive coverage in lectures, and emphasized the heavy reliance on self-study. Others felt the course was challenging and frustrating, especially for those without a strong background in linear algebra and statistics.',
        },
        'spring 2021': {
            pro: 'The course is well-structured, with helpful TAs and professors, easy-to-follow lectures, and engaging projects that promote understanding. Many students found the projects fun and enjoyed the supportive environment.',
            con: 'The course lacks depth in lecture content and some students found the projects difficult to start due to insufficient instructions. The overall course content might feel superficial and not sufficiently challenging for technical students.',
        },
        'fall 2020': {
            pro: 'The course is well-structured, interesting, with supportive TAs and instructors. Many found it a good introduction to robotics and enjoyable with fun projects. Students can achieve good grades with reasonable effort and advance planning.',
            con: 'Lecture content is often superficial and lacks depth, making it hard for some to grasp the underlying concepts. Projects may feel disconnected from the lectures, and some found the course too easy or lacking in challenge.',
        },
        'summer 2020': {
            pro: "The course features well-designed projects that are engaging and reflective of real-world problem-solving, along with helpful TAs and instructors involved in support. The grading is project-based with unlimited submissions, allowing for iterative improvement. It's a manageable course, especially suitable for summer, with a structure that allows students to work ahead.",
            con: 'The lecture content is often seen as superficial and lacks depth, focusing more on implementation than theory. Multiple reviews highlight that the course may be too easy for those with a programming background, with some projects involving frustrating parameter tuning that is inadequately guided. Overall, there is a perception of a shallow educational experience due to a lack of thorough theoretical coverage.',
        },
        'spring 2020': {
            pro: 'The course offers interesting and applicable concepts, enjoyable projects that align well with lecture content, responsive and helpful teaching staff, and a manageable workload. Students appreciated the straightforward structure and the opportunity to work ahead.',
            con: 'The course has a significant emphasis on parameter tuning, with some students finding it tedious and stressful. Critiques also include the superficial depth of lectures and the lack of rigorous content in projects, which some felt could be improved for a deeper understanding.',
        },
        'fall 2019': {
            pro: 'The course covers engaging and interesting topics, is well-structured, and features highly responsive instructors and TAs. Projects are considered challenging but rewarding, and the opportunity to work ahead is appreciated. The project-based format with autograders is also highlighted positively, allowing for multiple submissions.',
            con: "The projects can be very time-consuming, requiring significant parameter tuning, and there's feedback about the use of Python 2.7 as outdated. Some students found the video lectures lacking in depth and detail, and a few projects were considered frustratingly difficult, affecting grading.",
        },
        'fall 2017': {
            pro: 'Lectures provide a high-level understanding of material and are well-structured; projects are practical and offer good learning opportunities, with responsive instructors and TAs.',
            con: "Projects are time-consuming and challenging, often requiring significant additional self-study; there's a perceived gap between lecture content and project requirements.",
        },
        'fall 2018': {
            pro: "The course is well-structured, with helpful TAs, engaging lectures by Dr. Thrun, timely project releases, and practical learning through intensive projects. It's a great introductory course for robotics programming.",
            con: 'Some found the workload inconsistent with periods of heavy project demands, and the depth of mathematical concepts was perceived as lacking. There were complaints about unclear project requirements and dry lecture delivery.',
        },
        'summer 2018': {
            pro: 'The course is well-structured, offers engaging projects, and the instructors and TAs are highly responsive and helpful. Many found the content interesting and suitable for those with a background in AI and algorithms.',
            con: 'The course leans heavily on coding with minimal theoretical emphasis, and parameter tuning can be challenging. Some found the material easy to overlook, especially during summer sessions when key projects were omitted.',
        },
        'summer 2019': {
            pro: 'The course features engaging lectures, relevant projects that enhance understanding of concepts like Kalman Filters and Particle Filters, and has an active and responsive instructor. The structure allows for front-loading and offers automated grading via Bonnie submissions, which helps students gauge their progress.',
            con: 'Several projects are seen as overly challenging, with time-intensive parameter tuning and some gaps between lecture content and project requirements. The workload remains heavy for summer sessions, and there are issues with project design that can lead to frustration.',
        },
        'spring 2019': {
            pro: "The course is well-organized with engaging projects that enhance learning, and it's considered a good option for beginners with some Python experience. Supportive instructor and TAs, helpful Piazza discussions, and manageable when planned ahead.",
            con: 'Lectures are sometimes perceived as too simplistic and decoupled from projects, resulting in confusion. Technical issues persist, projects can be time-consuming, and the course lacks effective feedback. Some topics are rushed, and the course is viewed by some as not truly representative of AI.',
        },
        'spring 2018': {
            pro: 'The course offers a broad coverage of robotics algorithms and projects that are relevant to real-world scenarios. Many students appreciated the engaging lectures and supportive interactions among classmates on Piazza. The instructor and TAs were praised for their responsiveness and helpfulness.',
            con: 'The course is very challenging, particularly the later projects, which demand significant time and effort. Many students reported feeling overwhelmed and stressed, especially with the all-or-nothing grading system and limited guidance for projects. It may not be suitable for those without a strong programming background or those returning to education after a long break.',
        },
        'summer 2016': {
            pro: 'Some students found the lectures engaging and informative, and appreciated the helpfulness of the TAs. There was also a sense of excitement about the projects, with mentions of fun assignments like the runaway robot.',
            con: 'Criticism centered around poor instructional quality, lack of clear project alignment with lectures, and inadequate mathematical preparation. Frustration was expressed over errata in materials and grading policies that seemed overly harsh. Many felt the course was deceptive in difficulty and not suitable for students lacking a strong math background.',
        },
        'spring 2017': {
            pro: 'The course provides an interesting look into robotics with engaging lectures and helpful TAs. Many students found the videos enjoyable and appreciated the hands-on programming. Some projects were well-received, and the optional second project was considered fun by a few.',
            con: 'Many students reported that the course lacks depth, with lectures only touching the surface of the material. Assignments were hard and required a strong understanding of the content. There were issues with project consistency and the involvement of instructors and TAs was deemed insufficient.',
        },
        'fall 2015': {
            pro: 'The course has engaging instructors and TAs, covers important concepts in Robotics, and features interesting assignments that promote practical application of learned material.',
            con: 'Students felt the course could benefit from improved interaction among classmates and found the material somewhat short, with slower-paced lectures.',
        },
        'summer 2017': {
            pro: 'Interesting lectures with a great instructor, Dr. Thrun, and helpful TAs. Generous grading curve and numerous extra credit opportunities.',
            con: 'Projects are disconnected from lectures and significantly more challenging, requiring extensive unguided research. Increased workload over the semester, especially with the later projects, leading to stress and time management issues.',
        },
        'fall 2016': {
            pro: 'The two projects are appreciated and engaging, providing a chance for hands-on learning.',
            con: 'Lectures lack depth, insufficient instructor engagement, and a disconnect between lectures and projects; overall lack of leadership in course management.',
        },
        'spring 2015': {
            pro: 'Engaging course with fun group assignments; provides insight into self-driving cars and excellent instruction from an expert.',
            con: "Course may feel mechanical due to strict adherence to Udacity's structure.",
        },
        'summer 2014': {
            pro: 'Great introduction to OMSCS, excellent lectures, interesting projects that effectively applied concepts.',
            con: 'N/A',
        },
        'spring 2016': {
            pro: 'The course is engaging, allows for working at your own pace, and has excellent TAs who provide helpful support and materials. Lectures are described as easy to follow, and the structure of the course is manageable for students balancing other commitments.',
            con: "Professor Thrun is noted to be less involved with the course, which some students felt led to a disconnect. The final projects are reported as being more challenging than the earlier coursework, and coordinating group projects can be difficult due to students' varied schedules.",
        },
    },
};
