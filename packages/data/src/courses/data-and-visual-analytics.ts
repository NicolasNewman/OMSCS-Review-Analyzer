export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course covers important data science topics like data collection, cleaning, integration, SQL, and scalable computing. Students can achieve good grades with lenient project grading and unlimited assignment submissions.',
            con: 'Lectures are unhelpful and unrelated to assignments, and the reliance on group projects can lead to varied experiences based on group quality. Some assignments are deemed irrelevant and the grading can be inconsistent.',
        },
        'spring 2023': {
            pro: 'The course allows for collaborative group projects which many students found beneficial, and grading on these projects is viewed as lenient. Additionally, some students appreciated the exposure to various technologies, if not their implementation, and found value in working with classmates.',
            con: "The course suffers from a lack of depth in the curriculum, with assignments perceived as superficial and disconnected from lecture content. Many students experienced frustration with homework errors, a high workload, and insufficient support from TAs. There's a significant focus on D3 and cloud computing tools that some felt was redundant or poorly executed.",
        },
        'fall 2023': {
            pro: 'The course teaches a variety of valuable data science skills including D3, SQL, Python, and tools like AWS and Docker. Many students found it possible to achieve a good grade, often an A, while gaining at least some understanding of the material.',
            con: 'The course structure is poorly designed with ineffective lecture videos and unhelpful TAs. Students reported that much of the learning is self-taught and the grading system, particularly with the autograder, was frustrating. The D3 homework assignments were particularly challenging and not well-integrated with the overall learning objectives.',
        },
        'fall 2022': {
            pro: 'Some students found the course to provide valuable skills in self-instruction and adapting to new technologies; many praised group projects for being leniently graded and the availability of extra credit opportunities.',
            con: 'The course is criticized for poor communication from instructors, lack of depth in material, reliance on self-teaching, frustrating homework and grading systems, and overall high workload with minimal instructional support.',
        },
        'spring 2022': {
            pro: 'The course offers a wide breadth of topics related to data visualization and machine learning, providing exposure to industry-standard tools like D3, Tableau, and Python. Many students found the homework assignments to be well-designed and appreciated the auto-grader that allows multiple attempts for feedback.',
            con: 'The course suffers from poorly structured videos, irrelevant lectures, and confusion regarding assignment instructions. Many students felt that teaching was inadequate, with little guidance provided, leading to a frustrating self-taught experience. The workload can be overwhelming, particularly for those with limited programming backgrounds.',
        },
        'fall 2021': {
            pro: 'The course helps students acquire a wide variety of data visualization and related skills, particularly useful for job interviews. It provides practical experience through hands-on assignments, and many students reported positive experiences with their group project if they had supportive teammates.',
            con: 'The lectures are often viewed as unhelpful and disconnected from assignments, leading to many students feeling unprepared. The group project can be challenging due to unequal contributions from teammates, and grading is heavily impacted by group dynamics. Many found the instructions verbose and the autograders unreliable.',
        },
        'spring 2021': {
            pro: 'The course provides a breadth of exposure to various tools and platforms, and many students found the homework assignments challenging yet manageable, with a focus on practical skills. Some students appreciated the lectures for providing a good introductory overview of the topics, and TAs were generally helpful.',
            con: 'Many reviewers criticized the course for poor organization, vague and inconsistent grading rubrics, and superficial lectures that do not align with homework requirements. The group project structure was commonly viewed as a source of frustration, with complaints about uncooperative team members and academic-focused deliverables that detracted from practical learning. The D3 assignment and other homework were often described as tedious and time-consuming, leaving students feeling overwhelmed and confused.',
        },
        'summer 2021': {
            pro: 'The course provides a broad exposure to various topics with a supportive project team, and grading is considered generous with no major tests.',
            con: 'The workload is high, especially for HW2, and the course may be repetitive for those already familiar with the concepts.',
        },
        'fall 2020': {
            pro: 'The course offers exposure to a wide range of technologies and promotes hands-on learning, with some students reporting useful skills gained through challenging assignments. Lectures are appreciated by some, and responsive instructors are seen favorably.',
            con: 'The course is criticized for disorganized structure, overly long and complex homework assignments, lack of clarity in instructions, and poor support from teaching assistants. Many students express frustration over the workload, the effectiveness of the group project, and the relevance of the content to their career goals.',
        },
        'spring 2020': {
            pro: 'The course offers a wide exposure to various technologies and tools, with strong TA support and clear assignment rubrics.',
            con: 'Lectures are overly general and high-level, leading to a lack of foundational knowledge for homework, which is time-consuming and often disconnected from the material.',
        },
        'fall 2019': {
            pro: 'The course offers exposure to a wide range of technologies and techniques in data visualization and big data, and many students appreciate the hands-on experience and teamwork aspects.',
            con: 'Students frequently cite unclear instructions, high workload, lack of useful feedback, unengaged TAs, and a chaotic structure as significant downsides to the course.',
        },
        'spring 2019': {
            pro: 'The course offers a wide breadth of exposure to various technologies and topics in data visualization and analytics, and students find it interesting and engaging. Several reviews mentioned that with diligence, an A is attainable without exams.',
            con: 'The course is often criticized for being poorly structured, overly busy with numerous technologies without depth, and time-consuming homework. The group project can be frustrating and relies heavily on team dynamics, which can lead to unequal contributions and stress.',
        },
        'fall 2017': {
            pro: 'The course serves as a good introduction to R, data visualization, and basic machine learning concepts. Many students found it organized, manageable, and helpful for refreshing knowledge in statistics and programming.',
            con: 'The course has inconsistent grading, lacking comprehensive lectures and support from the professor. It is criticized for being overly focused on R and linear regression, with many students feeling unprepared and frustrated due to the depth required in math and concepts taught.',
        },
        'spring 2017': {
            pro: 'Some students found value in learning R and the data visualization concepts offered, noting that the content could be interesting despite logistical issues. A few mentioned learning practical skills applicable to their jobs and gaining exposure to various data technologies.',
            con: 'Many reviews pointed out significant issues with course organization, communication gaps between instructors and TAs, unclear and contradictory assignment instructions, slow grading, and a lack of professor engagement. Several students reported that these problems led to a frustrating learning experience and a diminished interest in the subject matter.',
        },
        'fall 2018': {
            pro: 'Students appreciated the breadth of topics covered and found the projects, especially the group project, to be fun and challenging. The teaching staff was responsive and engaged, enhancing the learning experience.',
            con: 'Many students criticized the course for its heavy workload and lack of depth in each topic, leading to frustrations with environment setups and unclear assignment instructions. The group project also posed significant challenges, particularly in terms of group dynamics and expectations.',
        },
        'spring 2018': {
            pro: 'The course is a good introduction to R and machine learning, offering valuable assignments, extra credit opportunities, and engaged instructors. Students appreciate the structured schedule and approach to learning foundational concepts.',
            con: 'Many reviews highlight tedious and convoluted homework, poorly designed lectures, inconsistent grading, and challenges with R programming that can be overwhelming for newcomers. Communication from assistants and the professor is sometimes lacking.',
        },
        'summer 2018': {
            pro: 'The course provides a broad exposure to various tools and techniques in data analytics and visualization, giving good insights into modern technologies like D3, SQL, AWS, and more. The assignments can be showcased in a work portfolio and the grading practices are reasonable, making it achievable to earn a good grade.',
            con: 'There are significant challenges associated with the workload, particularly for the group project where unequal contributions can lead to stress. Many found the lectures unhelpful and felt they had to teach themselves much of the course content. Additionally, some reviews point out that the course does not provide in-depth competency in the skills taught.',
        },
        'fall 2016': {
            pro: 'The course serves as a solid introduction to R, data visualization, and basic machine learning concepts, with engaging lectures and helpful TAs. Many students appreciated the practical approach and found the assignments fun and relevant to real-world applications.',
            con: 'There are significant complaints regarding disorganization, grading ambiguity, and a lack of meaningful feedback on assignments and exams. The final exam was particularly criticized for being poorly prepared for, and some students felt the course content was too light or simplistic.',
        },
        'Unknown Semester': {
            pro: 'N/A',
            con: 'Lectures are high level and not aligned with homework requirements; course content needs refreshing.',
        },
    },
};
