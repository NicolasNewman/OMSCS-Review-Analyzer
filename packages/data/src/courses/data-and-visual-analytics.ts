export default {
    ...
    syllabus: { url: 'https://poloclub.github.io/cse6242-2022fall-online/' },
    reviewCount: 291,
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'fall 2023',
            review: "Context for me, I had 0 background in programs outside Python/R/SQL, I double majored in economics/stats for undergrad and work in banking as a DS. This course is definitely a tough one to grade.  On the one hand you will in fact come out learning a lot but all of it will be self taught. The lectures aren't useful at all. You have 4 homeworks and each one gets three weeks to be finished. This is definitely a fair amount of time, 10 hrs a week will get you to finish them by the time it's due. I HIGHLY recommend you start early on these HWs, as in the weekend they come out do at least 2 questions (the one worth the most and an easy one). Then the next weekend another 2 (the next biggest question and next easiest), and then finish with the final question (i think there was always only 5 questions.) You will see Python classes/functions here, you will see a lot of SQL (lite) here too and some are very tricky queries, you will see Pyspark, Tableau, and intros to amazon AWS and docker (which are musts in the data science world). But I'd say the main component of the course (maybe 40%) is D3, and that is awful, those questions will make you want to cry, 2 pages of code for a bar plot. 10 pages for an interactive visualization. That's undoubtedly the toughest part of the homeworks. I would recommend you pick you groups ASAP and before even thinking about the project agree you'll use it to help each other out in the hw (NOT AS IN PLAGARISM) but as in \"hey for some reason this query works locally but in gradescope i get an error, what could it be?\" or \"any good resources for this D3 part\" or \"How can I make my graphs dots change color\". Specific things like that, because a lot of the time SMALL parts of your code will be what's not letting you get full credit. Getting a good team is a must, if you feel like the group isn't helpful FIND ANOTHER GROUP. The group project is worth 50% of your grade and is the easiest part of it. Do not screw it up. A good group and good project will guarantee you at least get an 80 even if you struggle in the hws (60s/70s). I ended up getting an A in this course (actually 89.90) but it was rounded up and I bombed (40% F) one of the homework assignments (tried to do the docker/aws HW3 in one weekend, DON'T do this.)  Thanks to my groups predisposition to help each other out, we did really well on the other HWs and got an A in our final report. I'd recommend taking this course AFTER Computing for Data Analytics and also Computational Data Analysis. I took all three fall 2023 and the dataviz+CDA combo whilst working full time nearly killed me, I was very stressed out. Don't do this, but you can deff pair this with an easier course (MGT or other mandatory intro courses) whilst working (probably even two if you really want to speed rush).",
            rating: 3,
            difficulty: 4,
            workload: 10,
        },
        {
            user: 'T2SR36LfLvG1Kcbmjyi/mQ==',
            reviewDate: 'December 18, 2023',
            semester: 'fall 2023',
            review: 'This is basically a self-traught class. Videos are only useful for extra points quizzes. Homework assingments are time consuming, but possible. The most difficult assigment is about D3, but even if you fail in D3 you can compensate with other assingments, group project and extra points. Easy to get an A, but I am not sure I learned anything.',
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        {
            user: 'kSkTikeZr8ta5+QDiyWemA==',
            reviewDate: 'December 16, 2023',
            semester: 'fall 2023',
            review: "Overall: Lots of work, but easy to get an A. Teaches a lot of skills at a surface level, with a bit more in-depth learning when it comes to D3.\nI'm an OMSCS student and was taking this course as an elective. The first two homework assignments took a lot of work and were a bit overwhelming; however, by the end of the second assignment I felt like I had a good grasp of D3. I really liked the autograder (though it was less helpful in the last assignment and a half - seems like they haven't developed as good of tests for those yet). The TA's were not very helpful in terms of answering questions, but other students were a good resource on edstem. The project is not too bad as long as you carefully follow the rubric.",
            rating: 4,
            difficulty: 3,
            workload: 16,
        },
        {
            user: 'LDbip5YQpIKx4O4AxpYDQQ==',
            reviewDate: 'December 7, 2023',
            semester: 'fall 2023',
            review: "I think this was probably the most disappointing course in the program for me, and it is really unfortunate that it is part of the OMSA core curriculum. Many of the reviews here comment on how finicky the autograder is, how the TAs aren't much help (not that they could be, given the impossible chat-only interface), how the class suffers from being ocean-wide and puddle-deep. And I agree with all.\nWhat was the point of the class though? What was I supposed to walk away from it with? Visualization skill? I have a very vague recollection of watching videos early in the class telling me never to use a pie chart, and warning me that less ink is better. I didn't gain anything from the d3 part of the class - I never really got fundamentals of javascript settled so that entire 1.5 HW set was a disaster. Was it working with large data sets? I used Docker once I guess, and Google Cloud Computing. I'm not putting either on a resume, and I wouldn't dare tell anyone I knew how to use either.\nPresumably if you come from OMSCS this class is easier, as maybe you're not expected to pick js up on the fly? But it was awful for me. There have been more difficult courses in the program, but at least I had a sense of what I was working toward. Not so with this course, at all.",
            rating: 1,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 'BYQagZxAOHYd/VFZGx43rw==',
            reviewDate: 'November 27, 2023',
            semester: 'fall 2023',
            review: "This class could be great, and really should be based on what it attempts to cover, which it is why it's so frustrating that this experience was so negative for me.  Keeping this short, the coding work ends up being student versus autograder, where a well coded and visually correct submission will potentially net almost no points, but a submission that cherry picks what the autograder wants and is unintelligible to humans can get full points.  This ultimately wasn't that difficult, but felt incompatible with the course goals of creating useful visualizations.\nThe project is also a black hole of time, I know one of the points of requiring group work is to simulate real world conditions, but for many of us, we already do 'group work' every single day, so adding that inhibiting factor of project management versus a solo project means most of the time goes into managing the work and the people, less into the project output or learning.  I'm sure this is team and person specific, but the project portion of other classes has been where I learned the most and got to apply my skills, whereas here that time is significantly reduced while trying to get alignment on every step of the journey.\nOverall, I'm just disappointed as I wrap up this class.  I'm lucky that I came in with knowledge about a lot of the topics that were covered, but unlike other courses, I can't say I've learned a single thing that I can apply to my job or life outside this class.",
            rating: 1,
            difficulty: 2,
            workload: 15,
        },
        {
            user: 'ADkEleB5VSTaLtzfiLkcDw==',
            reviewDate: 'November 5, 2023',
            semester: 'fall 2023',
            review: "In principle, the course material is vital and unique from the other required courses. However, the pedagogy in this course devolves into route instruction following with no room for actual learning or creativity.  Th homework corrections are not posted, so if you don't get a question just right, you will never learn.  The group project is more about following the tedious instructions then actually learning or producing something of value.",
            rating: 1,
            difficulty: 3,
            workload: 15,
        },
        {
            user: 'KXhotTHTc+BPxgmGoir9Eg==',
            reviewDate: 'June 5, 2023',
            semester: 'spring 2023',
            review: "The course is fine, however, TA is as good as invisible. There was a WhatsApp group created for us to share our pains. There's no use following the lectures as the assignments won't test what the assignment tests. Don't need to worry about D3 homework, get a good group, the group project will pull your grades up. Easy A if you got committed groupmates.",
            rating: 2,
            difficulty: 3,
            workload: 10,
        },
        {
            user: 'ehSSWA6SdcUxRsccLq1nlg==',
            reviewDate: 'May 15, 2023',
            semester: 'spring 2023',
            review: 'This course was disappointing for several reasons:\n\nThe benefits marketed by the professors at the beginning of the term were not delivered. (Ex: "You can list AWS on your resume" yet the assignment only required the student to make an account and write ~20 lines of code to filter a dataset. Hardly resume-worthy experience.)\nThe visualization portion of the course focused on D3 as opposed to any other visualization tool that is used by more than a handful of people. Technically there was some exposure to Tableau, but it was incredibly surface level and limited to part 1 of 6 on a single assignment.\nVideo lectures were not relevant to assignments. The instructors/TAs outsourced instruction by posting links to external sources and YouTube videos.\nEach homework had multiple errors that had to be resolved by TAs prior to being able to attempt the homework. There was no incentive to start a homework early due to the litany of errors with each assignment. Having 3 weeks for a homework sounds nice, but they didn\'t function correctly for the first week for any of the assignments.\nThe challenges associated with homework assignments largely focused on configuring different software packages or new tools as opposed to the actual problems.\n\nIf you enjoy group work, then having nearly 50% of your grade dedicated towards the project grade is a silver lining. If you don\'t like managing schedules with 4 other people across multiple time zones while also managing a full-time job, then consider the massive group project as reason #6 for this course being disappointing.',
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            semester: 'spring 2023',
            review: "I work as a data analytics professional and I was excited to take this course to deepen my understanding of popular tools such as AWS and Databricks. I got an A, but it was one of the most challenging classes I've ever taken. As others have mentioned, the curriculum covers a broad range of topics, but lacks depth -- which caused me to feel constantly overwhelmed. The homework assignments are tedious and students are expected to self-educate using public resources. Students found errors in the homework and the instructions were prone to change, so you have to stay on top of discussions in the ED forum. The lectures are short video clips (around 2-3 minutes long) that introduce each topic, but don't go into enough detail. A significant portion of my time was spent just configuring and troubleshooting my environment so that it would work with Gradescope. TA's were slow to respond or didn't respond at all. I think this is understandable for a class this size, but many students didn't feel supported by staff as a result. On a positive note, I got a lot out of working with classmates in student-led study groups. I also got a really great team for the group project and grading on the group project is very lenient. To be successful in this class, my advice is to start the homework assignments as soon as they become available. Don't wait until the last minute (or even the last week) before they're due.",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            semester: 'spring 2023',
            review: "I think this course suffers from the breadth of technology used in homework assignments. Each homework (4 in total) contains 4-6 questions, many of which will require a different platform or technology or library to be used to complete the problem. As a result, much of my time was spent figuring out how to start up and learn the (very) basics of these tools and very little time was spent actually solving the problem. I am left with scattered knowledge about the tech stack used and am disappointed that none of what I learned is enough to put on a resume (except for d3.js, but only if you also use it in the project).\nThe project is fine. I enjoyed how much freedom we were given because it allowed our group to do something really cool and novel. However, the assignments for the project are very rigid and it is hard to adapt a non-trivial project idea to the requirements of the deliverables. Project deadlines and homework deadlines sometimes intersect in a very stressful way.\nTAs are great and are active in the discussions on Ed.\nI would give this class a much higher rating if they concentrated the homework and gave students more focused assignments. I really feel like I'm walking away from the course having learned only what I needed to for the project.\nAdvice for those taking the course in the future: set a 15 hour limit to how long you will spend on a homework assignment and do not work on it after reaching that point. It's not worth it (in either grade points or knowledge gained) to work longer than than that, and your time is better spent on doing project work.",
            rating: 2,
            difficulty: 3,
            workload: 8,
        },
        {
            ...
            reviewDate: 'May 9, 2023',
            semester: 'spring 2023',
            review: "4th course in the program after AI4R, CN and ML4T and easily the most disappointing. For background I have a masters in MechE and used to do plotting and charting as my day job (using ancient proprietary aerospace tools). I was hoping to use some modern libraries like Plotly or at least get some cool graduate level info on making good charts.\nThe idea of getting to use stuff like AWS/GC and create some really cool visuals was appealing. However the execution in this course leaves so much to be desired.\nOn the cloud computing side it's essentially a bunch of redundant hellow world style assignments. We end up doing stuff across DataBricks, AWS, GC, and Azure. GC and AWS have so many features that are replciated by those other ones it ends up being super redundant. Would be better if they just picked two like Databrick and AWS or GC, espcially since AWS and GC are very similar.\nThere is python programming in this course but is extremely surface level. SciKit is an increible libray but the usage of it ends up being plug in chug. No plots, barely caring about the data results.\nThe D3 focus worked out for me because it kicked my butt into learning some JS but it seems like the goal during that segment of the class was to learn how to make good visuals. Changing the D3 assignment to a peer graded assignment using something like plotly (or a short list of recommneded libraries) would be a much better approach. It doesn't create any teaching burden because the lesson we were given for D3 were about 15min and a book that was two versions of D3 old and not up to date enough.\nI was really hoping this course would be a BD4H lite with more emphasis on visuals. The course fails on all learning outcomes I feel and should be skipped.",
            rating: 2,
            difficulty: 2,
            workload: 12,
        },
        {
            user: 'JIoe4fLGqsdVnzkj718opQ==',
            reviewDate: 'April 29, 2023',
            semester: 'spring 2023',
            review: "Students with Python only programming skills should be aware of this, the class is not using python only. Some of the assignments requires HTML, Javascript. For me it wasn't easy, maybe the python and other parts were fine, but not the javacript part.\nThe project was fun, we did a machine learning model which is pretty straight forward if you are familiar with Machine learning. The grades for the project is almost 1/2 of the total grades. So, make sure that you choose a good team and start work early on.\nThe overall experience was intense, it was taking me close to 50 hours to finish each assignment. You have 3 weeks to finish each assignment, be careful with the time and try to submit your assignment early as in many cases you would go back and fix the work. I would suggest that you submit each part o the assignment as you finish it, don't wait for the last moment to submit the whole assignment. I've been there and it's not fun.",
            rating: 3,
            difficulty: 4,
            workload: 15,
        },
        {
            user: '0Hin/zys0zVozdHVQOG6nA==',
            reviewDate: 'April 28, 2023',
            semester: 'spring 2023',
            review: 'Most of what was new for this course was new for a negative reason. And most else was covered in other courses. Had a similar idea to others that a capstone or iterative-nature to the HW focused around cloud computing + analytics would be the best direction at this point. Negatives; random HW, unrelated lectures (only need to watch for credit on bonus quizzes), project members dropping, projects all used prior knowledge and methods, Gradescope frustrations, only extremely guided visualizations in HWs, project+HW workload near end of semester, etc. Positives; Ed Discussion + TAs, plenty of EC + easy project grading (maybe survivorship bias, had a good team). Overall hope GT revises the course or the requirement.',
            rating: 2,
            difficulty: 4,
            workload: 15,
        },
        {
            user: 'lim//z2KeBxvHnMOOjZhlA==',
            reviewDate: 'April 16, 2023',
            semester: 'fall 2022',
            review: "BLUF: Awful class with a lot of lost potential\nBackground: This was my 6th class in the OMSA program and I came into it with high expectations--visualization is one of the most critical parts of analytics because it is essential to communicating findings effectively to stakeholders. Bad communication of findings results in uninformed decisonmaking, regardless of how good your analysis was.\nReview: Honestly, this is one of the worst classes in the OMSA program, a fact that is particularly egregious considering it is one of four classes that every student in the program must take. I came into this really excited to learn about visualization and thinking that it couldn't possibly be as bad as the reviews on here said, and walked away feeling that it was substantially worse. The course is a mile wide and an inch deep. Moreover, two core elements of the class demonstrate just how little this class is focused on actually teaching you anything: First, the instructors refuse to release any guidance, feedback, or corrections on homework assignments. Thus, if you don't manage to figure out some part of an assignment on your own (which I guarantee will be the case for SOME element of EVERY homework), too bad, guess you just don't get to learn how to do that from this class. Second, the final project accounts for 50% of the grade, but because you don't learn anything in the homeworks and lectures, you end up building it using techniques and tools that are not taught in the class at all, but that you came into the class already knowing. I got a B in the course despite bombing all of the homeworks except the first one (particularly #2 on D3) and creating a half-assed final project with my teammates that did not use any of the techniques we had been \"taught\" in the course.\nOther reviewers have mentioned that an important part of working in data analytics is the ability to pick up new skills, languages, and techniques on the fly, and that this requires a facility with self-instruction. These reviewers thus praise this class for helping reinforce this ability. While this observation is undoubtedly true, it completely ignores the fact that we are in this program, paying Georgia Tech to teach us new skills. If we wanted to be fully self-instructed, I would just work on my own projects and watch YouTube videos to learn new techniques.",
            rating: 1,
            difficulty: 4,
            workload: 16,
        },
        {
            user: 'd+H3taIYkAiAx+uvxQzEpw==',
            reviewDate: 'January 10, 2023',
            semester: 'fall 2022',
            review: 'Thought this was one of the easier courses. Was my seventh course in OMSCS. I took D&A to get some exposure across various areas like Azure cloud, tableau, spark, etc. Also, wanted to see if I could learn more on visualizations. I am proficient in Python, so most of the work was easy technically. Had to invest some extra time to learn Javascript and D3. The assignments were as well documented and fair as I have seen in any course. The main D3 project/assignment allowed flexibility to skip some parts and still get full credit. So, that alleviated some tedious work.',
            rating: 4,
            difficulty: 2,
            workload: 15,
        },
        {
            ...
            reviewDate: 'December 27, 2022',
            semester: 'fall 2022',
            review: "This class goes for breadth and not depth, as others have noted. The assignments can be time consuming, but they aren't particularly difficult. Assignments are autograded and you are given plenty of time to work on them (but start early). Very little interaction with the instructional team needed. I found the course to be enjoyable, since I enjoyed working with others in the OMSA program and had a good group. The workload actually decreased once we got to the group project phase of the course.\nI have a full youtube review/overview of the course that gives a lot more details about the course here!",
            rating: 4,
            difficulty: 2,
            workload: 12,
        },
        {
            user: 'DOAv5F/u/nA1D74lvZILuQ==',
            reviewDate: 'December 19, 2022',
            semester: 'fall 2022',
            review: "Below are 2 truths and 1 lie that I learned:\n2 Truths:\n\nheavy workload, with hw2 being the most intense and heavily focused on d3 (I personally had never heard of d3 prior to this class and will probably never use it again). I spent an average of 20-30 hrs per hw and 50 hrs on hw2 alone.\nProject is graded very generously and is worth 50%, Pick a good group of responsible teammates. I had a B average on hws, but got a 99 on the final and ended up with an A in the class.\n\n1 lie:\n\nlectures are helpful (not). Biggest takeaway and skill to learn coming out of this class is the ability to self-teach a new syntax quickly. I would suggest getting really good at using stack exchange, reading articles on algorithms, and youtubing.\n\nOverall, this class was more breadth and less depth. I wish I had more time to get to know each topic a little more instead of scrambling to learn 3 new languages per hw. Grading was also a lot more lenient than I expected and there are plenty of bonus points given. Don't procrastinate and pick a good project group and you should be fine.",
            rating: 2,
            difficulty: 4,
            workload: 20,
        },
        {
            ...
            semester: 'fall 2022',
            review: "Reviews regarding that a lot of the material learned is surface level are correct. HOWEVER, if you're an aspiring data analyst/scientist, being able to learn new technologies on the fly is an essential skill. I found that this class helped pad my resume with new skills such as javascript (D3) and cloud services (AWS, GCP).\nMy team was able to score a 100 on all project deliverables although none of us were particularly skilled in any of the tech stack we used. The key to scoring well on the project is \"selling\" it- you don't have to make a production-ready, super-innovative web app or algorithm. Just be able to have a story as to why your solution solves a problem. The graders will be lax if you're able to do this!! The average score for all project deliverables for Fall 2022 was around 95-100.\nThere is AMPLE extra credit available, both on the homeworks and through bonus quizzes, and CIOS bonus (abut 5 course points total). This allowed me to flop on one homework and still come out of the course with a 95. I would recommend stressing less on the homework and instead focusing on the project.\nIt may be intimidating in the beginnign of the course with people flashing their tech skills trying to find competent teammates, but if you want to find a chill group, there are also people looking for that!",
            rating: 4,
            difficulty: 4,
            workload: 10,
        },
        {
            user: 'I4OGdp3ULQ+sLgubm3PK7A==',
            reviewDate: 'December 1, 2022',
            semester: 'fall 2022',
            review: "This course had its highs and lows.  You cover a TON of different material from making web pages to cloud computing, which is both good and bad. Every step of the HW seemed like it involved installing a new program or having to learn another programming language.\nThe lectures are completely useless and have almost no relation to the HWs.  I would say 90% of the time you have to do a bunch of googling to get any help. The final grading is split almost 50/50 between HW and the project (no tests) and you should expect to sped a large amount of time on each of the four HW assignments.  The course doesn't offer any kind of solutions for the HW assignments so if there was a part you didn't understand that's just the way it's going to stay. I took an L on the second HW (got a 60%) and I think i'll still finish pretty close to an A.\nIf they would offer some solutions for the HW, it would greatly improve the experience.  Otherwise, you need to buckle up and prepare to be frustrated for a few month while still getting an A.",
            rating: 2,
            difficulty: 4,
            workload: 15,
        },
        {
            user: 'HiE+m6bs+afjaDOi2/v9Ng==',
            reviewDate: 'November 28, 2022',
            semester: 'fall 2022',
            review: "One of the hardest classes I have ever taken in my life. It has too many things going on at once in the homework. It was hard to keep up with the homework. The grader for the homework is very picky and specific. The project was relatively easy compared to the homework. If this class wasn't required to graduate, I would recommend not to take if coding is not your forte or are not good at heavy coding. The lessons were easy to follow though.",
            rating: 1,
            difficulty: 5,
            workload: 12,
        },
        {
            user: 'Yv3IFti8YIiwepPtO8tHoA==',
            reviewDate: 'November 18, 2022',
            semester: 'fall 2022',
            review: 'Don\'t listen to the other reviews!\nThis is the BEST course I have ever taken.\nLet me comment on some people\'s critic:\n\n\n"Lectures are useless": It is objectively true that there is low coloration between the lecture material and the HW/deliverables, but that is a good thing! To learn D3, you need hands on experience, no lecture is needed. On the other hand, the lectures are full of knowledge and insights, by the end of the semester you will have such a diverse tools you know you can use to analyze data, that it is not feasible to test you on that.\n\n\n"I was unlucky with the group I was assigned to": You are all completely missing the point. As an experienced dev, I guaranty that what makes a good programmer is ABSOLUTELY NOT how efficient he can code, but rather how well he can collaborate with other people. "You go to war with the army you have, not the army you might want or wish to have..." And by the way: even if you got unlucky, the grading is lenient.\n\n\nD3 assignment: This is the hardest part of the course. This was my first experience doing web dev, and it took me a lot of time. I actually agree that D3 is hard to use, but I wouldn\'t say it is completely useless tool, there could be some niche use for that, and it was nice knowing I have this tool and having some JS experience.\n\n\nOverall, this course is great since you learn a TON of tools to analyze data and it is well defined what you need to do to pass the course. I can understand why people give such reviews since the structure of the course is unique, but I loved it.\nDo the HW ahead of time, collaborate well with your team, and enjoy watching the lectures without stressing about an exam.\nHighly recommended.',
            rating: 5,
            difficulty: 3,
            workload: 25,
        },
        {
            ...
            review: "I wasn't psyched about this class going in, and in retrospect there's a lot here that I don't think will be very useful to me. The instructor seemed to focus a bit too heavily on network graphs, which was his field of expertise, but which isn't exactly the only thing in data vis.\nD3 turned about to be a great skill to develop, and the homework assignments were pretty well designed with an autograder and unlimited reattempts. This could be frustrating at times, but ultimately was a great solution to giving feedback in a large class format IMO.",
            rating: 3,
            difficulty: 3,
            workload: 8,
        },
        {
            user: 'rP3LZ2W8NXt015M/F5/1RQ==',
            reviewDate: 'October 31, 2022',
            semester: 'fall 2022',
            review: "I am a little surprised that this course has been way easier than I expected. I am not a coding god. I am intermediate at Python and close to novice at JS. However, +1 to the fellow reviewers, I sincerely do not understand why do they assigned a big portion of the class to D3 at all. If introducing JS into the class was a goal then it could have been much more fruitful to create some kind of dashboard with React.\nGradescope is the worst part of the class. You may find yourself finishing a whole assignment that meets the written requirement flawlessly in 3 hours and spend the next 30 hours figuring out why Gradescope says otherwise. I could imagine lots of people's (TAs, Profs, etc) hard work was put into building auto-grade modules like this but comparing to my previous Gradescope experience (ML4T), this one has been consistently worse. However, they provide some additional opportunities to make up the points and etc, so it kind of evens out I guess. Grading is definitely very generous.\nAs others said, instead of exploring tens of different data platforms, I wish they just picked one topic (preferably cloud data engineering) and structured it as capstone project. Overall it's not a bad class but not at its full potential yet.",
            rating: 4,
            difficulty: 2,
            workload: 20,
        },
        {
            user: 'LUk4i1mtHbNLCiaTm2652A==',
            reviewDate: 'October 30, 2022',
            semester: 'fall 2022',
            review: 'So far, it has been an okay course. Not super difficult, but not super rewarding either. It has been a bit more time consuming, though. I will update this review/post after the semester ends, but here are my thoughts through 60% of the semester:\nhttps://youtu.be/Q2Dkox8ymKA',
            rating: 3,
            difficulty: 3,
            workload: 15,
        },
        {
            user: '3ceFtQ/sKx/2BpQh0peDxg==',
            reviewDate: 'October 29, 2022',
            semester: 'fall 2022',
            review: "This was the last course I had to take before the project. This is by far the worst course in the program, I think.\n\nThere is no Georgia Tech added value here. There is no reason you can't learn the same information in the same period of time from the internet for free.\nHomeworks are just low impact busy work.\nHW2 in D3 is the hardest for most people. The homeworks are otherwise easy, but time consuming. Why they think data scientists need to learn D3 is beyond me. No one in their right mind in industry is going to spend that much effort on a bar chart when they can produce everything in Python or R, or even Tableau or Power BI, especially since many companies get Power BI and/or Tableau bundled with other things. It's an egregious waste of time. High effort, low reward.\nThe information given in lectures isn't even as deep as a decent YouTube tutorial. You can go the whole class and not watch them. You only need to skim them to take the quizzes.\nThe auto-grader can be a pain. But you quickly learn that you actually only need to accumulate points from the auto-grader, and nothing else really matters. So get the points and move on with your life. Figuring out why something doesn't pass the autograder can be frustrating. TAs at least are helpful with that, but not much else.\nTAs aren't very helpful in this course. Not compared to other courses....\nMake sure you have a good project team and an interesting project. There are lots of deliverables for the project. But it's highly doable.\n\nI this were my first course taken in the program, I would have dropped it and went to another. This is like an undergrad course loaded with busy work to justify it as a grad course. You'll learn more from YouTube and save money.",
            rating: 1,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 3, 2022',
            semester: 'spring 2022',
            review: "It's four assignments and one group project. The assignments are time consuming but not difficult. The group project requires staying on top of all the deliverables. There is a lot of work but the work is not hard. The recorded lectures were largely irrelevant but there are bonus quizzes that cover the material on the lectures. The main benefit of this course is that it is very broad and not deep and will pad your resume with skills like D3, Tableau, EMR/AWS, Pandas, and PySpark.",
            rating: 4,
            difficulty: 3,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: "I'm an OMSA student with a strong Python background. Due to my previous programming experience this course was a breeze. I can certainly see why some students have a rough time with this course: if you aren't a strong developer some of the homeworks would require 20+ hour weeks just debugging. There are many complaints about gradescope and homework instructions being a bit of a mess: I actually think it's pretty impressive that the TAs and prof can put together these assignments the way they do and evaluate them at scale. I'm honestly surprised that issues don't come up more frequently.\nTake a D3 tutorial before HW2, don't watch the async videos they're useless, and make sure you have a good group for the group project.",
            rating: 3,
            difficulty: 2,
            workload: 4,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'The class covers A LOT of material but never goes too deep into anything. The HWs are barely related to the lecture material.\nThere are 4 HW assignments of about 5 questions each. HW2 is the hardest\nThere are no Exams\nThere is a big project throughout the entire class with 3 deliverables.\nTo see my full review, check out my youtube channel: https://www.youtube.com/watch?v=XuXsg8H-jy8&t=10s',
            rating: 2,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'A very well planned course that makes sure you have a basic knowledge about data and visualization.\nThe visualization part covers D3 and Tableau while the data part covers Spark.\nKnowledge of JS/Python helps but if you already know D3 and Spark, HWs should be very easy.\nGrading distribution is 50% on individual home works and 50% on group project.\nGood thing about it is there are no exams; and quizzes are for bonus points only.\nBad thing about it is that the grading highly depends upon the group you work with. (Luckily, I had a decent group to work with resulting in A)\nYou along with your group choose what to work on in the group project from scratch.\nThey have taken extra steps to autograde all HWs so that the scores that you see in Gradescope are most likely final, which is great! (their claim is that they are unaware of any other attempt to autograde D3 assignments)\nTAs are very reasonable both while grading HWs as well as group project.\nTAs are assigned to group project based on the domain you choose, for e.g., we choose to work in pharma domain and our TA had a MD in Medicine and was a data scientist in healthcare domain.\nWhen students found some issues with the autograder for one of the HWs, TAs announced that 100% of points will be provided for 80% autograded score (and for 100% autograded score, they awarded bonus points!)\nOverall, I highly recommend this as one of the electives for anyone interested in ML specialization.',
            rating: 5,
            difficulty: 2,
            workload: 14,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 9, 2021',
            semester: 'fall 2021',
            review: "After almost completing this course, I feel like it took me a lot of effort and I didn't actually learn much besides some visualization techniques.\nHomework was not very hard and even that famous HW2 was manageable. I did do JavaScript and D3 introductory courses before I started DVA though.\nOn the other hand, I didn't like the group project. I did A LOT for it, probably 70% of all the work and it was exhausting without getting much learning back, for example, I knew already how to write a report or prepare slides, but this work is a bit boring and doesn't add much value.",
            rating: 2,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: "Just too much work. I don't really see a point in this rat race. Unfortunately the class was mandatory for me (OMSA).",
            rating: 1,
            difficulty: 5,
            workload: 30,
        },
        ...
        },
        {
            ...
            review: "I'm coming from a CS background. A lot of breadth, not a lot of depth, as I was expecting though. Lectures are pretty bad. Good JS practice though, but D3 isn't really used much in industry anymore I feel. Good survey class for data engineering.",
            rating: 3,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 11, 2021',
            semester: 'fall 2020',
            review: 'Seems that others said it all. While I got slightly less than 100%, I still think this is a very bad course.',
            rating: 1,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: "It's not that bad. There are 4 homework assignments and 1 final project (by team). I definitely learned something from those. The lectures are not useful though. The grading is very generous. But I will not recommend taking this one with another tough class.",
            rating: 4,
            difficulty: 3,
            workload: 18,
        },
        {
            ...
            semester: 'fall 2020',
            review: 'Horrible class. All negative feedback for this class is spot on. Please skip this class if you can. If not, then prepare for a rough semester.',
            rating: 1,
            difficulty: 4,
            workload: 25,
        },
        {
            ...
            semester: 'fall 2020',
            review: 'One word; garbage.\nEverything about this course is just pure garbage.\nThe review below this one says it all.',
            rating: 1,
            difficulty: 1,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: 'I liked the professor and lectures were easy to get. The class could do better on reducing the "setup" for homework assignments. The assignments were "instructionous". The group project was annoying. If you\'ll take it with another heavy class you might get screwed.',
            rating: 3,
            difficulty: 5,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: "First, the good.\nThis class did a really nice job of giving a review of a lot of tools out there that are kind of in vogue. Now I can credibly say that I'm comfortable with Hadoop, Spark, Pig, d3. Also, I thought the content of the homework assignments was great. They encouraged a lot of independent research, but not so much that it was unwieldy.\nNext, the bad.\nPersonally, I found the video lectures pretty lacking. They were almost absurdly high-level compared to how in the weeds homework got.\nAlso, I just really hated the group project. My team did well, but it was just so difficult to coordinate in a program like this where students have a lot of different lifestyles and everything was obviously remote. Further, we divided up the work in such a way that each person focused only on one domain. So this may have been a good approximation of the workplace, but I just didn't feel that was necessary. Really, I'd prefer to just have a 5th assignment.\nAlso, the first drafts of the homework assignments were rough. It was commonplace that TAs would post updated versions a week after an assignment opened. Or they would post clarifications in Piazza, but you'd need to sift through hundreds of comments to find that. You would be almost penalized by trying to work on homework early, because they would clear up poor instructions later.",
            rating: 2,
            difficulty: 3,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'I would not recommend this as a first course to students. This course is extremely difficult and takes a great deal of time. Work is unfairly graded. Would only take one course a semester if taking this course.',
            rating: 2,
            difficulty: 4,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: "I like the projects of this class. It can be challenging going through so many different technologies in such a quick pace however the grading seems to be fair as long as you work hard. I don't appreciate the amount of busy work that just adds on top of the actual workload. Instructions of the HWs are confusing and setups as well.",
            rating: 5,
            difficulty: 4,
            workload: 30,
        },
        {
            ...
            review: "Lots of people complained about this semester. I don't have any strong feelings. Ended up with a C, but that's because I didn't turn in one of the projects.",
            rating: 3,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            review: 'I took this as my first course in spring 2018 and enjoyed it very much. I had opportunity to learn R studio.',
            rating: 4,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "Fun course, it's not hard if you have good teammates",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "This was (one of the) first semesters of the new DVA. Also my first class in OMSCS. The class was considerably more difficult than expected. Some assignments took only a few hours, one (assignment 3) was on D3 and javascript, which I did not know at all. It took me something like 46 hours to complete, but was thankfully, by far the worst. It's a broad class but not very deep, I learned a lot, and loved the class.",
            rating: 5,
            difficulty: 4,
            workload: 18,
        },
        {
            ...
            review: 'I loved this course, it was a nice introduction into R and data analytics.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 13, 2019',
            semester: 'fall 2018',
            review: "This class is garbage. Don't waste your time",
            rating: 1,
            difficulty: 3,
            workload: 20,
        },
        {
            ...
            semester: 'fall 2018',
            review: 'This course was reinvented this semester and I liked.\nIt has a lot to improve yet, but it\'s not as bad as I was expecting (due to the previous bad reviews)\nThe course introduces you to a lot of tools, techniques and buzzwords from the big data and data visualization fields.\nIt is a broad survey over many distinct tools.\nYou get to know many things in a very short amount of time.\nThere are 4 very pratical assignments that makes you experiments many tools and a big team project that you need to create a complete "big data and visualization pipeline"\nI recommend getting some ML course before (like ML4T or ML), so you can focus on the tools not on ML concepts.\nAlso, knowing javascript beforehand can be of a great help.',
            rating: 4,
            difficulty: 2,
            workload: 12,
        },
        {
            ...
            reviewDate: 'January 9, 2019',
            semester: 'spring 2017',
            review: 'Overall DVA was a decent course and I learned enough. It was very set in the R way of doing things and I used mainly the tidyverse to get everything done with no issues.',
            rating: 4,
            difficulty: 3,
            workload: 6,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 7, 2018',
            semester: 'summer 2018',
            review: 'Quick summary: A LOT of work, and much of it fairly difficult, but reasonable grading practices make the course achievable. Learned a lot as well.\nGood:\nProfessor: Polo is a smart guy and knows what he is talking about. He has done a lot of work in the field.\nReal-world Application: All of the home works (which honestly are more like projects, think anywhere from 10-40 hours of work each) could all be shown in a work portfolio when finished.\nExtra Credit: Up to 3 points of extra-credit are available through fairly straightforward multiple choice quizzes.\nOK:\nGrading: While the home works were graded fairly harshly, the projects seemed to be graded leniently, which helped create a balance where if you struggle through the course you could still get a B pretty easily and even realistically get an A.\nBad:\nLectures: The lectures have very little to do with the assignments. I honestly just stopped watching them halfway through the course.\nTeaching Ourselves: I really felt like while the assignments did make me learn a lot, I felt like I had to teach myself most of this course.\nMy Background:\n23 years old, recently married, graduated undergrad in May 2017.\nCoding Experience: Moderate (academic experience with many languages, mostly Python and R)\nStatistics Experience: Moderate (4 undergrad level stat courses, Intro to Analytics Modeling, Regression Analysis)\nMath Experience: Moderate (peaked at 2nd year Calculus)',
            rating: 4,
            difficulty: 4,
            workload: 15,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'October 11, 2018',
            semester: 'summer 2018',
            review: "Took this summer '18 after taking ML4T and RL. It was not a good class. The lectures were pointless. The assignments were mostly busywork.",
            rating: 2,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'August 17, 2018',
            semester: 'summer 2018',
            review: "This class is getting replaced so this doesn't matter!",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: "Warning: This class will have drastically changed since I took it in the Spring 2018 so I not sure how much this review is worth.\nThis course was a perfect intro/orientation into Machine Learning and R for me. The presentation of the material (Lebanon's lectures) itself was the low point, but not terrible. I supplemented the material in this class with A LOT of outside text and mooc material.\nI wish I would have waited to take the updated format of the class but I would take this class again in the form it was because it was absolutely foundational to classes I ended up taking concurrently and after (AI and ML4T).\nStudying R alongside learning Numpy in another class helped me write better python code. Learning the basics of Regression/Classification and taking plenty of time to examine the mathematical rationale behind it aided me in projects in other classes which seem to assume this knowledge.\nDr Joyner was engaged, motivating, and helpful. TAs did pretty good job.",
            rating: 4,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'summer 2018',
            review: "There were 10 assignments,  4 activities, 4 home works (coding, papers) and 2 projects (project 2 based on project 1).\n2 projects worth 20% each, outcome and portion of code of project 1 will be used on project 2.\n4 home works worth 10% each, and aligned well with the class materials.\nActivities were for extra credit, and graded mostly based on completion, but also a good opportunity for learning new technics to visualize data.\nBeside: 2 tests worth 10% each, open everything, internet, note, RStudio... but questions were tricky.\nBe prepare to do Logistic/Linear regression down to Algorithmic level, means you will learn how to derive and reasone the whole thing, it's rewarding but might be frustrated to work with, you have to use calculus.\nThe visualization part was fun, you will learn several types of chart, several packages to help you effectively visualize data in R.\nThe 2 tests were hard, tricky. but it's only worth 10% each and if you manage to finish all assignments well, you will have a good grade.\nNOTE: This structure and material might be changed in the future, professor Joyner stated Summer 2018 would be the last semester using this material.",
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        {
            ...
            reviewDate: 'August 5, 2018',
            semester: 'summer 2018',
            review: 'Good class as a summer class because you can work ahead on most of the homeworks and projects.  It serves as a good introduction to data analysis as you learn R.',
            rating: 4,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "I was nervous about this course after reading the bad reviews for previous semesters, but found it fine! The assignments were ok and ease you nicely into R. David Joyner was eternally helpful and the TAs seemed fine as well. Projects were significant chunks of coding and writing but structured with a series of questions which helped. The content wasn't ground-breaking, but was a nice introduction to a lot of useful stats concepts. Would recommend for a first course/ML elective.",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'Classwork was relatively simple, but working in R proved to be difficult for this newcomer. When the class took a hard pivot to logistic/linear regression, the material was more difficult, but the grading was more lenient. If you know how to use R, this class will be a breeze. Otherwise, the learning curve for the programming language was the largest hurdle for me.',
            rating: 3,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 8, 2018',
            semester: 'spring 2018',
            review: 'Simple course. Try to do activities as they are very simple and easy scoring. Homeworks too are quite simple project need some thinking. Try to do R before starting the term.',
            rating: 4,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 7, 2018',
            semester: 'spring 2017',
            review: 'When I took this class in Spring 2017 there were lots of issues with the way class was run. You will mostly find negative reviews for that term. Even with all the issues I did learn a lot from this class as it was my 1st ML class. I liked overall course content and enjoyed all projects/home works. This class will prepare you for a Data Analyst role and may even be a good starting place for a DS role.\nIf you are interested in learning R and using R for data analysis and visualization along with few ML concepts then this is the class for you.',
            rating: 4,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 2, 2018',
            semester: 'spring 2018',
            review: "Excellent class! I think Prof. Joyner changed couple of things and now is so much better.  You can work ahead if you want to and you learn a lot along the way. I've never worked with R but by the end of the class, I felt pretty confident using that language to analyze and visualize data. This class has an excellent ratio of Theory and Practice.\nAlso, because of the practical side of this class, I was able to get a job as a Junior Data Scientist!!\nSo, in short, you'll learn R, Data Analysis and Visualization, Intro to ML (Logistic and Linear Regression) and hands-on experience in case you want to look for jobs in Data Science.\nThat's a 10 in my book, hehe.",
            rating: 5,
            difficulty: 3,
            workload: 25,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'April 16, 2018',
            semester: 'spring 2018',
            review: 'Very well managed class, interesting material for someone with no prior ML/Data science background. It was a great way to start the program',
            rating: 4,
            difficulty: 2,
            workload: 12,
        },
        {
            ...
            semester: 'spring 2017',
            review: "Great course! I've used R programming language for years but still learned a great deal about more efficient ways to manipulate and plot the data.",
            rating: 5,
            difficulty: 2,
            workload: 8,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'January 3, 2018',
            semester: 'fall 2017',
            review: "A good introduction course to R and simple machine learning analysis. With 5 extra credit, I think it's pretty easy to get an A which only requires a final grade of 90/105.",
            rating: 4,
            difficulty: 1,
            workload: 8,
        },
        {
            ...
            semester: 'fall 2017',
            review: 'A very good introduction to R and data visualization concepts. Also, a brief introduction to ML concepts. The lectures were not helpful at times; especially towards the end (Regularization etc).\nProjects were time consuming so make sure you have enough time in hands to complete and submit on time.\nExtra credits for the Activities did help in the end to get an A grade; inspite of the difficult and slightly confusing final exam (open everything).\nOverall, I am glad I took this course in-spite of the bad reviews from previous semesters. This time around it seemed a lot better organized in terms of communication - I believe it was the Joyner effect.',
            rating: 4,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            review: 'Lectures are high level and not close to what may be needed to complete the homework and assignment. It requires higher level maths. I personally feel not much was learned through this class. Also, the course content needs to be refreshed.',
            rating: -1,
            difficulty: -1,
            workload: -1,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 17, 2017',
            semester: 'fall 2017',
            review: "There are couple of major problems with this class.\n\nProfessor is missing. I am not sure why his name is part of this course. This course needs to be redesigned by someone who owns it.\nThe lectures are from Dr Guy Lebanon are pretty dry, math based and doesn't provide actual implementation basis. To me, it felt like you have to bridge the gap between theory and implementation. Without any background, it is very difficult. The course pre-requisites does not say you need ML background but you do.\nThe grading throughout the course is inconsistent, the exam fairly difficult.\nThe TAs are helpful if you know the material. They will not teach anything. I struggled throughout the course with no significant help in understanding the material.\nConclusion: Don't take this course unless the course gets redesigned under a new professor.\n",
            rating: 1,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "The course material does not cover the homework assignments. The TA's are not helpful, they constantly tell you to refer to the reading even when you say that you don't understand the reading. The professor only sends weekly announcement. He does not answer questions on Piazza or Slack.",
            rating: 2,
            difficulty: 4,
            workload: 18,
        },
        {
            ...
            semester: 'spring 2017',
            review: "Interesting class if you want to see Data Science from an R (vs Python) perspective. R is an 80's language with all the benefits and liabilities of a legacy system. The projects can be large and quite time-consuming; but not too difficult.\nI can see how you would use R professionally and there is demand for the skill, but it's not my cup of tea. IMHO : Cobalt + Data = R",
            rating: 3,
            difficulty: 3,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'Good course in my opinion. Starts off easy and gets harder at the end. I knew R coming into it which made everything a lot simpler. Definitely a good course to take before you take machine learning. Gives you a background in R, and touches upon the beginnings of machine learning with linear regression.',
            rating: 4,
            difficulty: 2,
            workload: 3,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'June 23, 2017',
            semester: 'spring 2017',
            review: 'A severe disappointment both in quality of instruction and content of instruction. The course contains less than half of the material taught by Prof G. Lebanon back on 2011 while he was teaching at Gatech.',
            rating: 1,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: 'This class had so much potential, but I think the switch to a new professor with limited experience running an online class really limited the class. It suffered greatly from "new class" issues, and I think the large class size in combination with the new professor and long homeworks / projects overwhelmed the TA\'s. I agree with most of the other posts as it was a poorly run class.\nBut, in spite of all the negative points, I still managed to learn (mostly on my own) about the R language, regression analysis, and some data analytics. If you are the type of person that is willing to learn and investigate topics on your own, this might be the class for you. Otherwise I would suggest passing on this class until it is cleaned up.',
            rating: 2,
            difficulty: 3,
            workload: 10,
        },
        {
            ...
            semester: 'spring 2017',
            review: "I'd taken this course seeing the highly positive reviews on this site for the previous semester offering. The Prof was changed for this semester and I found the course was very disorganized. Most of the students in the class seemed not so impressed. Hopefully changes will be made for the next semester.",
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "My score is higher than 100 in this course, but I will NOT recommend it. Here are the reasons:\n\nThe instructor is draggy and not prepared. Can you imagine the instructor is still preparing the final exam, when the exam window is already open.\nIt takes the TAs extremely long time to response to your request. I ever sent out a private message to my TA, and he responded, after tow-three weeks.\nThe grading is very slow. Some of the projects are connected. You don't know whether your solution for the previous project is correct, while the second one is already due.\nI'm not sure whether the instructor and TAs communicate, because sometimes their responses to student questions contradict to each other.\n\nIn terms of grading, the instructor is lenient. He find every opportunity to give out extra credits. I learned little from this course. All I did is collecting points.\nAs a conclusion, if you want to get a high score, go for it; if you want to learn something from the course, avoid it before the instructor is ready.",
            rating: 1,
            difficulty: 1,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "As some others have said, this is one of the worst classes I have ever taken. The material is interesting, but the class is managed ridiculously poorly. I've done okay in the course so far, but communication is so incredibly bad I wouldn't recommend this course to anyone. New professor this semester, so older reviews might not be super relevant anymore.",
            rating: 1,
            difficulty: 5,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "I think it's all been said already, so I'll merely agree with all the other awful reviews. Worst \"prof\" ever. He should certainly not be hired to teach in our program again.\nAlso, I've seen some students dismissing negative reviews on G+ several times before saying those are just the students who weren't prepared or didn't get good grades, etc. So I want to make clear, I'm getting an A. Doesn't change the facts.\nSome of the TAs were helpful in getting through the course despite the madness: thanks Ravish, Ryan and Adrian.\nThis could be a great class, but not until they get a real prof.",
            rating: 2,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "This Course is my first course in GT OMSCS, I preferred this after reading so many Good reviews about it, But it left me frustrated, thinking why I picked this one.\nCourse material is pretty easy, but the way Projects/Assignments are handled is pathetic, not worth of recognized US University. Too much of ambiguity, too much of (needless) load, makes learning second priority., e. g. Use of loops, run it 5 times, 10 times, 500 times, sorta questions, asking Complexity, No doubt this is essentials, but DVA is not meant for that.\nAnd cryptic messages for communication, asking TA's Or Prof. question over piazza or slack, u get very terse/generic feedback. I just couldn't realize Did TA/Prof. wanted to remove ambiguity or add to it. Like any stupid student I dared sometime, to re-ask the next question, to get No further reply.\nSome of my Piazza posts remained, unanswered. If I pass this course, it would be because of my own work and students who were active and prompt on piazza.\nNewly hired Prof. n TA's, Couldn't make this course interesting, neither they could make us realize potential of the course. Project/Assignment grading took forever, Course is about to finish, and we're yet\nto get feedback for half of our work.\nWith all due respect, I really doubt their credentials, to carry on, GT plz review this staff.\nDespite student asking for ideal answers, we never got any positive feedback on it. Grading is generous at times, but, rather than that, I'd prefer, what went wrong and how can I improve it.\nOhh, and how can we forget, TA Jiachen Yang's epic sarcasm. I think This guy, should be given privilege to write, pre-requisite section of DVA/and every other subject in OMSCS for next semesters.\nFall2017/Summer2017 ** Won't recommend this course, until GT reviews this **",
            rating: 1,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'April 7, 2017',
            semester: 'spring 2017',
            review: "New professor this semester. Material is not so hard, but the requirements are vague and ambiguous. You lose points if you did not successfully interpret what they really want(which is the most difficult part of this course for me).\nDifferent TAs reply the same question with different answers. I guess they don't even align before answering questions. Some of them are arrogant. I still remember a TA answered students' clarification request on a homework requirement like 'there is no ambiguity here' even though more than 10 students asked the same question.\nupdates: so the professor showed up one week before the final on Piazza. I also heard some students filed official 'academy grievance ' and it seems administrators are on students' side. You know who is wrong now. I got an A, btw, which ensures this review is not a 'grievance'.",
            rating: 1,
            difficulty: 3,
            workload: 12,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'March 10, 2017',
            semester: 'spring 2017',
            review: "The course itself it is not hard, but it is very hard to get good grades. There is no rubic or grading policy at all. And most of assignments questions are ambiguous. TAs are very lazy and don't answer the questions or answered in a very misleading way. Then at grading stage, they will surprise you and interpret the question in a different way it is being asked, and deduct points from the students. A few classic examples: 1. what is the growth rate of different format of file size? (They graded with big(O) notation) 2. Describe your observation (grading notes released after three weeks of submission saying, you can't say A is bigger than B, you have to say A is 4% and B is 3%, so A is bigger than B). The answer is in the figure the students submit, but the reason most of us didn't put them in the final conclusion is the assignment didn't ask it in the beginning.\nDefinitely the worst course have been seen in OMSCS",
            rating: 1,
            difficulty: 1,
            workload: 2,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "This is my 6th course in the program. By far the worst course I have taken so far in my entire life. I am hoping that they will do some changes. It is utterly disorganized and chaotic. TA's and instructors participation in Piazza is minimal. Just do not take it until they fix the course. I guess Dr. Lebanon was great. We just got unlucky that they have changed the instructor.",
            rating: 1,
            difficulty: 2,
            workload: 6,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'January 13, 2017',
            semester: 'fall 2016',
            review: 'This course was not well organized.',
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'This course builds a very solid foundation with R and basics of data science. Though it does not delve much into many ML algorithms, it focuses well on visualizations and key regression algorithms. Since it was a first offering, the structure of the course was bit vague and exam a bit surprising. But that said, overall a good course that is very informative',
            rating: 4,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 19, 2016',
            semester: 'fall 2016',
            review: 'This class is great! Professor Guy is very knowledgeable and taught very well in terms of practically use and theory behind regression, feature engineering and feature reduction. This course is really useful for daily tasks or project for data science work',
            rating: 5,
            difficulty: 2,
            workload: 8,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 18, 2016',
            semester: 'fall 2016',
            review: "Everyone should take DVA before Machine Learning to reduce the initial learning curve of ML. It's a great introduction to R and data analysis. There's some math involved as well, although not too complicated. The workload is moderate, light in the beginning, but picking up during later homework and the projects. The class is a good combination between practical and theoretic. I end up actually understanding regression and the math behind it and become quite proficient in R. It's such a bummer that the professor will not teach next semester. He is very involved with the class.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'August 30, 2016',
            semester: 'fall 2016',
            review: "Final review:\nThe class only has 6 parts to it: R programming, Data Viz, Preprocessing Data, Logistic Regression, Linear Regression, Regularization.\nBy the second part of the class, and the class continues to be heavy on R syntax and light on actual concepts.\nThe part on Logistic Regression becomes a bit more concept oriented (and less R oriented).\nIn general workload is still very light, except the projects took an average of over 30 hours to complete (but there were 2-3 weeks to do it). So make sure you start work early.\nThe class features interviews from Netflix data scientists. That is interesting to watch.\nProfessor is active in Piazza. Good experience with Youtube Live office hours.\nThe class organization could be better, TAs don't make too much presence on piazza.\nI think the class could have taught a lot more, while its a good intro to Data science, the amount of content is a bit underwhelming. 12 lessons would have been better and still manageable.",
            rating: 3,
            difficulty: 1,
            workload: 3,
        },
    ...
    reviewSummaries: {
        'spring 2024':
            'The course covers crucial data science topics like data collection, SQL, and data visualization but struggles with execution. Many found the lectures unhelpful and disconnected from assignments, leading to a self-teaching environment. The emphasis on D3 for visualization was criticized as impractical, while modeling topics overlapped with other courses, causing confusion about their relevance. Assignments vary in difficulty, with some students relying on tools like chatGPT to succeed. The group project, which constitutes half the grade, is graded leniently and depends heavily on group dynamics, yielding mixed experiences. While some appreciated the chance to apply course material, others felt the project lacked direction. Overall, with some adjustments, the course could transform from mediocre to excellent.',
        'spring 2023':
            'The course has elicited mixed reviews, highlighting both strengths and weaknesses. Positively, group projects can enhance grades, and committed team members can foster a supportive learning environment. Students found the flexibility in project topics enjoyable, and some appreciated the availability of extra credit. However, criticism is widespread regarding the lack of depth in the curriculum, with many assignments focusing on redundant technologies and requiring troubleshooting rather than substantive learning. The reliance on self-education and external resources, coupled with inadequate support from TAs, has left students feeling frustrated and overwhelmed. Many suggest prioritizing core technologies like AWS and SQL while de-emphasizing less applicable tools like D3, as the course ultimately fails to deliver on its initial promises.',
        'fall 2023':
            'The course has garnered mixed reviews, highlighting both its beneficial and frustrating aspects. On the positive side, students appreciate the opportunity to learn valuable skills, particularly in data visualization and various programming languages like SQL and Python. They note that while the homework can be time-consuming and teaches a lot at a surface level, it is generally manageable, and collaborating with peers enhances the learning experience. However, critiques focus on the ineffective lecture videos, unhelpful TAs, and a finicky autograder that complicates grading. Many feel that the course lacks depth and fails to foster genuine learning, particularly in concepts like D3, which are described as overwhelming and poorly taught. Overall, while students can achieve high grades, many question the practical value of their learning.',
        'fall 2022':
            "The course received mixed reviews, with many students expressing disappointment in its structure and content. Critics highlighted a lack of depth, ineffective lectures, and minimal guidance on assignments, leading to frustration and a sense of wasted potential in a critical area like visualization. Homework was often seen as time-consuming busywork, particularly the D3 project, which some felt was unnecessary for industry applications. Conversely, a few reviews praised the opportunity to learn various tools and the importance of self-teaching, noting the generous grading. While teamwork was emphasized, the course's overall value was questioned, with some suggesting that cheaper, self-directed learning resources could suffice. Ultimately, students seemed divided on whether the course met their educational expectations.",
        'spring 2022':
            'The course received mixed reviews, with some students praising its breadth of exposure to tools like D3, Tableau, and Python, which they found valuable for industry applications. The homework assignments, while time-consuming, were well-designed for feedback through an autograder, facilitating learning. However, many critiques focused on the lack of substantive teaching, with lectures deemed ineffective and unclear instructions leading to frustration. Students noted that those with limited programming experience struggled significantly, facing hours of debugging without sufficient guidance. Group projects were highlighted as beneficial, provided teams were well-organized. Ultimately, opinions ranged from finding the course a worthwhile challenge to viewing it as a waste of money and time, particularly for those requiring more structured support.',
        'fall 2021':
            "The course received mixed reviews, highlighting both valuable skills and significant drawbacks. Positively, students appreciated the breadth of topics covered, noting that it adds a variety of technologies to their skill sets, and many reported learning useful techniques despite frustrations. However, many found the lectures to be unhelpful and disconnected from assignments, suggesting students learn independently for better understanding. Group projects were often criticized; some students felt overwhelmed by the workload while others encountered interpersonal conflicts and unequal contributions. The overly detailed and contradictory instructions added to frustration, along with numerous issues related to the auto-grader. Overall, while some students achieved high grades, the course's lack of structure, guidance, and effective teaching led many to recommend seeking alternative learning resources.",
        'spring 2021':
            "The course receives mixed feedback from students, highlighting both strengths and weaknesses. On the positive side, many students appreciated the breadth of tools introduced, particularly JavaScript and D3, as well as the supportive TAs and the challenging but engaging homework assignments. Some felt that a solid background in Python made the coursework manageable. However, numerous complaints emerged regarding the course's structure, with criticisms focused on vague and disconnected lectures, poorly organized assignments, and an overload of content leading to confusion and fatigue. The group project, viewed as time-consuming and excessively academic, was often described as frustrating, with differing levels of team member contributions affecting all students' experiences. Overall, many felt the course needed significant improvement in clarity and coherence.",
        'summer 2021':
            'The course received mixed reviews from students. On the positive side, many found the workload manageable, especially when taken alongside other classes, and appreciated the supportive project teams that alleviated stress. Students noted that the grading was fairly generous and enjoyed the absence of traditional tests. However, the course was criticized for its lack of depth, covering a broad range of topics with minimal detail, leading to repetitive content for those familiar with similar concepts. Issues were also raised regarding the difficulty for students with weaker coding skills, as the course requires proficiency in various programming languages. Overall, while the class may not be a favorite, it is viewed as doable with proper preparation.',
        'fall 2020':
            "The course has received mixed reviews, highlighting both positive and negative experiences. Students appreciated the breadth of technologies covered, enhancing practical skills in data visualization and programming. The hands-on assignments were deemed challenging yet fulfilling, particularly for those with a programming background. However, many criticized the course's organization, noting lengthy, error-ridden homework instructions and unhelpful TAs. The group project was often seen as burdensome and poorly structured, requiring extensive reporting and coordination without clear guidelines. While some found value in the learning process, others felt overwhelmed by the workload, which seemed misaligned with a professional schedule. Overall, while the course offers valuable knowledge, its execution and management raised significant concerns.",
        'spring 2020':
            'The course has received mixed reviews from students, with many citing the lectures as excessively high-level and unhelpful for understanding practical assignments. Multiple reviewers found the homework assignments overly broad, covering numerous technologies without sufficient depth, leading to frustration and a lack of effective learning. Despite the challenges, some appreciated the robust support from TAs and the availability of extra credit opportunities. The team project was seen as a highlight, fostering collaboration, though it required significant effort and coordination. While some students reported feeling overwhelmed, others noted that planning ahead could make the workload manageable. Overall, while the class was demanding, many felt it offered valuable exposure to various tools, albeit with a need for clearer instructional alignment.',
        'fall 2019':
            'The reviews for CSE 6242 reveal a class that provokes mixed feelings among students. Many appreciated the breadth of technologies covered, gaining exposure to tools like D3, Hadoop, and AWS; however, the execution fell short with vague lecture materials and unclear grading criteria. While some students thrived in supportive teams and found the workload manageable, others faced challenges with group dynamics and ambiguous homework instructions, leading to frustration. The lack of published answers for assignments left many unsure of their performance. Overall, while the course offers valuable content for those willing to work hard and find good teammates, numerous reviews criticize the chaotic structure, poor communication, and insufficient guidance, making it a disappointing experience for many.',
        'spring 2019':
            'The course garners mixed reviews, with both positive and negative aspects noted by students. Many enjoyed its breadth, covering various data science and machine learning topics, particularly appreciating hands-on exposure to technologies like D3.js and Python. However, criticism arose regarding the disorganized structure, excessive focus on busywork, and the lack of depth in material, often leading to frustration. Group projects were a source of contention, with uneven participation impacting experiences. Homework assignments are described as time-consuming and often overly complicated for students not versed in JavaScript or D3. Some found the grading lenient, while others noted the challenges of working with unhelpful TAs. Overall, students feel a redesign is necessary to enhance learning outcomes.',
        'fall 2017':
            "The course has received mixed reviews, with many students criticizing it as one of the worst offerings in the OMS program due to its lack of depth and outdated materials. While some found the course a good introduction to R and data visualization, they noted the overwhelming focus on linear regression and the demanding nature of the projects. Positive feedback highlighted Dr. Joyner's organizational skills and helpful TAs, though concerns were raised about inconsistent grading and inadequate support. Reviewers expressed frustration with the outdated lectures and the need for a solid math foundation not clearly outlined in the prerequisites. Overall, while it may suit beginners or those seeking a low-effort course, many recommend caution due to significant shortcomings.",
        'spring 2017':
            "The reviews for the course reflect a significant divide in student experiences. Many students expressed frustration with disorganization, vague assignment instructions, inconsistent grading, and a lack of responsiveness from faculty. Complaints about the course structure and communication gaps between TAs and the professor were common, leading to feelings of confusion and anxiety during assignments and projects. However, some students reported learning valuable skills and appreciated the course's content, particularly regarding data visualization and the R programming language. Overall, while a few students found the course manageable and informative, the negative aspects overshadowed these experiences, leading to a recommendation to avoid the course until it is significantly revamped.",
        'fall 2018':
            'The course offers a broad overview of various data science topics including data processing and visualization, but many students found the lack of depth frustrating. Some appreciated the engaging projects and responsive teaching staff, while others criticized the time-intensive nature of assignments and the tedious setup required for tools and environments. The group project, accounting for 50% of the grade, was a common pain point, often resulting in unequal participation and added stress. Overall, students reported a steep learning curve, especially for those without strong programming backgrounds, and expressed a desire for more focused instruction to develop practical skills rather than completing busy work. Despite its challenges, many acknowledged learning valuable concepts and tools.',
        'spring 2018':
            'The course received mixed feedback, with several students praising its structured introduction to R and machine learning concepts. Many found the assignments engaging and beneficial for learning data visualization, linear, and logistic regression, making it a solid starting point for the OMSCS program. However, students criticized the course’s heavy reliance on tedious homework and projects, often citing confusion over ambiguous instructions and insufficient support from instructors. Lectures were regarded as lacking depth or clarity, leading many to seek external resources to supplement their learning. Additionally, some faced challenges integrating into the course due to the steep learning curve with R. Overall, while some students enjoyed the content and ease of obtaining good grades, the course management and workload were points of contention.',
        'summer 2018':
            'Overall, the course received mixed feedback, with many students appreciating its breadth of content and practical application while also expressing concerns about workload and depth of knowledge. Positive aspects highlighted include an effective introduction to R, modern tools like D3 and SQL, and supportive grading practices that allow students to achieve good grades. The group project, crucial for a significant portion of the grade, was seen as beneficial yet challenging due to varying team contributions. Conversely, students criticized the lectures for lack of relevance and the overwhelming amount of self-study required. The course structured evaluations, including multiple assignments and projects, demanded substantial time commitment, leaving some feeling unprepared despite the learning experiences. Overall, it served well for foundational knowledge but might not fully equip students for advanced skills.',
        'fall 2016':
            'The course has received mixed reviews, showcasing both strengths and weaknesses. On the positive side, many students appreciated the teaching style of Professor Guy Lebanon, highlighting his practical approach to R programming and machine learning concepts, which laid a solid foundation for future studies. The course effectively introduces basic data visualization and linear regression, making it a manageable starting point, especially for those new to R. However, several criticisms focused on the disorganization of the course structure, especially concerning grading criteria, inconsistent feedback, and an unexpectedly difficult final exam. While some found the workload light, others struggled with its ambiguity and the high stakes of the final as a significant portion of their grades, leading to an overall impression of unevenness across semesters.',
        'Unknown Semester':
            'The reviews for the course reflect significant dissatisfaction, particularly regarding the lectures, which are deemed too high-level and disconnected from the homework requirements. Many students expressed that the course lacks essential content, especially indicating a need for a refresh to better align with learning objectives. Additionally, the coursework demands advanced mathematics that some find overwhelming, leading to feelings of inadequate learning overall. While some may appreciate certain aspects of the content, the prevailing sentiment suggests a need for substantial improvements to enhance the educational experience and better prepare students for assignments.',
    },
};
