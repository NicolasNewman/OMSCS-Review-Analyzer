export default {
    ...
    reviewSummaries: {
        'summer 2023': {
            pro: 'The course covers a wide range of cybersecurity topics through projects and has extra credit opportunities focused on student feedback.',
            con: 'Unclear project instructions, poor TA response times, and several technical issues with projects, leading to frustrations and difficulties in understanding.',
        },
        'summer 2020': {
            pro: 'The course is challenging and encourages independent learning through external resources.',
            con: 'The course content is not in-depth, requiring significant additional reading and learning.',
        },
        'spring 2020': {
            pro: 'The course offers challenging projects that promote learning, particularly in areas like malware analysis and network intrusion detection, and there is potential for the material to improve in future offerings.',
            con: 'Many projects had vague requirements and were overly ambitious in scope, leading to confusion and frustration. Additionally, the lectures were poorly delivered, primarily consisting of recycled content, and the grading was inconsistent.',
        },
    },
};
