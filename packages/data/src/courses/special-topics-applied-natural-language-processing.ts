export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course offers a comprehensive understanding of NLP, with effective teaching methods from Dr. Riedl, and provides a valuable foundation in PyTorch and key principles like attention mechanisms.',
            con: 'The final project is significantly more challenging than earlier assignments, and some lectures from Facebook are difficult to follow.',
        },
        'fall 2023': {
            pro: 'The course is exciting and rewarding, offering the opportunity to learn how to create ChatGPT from scratch.',
            con: 'The difficulty level of the course has significantly increased, making it challenging for students.',
        },
        'spring 2023': {
            pro: 'The course is easy and suitable for beginners.',
            con: 'May be too elementary for a graduate-level program.',
        },
        'summer 2023': {
            pro: 'The course provides foundational NLP material and introduces various methods and architectures for NLP problems. It is considered beneficial for resumes and not overly demanding, with manageable homework difficulty for those with some background.',
            con: 'The course lacks comprehensive homework and detailed lectures, with criticisms about its brevity and the need for more in-depth application explanations. There are also technical issues with Gradescope and version compatibility, which may impede some students.',
        },
    },
};
