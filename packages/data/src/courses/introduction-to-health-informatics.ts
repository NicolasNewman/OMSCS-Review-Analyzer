export default {
    ...
    tags: ['IHI'],
    officialURL: 'https://omscs.gatech.edu/cs-6440-intro-health-informatics',
    textbooks: [
        {
    ...
    reviews: [
        {
            user: 'wc47puUJlSq+XS5YuXA5hw==',
            reviewDate: 'May 2, 2024',
            semester: 'fall 2023',
            review: 'Expected grade in this class is an A.\nPretty easy labs and quizzes in the first half, then a practicum project for the second half. I learned a lot, and it’s a good GPA booster. The TAs are some of the best in the program.',
            rating: 5,
            difficulty: 2,
            workload: 8,
        },
        {
            user: '3AEzatThriEmmXTyhdFFqQ==',
            reviewDate: 'May 2, 2024',
            semester: 'spring 2023',
            review: "** This review is for Spring 2024: **\nThis class runs well and the workload felt just right and rewarding. I learned a lot about the healthcare domain, including frameworks like FHIR. We had engaging discussions with classmates and did several labs that introduced us to different technologies, all building up to a practical final project. Lab 1 had a bit of writing, but it wasn’t too much.  TAs were informative, supportive, and did an exceptional job setting up the labs. There are no exams, just quizzes that are reasonably set. The lectures were fun to watch. Dr. Duke keeps you engaged. You can do the final project alone or in a team and you get a mentor. I chose to do it solo to challenge myself with the MERN stack, and it turned out great. The labs and the final project are good practice in software development.\nTaking this class is ideal if you're interested in learning about the healthcare domain or adding another area of expertise. I definitely recommend this course if you're into healthcare, want to try out various technologies, and work on a real-world project that's useful in a real job setting.",
            rating: 5,
            difficulty: 3,
            workload: 12,
        },
        {
            ...
            semester: 'fall 2023',
            review: 'I took this course concurrently with another and it was the best out of the two (the other being SDP). It was course 4 out of 10 for me.\nOverall, I think it was a great course, especially for those who would like to have a career in the healthcare industry. The lectures could be modified to improve the experience of the course (i.e. adding more engagement) and the labs could be improved on to focus on course topics rather than spending too much time on setup. The quizzes were a bit too easy as you usually have two attempts. There are no exams in this course. The Forum Participation aspect of the course seemed like more of a chore than a learning opportunity.\nThe best part of the course happened during the second half, which was the Final Project. Having the ability to pick/scout your own team gives you a lot of freedom on what technologies can be used for the final project. I learned A LOT from the Final Project and it made the class feel fulfilling, especially since it used topics that were discussed in the course. The most hours (around 12 hours a week) were spent during this part of the course but only because of the research and development required for the Final Project. My only suggestion is to add an extra week for the Final Project as the last week felt a bit rushed.',
            rating: 4,
            difficulty: 2,
            workload: 9,
        },
        {
            ...
            reviewDate: 'December 12, 2023',
            semester: 'fall 2023',
            review: 'Overall a great class. The first half of the semester were lectures, quizzes and labs. As someone new to healthcare, I found the content and assignments interesting and engaging. Workload was manageable. The second half of the semester was a solo or group project. I chose a subject that interested me and did it by myself. No exams.\nTAs were responsive on Ed discussion, and very generous in terms of extra credit opportunities and deadline extensions upon student requests.',
            rating: 5,
            difficulty: 2,
            workload: 8,
        },
        {
            ...
            semester: 'spring 2023',
            review: 'Full disclosure I will most likely make an A in this class now that final grades are out.\nThe first half of the course contains a Quiz and a Lab due every week/ every other week. The quizzes are not timed and are open book with reasonable questions without any trick questions. The Labs are reasonably decent amount of work as well. Most labs and quizzes were extended.\nThe second half is project based, in the beginning you pick 3 of your preferred projects and the TAs assign one based on availability. I waited last minute to find a team. But I still lucked out with our project choice and team mates. So you ideally want to start this as early as possible to leave room for error. The scope of the project and the work you need to do is entirely self driven making this an easy A but also a place where if you get lazy you can lose a lot of points.\nOverall I would definitely recommend this class.',
            rating: 5,
            difficulty: 4,
            workload: 8,
        },
        ...
        },
        {
            ...
            review: "Class was a breeze. Don't recall much new information, but I have worked a couple of jobs in IT Healthcare already, so some of the information was more of a refresher. But still, I think most folks who took this class online for this semester would agree that the workload was extremely light.",
            rating: 4,
            difficulty: 1,
            workload: 5,
        },
        {
            ...
            semester: 'spring 2021',
            review: "I think this course is underrated.\nThe workload might not be even, video lectures are only somewhat aligned with the course material, but I didn't struggled at all with this course.\nIt's a great complimentary course that you might want to take with something else a bit more complex to get relatively easy A.\nThere's something to learn in this course, and couple of projects were very interesting, for example where I used ML techniques on COVID-19 data. Given that I never used any of these it wasn't that hard to learn it from scratch given that lab didn't required in depth knowledge of the tool.",
            rating: 4,
            difficulty: 2,
            workload: 5,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'March 20, 2021',
            semester: 'spring 2021',
            review: 'This class sucks. TAs have a stick up their ass and will tell you to go fuck yourself if you ask for their help. The content is garbage and you will have 5 assignments due every week',
            rating: 1,
            difficulty: 5,
            workload: 25,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 1, 2019',
            semester: 'fall 2019',
            review: 'There are one individual project and one group project, some case studies, and labs. No exam.',
            rating: 4,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'A very boring courses and not necessarily an easy A either. Lectures are completely useless. We have 7 case studies, 7 labs, 1 individual project, 1 group project.',
            rating: 1,
            difficulty: 3,
            workload: 20,
        },
        {
            ...
            semester: 'fall 2019',
            review: 'I think this was a great first course to the OMSCS program.  There were lots of changing due dates that can be confusing.  But but aligning as a team and staying ahead of due dates was very helpful. The Instructors and the TA’s were awesome.',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'October 20, 2019',
            semester: 'fall 2019',
            review: "Please stay far away from this class! This is my 8th course taken in this program and this is the most disorganized course I've ever taken at any point in my academic career. The tools that you use for labs rarely ever work and are frequently down. Extensions are given to certain assignments and not others. There's an individual project that was thrown in at the last minute which was poorly thought out and adds zero value to the course. There are a million announcements made on Piazza throughout the week, good luck keeping up with that. Labs provide poor instructions, FHIR assignment provides no instruction, case studies provide no substance and there's something due every week. This course is absolutely horrible! Stay away!",
            rating: 1,
            difficulty: 3,
            workload: 7,
        },
        {
            ...
            semester: 'fall 2019',
            review: "One of the worst course ever. Poorly organized and way too much noisy communication over Piazza.  Totally disappointed with the course organization.\nThe content boring and if you don't have enough of web development or software engineering experience you would have to struggle a lot.",
            rating: 1,
            difficulty: 4,
            workload: 10,
        },
        {
            ...
            review: "The project is actually quite hard. If you don't have great teammates, or if no one in your team has experience in web development, the project would be very challenging. Most of the content in this class is about the health system. I don't recommend this class.",
            rating: 3,
            difficulty: 4,
            workload: 10,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'July 13, 2019',
            semester: 'spring 2019',
            review: 'Easy but boring course.',
            rating: 2,
            difficulty: 2,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "Introduction to healthcare informatics is good course if want to understand how informatics works. I found it fun course and learnt about FHIR.\nContent:\n\nProvides overview about informatics and how complex the field is. Also, includes guest lectures from industry practitioners.\nIntroduction to FHIR with activities on  INGInious.\nCheck your understand to test how will you resolve case study topics\nGroup Project where you will develop a app using Git, Docker, Jenkins, Rancher,..\nStretch assignments on different topics (Django, ANSI, FHIR, ...)\n\nWhat is good about the course?\nInformatics as topic is vast. Anyone who has worked on HL7 in past will appreciate the ongoing efforts with respect to FHIR.\nThe course teaches you how to use FHIR resources.\nGroup project for me was fun. Again, depends on your team and mentor.\nPlenty of stretch assignments to improve your score.\nWhat may disappoint?\nIf you are expecting lot of ML, DA, AI,  assignments then you will be let down.\nThings to take care:\nGroup projects can easy if your team plans all the activities well in time. Requires team effort so be willing to contribute don't wait try to finish things at the earliest.\nThis is one of the courses which can combined with other courses.",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2019',
            review: "This class was one of the most boring and seemingly useless classes I've taken. The only learning benefit i got was from the group project since I had never done front-end development before and had to learn React super fast. Video lectures were absolute trash, and it seemed like they were just giving you busy work the entire semester. They just want to seem like they matter as a class. Anyway... it's an easy A and you can double up on classes in a semester if you do this one. Have fun...",
            rating: 1,
            difficulty: 2,
            workload: 6,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 7, 2019',
            semester: 'fall 2018',
            review: 'Overall good course, what can make it difficult or easy is the group project.',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'I learned a great deal about health informatics.  The course had a few challenging moments, however, it was a pretty easy course.  There was 1 group project and I feel the team I was on made the assignment very simple.',
            rating: 5,
            difficulty: 2,
            workload: 12,
        },
        {
            ...
            semester: 'spring 2018',
            review: 'Pros: Overall well run. I work in Healthcare IT and found class useful. Easy workload, makes a good candidate to pair up with another class.\nCons: Subject matter is very boring and videos are dry.',
            rating: 3,
            difficulty: 2,
            workload: 6,
        },
        ...
        },
        {
            ...
            reviewDate: 'April 29, 2018',
            semester: 'fall 2017',
            review: 'Extremely easy class. Virtually no work, but also no information.',
            rating: 2,
            difficulty: 1,
            workload: 3,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "Really easy class. I didn't watch any videos. Essay and assignment take 1 hour to finish. The group project is a simple demo. A good class to pair with the hard ones.",
            rating: 4,
            difficulty: 1,
            workload: 2,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: 'The material is very interesting. The professor and TA Team are passionate and helpful. Class Piazza Participation is great. As mentioned in the previous reviews, the FHIR activities were pretty interesting and provide hands on knowledge on using APIS accessing FHIR database. The recommended readings provide good background on the topics covered. Would have been better if the team project weight is reduced from the current 35% because the team performance matters a lot in delivering a quality project.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: "This class was the worst class I've ever taken in person or online. The only redeeming factor was getting an A. However, if this was my first course in the program I probably would not have continued. It is very easy, but if your group project isn't an enjoyable experience, you will probably hate this class. If you're not planning on the Interactive Intelligence specialization, don't take this class. Even if you are in II, you may want to wait and take Computational Journalism.",
            rating: 1,
            difficulty: 1,
            workload: 5,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 10, 2016',
            semester: 'spring 2016',
            review: "As many others have stated, this class is poorly run with bad communication and inadequate assessment. I had the benefit of a great group for the project, but without that bonus I would have found this class highly frustrating. That said, the basic HIT concepts under discussion are important and interesting. I'm glad I was exposed to them, even in such a suboptimal fashion.",
            rating: 3,
            difficulty: 2,
            workload: 4,
        },
        ...
        },
        {
            ...
            semester: 'fall 2015',
            review: 'This is an easy class if you have a good group for the final project that is worth 50% of your grade. Quizzes are pretty easy if you take good notes for the lectures. Double check to make sure the answers are correct. Several answers on several quizzes were counted wrong but they were correct.',
            rating: -1,
            difficulty: 2,
            workload: 5,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2014',
            review: 'Agree completely with entry 2 (except there was no final) and Kyle (entry 5). Off-camera I found prof frustrating, illogical, error-prone, even dishonest about these, and i wil complain again when semester is over.',
            rating: -1,
            difficulty: 2,
            workload: -1,
        },
        ...
        },
        {
            ...
            reviewDate: 'November 5, 2015',
            semester: 'fall 2015',
            review: 'Agree with the comments above. Not too much instructor involvement.',
            rating: -1,
            difficulty: 2,
            workload: -1,
        },
    ...
    reviewSummaries: {
        'fall 2023':
            'The course received generally positive reviews, praised for its manageable workload, engaging content, and excellent TAs. Many students appreciated the easy labs and quizzes in the first half, viewing the course as a strong GPA booster, especially for those entering the healthcare field. The Final Project was highlighted as the most rewarding aspect, allowing for significant learning and application of course material, although some felt the timeline was rushed and suggested an extension. However, critiques included a desire for more engaging lectures and a better focus on relevant lab topics. Some students found quizzes too simplistic and forum participation to feel more laborious than beneficial, indicating potential areas for improvement. Overall, it was considered a fulfilling course.',
        'spring 2023':
            'The Spring 2024 course received largely positive reviews, highlighting its well-structured workload and informative labs, which delve into healthcare technologies like FHIR. Students appreciated engaging lectures by Dr. Duke and supportive TAs who facilitated practical final projects, often completed solo or in small teams. The quizzes and labs were deemed fair and manageable, with ample extensions provided. However, some noted that the self-driven nature of the final project could lead to significant point loss if one procrastinates. Overall, the course is recommended for those interested in healthcare and practical software development, with students expressing confidence in achieving high grades if they stay proactive.',
        'spring 2022':
            'The course presents an uneven workload, with a light initial week followed by five weeks of heavy demands involving lecture videos, quizzes, and labs. Quizzes are manageable with fewer tricky questions compared to other classes, but the vague lab assignments and difficult documentation—particularly regarding FHIR—pose challenges. However, the support from discussion forums and TAs proves invaluable. The latter part of the course offers relief, eliminating weekly quizzes and labs as students focus on self-chosen projects, which many find beneficial. Lectures by Dr. Duke are well-received for their clarity, and active participation on forums is crucial for credit. Overall, the course is recommended for those who can handle a heavy start but prefer lighter workloads later on.',
        'spring 2021':
            'The course has received mixed reviews, with some students finding it manageable and even enjoyable, citing light workloads and engaging projects, such as those involving machine learning. However, a significant number of students described it as poorly structured and disorganized, with vague assignment guidelines and little support from TAs. Complaints about irrelevant content, excessive busywork, and unhelpful responses to questions were common. Some reviewers went as far as to label the course a "mismanaged disaster," warning others to avoid it due to the high workload combined with low-quality instruction. Overall, the class\'s inconsistency and perceived lack of direction led many to suggest reconsidering enrollment.',
        'summer 2021':
            'Reviews for the course reveal significant dissatisfaction among students. Many highlight vague requirements and last-minute changes to assignment due dates, which leave little time for meaningful completion. The limited support from TAs, described as snarky and unhelpful, amplifies frustration, particularly when complex assignments are poorly designed and unevenly distributed. Students also criticized content that was introduced but subsequently ignored. While some students may find the course manageable if assigned easier topics, overall, the inconsistent workload and lack of clarity contribute to a negative learning experience. Many recommend skipping the course altogether and seeking information independently online for a less stressful exploration of the subject.',
        'fall 2020':
            'The course underwent significant changes, resulting in a much heavier workload filled with busywork that often overwhelms students. Many reviewers noted irrelevant lectures and a poorly structured assignment timeline, with intense pressure in the first half and a lighter second half. While some TAs provided valuable support, inconsistency and a dismissive attitude from others detracted from the experience. The course primarily focuses on FHIR within health informatics, which limited exploration of wider subjects. Although students received a high grade, many felt they learned little. The course is recommended only for those with a genuine interest in healthcare or adequate web development skills and should not be taken concurrently with another class due to its demanding nature.',
        'spring 2020':
            "The IHI course garners mixed reviews from students. On the positive side, participants appreciate the absence of quizzes and exams, alongside supportive TAs and the opportunity to develop a full-stack web application through a group project. Additionally, those with a background in healthcare report a certain relevance and alignment with their professional goals. However, criticisms include an overwhelming amount of busywork, with numerous assignments feeling unnecessary or poorly defined, leading to significant stress in the first half of the semester. Some students find the lectures unhelpful and express concerns about group dynamics and external mentors' reliability. Ultimately, while it offers an easy grade for some, many caution that those seeking substantial learning may find it lacking.",
        'fall 2017':
            'This course is deemed very easy, with minimal workload but lacking depth in content. Students appreciated the well-recorded lectures and the supportive instructional team, particularly Dr. Duke and the TAs, but expressed frustration over the range of low-value assignments and group project dynamics. While some found the course engaging for its insights into health technology, others criticized it for being overly focused on grades rather than student learning, citing issues with assignment guidelines and grading criteria. The collaborative group project, which varies greatly depending on team members, was both a highlight and a source of frustration. Overall, the course offers valuable exposure to healthcare IT but requires better structure and more engaging assignments.',
        'fall 2019':
            'The course drew mixed reviews, with a notable divide between those who found the subject interesting and engaging and those frustrated by its disorganization. Many praised the enthusiasm and support of the instructional staff and appreciated the numerous extra credit opportunities. However, the course was criticized for its confusing structure, excessive assignments, and technical issues with tools like RStudio and Azure, leading to frustration. Some students described group projects as particularly challenging due to uncommitted teammates, while others felt the course lacked substantive content. Overall, it appears to be a gamble; students who thrive under chaos and enjoy healthcare analytics may benefit, while others may find it overwhelming and poorly organized.',
        'spring 2019':
            'The course on health informatics has received mixed reviews highlighting both strengths and weaknesses. Positive feedback emphasizes the engaging content from Udacity lessons and valuable group projects, particularly for those deeply interested in medical informatics and technologies like FHIR. However, many students criticize the dry and uninformative video lectures, overly simplistic quizzes, and disorganized assignments that often require extensive Google searches rather than substantive learning. Group projects can be stressful and depend heavily on team dynamics, with some students feeling isolated due to uncooperative teammates. While achieving an easy A is possible, the overall learning experience varies significantly, with many feeling that the course lacks depth and real-world application.',
        'spring 2018':
            'The course received mixed reviews, with many students finding it boring and lacking in meaningful content, particularly criticizing the video lectures as ineffective and disorganized. Despite this, some appreciated the group project and the chance to collaborate with a CDC mentor, which provided practical experience and made the course feel more valuable. Students noted that the workload could be inconsistent, with some weeks demanding significant time investment. A few found the material interesting and relevant to healthcare IT, praising the up-to-date lectures and responsive TAs. Nonetheless, several reviews highlighted that the scope of the course was too ambitious, leaving many feeling overwhelmed and dissatisfied with their learning experience. Overall, while the course might suit some, it left others unenthusiastic.',
        'fall 2018':
            "The course receives mixed reviews, highlighting both positive and negative elements. On the positive side, students appreciate the lack of exams, exposure to health informatics applications, and the opportunity to work with industry mentors. It's seen as an easy GPA booster, especially for those seeking a low-effort course. However, many reviewers criticize the course for its superficial content, stating that lectures and assignments lack depth, and real skills are not acquired. Group projects varied significantly, leading to inconsistent experiences. Additionally, technical issues with the autograder and slow feedback on assignments were frustrating. Overall, while the course has its merits, many feel it lacks the substance and rigor expected in a program of its level.",
        'spring 2016':
            'The reviews for this course present a mixed bag of opinions. Positively, many students enjoyed the class for its intriguing lectures and the insights it provided into healthcare data management, particularly with FHIR. Several highlighted the importance of group projects, which yielded valuable collaborations and learning experiences. Conversely, numerous critiques point to significant organizational issues, poor communication from staff, and a lack of rigorous assessment, with assignments frequently being postponed and course materials released late. Some found the project poorly defined and lacking useful feedback, leading to frustration. While it may offer an easy grade, many suggest that the course needs substantial improvements to enhance overall learning.',
        'summer 2017':
            'The course received mixed reviews from students. On the negative side, many expressed frustration with the heavy emphasis on short assignments, quizzes, and strict word limits for essays that hindered in-depth learning. The group project was also criticized for its rigid structure and the challenge of securing mentor support, leading to disinterest and difficulties in execution. However, some students acknowledged the value of specific activities, like working with FHIR databases, which provided practical experience. While high scores were common, suggesting easier grading, the overall sentiment reflected a lack of engagement and depth, with students feeling they could learn more independently than through the course structure.',
        'fall 2016':
            "The course received mixed reviews, highlighting both strengths and weaknesses. Students appreciated the professor's enthusiasm and engaging lectures, which contributed positively to the learning experience. However, many found the assignments poorly structured and the group project experience frustrating, particularly when team dynamics were problematic. The lead TA's condescending attitude and the course's tight deadlines left some feeling overwhelmed. While some students noted the class could lead to an easy A, others warned it could be a daunting experience if group members didn't contribute effectively. Overall, frustrations with logistical issues and the course's relevance added to the negative sentiment, leading some to question its future viability.",
    },
};
