export default {
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course offers easy labs and quizzes, engaging content, and a fulfilling Final Project that enhances learning. TAs are supportive, and the workload is manageable.',
            con: 'Lectures lack engagement, labs require excessive setup time, quizzes may be too easy, and the Forum Participation aspect feels more like a chore.',
        },
        'spring 2023': {
            pro: 'The course has a well-structured workload that is both rewarding and informative, with engaging discussions, supportive TAs, and practical hands-on labs leading up to a valuable final project. Quizzes are open book and manageable, and lectures are enjoyable.',
            con: 'The self-driven nature of the final project may lead to issues for students who are not proactive, as procrastination could result in losing points.',
        },
        'spring 2022': {
            pro: 'The course has clear and easy-to-understand lecture videos, a reasonable quiz format, and supportive TAs and forums. The later part of the course offers a lighter workload focused on individual projects.',
            con: 'The workload is uneven, with initial weeks being very light followed by a heavy load of quizzes and lab projects. Lab assignments are vaguely worded, and there is insufficient documentation on the material.',
        },
        'spring 2021': {
            pro: 'Some students found the course workload manageable and considered it a good complementary course with interesting projects, even if it was largely a refresher for those with prior experience.',
            con: 'Numerous reviews criticized the course for poor structure, vague assignments, lack of support from TAs, irrelevant content, and overwhelming workload, leading to frustration and a negative learning experience.',
        },
        'summer 2021': {
            pro: 'N/A',
            con: 'Vague requirements, frequent assignment due date changes, poor assignment design with unequal workloads, little help from TAs, and content that is quickly disregarded.',
        },
        'fall 2020': {
            pro: 'The course offers valuable insights and practical knowledge in web development and healthcare technologies like FHIR. Some TAs are helpful, and the absence of tests or quizzes is seen as a positive.',
            con: 'The course is overloaded with busywork, resulting in poor time management and student frustration. Many assignments lack clarity, and inconsistent grading has been reported. Lectures are deemed irrelevant, and the disorganization with TAs contributes to a negative course experience.',
        },
        'spring 2020': {
            pro: 'The course offers no quizzes or exams, meaningful group projects, and responsive instructors, providing an opportunity to build a full stack web application.',
            con: 'There are many busywork assignments, lectures are often unhelpful, and the workload is poorly distributed, causing mental fatigue.',
        },
        'fall 2017': {
            pro: 'The instructional team, including Dr. Duke and TAs, is highly responsive and helpful. The course offers interesting material, particularly in healthcare technology, and allows for hands-on experience with FHIR activities. The workload is light, making it a good option to pair with more challenging courses.',
            con: 'The course is perceived as overly easy, lacking depth and engagement. It requires a lot of organizational skills to manage numerous assignments, and many students found the lectures boring and not directly useful to the course objectives. Issues with grading seem to focus more on format than on content understanding.',
        },
        'fall 2019': {
            pro: 'Engaged instructional staff, interesting subject matter, many extra credit opportunities, and a progression of material that makes the course feel manageable despite numerous assignments.',
            con: 'Highly disorganized, technical systems frequently malfunction, excessive and confusing communication, poor quality of case studies and assignments, and significant issues with group projects.',
        },
        'spring 2019': {
            pro: 'The course provides an interesting overview of healthcare informatics and offers engaging projects, particularly the group project, which can be rewarding if working with a good team. The Udacity lessons and guest lectures feature worthwhile content, and it is relatively easy to achieve a good grade.',
            con: 'The course includes many dry and lengthy lectures, irrelevant content in case studies, and a frustrating grading system, particularly with the auto-graded activities. Group projects can be stressful due to uneven participation and conflicts arising from team dynamics.',
        },
        'spring 2018': {
            pro: 'The course includes interesting material with practical applications, a well-structured group project with external mentors, and responsive TAs for support. Many found it to be an easy course, beneficial for learning health informatics and industry standards.',
            con: 'The lectures were often seen as boring and poorly produced, with inconsistent workload and a disorganized structure. Some students felt the course was overly ambitious and lacked depth in certain areas.',
        },
        'fall 2018': {
            pro: 'The course exposes students to various health informatics applications and supports collaboration with industry mentors on group projects. It is also regarded as a good introductory course for Java and interoperability issues.',
            con: 'The course lacks depth in lectures and assignments, making it easy but not very fulfilling. Many students felt they did not gain new skills, and issues with grading on assignments were common. The group project was also seen as inconsistent in terms of learning outcomes.',
        },
        'spring 2016': {
            pro: 'Many students found the course enjoyable and appreciated the interesting lectures, group projects, and the exposure to important concepts in health informatics.',
            con: 'The course was criticized for being poorly organized, lacking rigor, having inconsistent communication, and offering minimal useful knowledge, along with a disorganized course staff.',
        },
        'summer 2017': {
            pro: 'The FHIR activities provided practical experience with Java and working with a FHIR database, which was beneficial.',
            con: 'The class structure limited depth of learning due to strict word limits on assignments, and the group project faced challenges with project selection, mentor availability, and time management.',
        },
        'fall 2016': {
            pro: 'The professor was enthusiastic and presented interesting material. Lectures were considered a redeeming quality of the class.',
            con: 'Course structure was poorly organized with messy assignments, overwhelming workload, unhelpful TA, and relied on ineffective engagement exercises. Group work could lead to poor experiences due to unequal contributions.',
        },
    },
};
