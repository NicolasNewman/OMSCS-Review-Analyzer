export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'Good course!  Recommended.',
            rating: 5,
            difficulty: 2,
            workload: 12,
        },
        ...
        },
        {
            ...
            review: 'If you get 89.5% in this course you will end up with B which means 3 out of 4.  Good grading system when i work myself off all semester and got B. Ridiculous!',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2020',
            review: "This class was okay. The lectures were organized well and provided a good overview of the material. The readings were hit and miss. A few of them were good and provided some good insights into the struggles of information security policies.\nThe group projects are probably what left a sour taste in my mouth with this class. It is really up to the luck of the draw with this.\nOverall, it was an okay class. I believe it would be better if it didn't have the group projects.",
            rating: 3,
            difficulty: 2,
            workload: 4,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'Very easy, and good class. Light workload, and solid overview of security policy. Does involve group projects, so managing other people can be an extra headache and time suck to take into account. Overall a good class to take if you have the opportunity.',
            rating: 4,
            difficulty: 1,
            workload: 4,
        },
