export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: 'This has been my least favorite class in the entire program and I am almost done with the program.',
            rating: 1,
            difficulty: 3,
            workload: 6,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'July 13, 2021',
            semester: 'summer 2021',
            review: 'I maybe a minority here, but I have liked this course. I did not have business background to begin with.I am not sure how much of what I am learning will have any relevance to any analytical work but the course by itself is not bad. It does a good job of introducing the various modules :accounting, finance, supply chain and marketing. ( no strategy for summer). Prof Flurry was nice enough to have the accounting module take home test too. It is one of the very few courses that does live teaching ( not just office hours). It is important to listen and assimilate what is being said in the videos and weekly video conferences. A lot of questions in the exams come from that. Some of these things are not written in the slides. The problems are basic 10th standard arithmetics. Overall a good course by itself. Just not sure about its relevance to OMSA.',
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: "Contrary to popular opinion I thought this course was great. It's a business fundamentals course and it delivered on that really well.\nIf you have an undergrad in business, skip it.",
            rating: 5,
            difficulty: 3,
            workload: 6,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: 'I have an MBA. This course should have been cake. Nope. This course is heavy memorization. VERY heavy memorizarion. Opt out if you can.',
            rating: 1,
            difficulty: 5,
            workload: 2,
        },
        ...
        },
        {
            ...
            semester: 'summer 2020',
            review: 'Overall the course is good but should not be a required course as its content is not directly relevant to analytics except for supply chain module maybe. Marketing module can be improved by focusing on analytics related topics such as A/B testing, Multi-arm bandit testing, etc.',
            rating: 4,
            difficulty: 2,
            workload: 3,
        },
        ...
        },
        {
            ...
            semester: 'spring 2020',
            review: 'They need to reduce the length of the office hours, drop the marketing module, and reorganize the business strategy module to make it more coherent in terms of contents...... The fact that this class is mandatory is a bit strange to me.',
            rating: 2,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "Easy class. Just don't fall behind.",
            rating: 3,
            difficulty: 2,
            workload: 5,
        },
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The accounting module is highly praised for its excellent teaching and resources, with engaging lecture videos and high overall class performance. Supply chain is also well-received for its straightforward concepts and helpful lecture videos. TAs are noted to be supportive and helpful for students.',
            con: 'The marketing section is criticized for being poorly structured and overwhelming, requiring excessive memorization with little guidance. Finance is noted to be challenging with a high volume of difficult material, and the frequent exams can be exhausting. Some students feel that certain topics are unnecessarily repeated.',
        },
        'spring 2024': {
            pro: 'The course is not too difficult and offers extra credit on exams.',
            con: 'The material is surface-level and focused on memorization; lectures often exceed the expected duration, and a large portion of the grade relies on exams, which may disadvantage poor test-takers.',
        },
        'spring 2023': {
            pro: 'The course includes valuable case studies, such as the Tesla and Trader Joe cases, which effectively connect to the material.',
            con: 'Lectures are lengthy and often repetitive, with outdated content; office hours are unproductive; marketing homework lacks variety; and TAs provide inadequate support.',
        },
        'fall 2023': {
            pro: 'Course covers interesting and applicable topics for business, with well-structured modules in Finance Accounting and Marketing.',
            con: 'Frustrating exam structure with varying difficulty across modules, chaotic Supply Management content, and rushed 3-week module format.',
        },
        'summer 2023': {
            pro: 'The course is enlightening and broadens understanding of key business areas. The instructors are fantastic at explaining complex concepts and providing support. Module-ending quizzes effectively reinforce learning.',
            con: 'The course structure is intensive with frequent exams, making it taxing. There is a lack of connection between course content and Data Analytics. More downtime between modules would be beneficial.',
        },
        'fall 2022': {
            pro: 'The course offers a practical and refreshing learning experience, particularly valuable for students with an engineering background. The instructor was passionate, approachable, and dedicated to student success, extending class times to accommodate questions. The varied subjects cover essential topics like finance, supply chain management, business strategy, and marketing, providing valuable skills for real-world application.',
            con: 'Some students felt skepticism due to low ratings and the necessity of attending the class. There are assignments that require additional payment for submission, which some found odd. The course might be less beneficial for those already familiar with business concepts.',
        },
        'summer 2022': {
            pro: 'The TA office hours for Accounting and Finance are praised for their detail and support. The course is self-contained, allowing for a quicker completion in the Summer, and some topics, particularly in Finance, are noted as interesting.',
            con: 'The course has poor organization with different grading requirements, a rude Head TA, a lack of feedback or grade curving, and much of the material is deemed irrelevant or redundant. Tests were criticized for being unfair, and the knowledge gained is often viewed as not applicable.',
        },
        'spring 2022': {
            pro: 'The course is generally well-organized and covers a lot of material, with engaging simulations and supportive professors.',
            con: 'The volume of information is overwhelming, with disorganized quizzes and a mismatch between exam content and study materials, making it challenging for those with lower recall abilities.',
        },
        'fall 2021': {
            pro: 'The course material is considered good and valuable for future careers, with positive experiences related to in-person interactions with caring professors who offer support and flexibility with deadlines.',
            con: 'Many students find the course excessively challenging and frustrating due to the amount of unnecessary information, lack of actual learning, and an inflexible structure that does not accommodate non-industry professionals.',
        },
        'summer 2021': {
            pro: 'Some students found the course helpful for learning business fundamentals, especially those without a background in business. The responsiveness of Professor Flury and the organization of the material into modules were appreciated by some.',
            con: 'The course received criticism for being poorly organized, with inconsistent teaching styles among professors and insufficient instructor support. Many students found the workload overwhelming and felt that the course did not cater well to those without prior business knowledge.',
        },
        'spring 2021': {
            pro: 'Professor Flury is very responsible and cares about student engagement and learning. The accounting part is well-received for its clarity.',
            con: 'The course is criticized for being poorly organized, with outdated materials, excessive unrelated content, and inconsistent teaching styles. Many students find it difficult due to a lack of a textbook and the overwhelming amount of information crammed into the syllabus.',
        },
        'fall 2020': {
            pro: 'The course delivers well on business fundamentals, offers engaging professors and TAs, and provides ample practice materials for exams.',
            con: 'The course requires heavy memorization, has a large content load with little reinforcement, and lacks practical application in several modules.',
        },
        'fall 2019': {
            pro: 'Students appreciated the accounting and finance modules for their practical applications and found the professors accessible and engaging. The homework and group projects were viewed positively, aiding exam preparation.',
            con: 'Many found the latter modules, particularly marketing and business strategy, to be overly verbose and filled with common-sense concepts presented in complicated language. Some felt the course required excessive memorization, which they deemed unnecessary.',
        },
        'summer 2020': {
            pro: 'Some sections, particularly Supply Chain, were well-received, with engaging professors and interesting material. The course provided a broad overview of various business topics and helpful examples of real-world applications.',
            con: "The course faced significant criticism for reliance on rote memorization, poor lecture presentation, and an unorganized structure. Many students found the main professor confrontational and the exams difficult, leading to frustrations about the course's design and content relevance.",
        },
        'spring 2020': {
            pro: 'The course is well organized, with helpful professors and TAs. The accounting and finance sections are particularly praised, along with the overall structure and responsiveness of the teaching team.',
            con: 'The marketing module is poorly executed and overly broad, lacking coherence and meaningful engagement. Many reviews highlight issues with group project participation, unclear grading rubrics, and a lack of feedback on assignments.',
        },
        'summer 2019': {
            pro: 'The course features enjoyable mathematical content in finance, helpful strategy sections, and supportive professors and TAs who provide quick responses to questions. Many students found the terminology useful in their current jobs.',
            con: 'There is a significant amount of memorization required, especially in the second half, which some students found challenging. Weekly video calls can be lengthy and disorganized due to off-topic questions, making it hard to locate required material.',
        },
        'spring 2019': {
            pro: 'Some students found the accounting and finance sections informative and essential for analytics graduates, especially due to the inclusion of mathematical concepts and clear answers.',
            con: 'Many reviews highlighted issues with the course structure, difficult assignments, outdated materials, lack of substance in marketing/business strategy sections, and confusion during lectures, leading to a general sense of dissatisfaction.',
        },
        'summer 2018': {
            pro: "Some students found the material interesting and engaging, with specific praise for Professor Flury's responsiveness and explanations. A few also appreciated that the course provides a solid framework for understanding a variety of business topics.",
            con: 'Many reviews highlighted issues with the course structure, unmanageable content volume, poor lecture delivery, high memorization demands, and a lack of meaningful assignments or projects. Several students reported feeling overwhelmed and recommended avoiding the course if possible.',
        },
        'spring 2018': {
            pro: 'Some students appreciated the course for its relevance, organization, and clear expectations. The professor was noted for being responsive and helpful, and some found the material applicable to their careers in business.',
            con: 'Many students criticized the course as poorly taught, irrelevant, and overstuffed with material. Issues with grading, limited opportunities for assignments, and a lack of practical application were also common complaints.',
        },
        'fall 2018': {
            pro: 'The course provides a wide breadth of material that gives a solid introduction to business concepts, with a responsive professor and effective class coordination.',
            con: 'The course lacks a connection to analytics, has a challenging exam format with excessive material, and could benefit from more engaging, project-based work.',
        },
        'fall 2017': {
            pro: 'Some students found the course enlightening, providing a broad overview of various business topics they were previously unfamiliar with, particularly those without a business background.',
            con: 'The course structure, teaching methods, and grading practices were heavily criticized, with many students describing the material as dense, poorly presented, and disconnected from analytics. The instructional style was often seen as dry and ineffective, and the grading lacked fairness, with no partial credit and overly specific memorization required for exams.',
        },
    },
};
