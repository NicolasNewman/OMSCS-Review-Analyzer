export default {
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: 'The course is enjoyable and interesting with straightforward assignments and projects. It allows for a lighter workload and does not include unreasonable busywork.',
            con: "Some content can be dry, and the success of group projects may depend on the group's programming skill level.",
        },
        'fall 2019': {
            pro: 'Lectures and readings were very interesting; overall a good class to pair with other difficult classes.',
            con: 'Group projects can be challenging if team members are unresponsive; time management is important.',
        },
    },
};
