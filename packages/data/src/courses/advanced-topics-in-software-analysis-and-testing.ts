export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            review: "I am 5 courses into the program, and this is my favorite course I have taken so far. The lectures are well done, informative, and do not run long like some of the other classes I have taken. The teaching staff is responsive to questions asked, which is great. The biggest complaint that I have seen from others is that the LLVM documentation isn't great, which while somewhat true, is also representative of how software engineering can work at times. I found that as the course progressed I got much better at finding what I needed and getting the labs done quickly. Overall, I loved this course and would highly recommend it.",
            rating: 5,
            difficulty: 2,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: 'The labs are challenging (in a good way) but fair.  They offer a great opportunity for the generous extra credit once you figure them out and help others.  The instructor and TAs are very active on Ed and Slack.  Unlike other classes, grade response is very quick.  Today is the last day that assignments are due (8 AM), and we got our final grade at 2:45 PM.',
            rating: 5,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            review: "This was my first OMSCS course and it was a good one! The topic itself was not one I had much interest in, but it turned out to be pretty interesting. The assignments (labs) were very technical and just challenging enough. I hadn't touched C++ in at least 5 years but there was no real in-depth language knowledge required to complete them. My lowest score was on the exam but it was easy to make up for that with the labs and get an A in the end. The profs and TAs are very responsive.",
            rating: 4,
            difficulty: 2,
            workload: 6,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: "I think this would be a good first course for many entering the program, as you really just need a pretty basic programming background for the labs. While I found several challenging, the complexity comes mostly from the LLVM infrastructure you work with in most labs\nI thought the course lecture content was interesting, although I also feel like it may be material I won't utilize much in my professional career. If you are interested in automated testing then this is definitely a must take. TAs were good, quizzes and the one exam seemed fair",
            rating: 4,
            difficulty: 3,
            workload: 16,
        },
        ...
        },
        {
            ...
            review: "Didn't really know what to expect from this course but I wanted to get exposed to this domain. I think this course does a great job in introducing a beginner to this landscape.\nI would love to see a sequel to this course that would select a couple of tools from this course and have students apply that on open source projects",
            rating: 4,
            difficulty: 3,
            workload: 14,
        },
        ...
        },
        {
            ...
            review: 'One of the most well-run course in the entire program. Fantastic team of TA who genuinely cares about the students. Very fast turn-around for grades too. The material was a little dry though. Overall, an OK class.',
            rating: 3,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            review: 'You can learn some really interesting techniques during this course.',
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'February 3, 2020',
            semester: 'spring 2020',
            review: 'This is my first semester and I was very excited about this class and now I am about to withdraw. I will try doing lab2 and if I am unsuccessful I will be done with it. Lab2 seems to be a lab from a compilers class WTH, knowing that you have students coming from different backgrounds not CS only background, they should try to do better. I am pretty sure this class is a breeze for CS majors... I am very sad right now. I agree you should know C++ for the first labs. I spent more time figuring out when to pass a reference, a pointer or an object, seems that the only way to teach Software Analysis is using C/C++. I hope the other classes in the program are not like this one.',
            rating: 2,
            difficulty: 4,
            workload: 16,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: 'Fascinating course. Labs are challenging but actually very relevant to the content, and the tests are also challenging but fair and balanced. This course is incredibly well run. The TAs operate like a machine. Grades come back lightning-fast, and contact with the teaching staff is easy and readily available. This is a great first course in OMSCS.',
            rating: 5,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: "Very responsive instructors. Interesting projects. Quickest grading I've seen yet.",
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        {
            ...
            semester: 'fall 2019',
            review: 'The lectures are OK. They are a bit dry and hard to follow at times (especially when the sentences are looooooong). The projects are released very early so you could in theory front-load the whole course.',
            rating: 3,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            review: 'Was not bad by itself. Tests are "open note" with specific guidelines. you have 3 hours to take the tests, You could potentially take the full time.',
            rating: 3,
            difficulty: 3,
            workload: 20,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'September 22, 2019',
            semester: 'fall 2019',
            review: 'The course material is very simple and I liked the video course content. To make for simple content, the lab instructions were less clear and somewhat omitted instructions. Apparently, I felt like the goal was "gotchas" rather than programming skill that was presented.\nSo I dropped from the course so that I can concentrate on other courses that emphasized learning rather than\ndealing with snags.',
            rating: 2,
            difficulty: 2,
            workload: 5,
        },
        ...
        },
        {
            ...
            review: 'Great info on static and dynamic analysis of software, plus some fun QA techniques.',
            rating: 4,
            difficulty: 2,
            workload: 12,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'April 13, 2019',
            semester: 'fall 2018',
            review: "Great first class for the program.  The theory was interesting and presented clearly, and the labs backed up most of the modules with practical application.  Exams were challenging but fair.  TAs and professor were available on Piazza and for office hours.  I think this would be a good summer course too.\nHere's how the labs broke down for this semester:\n\nFuzzing (pretty easy)\nAutomated test generation (pretty easy)\nDataflow analysis in C++ (tougher)\nDataflow analysis in Datalog (difficult conceptually but not too much actual work)\nStatistical debugging (tricky but cool)\nDelta debugging (pretty easy)\nSymbolic execution (difficult)\n",
            rating: 4,
            difficulty: 2,
            workload: 5,
        },
        {
            ...
            semester: 'fall 2018',
            review: 'Learned a few things that would be useful for work, like using datalog to analyze java code and a few analysis and testing techniques. THIS IS NOT A COURSE ABOUT TESTING LIKE WE DO AT WORK (unit/e2e/smoke/etc.)\nDisliked having to parse recursive algorithms manually during test via proctortrack , with over 20 droddown list to  fill without the use of any paper. That was just ridiculous',
            rating: 2,
            difficulty: 4,
            workload: 25,
        },
        ...
        },
        {
            ...
            reviewDate: 'January 3, 2019',
            semester: 'fall 2018',
            review: 'Course videos/resources did not align with assignments/tests, which made the course challenging.  If you are familiar with C and scripting the course may be a good one for you.',
            rating: 2,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "I started out not liking this course but it started to grow on me more into the semester.  It is NOT just writing unit tests, it is more tied to the analysis of code in general and touches on some interesting topics around testing.  I enjoyed doing the labs, they can be challenging(the Datalog one was particularly cool IMO).  The exams are hard, and worth 19% each - but fair.  If you make a good study guide, understand the concepts, and watch the TA video before you should do fine.  They take the best 6 of 7 labs which worked well for me because I totally forgot about an early lab.  Ended up with an A and I wouldn't say it was the most time intensive course.",
            rating: 4,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'I went in with low expectations for this course topic but I was totally wrong.\nWonderfully integrated course with the lectures and the projects complementing each other fantastically. The TA and Prof are very responsive and the course material was fresh introducing a wide range of new tools that can be utilized in current day work environment.',
            rating: 5,
            difficulty: 3,
            workload: 11,
        },
        ...
        },
        {
            ...
            review: 'The worst class I have taken. Do not think I will really use anything I "learned" in this class.',
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            semester: 'fall 2017',
            review: 'I really enjoyed this course and was exposed to a lot of new analysis and testing concepts.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'one of the worst course I have ever taken. Both professor and TAs were disinclined to help students with very less participation and clarification. I doubt if I will ever use topics learnt in this course in my professional career. regret taking this course after putting so much of effort and time.',
            rating: 1,
            difficulty: 5,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: 'Really engaging class with a ton of instructor support. Highly recommended if you are just starting the OMSCS program as it eases you into the school schedule. The course content lead to more investigation into different testing frameworks and code analysis that I am able to apply at work!',
            rating: 5,
            difficulty: 3,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'spring 2017',
            review: "the class leverages out of data technology for the assignments making it very difficult and time spent on those projects. Secondly there is not enough readings for the lecture material and the lectures are very lacking. Wasn't a fan of the material in this class. Also the exams are very challenging. this class would be best suited if it updated to newer technology and provides a good book.",
            rating: 1,
            difficulty: 5,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'For NON-traditional students – the course is not difficult but expects you to be familiar with many different tools. Don’t get caught because you not familiar with basic linux debugging for java and c.',
            rating: 4,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: "Hands down the worst class that I've ever taken in my life. The material isn't that difficult but the professor is just an amateur instructor.",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'spring 2016',
            review: "Really interesting class - it does a good job of balancing practical and theoretical aspects of software analysis, and covers some very interesting tools and techniques. The videos are very well done, and explain the concepts well.\nIt suffers from some pacing issues - it switches from being very busy to having nothing to do for a few weeks - but I'm attributing that more to it being the first offering of the class.\nRecommended.",
            rating: -1,
            difficulty: 3,
            workload: 5,
        },
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The course content is interesting and well-organized, providing good preparation materials and promoting a fair examination structure. The course team shows substantial effort in course design.',
            con: 'Lectures can be hard to follow with poor logical flow. The labs are frustrating due to insufficient guidance on using LLVM, and the teaching approach of leaving students to figure things out has been criticized. Documentation for LLVM is deemed inadequate, leading to confusion and wasted time.',
        },
        'spring 2024': {
            pro: 'The course is highly organized with extremely helpful instructors and TAs. Lab instructions and videos are clear and contribute well to understanding the concepts. Students appreciate the opportunity to work ahead and the overall learning experience.',
            con: 'Some course materials, like software versions, could be updated. Parts of the course on software analysis were not engaging for all students.',
        },
        'summer 2023': {
            pro: 'The course is well-organized with informative lectures, responsive teaching staff, balanced assessments, and effective hands-on labs that reinforce learning.',
            con: 'Some students felt they did not learn much and found the labs challenging, particularly if they were not well-versed in C++. There were mentions of a need for improvement in exam and quiz formats.',
        },
        'summer 2022': {
            pro: 'The course is considered surprisingly good and underrated, especially after completing the initial labs. Most lab assignments provide helpful code frames, and the course is perceived as easy after overcoming early challenges.',
            con: 'TAs are not very helpful, providing vague instructions, and there is a lack of sufficient online resources. The material is deemed outdated and theoretical, leading to limited learning outcomes.',
        },
        'fall 2022': {
            pro: "The course offers a practical application of LLVM and is deemed very industry-relevant, with well-structured lectures and labs. Most students find the midterm and quizzes fair, and there's good support through extra credit opportunities and timely grading of assignments.",
            con: 'The course has a steep learning curve with LLVM, leading to frustration due to misleading course title and insufficient supporting resources. The assistance from TAs is inconsistent, and some quizzes did not align well with the material covered in lectures.',
        },
        'spring 2022': {
            pro: 'The course is well-organized with engaging lectures, challenging yet fair labs, ample extra credit opportunities, and responsive instructors and TAs. It provides exposure to a range of advanced topics in software analysis and encourages active learning and application of knowledge.',
            con: "Some students felt the course lacked collaboration and a sense of community, and it may not directly add value to everyone's skill set. Certain quizzes had vague questions, and lectures could be perceived as dry.",
        },
        'fall 2021': {
            pro: 'The course is well organized, with clear lectures and responsive TAs. Quizzes are easy and open note, and many students found the workload manageable, allowing completion in a shorter time frame.',
            con: 'The course content is superficial and lacks depth; the labs are often easy and rely heavily on provided algorithms. Some labs can be challenging, and there are frustrations with quiz question misunderstandings.',
        },
        'summer 2021': {
            pro: 'Well-organized course with clear lecture videos, plenty of office hours, quick grading, and practical insights into software analysis and testing tools using LLVM. Labs provide a good understanding of concepts without being overly tedious, and quizzes help reduce stress.',
            con: 'Dry and boring lecture style, minimal help from TAs, stringent grading policies, and hidden lab test cases. Some students expressed difficulty with the pace, particularly during the summer semester, and found the course challenging if not well-versed in LLVM.',
        },
        'fall 2020': {
            pro: 'The course offers interesting projects, helpful TAs, and a well-structured schedule that allows for pacing. The content is described as engaging, especially for those interested in automated testing and puzzles.',
            con: 'The course material can be dense and poorly explained, with assignments often exceeding the scope of the lectures. Some students found the TAs unhelpful and the recommended readings excessive and irrelevant, particularly for those without a CS background.',
        },
        'spring 2021': {
            pro: 'Students appreciated the engaging content, responsive instructors and TAs, and the opportunity to earn extra credit. Many found the course interesting and useful for improving coding skills, especially regarding software analysis and testing.',
            con: 'Some reviews mentioned disorganization in lab instructions, confusion due to differing difficulty levels of labs, and the need for extensive outside research. Additionally, issues with the class VM and mixed experiences with TA support were noted.',
        },
        'summer 2020': {
            pro: 'The course effectively introduces beginners to the domain and provides a broad overview of software testing and analysis, with accessible and accommodating instructors.',
            con: 'The condensed summer format made the course challenging, the material was considered dry by some, and prior knowledge of C and LLVM is essential for success.',
        },
        'spring 2020': {
            pro: 'The course is well-run with a fantastic team of TAs who care about students. The grading turnaround is quick and the content is clear despite its abstract nature.',
            con: 'The course is considered poorly designed and too theoretical, focusing heavily on compiler optimization rather than practical software analysis. Lectures are seen as cryptic, labs are vague and difficult, and there are strict rules that some students find controlling.',
        },
        'spring 2019': {
            pro: 'The course offers interesting techniques, is well-organized, and has knowledgeable TAs. Labs are engaging and the content deepens understanding of programming languages and debugging.',
            con: 'The subject matter is considered dry by some students, making it difficult to stay engaged, especially for those without a formal computer science background.',
        },
        'fall 2019': {
            pro: 'The course is well-organized with responsive instructors, helpful lab materials, and efficient grading. Many found the TAs supportive and the projects interesting and relevant to the content.',
            con: 'The course content is viewed as simplistic and less applicable for many students, with some reviews highlighting confusing lab instructions, a challenging virtual environment, and invasive proctoring requirements.',
        },
        'summer 2019': {
            pro: 'The course provides interesting content on program analysis with helpful labs and great support from TAs. Many students appreciated the responsive instructors and valuable techniques learned, especially in testing methodologies.',
            con: 'The exams are poorly designed, causing confusion and inconsistent grading, which has led to low average scores. Some reviews also expressed dissatisfaction with the course material, describing it as lacking substance.',
        },
        'spring 2018': {
            pro: 'The course was well organized with informative lectures that correlated well with projects. The TAs and professor were responsive and helpful, with helpful office hours. Projects were engaging, and those with programming skills found the course manageable.',
            con: 'There was a disconnect between lesson videos and assignments, with some assignments being frustratingly abstract. The exams were much tougher than expected, and one student reported a lack of assistance from professors and TAs, leading to dissatisfaction.',
        },
        'fall 2018': {
            pro: 'The course is well-organized with a broad range of engaging topics that bridge theory and practical application. TAs and professors are responsive and supportive. Labs reinforce learning and are diverse in content. Exams are challenging but fair, with practice materials provided.',
            con: 'Exams may not align well with lecture content, leading to potential confusion. The course requires knowledge of multiple programming languages, which might be difficult for some students. Some assignments are complex and may require excessive time spent learning new tools and frameworks.',
        },
        'summer 2018': {
            pro: 'The course offers a lot of interesting and new material on static and dynamic analysis, effective projects, and is well organized with strong support from instructors and TAs.',
            con: 'Lectures lack depth compared to challenging exams, and some students found the workload and grading policies, particularly regarding labs and tests, to be unfair.',
        },
        'summer 2017': {
            pro: 'Some students found the class to be great, appreciating its depth in software analysis at static and dynamic levels, and felt it provided a solid foundation for further study.',
            con: 'Many students were disappointed with the course content, stating it did not align with their expectations regarding software testing techniques and felt it was more suited for those with a background in CS and compilers. They also criticized the lecture material for being dry and the lack of support for assignments.',
        },
        'fall 2017': {
            pro: 'Many students found the course engaging, appreciated the support from instructors and TAs, and valued the exposure to new tools and concepts related to software analysis and testing. The assignments and exams were often viewed as challenging yet fair, helping to reinforce learning.',
            con: 'Several students reported a steep learning curve, a lack of alignment between lectures and assignments, and outdated or overly complex materials that could lead to confusion. Some assignments were described as frustratingly inconsistent in difficulty, and there were complaints about inadequate resources and support in certain instances.',
        },
        'spring 2017': {
            pro: 'Several reviews noted that the course covers interesting topics related to software testing and analysis, and some students found the assignments to be engaging and well-aligned with lectures. The support from TAs was often highlighted as helpful and responsive.',
            con: 'Many reviews expressed dissatisfaction with outdated technology, ambiguous lectures, and the difficulty of exams compared to the preparation materials. Students criticized the lack of comprehensive supporting materials and clarity in assignment instructions, leading to frustration and a sense of unfair grading.',
        },
        'summer 2016': {
            pro: 'The course introduces valuable tools for Android testing and offers a hands-on approach with exciting content. TAs provide excellent support, and the workload is manageable for some students.',
            con: "The course suffers from an absent professor, outdated materials, and weak video explanations. Some assignments are poorly documented, and the class content does not meet all students' expectations.",
        },
        'fall 2016': {
            pro: 'The course material is interesting and well-presented through video lectures. Exams are well-written and helpful practice exams are provided. TAs and fellow students are noted to be supportive.',
            con: 'Documentation for assignments is inadequate, leading to difficulty in completing them. Some assignments do not align with lecture content, and there is perceived aloofness from the teaching staff. Outdated APIs and poor documentation are also mentioned as challenges.',
        },
        'spring 2016': {
            pro: 'The course offers interesting content with well-structured lectures and engaging assignments. Many found the quizzes helpful for learning, and some appreciated the practical applications of the assignments, especially in software analysis and testing. The teaching staff was noted for being active and supportive on Piazza, with overall favorable grading.',
            con: 'The course suffers from significant challenges, including high difficulty levels of exams that do not accurately assess student knowledge, a lack of clarity in assignment instructions, and an intimidating environment regarding plagiarism. Many students felt that the course content strayed from initial expectations, leading to frustration and confusion.',
        },
    },
};
