export default {
    ...
    reviewSummaries: {
        'fall 2021': {
            pro: 'The TA and professor dedicated significant time to office hours, providing support to students.',
            con: 'The class lacked organization and timely provision of project materials, leading to student stress.',
        },
    },
};
