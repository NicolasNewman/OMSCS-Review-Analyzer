export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'summer 2024',
            review: "As this is my first summer semester, I find the course to be densely packed with well-thought-out content. While it's certainly worth the effort, I would recommend offering it during the spring or fall semesters instead. The course is well-structured, with comprehensive and self-sufficient content. The recorded tutorials for the sample tests are particularly helpful. Dr. Goldman's enthusiasm and humor in the lecture videos are also noteworthy.",
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2022',
            review: 'I love this course so much. The ability of Professor to teach math with fun is beauty of the course. TAs are awesome. Grade distribution is 2.5% bonus, 25% on Midterm 1, 25% on Midterm 2 , 30% on final , 10% on project and 10% on homework’s. If you able to watch weekly videos , homework’s are doable.',
            rating: 5,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 8, 2022',
            semester: 'spring 2022',
            review: "OMSCS, Stats background. This course is soft and gentle, and a good refresher. The professor makes sure to throw in free (funny) points. There are simulation materials that are good to be aware of, but I'm not sure I'd use them. Even if you are not strong in maths, exams are not that hard (seriously, make good cheat sheets and you don't need to worry much). Grading on the project is also lenient. All in all, this is a breather, fine choice if you want to do a two-course sem and simulate your maths a bit.",
            rating: 3,
            difficulty: 2,
            workload: 5,
        },
        {
            ...
            semester: 'fall 2021',
            review: 'If you are good at learning theoretical concepts, this course is for you. The course is not bad, but not the best either. The professor makes a big curve at the end of the semester, so earning a high D+ represents B',
            rating: 3,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'This is a great course with a lot of theory and applied knowledge.  The instructor and TAs are extremely responsive.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 13, 2021',
            semester: 'fall 2021',
            review: 'This is really just an advanced stats class. I feel much of what we learn in this class will never be used by anyone. We spent multiple lectures on how to generate a random numbers and variables which for most people is useless and typing rand() will suffice. In addition this class has a lot of theory and less practical material.\nIn my opinion the most useful stuff is at the end of the class, such as non homogeneous Poisson processes and output/ steady state analysis.',
            rating: 2,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'July 30, 2021',
            semester: 'summer 2021',
            review: 'The boot camps at the outset of the class were helpful but it’s been going on 20 years since I took Calculus and Statistics classes, so I found it difficult to answer some of the questions asked around things like the Central Limits Theorem and such, even though I could follow along and understand the examples. So know that you will need to brush up on these topics.\nOtherwise, I thoroughly enjoyed this class. It is my 8th in the OMSA program and I think the best one with ISYE-6501 coming in second.',
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            semester: 'summer 2021',
            review: "Really enjoyed the class! You can tell the professor and TA's were all knowledgeable and wanted people to learn.",
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2021',
            review: 'Great professor and very responsive and helpful TAs - the lectures were engaging and the slides were clear. The class is basically a ton of stats with a little bit of Arena thrown in. I was very, very rusty in stats prior to taking this course but as long as you keep up with the lectures and spend time prepping your "cheat sheets" for the exam, you should be okay if you\'re willing to put in the work. The professor also offers quite a bit of extra credit. I would also highly recommend getting a graphing calculator such as the TI nspire CXII. If you\'re rusty on some basic math functions (like solving integrals, etc.), the calculator is an absolute lifesaver.',
            rating: 5,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 5, 2020',
            semester: 'fall 2020',
            review: 'Good course, no complaints',
            rating: 4,
            difficulty: 2,
            workload: 6,
        },
        {
            ...
            semester: 'fall 2020',
            review: 'Be aware that you will be tested on Arena, so despite being told you can use the programming language of your choice, you should use it for the project.  Tests are the bulk of the grade.',
            rating: 4,
            difficulty: 2,
            workload: 5,
        },
        {
            ...
            review: 'Interesting and easy course. It covers basic concepts in statistics, simulations with randomness, and introduction to a software Arena. There is weekly easy quiz, which covers similar questions in exams.',
            rating: 4,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2020',
            review: "Extremely well run class. Goldsman and the TAs are awesome. Videos are top notch. Assignments and exams are straightforward. Dad jokes are awesome. Disappointed with the material though. Calling this class Simulation is a misnomer. It's much more of a Math/Stats/Probability class than it is Simulation.",
            rating: 2,
            difficulty: 3,
            workload: 10,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'July 13, 2020',
            semester: 'summer 2020',
            review: 'I felt bit tough to manage the schedule along with other commitments but Prof.  & teaching assistants are really helpful and very much caring. It is very difficult to get a A but with consistent effort we can get a B.',
            rating: 4,
            difficulty: 5,
            workload: 17,
        },
        ...
        },
        {
            ...
            reviewDate: 'May 4, 2020',
            semester: 'spring 2020',
            review: 'This was a very difficult course, but Dr. Goldsman is a great professor! There is a lot of math and stats involved, so the lectures tend to be longer than ISYE 6501. The homework a multiple choice quiz on canvas. I found that writing out the practice tests to a given sheet to be fairly effective at studying for the tests. I wish I had done that for midterm 1!',
            rating: 5,
            difficulty: 5,
            workload: 8,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'March 2, 2020',
            semester: 'summer 2019',
            review: "It seems more like a stats class....but overall a great class.  The lectures are great and the TA's are some of the best in the program.  You will be given all the tools you need to do well on the exams.   Not easy to get an A, but you can get an A if you put the time in.",
            rating: 5,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'This is a must-take class if you are in the OMSA program, just so that you get to work with Professor Goldsman. His puns are classic "dad" jokes, and he is very engaged in the Piazza forums (as are his TAs). The first couple of weeks of class do a great job in refreshing your math /probability and stats which comes in useful in later ISYE classes. I also liked the glimpse into queuing theory, and the the Simulation software. Would heartily recommend (though it was a lot of work since my math is very rusty).',
            rating: 5,
            difficulty: 3,
            workload: 16,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'Great professor. Very math heavy. However, this course will give you a solid foundation of statistics needed for other classes in the program. I would like to a see a simulation project added to this course. It was tough to see the tangible outcomes of the information we were learning.',
            rating: 4,
            difficulty: 4,
            workload: 11,
        },
        {
            ...
            semester: 'summer 2019',
            review: 'This is one of the best classes I have taken.  Well thought out lectures, homeworks tested your understanding, and the exams while difficult tested your knowledge and he curves generously.  The professor truly cares and was very active in answering student questions.  Overall an excellent course that tested the underlying theory and then the actual execution of that theory.  My only feedback would be that I wish they would spend more time with Arena.  We went through it in one week and feel like we only skimmed the surface.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: "This course is a good intermediate refresher for your prob/stats. It also tackles some interesting concepts in Simulation that would surely help you in your analytics career. Dr. Dave Goldsman is a brilliant lecturer that imparts knowledge to students like no other.\nIf you are someone that has a rusty math background like I am, you would find this course a bit challenging at times (thus why I indicated 8hrs/week).\nEnroll at your own risk if you love Justin Bieber and you're offended by Clean, Old-Fashioned Hate (a.k.a. making UGA look bad).",
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        ...
        },
        {
            ...
            reviewDate: 'August 5, 2019',
            semester: 'summer 2019',
            review: "Dr. Goldsman makes this course. He teaches concepts well and keeps you entertained. The TA's are excellent, too. I felt the review of statistics was really helpful for me as I don't have a good statistics background.",
            rating: 5,
            difficulty: 4,
            workload: 5,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'Loved the interaction with Goldsman and the TAs were very responsive.  Super interesting material and great overall course.',
            rating: 5,
            difficulty: 3,
            workload: 7,
        },
        ...
        },
        {
            ...
            reviewDate: 'April 25, 2019',
            semester: 'spring 2019',
            review: 'This is a phenomenal course. Professor Goldsman does an amazing job of keeping the course self contained (you won\'t need to remember much from your "baby stats" class) and presenting very complex material in a common sense manner.\nAssignments were fair, nearly every assignment had bonus problems. All tests were multiple choice (surprisingly difficult still) but he does grade on a curve.\nThis is my favorite course in the program so far.',
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: "The course is well-structured, engaging, and offers comprehensive content that prepares students for advanced classes. Dr. Goldsman's teaching style is praised for being entertaining and effective, making the material accessible and enjoyable.",
            con: 'The course is densely packed with material, which some students found challenging, and there are warnings about varying exam questions compared to homework. Additionally, the heavy focus on mathematics may be difficult for those without a strong background.',
        },
        'summer 2023': {
            pro: 'The course is well-designed with great lectures, knowledgeable instructors, and ample supplemental material; Professor Goldsman is engaging and cares about the subject matter.',
            con: 'The course is math-heavy with limited hands-on experience, making it challenging for those without a solid statistics background; there is a focus on industrial simulations rather than financial modeling.',
        },
        'spring 2023': {
            pro: 'The course content is well-delivered, challenging, and engaging, with helpful professors and TAs. Many students found the material beneficial for strengthening their understanding of simulation and statistical concepts.',
            con: 'The course has a steep learning curve, requiring prior knowledge in math topics. Some students found the exams difficult to navigate, despite them being perceived as not overly challenging.',
        },
        'fall 2022': {
            pro: 'Prof. David and TAs are supportive, with a good sense of humor and a caring attitude towards students. Grading is generous, and forming study groups is encouraged for success in exams.',
            con: 'The course may be too easy for some students, and understanding the material can be challenging for others.',
        },
        'summer 2022': {
            pro: 'The course features engaging teaching from Professor Goldsman and supportive TAs, making math enjoyable. The grading distribution is clear and manageable, with bonus points available.',
            con: 'The course content does not focus enough on practical simulation applications, with too much emphasis on advanced math concepts that may not be relevant for all students.',
        },
        'spring 2022': {
            pro: 'The course provides a good theoretical framework and is beneficial for refreshing calculus and statistics skills. Professor Goldsman is engaging and adds humor, and the TAs are effective in their roles. Grading is perceived as lenient, particularly concerning projects.',
            con: 'The course is heavily math-focused and theoretical, which can overwhelm students with weak math backgrounds. Many students feel that the practical applications of simulations and ARENA are not clearly conveyed, leading to frustration with the volume of content crammed into a short period.',
        },
        'fall 2021': {
            pro: 'The course offers a strong theoretical foundation with responsive instructors and TAs, balanced workload, and opportunities for engaging learning through weekly assignments and relevant simulations.',
            con: 'The course is heavily math-focused, which may be challenging for students without a strong background in math or statistics. There are complaints about the workload being excessive and students struggling with prerequisite material, detracting from the overall experience.',
        },
        'summer 2021': {
            pro: "The course is well-taught by Professor Goldsman, who is knowledgeable and supportive. Students appreciated the intensive material, especially the math and simulation topics, and many felt it improved their skills. The course's structure and assessments were generally deemed fair and beneficial for those prepared.",
            con: 'The course is challenging, particularly for those without a strong background in calculus and statistics. Many students found the pace too fast and the workload in summer intensive. Some felt that the materials and assignments did not translate to practical applications for their careers.',
        },
        'summer 2020': {
            pro: 'Professor Goldsman and the TAs are highly praised for their engagement and responsiveness. The course offers a solid foundation in probability and statistics, with enjoyable lectures and effective teaching methods. Many students appreciate the straightforward assignments and exams, as well as the community support through Slack.',
            con: 'The course content is perceived by many as being more focused on mathematics and statistics rather than simulation, leading to some disappointment. There is a heavy emphasis on exams with high stakes, and feedback suggests that the exams may not effectively test understanding of practical simulation. The workload can be challenging to manage alongside other commitments.',
        },
        'spring 2021': {
            pro: 'Engaging lectures and great professor, Dr. Goldsman, who is attentive and responsive. The course offers extra credit opportunities, interesting mini-projects, and a supportive TA staff.',
            con: 'Course is heavily focused on statistics rather than simulation, requiring a strong math background. The content can be overwhelming, and exams are difficult, with some students feeling the teaching approach lacks intuitive explanations.',
        },
        'fall 2020': {
            pro: 'Students found the course to be a solid review of probability and statistics, with organized materials and supportive professors and TAs. The project added hands-on experience, and many viewed the course as a manageable elective with low effort required for good grades.',
            con: 'The course was criticized for being too math-heavy with less focus on practical applications, and some found the Arena software frustrating. Additionally, some challenges were reported in organizing the new project components.',
        },
        'spring 2020': {
            pro: 'Interesting course with engaging lectures and great professor. Clear explanations and responsive teaching staff. Low workload and generous grading.',
            con: 'Some content is difficult and may require a strong math background. Limited hands-on experience with simulation software Arena.',
        },
        'summer 2019': {
            pro: 'The course is well-structured, engaging, and features excellent professors and TAs. It provides a strong foundation in statistics and probability, enhancing understanding of underlying concepts while offering fair assessments. Students appreciate the interactive learning environment and the depth of material covered.',
            con: 'The course is primarily focused on statistics and probability, lacking in applied simulation content and hands-on experience with simulation software like Arena. Some students found it challenging due to a rusty math background and felt that practical application in industry was insufficient.',
        },
        'fall 2019': {
            pro: 'Prof Goldsman is enthusiastic and charismatic with well-organized lectures and informative slides. The TAs are excellent communicators and provide helpful feedback. The course offers a solid review of statistics and calculus, making it accessible for students with varying backgrounds.',
            con: 'The course is heavily focused on mathematical theory rather than practical simulation applications, which may disappoint those expecting hands-on experience. Some exam questions are not thoroughly covered in lectures, leading to confusion, and homework could be more challenging to better test student understanding.',
        },
        'summer 2018': {
            pro: 'Dr. Goldsman is an engaging lecturer who effectively teaches complex math concepts. The course provides a solid foundation in probability and simulation, along with good TA support and a fair workload. Students appreciated the quality of lecture materials and practical insights.',
            con: 'The course is heavily focused on theoretical mathematics, with limited practical application of simulation tools like Arena. Many students felt that the material was overly proof-based and lacked real-world case studies, making it difficult to see the applications of what they learned.',
        },
        'spring 2019': {
            pro: 'The course is well-structured and entertaining, with Professor Goldsman providing engaging lectures and a solid foundation in statistics and simulation concepts. Assignments and tests are fairly challenging but graded leniently, and TAs are highly regarded for their support.',
            con: 'The course title can be misleading as it focuses more on theoretical understanding rather than hands-on simulation building, which may disappoint some students.',
        },
    },
};
