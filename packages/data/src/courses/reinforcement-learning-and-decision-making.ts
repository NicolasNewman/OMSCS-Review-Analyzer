export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course is interesting and the lectures are comparable in quality to the ML course. Projects 1 and 2 were found to be easy, and the overall experience is described as enjoyable.',
            con: 'The lectures lack depth and do not adequately prepare students for Projects 2 and 3. Project 3 is particularly difficult, and the final exam is criticized for its lack of guidance and relevance to the course content.',
        },
        'spring 2024': {
            pro: 'The lectures were highly rated for being solid, with useful assignments that promote significant learning, especially through hands-on projects. The teaching staff were described as responsive and dedicated. Overall, students felt they learned a lot from the course, particularly those interested in reinforcement learning.',
            con: 'The course was considered difficult and math-heavy, with students feeling unprepared for the final exam despite studying. Many found the lecture videos unengaging and distracting, and there were complaints about the overwhelming workload, particularly for the projects.',
        },
        'fall 2023': {
            pro: 'The course fosters a collegial relationship with TAs and encourages self-directed learning, with projects that are challenging but promote practical understanding.',
            con: 'Lectures are disconnected from practical applications, dense, and often confusing. The course content is considered outdated and lacking in real-world relevance, with insufficient teaching on key modern topics like multi-agent reinforcement learning.',
        },
        'summer 2023': {
            pro: 'The course has a significant project (Project 3) that offers a valuable capstone experience, allowing students to apply advanced techniques and tweak algorithms to achieve results. The use of visualizations and practical training setups, coupled with strong student performance opportunities, is noted positively.',
            con: 'Lectures are described as poor, outdated, and lacking relevance, with numerous mistakes and a lack of coverage on important topics like policy gradient methods. Support from peers was insufficient during the summer due to low enrollment, leading to an ineffective Slack discussion environment.',
        },
        'spring 2023': {
            pro: 'The course provides a fascinating exploration of reinforcement learning, offering valuable hands-on experience through demanding projects and a strong emphasis on interpretation and analysis over mere implementation. The TAs are highly supportive, and the readings are well-selected, contributing to a rich learning environment.',
            con: 'The course is very theoretical with limited real-world application, particularly in industry. Lectures are inconsistent, with some being confusing, and the final exam is poorly structured, causing frustrations among students due to its lack of alignment with course content.',
        },
        'fall 2022': {
            pro: 'Engaged TAs, insightful material, and fun projects that challenge students with a graduate-level workload; additionally, the course covers a blend of classic and modern techniques in reinforcement learning.',
            con: "Heavy workload and time consumption, slow grading process, confusing project instructions, and inconsistent grading based on TAs' subjective opinions. Final exams and projects can be particularly difficult.",
        },
        'summer 2022': {
            pro: 'The course offers extensive coverage of topics, clear teaching, and a generous grading curve. Projects are engaging and rewarding, enhancing learning.',
            con: 'The final project is overly time-consuming and requires significant computational resources. The final exam is not well-aligned with course content, and lectures can be unclear on fundamental concepts.',
        },
        'spring 2022': {
            pro: 'The course is well-structured, with straightforward assignments and engaging TAs. Students found the projects enjoyable and the TAs responsive, making for a positive learning experience.',
            con: 'The final exam is seen as extremely difficult with unclear expectations, contributing significantly to the final grade. Project 3 is particularly challenging due to its complexity and resource demands, leading to frustration.',
        },
        'fall 2021': {
            pro: 'The course is fun and demanding, with a heavy grade curve that allows for high final grades. The TAs are very helpful and supportive, particularly for homework and projects. Video lectures cover a wide range of topics with good clarity, and students appreciate the guidance provided for assignments and projects.',
            con: 'Many students find the lectures unengaging and some content outdated. The exams are vague and ambiguous, with a significant emphasis on obscure details. Projects are time-consuming and the grading can feel inconsistent at times. Some students wish for better structuring of assignment releases.',
        },
        'summer 2021': {
            pro: 'The course has interesting material with a strong academic focus, enabling a deep understanding of theoretical concepts in reinforcement learning. The TAs are knowledgeable and helpful, and homework assignments are generally easy to complete.',
            con: "The class is very demanding in terms of time commitment, with a significant amount of reading and challenging projects. Most students found the lectures ineffective and preferred external resources like David Silver's lectures. The final exam was considered poorly designed and disappointing compared to the projects.",
        },
        'spring 2021': {
            pro: 'The course provides a thorough introduction to Reinforcement Learning concepts, with helpful TAs and engaging lecture videos. Projects are seen as rewarding despite their difficulty, and the course prepares students for further research in the field.',
            con: 'Many students found the course difficult due to its intensity, lack of clear grading rubrics, and inconsistent homework value. The final exam was challenging and comprehensive, which left some feeling uncertain about their understanding.',
        },
        'fall 2020': {
            pro: 'The course is enjoyable, with engaging lectures and a good mix of challenging projects. Students appreciate the useful lectures and helpful TAs, and many found the course content relevant to their jobs.',
            con: 'Students found the workload to be heavy with a lot of reading, and some struggled with the difficulty level, especially those without prior machine learning experience. The exams had ambiguous questions and the grading rubric for projects was seen as vague.',
        },
        'fall 2019': {
            pro: 'The course offers interesting and cutting-edge material on reinforcement learning, with passionate TAs and a healthy curriculum structure that promotes significant learning through projects and assignments.',
            con: 'The course is perceived as challenging due to its heavy theoretical content and lack of prerequisites, leading to a fast pace and grading inconsistencies, with some reviews citing issues with the lecture delivery and humor.',
        },
        'spring 2020': {
            pro: 'The course challenges students with a comprehensive understanding of reinforcement learning, emphasizes mathematical foundations, and provides access to a supportive TA team. Many found the projects engaging, and the course is recognized for equipping students with essential skills for navigating the RL field.',
            con: 'The course workload is heavy, with a substantial amount of material to cover. Some students felt the lectures were ineffective, and projects required significant time investment without clear grading rubrics. Complaints included outdated content, tricky exam questions, and a perception of arbitrary grading practices.',
        },
        'spring 2019': {
            pro: 'The course provides demanding and rewarding projects, a generous grading curve, and decent engagement from TAs. It introduces several reinforcement learning topics and encourages students to manage their time and read research papers thoroughly.',
            con: 'The lectures are poorly structured, often lack coherence, and are filled with excessive humor that detracts from learning. The final exam is difficult and inadequately reflective of the course content, while the distribution of material between lectures and assignments can be confusing.',
        },
        'summer 2020': {
            pro: 'The course has engaging TAs, valuable homework and projects, and provides a solid foundation in reinforcement learning (RL) concepts. Many students noted that the peer community is active, and projects allow for practical application of algorithms, improving technical reading skills in the process.',
            con: 'Several students found the lectures hard to follow, with vague grading policies and feedback on papers. The course heavily relies on replicated academic papers, which some found uninteresting and less applicable to real-world scenarios. There are concerns about the lack of instructor engagement and discrepancies in grading.',
        },
        'summer 2019': {
            pro: 'The course has a strong practical component with engaging projects, especially Project 2, and students report significant learning outcomes. TAs are supportive, and there is a generous grading curve overall.',
            con: 'The lectures are considered poorly structured and often lengthy, leading to a challenging learning experience. The coursework is time-consuming, especially during summer, and there is a lack of clarity in project grading.',
        },
        'summer 2018': {
            pro: 'The course covers interesting and contemporary material in Reinforcement Learning, providing a strong theoretical foundation and engaging projects. TAs are generally helpful and responsive, and some students appreciated the self-learning aspect of the course.',
            con: 'The course has a heavy workload, which can be overwhelming, especially in summer. Lectures are often perceived as unhelpful or poorly structured, making it difficult to grasp concepts without external resources. Grading policies and project specifications have been criticized for being unclear and inconsistent.',
        },
        'spring 2018': {
            pro: 'The course offers valuable insights into reinforcement learning concepts, provides interesting projects, and has supportive TAs who are accessible for help.',
            con: 'The course is highly challenging, requires reading difficult academic papers with limited guidance, has a very hard final exam, and may not provide sufficient practical application.',
        },
        'fall 2018': {
            pro: 'The material is engaging and challenging, with well-curated papers and excellent TA support. Many students felt they learned a lot and found the projects rewarding despite their difficulty.',
            con: 'The lectures were often considered outdated and unhelpful, with some students finding them difficult to follow. The lack of guidance from the professor and the challenging nature of the projects led to frustration among some students.',
        },
        'spring 2016': {
            pro: 'The course features engaging video lectures and an interesting exploration of reinforcement learning. Students appreciate the challenging projects, the helpful TAs, and the Python-friendly approach.',
            con: "The course is very challenging with a heavy workload, including frequent homework assignments that contain 'tricks'. Some students expressed disappointment with the level of instructor involvement and found the class to be more difficult than expected.",
        },
        'fall 2017': {
            pro: 'The course was well-structured, informative, and provided a solid foundation for reinforcement learning. TAs were supportive and helpful, and projects were fun and educational, encouraging outside research. The conversational teaching style was appreciated.',
            con: 'Projects were time-consuming and often challenging, leading to stress. The final exam was particularly difficult, and some students found the theoretical material of the lectures hard to follow.',
        },
        'summer 2017': {
            pro: 'The course features great material and passionate TAs, providing an engaging exploration of reinforcement learning with hands-on projects that allow practical application of advanced concepts.',
            con: 'The workload is exceptionally high, especially for a summer class, leading to significant stress and a demanding pace that can overwhelm students; there is minimal interaction with the professor, vague instructions for assignments, and a lack of coherence in lecture presentations.',
        },
        'spring 2017': {
            pro: 'The course is comprehensive with practical-oriented assignments and projects that enhance understanding of reinforcement learning. The teaching assistants are supportive, and the content is engaging for those interested in deep dives into machine learning topics.',
            con: 'The course is challenging and fast-paced, with a heavy emphasis on academic papers that some students found unhelpful. Professors are often unavailable, and students may struggle with the amount of reading and the disconnect between homework and lecture material.',
        },
        'fall 2016': {
            pro: 'Engaging course with fun assignments, particularly those involving Open AI gym. Provides good insights into reinforcement learning through papers and projects.',
            con: 'Upgraded difficulty level in Fall 2016, with frequent homework and significant project workloads, which may challenge students.',
        },
        'fall 2015': {
            pro: 'The course features engaging lectures and useful projects that provide insightful understanding of the content.',
            con: 'Some assignments may seem challenging if not approached correctly; there is a risk of misunderstanding the workload expectations.',
        },
        'summer 2016': {
            pro: 'The course features engaging lectures, insightful readings, and valuable projects that replicate published research, providing a strong foundation in Reinforcement Learning.',
            con: 'Assignments are often too easy and not strongly related to the course material, resulting in a disconnect between homework and lectures.',
        },
    },
};
