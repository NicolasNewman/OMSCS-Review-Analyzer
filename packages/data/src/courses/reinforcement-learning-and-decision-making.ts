export default {
    ...
    tags: ['RL'],
    officialURL: 'https://www.omscs.gatech.edu/cs-7642-reinforcement-learning',
    description:
    ...
    reviews: [
        ...
        },
        {
            ...
            review: "The lectures for this course were some of the better ones I've seen in OMSCS, of course there is always room for improvement and to teach more state of the art material, but overall was still extremely solid. The assignments were also pretty useful for the most part, especially the projects. I like classes like these where it requires a good deal of time and work BUT the assignments are designed in such a way where you actually learn a TON. Granted, a lot of the learning was done on the projects from my own research, but I also feel like they graded much fairer than other courses (CV and ML4T) and the assignments were not nearly as tedious as other classes (CV). The information learned in doing the assignments and projects was great in my opinion, especially if you have an interest in RL. I wish that continuous action spaces were covered more, along with a more formalized learning of multi-agent RL and how to use RL libraries (since everything was implemented from scratch except NN neurons and backprop). The projects, especially projects 2 and 3, require an insane amount of time so plan accordingly to start VERY early. I got a 100% on the third project but turned it in late and got a late penalty since I didn't allocate my time correctly. I highly recommend this class as it is probably the best one of the 8 courses I have taken.",
            rating: 5,
            difficulty: 3,
            workload: 16,
        },
        {
            ...
            semester: 'spring 2024',
            review: 'I had taken AI and DL prior to RL, and I would rank the difficulty of the classes such that RL > AI > DL. I\'m very glad that I took RL LAST because this was the class where I underestimated how much effort it would take to absorb the material, let alone just be able to do the assignments! RL is very conceptual and math-heavy, so if you do not understand how and why the math works then you\'re in for a world of hurt.\nStudent performance is judged based on 30% Homework (Gradescope submission work), 45% Projects (code to GitHub and research-style paper submissions), and 25% Final Exam (one closed-book exam proctored by HonorLock for 120 min).\nHomework - Other people in OMSCentral have already remarked on the Homework assignments, so I have nothing new to contribute here. Seems unchanged from previous years for Spring 2024.\nProject #1 - I highly recommend to put most of your effort on writing a high-quality research-like report for each project and not being fixated on mimicking the exact results of a research paper and/or getting the "best possible" results for each experiment. I learned this from Project 1 where even though I was able to get results very similar to Sutton\'s paper of TD Lambda, I still got a 10 point deduction for "not having sufficiently in-depth analysis" in my 5 page paper. To be fair, I agreed with this comment from the grader - I did not know how to best analyze the "whys" of what I was seeing and was not explaining it in a sufficient depth. I am pretty sure the deduction would have been far less if I had been unable to mimic the results of Sutton\'s paper but was able to explain the theoretical "whys" of why failures happened in my experiments.\nProject #2 - This time around, I quickly coded up a solution that I thought worked sufficiently to address the Lunar Lander AI problem and spent over 1 week writing a report that elaborated much more on the "why" analysis of my experiments. There were pros and cons to this approach, but I wouldn\'t realize it until Project 3. The pros was that I got zero deductions on Project 2 (full score), which meant my report was solid), and I knew then exactly how yo format any future reports that I would ever need to turn in for RL. The con was\nthat my agent for Project 2 was not the most efficient, and this would later affect me in Project 3.\nProject #3 - This was only the 2nd time that the course had students work on a multi-agent problem that was the Overcooked AI problem, and I could tell they were still observing where they should fix any kinks if they were to have Project 3 remain the same for future semesters. This project made me sick...literally! I spent over 3 weeks spending all my free time reading more than 30 research papers and attempting so many different experiments in order to get some results for a writeup. I lost sleep, had constant headaches, etc. I was not looking for perfection of being able to solve all 5 layouts of Overcooked, but I did panic when I realized that I was getting stuck just solving 2 out of the 5 layouts and not making any progress despite my efforts.\nThe teaching staff recommended that as a baseline people try using their single-agent approach from Project 2 to solve Project 3 and see how far they get before attempting any other new multi-agent approaches. This is where my con from Project 2 affected me - since I didn\'t spend countless hours making the most efficient agent, the agent from Project 2 was only able to solve 2 layouts in Project 3. I spent the next 3 weeks trying new algorithms (and failing), and then resorting back to trying to salvage my agent from Project 2 to solve at least one more layout so that it wouldn\'t have such a pathetic performance. I ended up being able to only solve 3 out of 5 layouts with my final implementation, but I wrote what I thought was a high quality paper explaining the whys of my successes and failures. Ultimately, I got very small deductions for not being able to solve the remaining 2 layouts and got a higher score than I did in Project 1. The class everage and median for Project 3 was low (in the 70s), and I think this is due to 2 potential reasons. Either people spent all their time doing experiments but didn\'t put the same amount of focus into their reports, OR people procrastinated and thought they could spend just a few days before the deadline to get everything done (code and report) and quickly realized that Project 3 is 10x harder than both Project 1 and 2 combined. I personally think that if I had spent more time in Project 2 making the most optimal agent possible, then I would have better experimental success in Project 3 because enhancing a very efficient single-agent approach to work for the multi-agent environment would have shaved off a lot of experimentation time for me.\nFinal Exam: I needed the high scores from Projects and Homework to save me. I failed this exam so terribly that if you were to look at my performance in relation to the rest of the class for just the exam, it looked like I did not learn a darn thing all semester! I studied and prepared for 7 days prior to the exam, and still "failed". My advice is to not over-prepare by studying the lecture videos - instead, read the relevant chapters from the class textbook and then just take the test. I spent too much time going over lecture videos and not enough time reading the high-level perspectives from the textbook. Also, blind guessing results in points deduction because the final exam is multiple choice with multiple answers for some questions. If you choose 1 wrong choice and 1 right choice for a multiple-answer question, then you get 0 points on that question!\nLecture videos - So awful...this is the first class where I felt like vomiting everytime I started a video to hear the non-stop bantering and joking of the 2 professors who star in the lecture videos. The joking got in the way of me learning anything at all, and they would purposely spend hours deriving something trivial and then wiping the math away to say they deliberately made errors to prove a point. It got to the point where I stopped watching the weekly allotment of videos for 1 month because I couldn\'t sit through all the unhelpful chatter of the videos. My feedback to the teaching staff was to please just do away with the current lecture videos because they were the worst part of the course (even worse than the experience of taking the final exam).\nTeaching staff: This class is so darn RESPONSIVE! This is the first class where the TAs explained their background and hobbies on a Ed post at the beginning of the semester, and it was so nice to know these people were "real people" and not just names on a virtual board that answered questions or graded assignments. Some of the TAs had IMPRESSIVE backgrounds, and I found myself wondering "wow, how high is the caliber of expectations to be able yo qualify as a TA for RL?!". Also, the TAs are hovering around Ed Discussion around the clock, and responses to student questions are posted within a few hours. That is such a crazy difference compared to AI where questions from students could go unanswered for up to 7 days! The TA in charge of Project 3 also spent a lot of time asking for feedback about how to improve Project 3 for the future. The way the TAs helped to run the course is how all classes in OMSCS should run.\nExtra Credit: We had an extra credit opportunity this semester, and I did not get it. But if I did, it would have added an extra 10 points to my grade on Project 3. I guess in the end I didn\'t really need any extra credit because I lost very few points on Project 3 despite dismal experimentation results (solving 3 out of 5 layouts is still just solving 60% of a problem, which is really not something to rave about if I were on a podium).\nConclusion: I learned SO much, and also worked SO much for Project 3 that I need to find a passion project to showcase everything that I can do now with reinforcement learning! Even though I failed the Final Exam, my performance on Homework and Projects was high enough to still result in an A (with the help of the class curve). I had estimated that this would be a B grade class for me since it took so much effort for me to understand the material, and therefore I was pleasantly surprised to see my final grade in the class!',
            rating: 5,
            difficulty: 5,
            workload: 25,
        },
        {
            ...
            semester: 'fall 2023',
            review: "Very difficult, but in the right ways. This class treats you like an adult and puts you in charge of managing your time and research to get to the finish line. Probably the first class in OMSA that fostered a collegial relationship with TAs (10 classes taken).\nChallenging but achievable, and very engaging because of this. Just finishing the class won't get you an A, unlike many other OMSA courses. The projects are hard and you'll have to do some research of your own to succeed. But it's a process that will help you learn a lot in very practical ways. If RL is at all interesting to you, don't miss this class - just take it alone or pair it with something easy.",
            rating: 5,
            difficulty: 5,
            workload: 15,
        },
        {
            user: 'Op880d/6dofv1aYhkGTiRw==',
            reviewDate: 'December 13, 2023',
            semester: 'fall 2023',
            review: "One thing that holds this course back is that there is an amount of disconnection between the lectures and everything else.  The lectures follow the mathematical theory behind how the various RL topics work.  Then the projects and weekly homework focus on practical applications.  In between those two ends, you have the readings -- they should bridge the gap, but often fall short.\nThe readings consist of the Sutton and Barto book, which I did enjoy, and then research papers.  I recommend buying the hard copy of the book because it is foundational and I found it handy to write in the margins and highlight.  I'll be returning to it during self-study a lot.  The research publications are just okay.  Some are far more recent than others, and while the older papers provide some much needed insight into how the RL paradigm has shifted over the past 10+ years, the last third of the class is definitely in need of renovation.\nFor example, the third project focuses on multi-agent reinforcement learning (MARL).  It's been said before, but it is an absolute giant of a project that tested me in so many different ways.  You would think that multi-agent learning would make up some portion of lectures, right?  Negative.  The last third of the class lectures focus on a smattering of topics, mostly game theory.  While game theory was interesting, the MARL domain is so relative today that it was boggling that it wasn't covered in much detail.  That was pushed to a lot of self-study centered around Project 3:  we were given a laundry list of papers to read, pick an algorithm(s) to implement, and build a MARL solution to a cooking environment.  It didn't help that there was a bug in the environment that I got conflicting responses about what it affected.\nOverall, this is a difficult, math-heavy course.  It is in need of modernization.  The lectures are dense, and sometimes confusing, and the interplay between the two lecturers is grating at times.  When you just want things explaining simply, it can get frustrating.  There needs to be a better bridge between theory and practice.  Get ready to spend ungodly amounts of time looking at other resources, like the fantastic David Silver lectures or alternative textbooks.  The TAs are great; they're just working within the framework that they've been given.  I enjoyed the first two projects, and yes the final exam is very hard.  I scored in the 50s and was above the course average so it is universally difficult.",
            rating: 4,
            difficulty: 5,
            workload: 25,
        },
        {
            user: 'mJKb1Qa6lGYdomsFC3NlvA==',
            reviewDate: 'December 11, 2023',
            semester: 'fall 2023',
            review: 'If you were inspired to take reinforcement learning after hearing that it was used to train ChatGPT, avoid this course, because you’ll learn none of it unless you self-study, in which case you might as well not take the module at all. IMO, the short reinforcement learning section in ML4T is more applicable to real-life than the entire 7642 syllabus.\nLectures are absolutely useless except for Final Exam, and maybe HW1:\n•\tCharles is fine but he only teaches a negligible proportion of the syllabus\n•\tMichael is incomprehensible?? More than once he switches train of thought mid-sentence, and he jumps from concept to concept without any context or explanation. The bantering style of lecturing exacerbates this\n•\tLecturing style aside, the syllabus is so theoretical, it teaches you absolutely nothing about how to implement anything, much less best practices in modern RL. This is a massive wasted opportunity because RL is super interesting (as I found out during self-study)\nMy recommendation is to read the relevant textbook chapters before watching the lectures, then the lectures might make a bit more sense.\nThe rest of the weekly readings are mostly useless except for the final exam:\n•\tBelieve it or not, the paper introducing deep RL is not even in the reading list. In fact, I don’t think any deep RL papers are on the reading list\n•\tMost readings were authored in the 1990s, i.e. were focused on solving simplistic computer games. It’s hard to see any application to real life\n•\tProject 3 has 12 suggested readings in it, all of which are 2016 or later, covering more recent techniques in RL. Why aren’t these in the weekly readings instead?\nTAs are insanely helpful & trying their absolute best. I cannot stress this enough. I feel like they themselves know that the course content is useless, but there’s only so much they can do.\nProject 3 will have you implementing a multi-agent model (which they don’t teach). As others have already mentioned, this project is an absolute beast, and combining multiple neural nets in 1 model can be very very tricky in PyTorch. Clear all other deliverables ASAP, and get started the moment it’s released.\nFinals-wise, know that for multiple semesters, the average grade has been <50%. You’ll need a super deep understanding & memorization of the attributes and properties of the whole syllabus (which is massive). Most of the questions don’t have answers explicitly stated in the lectures or readings. And cheatsheets aren’t allowed.',
            rating: 2,
            difficulty: 5,
            workload: 30,
        },
        {
            ...
            reviewDate: 'October 25, 2023',
            semester: 'fall 2023',
            review: 'Super hard course, haha check out my candid review here!\nhttps://youtu.be/LEwjFYt4XIQ',
            rating: 2,
            difficulty: 5,
            workload: 15,
        },
        {
            user: 'bGMsiYUbTvuCh+jf02bt7w==',
            reviewDate: 'August 10, 2023',
            semester: 'summer 2023',
            review: "I took this course over the summer (doing my first week of homework on a cruise ship in the Mediterranean) with full knowledge that it is a tough class, but observing that the grade distribution for the class in the summer (https://lite.gatech.edu/lite_script/dashboards/grade_distribution.html) is generally about the same as for the fall and spring. Sure enough, this semester the distribution came out to be 41% A, 28% B, 1% C, 2% D, 2% F, 25% W.\nI rate this class only a 3 because the lectures are poor, dated, and lacking relevance. The lectures contain many mistakes which aren't all annotated. Many results are presented only at a high level so that it is difficult to understand the meaning or how to practically apply the results. The continual banter, including debates about the meanings of things, adds to confusion. The lectures don't contain any material on policy gradient methods even though these are arguably the most important and commonly applied techniques in modern RL. It is also annoying that project 3 is all about policy gradient multi-agent methods for which the lectures provide no support at all. As other people have, I recommend the David Silver lectures on Youtube.\nOne unexpected downside of taking this class over the summer was that only 160 students were enrolled so that there was no critical mass for good Slack discussions. Consequently, everyone gave up on Slack and questions posted there went unanswered. You get better support from other students by taking the class in the Fall or Spring. Fortunately, I had manually copied the Slack discussions from the spring into a Word doc to preserve these before I'd lose access. Having these available and searchable was useful.\nAs other people have said, project 3 is a beast and really represents a capstone project even though the grade allocation is the same as for projects 1 and 2.  I finished project 2 and the homeworks early so I'd have 3 weekends on project 3. I also took some days off work, ending up spending about 90 hours on the project.\nI was able to significantly beat the baselines on project 3 using CCPPO (following the ray lib example), increasing the size of the central critic NN (because coordinated value estimation is hard), and with lots of reward shaping to incentivize better and more aggressive defense. Reward-shaping is tricky and easily becomes pathological, so this tip may not be much of a tip since it takes a ton of training experimentation to get this working.\nWatch the video visualizations generated by the provided Jupyter notebook. The best baseline (3) wins nearly all games in which the agent team starts with the ball (the odd episodes), but ties most games in which they do not (the even episodes). So the best strategy for improving on this may be to find a way to add an aggressive defense and try to steal the ball and also score on the even episodes. I did this mostly by adding reward shaping to incentivize more aggressive defense. I found this wasn't enough with PPO alone: I needed an algorithm with more coordination.\nFor my setup, I used docker on my Windows 11 host system using an RTX3090 GPU and a CPU with 20 cores and 64gb ram. Lots of people had trouble with cloud setups and some people were hardly able to complete any training at all, spending most of their time troubleshooting problems and complaining about this on Ed. Following a suggestion someone made in Slack the previous semester. I was able to speed up training significantly by increasing the SGD minibatch size and related parameters, and also the learning rate--so that I could complete a 20 million step training run in around 10 hours (instead of 24).\nThe final exam was an exercise in remembering details from the lectures and two papers (KWIK and Sutton 88). I wish I had made a table of methods/techniques/algorithms and their properties and memorizing this as someone suggested in another review. I studied by rewatching all of the lectures and making notes, and studying the posted student answers to study questions, finding other sources for answers when those were weak. This study was enough to get me a score above the upper quartile, but I think I could have done better with added table memorization. The mean score was 46, median 48, and upper quartile 56.\nI ended up with an A, scoring (94,95,97) on the projects, and a 61 on the final.",
            rating: 3,
            difficulty: 5,
            workload: 25,
        },
        {
            user: 'Pqc0oBP00i24fWaUAIuZDQ==',
            reviewDate: 'May 12, 2023',
            semester: 'spring 2023',
            review: 'Reinforcement Learning Review\nReinforcement Learning (RL) is a fascinating class, but I have mixed feelings now that the course has concluded. On the plus side, RL feels like it just might be the next "big thing." The field is a fascinating fusion of classical computer science, statistics, cognitive and neuroscience, and mathematics. Before taking this class and having taken the AI, ML4T, and ML courses, this class felt like what AI should be, or at least, what I expected AI and machine learning to be like; that is, an agent that explores an environment, acquiring feedback and evaluating its progress towards some goal at each step along the way. The agent-centric aspect of RL distinguishes it from other areas of AI and ML, and it is a novel way to think about problems in this space.\nOn the downside, RL is still very theoretical and has yet to gain traction in industry, as it is not applicable to most commercial use cases. The domains where RL has been successful have been confined mainly to robotics and gaming - although I have heard that large language models like chatGPT used specific RL techniques. RL is an active area of research, and I hope it will find broader appeal as success in new domains and use cases accrue. RL is definitely something to keep your eye on if you are in the Machine Learning or Interactive Intelligence specializations.\nThere are three projects (45%), six homeworks (30%), and a final exam (25%) that make up the final grade. There are course lectures, office hours, and a lot of readings. This class is demanding, and the projects require a lot of time. In terms of effort and workload, it is up there with ML and AI, and I easily spent at least 40-60 hours on each project. Preparing for the final was chaotic, and I was "burned out" after P3. The instructors included a series of game theory lectures at the end. Including this material was a little puzzling, at least to me, since none of the homework or assignments involved game theory. However, conceptually there is an overlap between game theory, a la John Nash\'s "a beautiful mind" equations, and multi-agent RL.\nI finished with a final grade of 74%, which was a B. I did below average on the first project and the exam and was at or above the median for the rest. With a little effort, you can get 100s on all HWs - the first one is the hardest, and they get progressively easier and less time-consuming. Understand how to write a good report for the projects - results are less important than showcasing your understanding. For the final, don\'t overthink it - know the big picture. The average/mean was around 46-48% (I scored a 42%), but it is easy to go down the wrong path in studying since there is so much material. I certainly did.\nLectures and Class Material\nThe lectures for this class could be better. I did not enjoy them and stopped watching them halfway thru. Some are good, while other modules were just confusing. The focus was mainly on mathematical proofs and lacked a coherent narrative. I don\'t think the course modules were helpful for the final - they went into too much detail.\nI watched most of the David Silver lectures, which were terrific. The David Silver lectures were coherent and well-paced, each one building on the previous one in a coordinated fashion. The course lectures were less connected and felt arbitrarily stitched together in comparison. Often it was unclear why a proof or equation was being introduced or how it fit into a larger RL context. I often felt "lost in the details." Combing both the Silver lectures and the course lectures is likely the best approach since the Silver lectures provide a layout while using the course lectures to fill in the mathematical details whenever needed - but who has the time to watch so many videos?\nMany of the readings were excellent. After you bang your head for a while on an academic paper, it does eventually begin to make sense. I learned quite a bit from the papers and the book. I didn\'t read everything, and some readings were harder to grasp or seemed to fringe, but the course designers did an excellent job selecting the essential readings in the field. The DQN journal articles and the Sutton paper on TD learning are foundational readings. The Barto and Sutton text was also quite good, at least the early chapters (i.e., 1 thru 7) I had read.\nThe TAs for the class were talented and generally impressive, particularly the lead instructors. They were very positive and supportive, but your YMMV for the office hours. The TAs preferred facilitating class discussions, letting things flow organically, instead of a more structured guided office hour. Often, I felt they were reluctant to provide solid answers or advice, instead encouraging students to give it their best shot and not be afraid to take some liberties or explore the topic independently.\nEd discussions were good - lots of class participation but not too much direct involvement from the TAs. Again, they preferred to stay in the background and referee more than actively participate. But they did help direct and clarify topics when necessary.\nOverall a great class and an important and emerging area for those interested in AI. It gets a bit theoretical at times, but the projects were fantastic and provided the necessary hands-on RL experience I was looking for. If you want to prepare for the class, study a bit of dynamic programming and read up on and understand the grid-world MDP problem using value and policy iteration. Learning the basics of PyTorch will come in handy. Understand gradient functions (or read Sutton\'s Temporal Difference Learning paper). Also, I would learn how to spin up and configure a virtual machine using one of the major cloud providers - that may come in handy for P3 if you don\'t own a souped-up home machine. Finally, if you have a lot of spare time, watch David Silver\'s lectures, read his DQN paper, and the first 5 or 6 chapters of Sutton.\nGood luck.',
            rating: 5,
            difficulty: 5,
            workload: 25,
        },
        {
            user: 'V3XDGwLyDdCA+/FluLIh3Q==',
            reviewDate: 'May 9, 2023',
            semester: 'spring 2023',
            review: "I won't spend a lot of time re-iterating stuff that other people already accurately described. TAs good (and very nice, can't praise them enough), assignments very easy, lots of reading, projects generally hard. I'll just provide some more insight into project 3. You could probably submit this project as the capstone project for DL, the one that you have multiple months to do and must complete with a group, and I'm very sure the TAs would OK it; it's that complex. If you aren't intimately familiar with RLLib, I would strongly, strongly recommend spending time earlier in the semester looking through the source code and the examples it contains. Learn how to modify the structure of a neural network or the overall behavior of one of the pre-existing algorithms. That was probably what most of us spent most of our time doing, and it's a real shame, because that cuts into valuable experimentation time. Also, have a fairly modern 6 (really 8) core CPU and 32 GB of RAM MINIMUM if you don't want to be renting a VM from someone. I know everyone always says \"start early,\" which is often not even an option for a lot of people, but really do clear some time for this one, if possible.\nThat said, I think grading was more lenient on P3 than the other projects. The median ended up higher, while the mean was lower. I did quite well  with, and I can't stress this enough, garbage results. They give a lot of points for demonstrating one's understanding of the principles behind multi-agent RL, and for thoroughly explaining why one's agents performed in the manner they did.\nThe final was extremely dumb. Assuming they keep the multiple-choice format, my recommendation would would be to simply re-watch the lectures, making note of any time they define something or describe the performance characteristics of some algorithm. (how well it does/what kind of environments it can operate in/what information it needs in order to work). You should be able to beat the curve with that alone. They provided a lot of study questions in Ed, but I wish I spent less time on them, as rote memorization would have almost certainly earned me a better score.\nI hope they are able to improve/streamline P3, because it seems like a project with a lot of potential that was simply too difficult and complicated for most people to get working and then have time to conduct detailed experimentation in a timeframe of 3-4 weeks (Again, start early if you can. Neglect your children if you have to!). I think the idea was to give people this powerful RL framework with which would allow them to spend less time implementing and more time experimenting, but I think the opposite ended up happening.",
            rating: 3,
            difficulty: 5,
            workload: 30,
        },
        {
            ...
            semester: 'spring 2023',
            review: "This class is pretty great and feels like a grad class. The homeworks are easy expect HW1 which I found to be pretty stressful and difficult. I will say the TAs were pretty amazing throughout the entire class and were very supportive. A lot of students too were very involved which made for a fun time as a fellow student.\nThe projects are all good:\nProject 1-  Pretty easy to follow pseudo code from the book and other students discuss little tricks they had to do to get the exact results on here as well as in your slack.\nProject 2- Fun project, I used a DQN. Feels sort of out of left field to be learning some DL, but once you get past that hump its not too hard. Still a lot of work and time to train and tune, but its pretty fun to do and overall enjoyable.\nProject 3- New project as of the last year or two. Really really really hard. I was not able to beat the baselines we had to train against despite trying all sorts of strategies. I trained locally, and you need at least 18gbs of memory to train your model. Spent lots of time and effort on this and felt bad to not get good results. Most of my time was spent scouring github libraries for MARL to try and understand how to implement a decent agent and make it work in RLLIB.\nAll of these projects require you to start the minute they open otherwise your chances of finishing them and getting a good grade is very slim.\nExam-\nThe exam was total BS. Some of the questions were about an algorithm that we never talked about. The review questions did not really prepare you. The TAs were suppose to post answers but they never did. While I liked the idea of us learning off each other, please also post the answers!\nI also tried to take it at my parents house while on vacation so I bombed it as I rushed through it. Oh well, my exam grade doesn't reflect how much I learned. I had pretty much aced every single homework and project and still did so incredibly poor on the final.\nLectures-\nI didn't mind the jokey tone that smoov and curly took in this one, but a few of the topics in the middle where just like straight math proofs with no real explanation of how they connect to the topics. It was fine, and I would never say the lectures are bad, but I wouldn't say they blew me away either. As others have mentioned David Silver's lectures are much better and I would recommend watching those. Like a good grad class, you will need to do a lot of learning outside of the provided materials. In this class it's cool to read papers that are cutting edge and interesting, and be able to understand them.\nOverall-\nTAs were really good. TJ and Jake in particular (as well as others!)  who ran our office hours were always very supportive. It's a fun, challenging class that despite the final I'd take again.",
            rating: 4,
            difficulty: 5,
            workload: 25,
        },
        {
            ...
            reviewDate: 'May 8, 2023',
            semester: 'spring 2023',
            review: "This is probably the most difficult course I've taken in my entire academic career. Thankfully, the difficulty isn't artificial and doesn't come from needless busywork, but rather from the intensity of the material itself.\nThe course is broken down into six homeworks, three projects, and one exam. The six homeworks are auto-graded in Gradescope and cover the material from the lectures/readings and help give a good foundation for thinking about the projects. The projects are interesting in that you are not graded on your implementation at all, but rather on your interpretation of your results, and the exam is a multiple choice exam that covers all of the material in the course.\nThe homeworks don't have anything of note in them that makes them stand out - they're fun and interesting, but a bit foundational. Once you crack the main idea of the problem, the implementation is generally straightforward.\nThe projects are real work. You'll end up writing a ton of code and submitting it, but it's basically only checked to make sure it runs and isn't a copy of another implementation. The effort comes from writing the reports and coming up with justifications for how you approached the problem, and (more importantly) showing that you understood the problem. My undergraduate degree was a writing degree, and these projects felt like a real synthesis of all of my skills. I enjoyed the process, though I generally spent a single day writing the report, which I wouldn't recommend unless you have experience writing a 15 page paper in 10 hours. It melted me and affected basically everything else in my life.\nOne thing to mention about the projects is that the work starts hard and gets mind-blowingly difficult. The third project leans heavily on compute power and understanding the RLlib abstraction, and if you wander off in the woods for any amount of time, you will likely not be able to solve the problem. I was not able to beat the benchmarks, mainly because I had a significant amount of difficulty understanding the RLlib abstraction and figuring out how to write and debug my own code. I spent about 100 hours on the project, but beat the median only by a little bit, mainly because I wasn't able to come up with excellent points because I didn't fully understand what was going on. It was humbling, but (most importantly), it made me thirsty for more.\nThe final, though, was awful. They give you a study guide with open-ended problems, but don't give you the answers they think are right. Given that the students argue over definitional true/false questions, this makes it really difficult to study and know if you are on the right track. Couple that with the fact that the exam doesn't reflect what was in those study guides, and the average for the final was about a 45 and the highest grade was an 80.\nI don't think the exam was difficult enough to warrant this, and the main problem with it was the lack of getting the students prepared. I think they can solve this by offering gigantic question banks they draw from for the exam, and offering guidance on how to approach the problems.\nOutside of the exam, this course was excellent and felt like a real graduate course (instead of undergraduate+, like GIOS and ML4T) as the focus was on interpretation and analysis rather than code.\nI would recommend this course, but understand there are points where you're likely going to want to give up and/or cry and/or hallucinate from lack of sleep.",
            rating: 4,
            difficulty: 5,
            workload: 30,
        },
        {
            ...
            semester: 'fall 2022',
            review: "Heavy workload if taking another course, TAs are engaged and not snarky, 2 office hours sessions a week, covers the classics, but also gets into the newer DRL stuff. Lots of papers to read and process, which is fun and feels more like a graduate class than some other courses.\nAssignment grading is slow, which seems by design (given there is no shortage of TAs). You just have to have confidence that you're doing the right things.",
            rating: 5,
            difficulty: 4,
            workload: 25,
        },
        {
            ...
            review: 'It is the best class that I took in OMSCS so far. You definitely learn a lot. The topics are eye opening. It is harder than AI, ML and DL imo.',
            rating: 5,
            difficulty: 5,
            workload: 29,
        },
        {
            ...
            reviewDate: 'December 21, 2022',
            semester: 'fall 2022',
            review: "Overall - It is the most insightful and difficult course I've taken so far (KBIA, ML4T, AI4R), which is to be expected from the reviews. Loved project 1 and project 2, reading papers and trying to implement TD(lambda) and DQN was super fun!\nProject 3, I have no idea what I was doing. I feel like it was such a huge step up from P1 and P2, and I was not making any progress in any meaningful way. rllib is a monster of abstraction which is pretty much the crux of the project. I would recommend anyone taking this course in the future, try to implement P2 in rllib after doing it in just PyTorch. Also, you'll need a machine that is good enough the train for P3. I know the TAs did not explicitly say this but if you can't train 1 million timesteps within 1 hour, you need a better/faster machine. This is the ONLY way to know that what you are doing is making an impact on the agent.\nHomework was trivial, given that this is not your python course, you'll be fine.\nThe Final was brutal. As stated in various posts, the average was in the 40s. I rewatched the entire lecture videos, read various sections of the book, and did the practice exam twice. After all of that, I still got the average.\nTime spent per week: 20+\nConclusion: ML specialization, this is a must. Even if ML is not your specialization, you might as well take it. Everything else will be a walk in the park.",
            rating: 5,
            difficulty: 5,
            workload: 25,
        },
        {
            user: 'Ibg01OgkOuJlAKeU+X2d9Q==',
            reviewDate: 'December 20, 2022',
            semester: 'fall 2022',
            review: "Very interesting and engaging material, but extremely time consuming course. Would not recommend taking another course at the same time if you're a part time student. I found the lectures in the course material hard to follow and keep up with, the David Silver lectures on YouTube cover a good chunk of the same material and I found those much easier to understand.\nThe final project is very computationally demanding, you should have a decent GPU, a high end CPU, and at least 64GB of RAM available you if want to train on your own system.\nAfter dedicating over 90% of my free time after my job to this course, I was able to pull off a final grade of B.",
            rating: 3,
            difficulty: 5,
            workload: 20,
        },
        {
            user: 'pEfU6w1LKfuEWEoJdlEXqw==',
            reviewDate: 'December 18, 2022',
            semester: 'fall 2022',
            review: "It was my 10th course in OMSCS. Some feedback may not contain too many details due to the large class size. Nonetheless, this course is well-managed by TAs.\n\n\nHomework. HW1-6s are simple and easy to implement. HW5-6 may require additional readings regarding KWIK and game theory.\n\n\nProjects. They are most time-consuming. I didn't work well in Project 1 but achieved 100 in Project 2 and Project 3. The key is to explain your methods, experiments, and analysis thoroughly. That's the reason why TAs recommend IEEE templates. The main structure of the analysis is describing phenomena -- providing hypotheses -- validating your conclusion theoretically and experimentally. IEEE papers usually separate experiments and results. But I recommend combining them because of the 5-pages limitation. It is also convenient to read and prune. Besides, I strongly recommend following Kaiming He's writing style in the Masked Autoencoders paper. You can highlight or bold key concepts at the beginning of paragraphs.\n\n\nProject 1 focuses on TD-lambda. You need to introduce TD methods, replicate experiments and provide your own analysis. Showing your understanding of each experiment is the crux. But I couldn't realize it until submission.\nProject 2 is about deep reinforcement learning, specifically, the DQN series. Two experiments include the training phase and hyperparameter-tuning. It is easy to talk a lot about hyperparameters, like model architecture, learning rate, discount factor, and epsilon-greedy. However, don't forget to describe your training result and analysis in detail.\nProject 3 introduces multi-agent reinforcement learning and plays a Google research football game. The provided baselines depend on PPO. PPO is such a robust algorithm that you may fail to achieve some improvements. So I suggest using QMIX, MAPPO, or other SOTA methods directly because each trial may take several days (So sorry that I was not able to reply to some questions in Edstem). I trained MAPPO on Google cloud and paid 50 dollars plus 300 free credits. Although it is manageable to use GCP with only the free credits, the high computing requirements (especially CPUs) cause much trouble in coding and debugging. For RLlib-based implementation, I recommend seeing some GitHub extensions, such as epymarl and MARLlib. As for the report, except for win-rate improvements, you need to select or customize parameters to display team coordination.\n\nExam. Important Relevance: Sutton & Barto's book > David Silver's slides > lecture videos. Although lecture videos don't cover all concepts, you can still achieve an above-average grade by only watching them.\n\nOverall, I think this course is a real graduate-level course in OMSCS. If you have some questions, don't be afraid to ask TAs on Edstem and watch the office hours.",
            rating: 4,
            difficulty: 3,
            workload: 25,
        },
        {
            ...
            reviewDate: 'November 4, 2022',
            semester: 'fall 2022',
            review: "Background: Non-CS, process engineering\nPrior Courses: KBAI (A), ML4T (A)\nI wanted to get into ML but couldn't get past the waiting list. So I took this first.\nMy current standing is:\nProject 1: .5 STD above median\nProject 2: (probably) .5-1.0 STD below median\nProject 3: not due for 5 weeks\nHWs: All 100%\nFinal: ???\nML isn't necessary for taking RL.\nML4T helped in some respects because I already had a general idea of what 'learning' was, what is a Markov Decision Process, how to deal with NumPy, and how to do Q-learning. Q-learning is one of the HW assignments and is a general idea behind DQN which has many use for project II. ML4T was an advantage, but I don't think it's necessary.\nThis course requires a LOT of reading. This course for reading is as KBAI is for writing. The lectures are really thick with theory and math as well. You will spend more time reading research papers and textbooks than writing code. If you are a theoretically inclined person, this course will suit your strengths. If not, you will struggle. I haven't had to 'use' or derive any math yet, but you need to follow to understand.\nI enjoy the projects and the homework assignments are fun little challenges. I have yet to start on the final project or take the final exam, but the final project looks like a real challenge.\nMy advice is to re-read everything after you get about halfway into the course. So much of the readings were illegible to me until after completing project I. Then, what was previously alien, became plain English.  In addition to that, I will watch the David Silver lectures. I would expect to do well on the final with this strategy.",
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        {
            ...
            semester: 'fall 2022',
            review: "Just watch David Sliver's lectures.\nAmbiguous instructions in projects. No rubrics. Grading depends on TA's mood.\nAvoid this course if you have better options. UCL or Edinburgh RL course is much better.",
            rating: 1,
            difficulty: 5,
            workload: 25,
        },
        {
            user: '9f+FXCLHa7L3nGW3c4zE5w==',
            reviewDate: 'October 28, 2022',
            semester: 'fall 2022',
            review: "The video quality is really low. You have to learn by yourself. The project sucks. The project prescrption is much less to be detailed. You don't know   the points for each part. The grade you got would be unbelievably low. If you argue, you would be deducted 10 points. Seemed decided on your luck to meet a good TA. Totally ruined my semester and good mood. QUit.",
            rating: 1,
            difficulty: 1,
            workload: 21,
        },
        {
            user: 'Y4z95oGgZGBeX6yHmEQlRQ==',
            reviewDate: 'August 22, 2022',
            semester: 'summer 2022',
            review: "Not much to say here that hasn't been said in previous reviews:\nTaking this course in the summer is a behemoth and I do not recommend anyone take this course with another course in the summer (or even in the fall and spring). Not because of most of the course, but because of the final project.\n(6) HW's that accout for 30% of the grade and start with a first really difficult HW and get progressively easier as the course goes on. HW 5 and 6 are an absolute joke compared to HW 1. Aim to get 100's on all HW's, which is very doable.\n(3) Projects, 45% of the grade (15 each). The best and most rewarding part of the class IMO. 1st project on re-proving TD learning, which is quite easy to do but doubly easy to get a bad grade on since TA's are hit-and-miss on what they take points off for. Highly recommend focusing on theory and analysis of data for the reports and little on the actual implementation. The TA's want to know what you learned from the results and implementation, and why you implemented it; not how you implemented it. Embody that in your report and a better grade will follow.\nThe second project is the OpenAI Lunar Lander which is really fun and allows you to use whichever agent and algorithm of your choosing. The perfect project, harder than the first but very rewarding in terms of knowledge and application if done properly.\nThe third project is an absolute behemoth. Prepare yourselves for hours to just get acquainted with the project. Start as soon as possible. Read as much literature as possible. Fully understand the provided code and objective before throwing stuff against the wall and seeing what sticks. I highly recommend approaching the problem like a scientific experiment, and write the report as such. Have a hypothesis on why a particular technique will work, explain why you think it will work, then implement it and gather good results. Write the report detailing this hypothesis - theory -(small bit on) implementation - (large chunk on) analysis of results. My report followed this format and, even though the agent did not improve upon baseline, since my report showed clear understanding of the literature and results I still received an A. The average is very low for this project since most people just use an inbuilt algorithm and see if it works without really understanding what it is they are doing or why they are doing it. Highly recommend going the reward-shaping route (not based on my project but on high-performing others).\n(1) 25% Exam which is honestly a gotchya. They should really change the exam as this has been a real black eye for the class for as long as reviews have been here. Nothing new, 50% avg grade. Know the material and you should do well enough to beat the average, but nothing will properly prepare you for the exam since it is all gotchya's.",
            rating: 5,
            difficulty: 5,
            workload: 22,
        },
        {
            user: '06OoEITW5lqbVxY08s6LlA==',
            reviewDate: 'August 11, 2022',
            semester: 'summer 2022',
            review: "ML really put me through the wringer. I expected RL to be less stressful because the assignments are less open-ended. It was, in much the same way that being punched in the stomach is less stressful than being kicked in the crotch.\nThe projects are great; I learned a ton and I'm excited to go do more experimentation on my own. In each project, it felt like there was some mysterious thing that I never figured out standing between me and the expected results, hence the stress. Fortunately, this doesn't prevent you from doing well in the class. Scoring is less harsh than ML but perhaps more harsh than most courses; correspondingly, the grading curve is less extreme than ML but still unusually generous (the cutoff for an A during this term seemed to be somewhere a little below 80%).\nThe TA team was fantastic. I think I got a lot out of both the textbook and the (large list of) assigned papers. The lectures were hit-and-miss - not as great as the ML lectures (but lectures are my least favorite way to learn anyway).\nI used about $430 worth of Google Cloud resources for project 3. Currently Google gives you $300 for free if it's your first time using it; I paid the rest out of pocket. I'm not sure this was necessary, but I think it made things easier for me. GPUs aren't important for the project, but having lots of processor cores is.\nAdvice:\n\nDon't take it in summer. The class has a ton of reading, and the projects involve experiments that take significant time to run, so spreading things out more would have been really nice. In particular, having only 2 weeks for project 2 sucked.\nOn project 3, if you aren't seeing good results quickly, try several different approaches. I think I wasted too much time trying to figure out what was going wrong with one particular approach, when other options would have yielded good results more easily.\n",
            rating: 5,
            difficulty: 5,
            workload: 25,
        },
        {
            user: 'o6Q0CDcILzP1xNbieTkD7g==',
            reviewDate: 'August 10, 2022',
            semester: 'summer 2022',
            review: 'Conclusion: This is a course with both significant advantages and disadvantages. Be very careful of taking it during a summer session.\nBackground: Quant, with a B.S. in Physics and M.S. in Financial Engineering.\nFinal grade: A\nPros\n\nExtensive coverage, including some new research in RL field.\nCourse is taught in a relatively clear way.\nFinal grade is curved generously.\nYou actually do not need that much maths.\n\nCons\n\nThe last project is way too time-consuming and requires A LOT OF computational resources. Better have a nice GPU before start.\nThe final exam does not have a lot to do with the lectures. It covers some readings, and details in the homework/projects as well. You can easily spend plenty of time preparing for it and get a low grade (as I did :D)\nThe professors talk about too many topics, but do not express some fundamental concepts in a clear way.\n',
            rating: 3,
            difficulty: 5,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: "It's quite difficult. Especially the theoretical part of the RL's (convergence, etc) are well covered. Project 3 requires a decent amount of RAM and patience because the training takes a while.",
            rating: 5,
            difficulty: 5,
            workload: 50,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'September 21, 2021',
            semester: 'summer 2021',
            review: 'This class was really tough in Summer semester. I would recommend taking it during Fall or Spring so you have more time to digest the many interesting papers and have time to properly tackle the assignments.',
            rating: 4,
            difficulty: 5,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: "This is my first course in OMSCS and has been a great learning experience. I have a non-CS undergrad degree but have spent couple of years in machine learning domain.  The course content was easy to grasp but for someone with no prior ML experience, I would suggest taking CS 7641 first as there were quite a few references to CS 7641 course (I did the udacity version of CS 7641 couple of years ago) .\nThe lectures are great. Prof Charles and Littman made the lectures quite enjoyable. I found David Silver's lectures a good supplementary material for the course.\nThe course had 6 homeworks. They consisted of jupyter notebook having some skeleton code from a concept discussed in lectures or from some research paper. We were asked to complete the code and submit it on gradescope. They were autograded and results were given instantly. They were simple enough and I was to able to finish each of them within 2-3 hours.\nThe projects were the best part of this course. There were 3 in total, each tougher than the previous. They required implementing parts  of a research paper and then writing a report on the methods and results obtained. The grading rubric was a bit vague, but what I observed was the TA's were mainly looking if the learner could express the ideas of the main paper in their own words or not. To get A, you definitely need to ace the projects. Start them as soon as they are released and keep atleast one week for writing the report.\nI felt the lectures and the deliverables were not fully in sync and this resulted in considerable additional reading, especially the part on game theory.\nThe final exam was easy. It covered the concepts discussed throughout the lectures as well as some questions were from assigned readings.\nThe TA's had been fantastic. The office hours were great and they were responsive on Piazza.\nOverall the course was a great introduction to reinforcement learning and I definitely recommend this course to anyone who is remotely interested in this area.",
            rating: 5,
            difficulty: 3,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: "Course was challenging, even with being fluent in python and having a DL background.  Projects and homework both take time to figure out the trick (or find the bug).  Don't procrastinate or you won't have time to solve the problems that crop up.",
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'July 27, 2020',
            semester: 'fall 2019',
            review: 'You learn a lot, also it has the best project of the program, but the lectures are the worst with distracting jokes everytime.',
            rating: 2,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            reviewDate: 'December 27, 2019',
            semester: 'fall 2019',
            review: "I enjoyed this class and definitely learned a lot. The homework assignments were easy and sometimes helpful for understanding the material. They only took a few hours each and were graded as you submitted. The projects required way more time and were more interesting. The grading for the projects seemed a bit all over the place. I received my lowest score on what I thought was my best work and my highest score on what I felt I had rushed. The final exam covers a lot of material that you never really had to think much about throughout the entire semester. I didn't get to study much for the final and was genuinely concerned I failed the course, but somehow ended up with an A so there must be a very generous curve.",
            rating: 4,
            difficulty: 3,
            workload: 11,
        },
        {
            ...
            semester: 'fall 2019',
            review: 'Way too much theory for 1 course. Final exam is closed book and it is impossible to remember all the concepts taught in the course. Homeworks are manageable, though not easy. Projects are brutal.',
            rating: 3,
            difficulty: 5,
            workload: 30,
        },
        ...
        },
        {
            ...
            semester: 'fall 2019',
            review: "I've lived in the US for almost 10 years now, and watching the video of this class just makes me feel like I don't know English. I really hope they can show the contents in a clearer way. Watching the videos is just so painful :'(",
            rating: 2,
            difficulty: 3,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: "If you're thinking of taking this in the summer....having NOT taken ML....just don't. Don't do it.\nThe pace is absolutely brutal with a homework or project due every week, 5 papers to read, and 1-2 lectures to watch. It's even more brutal when you don't know what you're doing and this is your first ML course. Just don't do it.\nThe material is very interesting and it's a very important part of ML, but the lecture delivery is the worst I've ever seen. You will end up watching a second set of lectures from Silver or one of the Stanford classes. They throw you in the deep end in shark infested waters with nothing but a due date and a link to a paper as guidance.\nThe material is too deep to absorb in such a short period of time. I'm going to have to properly re-read everything in order to absorb it.\nYou may be able to earn an A, but was the PTSD really worth it? Take it, but take it in a regular semester. You'll suffer, but less.",
            rating: 4,
            difficulty: 5,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2019',
            review: 'This course is complete garbage. The lectures are terrible. The projects are terrible. I really regret taking this course.',
            rating: 1,
            difficulty: 4,
            workload: 30,
        },
        ...
        },
        {
            ...
            review: "I would say this course is not bad. Here are my suggestions\nProjects: write the report carefully and pay some attention to the project requirements. Don't need to spend a  lot of time on the code.\nHomeworks: these are the easy part of this course, make sure you get 100 of all it. These are the only assignments that you actually can control how many scores you can get.\nexam: this is a joke. Just watch the video many times and take notes as much as possible.",
            rating: 3,
            difficulty: 4,
            workload: 25,
        },
        ...
        {
            user: 'Georgia Tech Student',
            reviewDate: 'April 7, 2019',
            semester: 'spring 2019',
            review: "Pros:\n\nThis course will force you adapt to grad level study, which means you need to be able to read a paper and replicate the models in paper\nTAs reply on piazza\n\nCons:\n\nPoor lecture, to many jokes and off-topic discussions in lecture videos\nZero coding sample in lecture, this courses is basically teach basic markov chain, DP, and game theories. You won't learn practical knowledge\n",
            rating: 1,
            difficulty: 4,
            workload: 18,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: 'Comments were pretty spot on for this class though opinions will very. Not a killer like ML, AI, or GA but definitely on the more difficult end like a 4 out of 5 on the scale. Based around reading papers and replicating results so expect a lot of learning a lot of the more difficult mathematical/algorithmic concepts on your own.',
            rating: 3,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            review: 'Very challenging class.  Challenging projects include trying to replicate results of RL papers.\nGood video lectures.  Some overlap with ML (RL videos from ML are reused for this class).',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2018',
            review: 'This is a tough course but doable one. The projects are fun & very stimulating. Prof Isbell is not as active as in case of ML. But the TAs are very engaged so you won’t miss the guidance needed.Miguel Morales needs a special mention. He is not only very knowledgeable but very humble too; he’s very keen to teach as well so that makes it even better.\nOverall a very enjoyable class with lots of learning...',
            rating: 5,
            difficulty: 4,
            workload: 15,
        },
        {
            user: 'Georgia Tech Student',
            reviewDate: 'October 16, 2018',
            semester: 'summer 2018',
            review: 'Very interesting course. Lectures were sort of useful. Thank god for David Silver lectures',
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'summer 2018',
            review: 'Good course. Covered contemporary RL. Theory focused.',
            rating: 4,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'fall 2017',
            review: "Wish I had taken ML first, but this course was still fascinating and opened my mind to a lot of new ideas I hadn't encountered before.  Project can be very tough and take a lot of time between iterations - start them early! I hate writing papers, but it was worth it for this class.",
            rating: 5,
            difficulty: 4,
            workload: 20,
        },
        ...
        },
        {
            ...
            semester: 'summer 2017',
            review: 'Good course overall !!!\nProjects are interesting... you get to know about latest research - hard work but you learn a ton.. Get grip over some algebra - it will only help..\nOne pro tip - focus on the report you submit - even if you are not able to accomplish end goal - just put in arguments about the subject matter and what all you tried.. you will be rewarded for your efforts and reports and not about the actual result - makes total sense - but something I was not aware of..',
            rating: 5,
            difficulty: 4,
            workload: 25,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'Good course, that delves into one part from 7641 deep. Many fun assignments, especially the one that uses Open AI gym. Lots of paper to read that gives a pretty good insight into the workings are reinforcement learning. Overall a fun, medium difficulty level course',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2015',
            review: "I loved this course. The lectures were great - informative and engaging and the projects, which were rarely super hard, helped give you some subtle insights into the course content that I don't think you could have gotten any other way. I wish there were more courses on this... I'd take them in a heartbeat.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        {
            ...
            review: 'The content was very interesting and the TAs were very accommodating.\nThe weekly projects we very light compared to the final project, but overall, the course is great. There were a lot of reading materials, but I learned a lot about Reinforcement learning!',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'summer 2016',
            review: 'Weekly assignments were easily accomplished with a few lines of code in Python without having to think too much in terms of MDPs. The final project required many more hours of reading and coding than the first.',
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2015',
            review: 'I loved the material, lectures and final project. Assignments were a mixed bag for me. communication on piazza was sorely lacking. Student study group a life saver.',
            rating: -1,
            difficulty: 4,
            workload: 20,
        },
    ...
    reviewSummaries: {
        'summer 2024':
            'The course is generally well-received, praised for its engaging lectures similar to previous machine learning classes and enjoyable material. However, the lectures lack depth, requiring students to rely heavily on readings, as they don’t adequately prepare for Projects 2 and 3. While earlier projects like 1 and 2 are deemed manageable with proper reading, Project 3 is notably challenging, especially due to its implementation in Python and a slow environment. Homework is easy, but the final exam poses issues with unclear guidelines and an emphasis on multiple-choice questions, which some find disingenuous for a graduate course focused on analysis. Overall, students recommend the course for those genuinely interested, but caution about the difficulties of higher-level projects.',
        'spring 2024':
            'The course received mixed reviews, highlighting both strong teaching and significant challenges. Positively, students praised the lectures as solid and the assignments as effective for deep learning, especially in reinforcement learning (RL). The teaching staff was valued for their accessibility and responsiveness. However, many found the course content dense and math-heavy, leading to underestimation of the workload, particularly for projects that required extensive time and effort. Students noted that projects lacked clarity on expectations, impacting their performance. The final exam was criticized for its difficulty and ineffective preparation focus. Despite these hurdles, many students were pleased with their overall learning and final grades, indicating that the effort was worthwhile, albeit exhausting.',
        'fall 2023':
            "The reinforcement learning course is both challenging and engaging, encouraging students to take control of their learning through time management and independent research. Many appreciate the rigorous projects and supportive TAs, noting the course's real-world applicability. However, there is significant criticism regarding the disconnection between theoretical lectures and practical applications, with students often feeling lost due to unclear explanations and outdated readings. The syllabus lacks modern reinforcement learning concepts, which could enhance understanding. While some find value in using supplemental resources, others recommend avoiding the course if seeking practical knowledge, as many topics are inadequately covered. Overall, students warn that the course demands extensive effort and may not meet expectations for contemporary applications.",
        'summer 2023':
            "The reviews for this course reflect a mix of experiences, highlighting both challenges and rewards. Students acknowledge the course's difficulty and rigorous grading distribution, particularly praising the thoroughness required for project 3, which many consider a significant undertaking. However, criticisms arise regarding the dated and confusing lectures, lack of coverage on policy gradient methods, and insufficient peer engagement during the summer session, resulting in minimal Slack discussions. Technical difficulties, especially with cloud setups, exacerbated frustrations for some. Despite these hurdles, students who invested time and effort reported substantial learning and achieved high project scores, suggesting that the course can be rewarding for dedicated participants willing to seek external resources and support.",
        'spring 2023':
            'The Reinforcement Learning course offers a compelling blend of theory and practical experience, highlighting the intersection of AI, statistics, and neuroscience. Positive reviews emphasize engaging projects that deepen understanding, supportive TAs, and valuable readings, with many students finding the hands-on aspects rewarding. However, the theoretical nature of the course and its limited industry application raise concerns. The lectures varied in quality, with some feeling disjointed and overly focused on mathematical proofs. Many students struggled with the final exam, criticizing its disconnect from course materials and lack of guidance. Overall, while the course is challenging, especially with its demanding workload, it’s seen as a valuable experience for those pursuing AI and machine learning.',
        'fall 2022':
            'The course is engaging and rich in material, offering a challenging workload that may not be suitable for part-time students. Positive feedback highlights the helpful TAs, insightful projects, and the enjoyment of reading and implementing cutting-edge theories like TD(lambda) and DQN. However, many reviewers mention a slow grading process and unclear project instructions, which can lead to frustration. The final exam is particularly difficult, with low average scores noted. Students recommend having a strong computing setup for projects and suggest supplementary resources like David Silver’s lectures for better understanding. Some negative reviews express dissatisfaction with grading inconsistencies and video quality. Overall, the course demands significant time and effort, with mixed experiences reported by students.',
        'summer 2022':
            'The course on Reinforcement Learning (RL) has received mixed reviews. Many students found it to be one of the best in the OMSCS program, highlighting the extensive coverage of topics and the eye-opening content. The projects were generally praised for their educational value, particularly the second and third projects, which offered challenges and practical applications. However, students warned against taking the course during the summer due to its demanding workload and the highly time-consuming final project. The grading curve was perceived as generous, but the final exam was criticized for being disconnected from the lectures and difficult to prepare for. Additionally, students noted that computational resources were crucial, especially for the last project, which added to the stress of the course.',
        'spring 2022':
            "The course received mixed reviews, highlighting both its strengths and challenges. Many students appreciated the straightforward nature of homeworks and the engaging TA support, noting that projects were manageable, with the exception of Project 3, which was considered particularly difficult and time-consuming. Students found early assignments easy, while others struggled significantly with the final exam's ambiguous questions and additional content not covered in the study guide. Participants recommended starting projects early and utilizing established libraries like RLlib. Some expressed frustration with various setup issues, especially related to hardware configurations. Overall, students acknowledged the course's relevance and engaging content, valuing the deep reinforcement learning focus, despite the heavy workload and exam challenges.",
        'fall 2021':
            "The course on reinforcement learning (RL) is both enjoyable and challenging, with a heavy curve benefiting grades. Many students find the homework manageable, particularly after the first assignment, and appreciate the supportive TAs. However, projects are demanding, often requiring over 30 hours of work each, with Project 3 introducing issues like insufficient time and resource management, leading to stress. Lectures are critiqued for being inconsistent with helpful content, prompting students to seek external resources like David Silver's lectures. The final exam proved difficult due to vague questions, though strong preparation was emphasized. Overall, while the course is rewarding, the workload and grading inconsistency raise concerns among students.",
        'summer 2021':
            "The course on Reinforcement Learning (RL) has generated mixed reviews among students. Many praised the academic rigor and interesting theoretical discussions, making it a good fit for those passionate about theoretical computer science and AI. However, the condensed summer format posed challenges, with students advising future participants to take it in fall or spring for better pacing. While homework assignments were generally perceived as manageable, the three major projects were time-consuming and demanding, requiring significant preparation. Complaints about the final exam highlighted confusion and lack of clarity, particularly when compared to the project's intellectual depth. Overall, while the material is compelling, the course workload and lecture quality often left students feeling overwhelmed and frustrated.",
        'spring 2021':
            "The course on Reinforcement Learning presents a mix of challenges and rewards. While many students appreciated the depth of content and the engaging lectures that covered essential algorithms, they found the projects, particularly the replication of research papers, to be quite difficult and sometimes frustrating. Homework assignments were often viewed as either too easy or lacking in educational value. The TAs received high praise for their support, although the professors' absence was noted. Some felt the course materials were heavily biased towards the instructors’ work and that theoretical concepts sometimes overshadowed practical applications. Overall, while the foundational knowledge gained was valuable, the course's design was considered inconsistent and could benefit from clearer grading rubrics and more relevant assignments.",
        'fall 2020':
            "The course on reinforcement learning (RL) received mixed reviews, with many students appreciating the engaging lectures and the practical focus on projects and homework. Reviewers noted that the lectures were helpful, although some found the humor excessive, and highlighted the importance of prior knowledge in algorithms and machine learning for success. Homework and projects were described as challenging but beneficial, with many recommending that students start projects early. The amount of reading, particularly dense research papers, was a common complaint, as was the exam's difficulty level. Some students felt overwhelmed, especially those lacking strong coding and math backgrounds. Overall, the course was recommended as an informative introduction to RL despite its challenges.",
        'fall 2019':
            'The course on reinforcement learning is a challenging yet rewarding experience that effectively immerses students in cutting-edge research. Reviewers praise the comprehensive curriculum, engaging TAs, and the necessity of strong mathematical foundations, particularly in probability. Many highlight the interesting projects, albeit time-consuming, and appreciate the learning opportunities they provide. However, some students feel the lectures lack depth and often contain distracting humor, detracting from their effectiveness. The final exam is noted for its difficulty and the heavy reliance on theory, leading some to feel unprepared. While most students find the workload manageable, those who attempt to juggle multiple courses may struggle. Overall, the class is well-received but demands significant effort and preparation.',
        'spring 2020':
            'The course on reinforcement learning received a wide range of feedback from students, highlighting both its strengths and weaknesses. Positively, many found the content engaging, with a solid foundation in mathematical concepts and a rewarding academic challenge that bolstered confidence in tackling complex topics. Students appreciated the structured approach to projects, which often included practical applications, enhancing their understanding of the material. However, criticisms emerged about the workload, with some feeling overwhelmed by the extensive reading and steep learning curve, especially for those lacking prior experience in reinforcement learning. The grading process was another area of concern, with complaints about lack of clarity in rubrics and subjective evaluations. Overall, while the course is viewed as essential for serious learners, it demands substantial time commitment and resilience.',
        'spring 2019':
            'The course has received mixed reviews, with significant emphasis on the disconnect between lectures and practical applications. Many students found the lectures to be disengaging and poorly structured, relying too much on jokes and lacking depth in explanation. Feedback on the final exam is lacking, and its difficulty contributed to low average scores. In contrast, projects are often highlighted as the most enjoyable and rewarding parts, allowing for hands-on experience, though they are time-intensive. While assignments are generally considered manageable, the grading can feel arbitrary. Overall, students recommend caution due to the heavy workload and ineffective teaching methods, suggesting alternative resources for better learning outcomes in reinforcement learning.',
        'summer 2020':
            "The course received a mix of positive and negative feedback from students. On the positive side, many appreciated the engaged teaching assistants (TAs) and the opportunity to learn a lot through hands-on projects and extensive reading of research papers, which enhanced their technical skills. The exams were deemed fair, with generous grading curves. However, several students criticized the lectures as hard to follow and the grading on papers as vague and arbitrary. The projects often involved replicating outdated studies, which some found less valuable for real-world applications. While some students enjoyed the depth and challenge of the course, others felt disappointed by the lack of instructor involvement and the course's overall structure.",
        'summer 2019':
            "The Reinforcement Learning course in the OMSCS program received mixed reviews. Positively, students appreciated the depth of learning, hands-on projects like the Lunar Lander, and the valuable insights from the TAs. Many noted that despite the heavy workload, they gained significant knowledge about reinforcement learning concepts. However, the course was often described as challenging, especially for those without a background in machine learning, with some finding the lectures lengthy and poorly delivered. The project grading felt subjective, and the rigor of the assignments combined with the compressed summer schedule led to high stress levels. Recommendations included completing prior ML courses and leveraging additional resources, like David Silver's lectures, for better comprehension.",
        'summer 2018':
            "The course on Reinforcement Learning is notably challenging, with students highlighting a demanding workload that includes numerous readings, projects, and weekend assignments. Positive feedback often centers on the engaging and knowledgeable TAs, the stimulating nature of projects, and the interesting course material. However, critiques frequently mention the lectures as lacking clarity and usefulness, suggesting reliance on external resources like David Silver's lectures. Students also express frustration with unclear grading policies, particularly regarding vague feedback and regrading processes. The tight schedule in summer sessions exacerbates these issues, making it hard to keep up. Overall, while the course provides valuable insights into RL, many recommend prior ML experience and caution against taking it in the summer without adequate preparation.",
        'spring 2018':
            "The Reinforcement Learning course generates mixed feedback from students. Positive reviews highlight its engaging content, including challenging projects that foster deep understanding of essential concepts like temporal difference learning and hyperparameter tuning. However, many students express frustration over the heavyweight reading assignments, complex projects, and a brutal final exam that lacks clarity. Homework assignments are generally seen as easier but do not carry significant weight in grading. Some students appreciate the supportive TAs and suggest watching external resources, like David Silver's lectures, to clarify confusing material. Overall, while the course is deemed interesting and rewarding, it demands substantial time commitment and a strong background in math, making it challenging, particularly for newcomers to the field.",
        'fall 2018':
            'The course on Reinforcement Learning (RL) receives mixed reviews from students. Positively, many find the material engaging and appreciate the well-curated papers that enhance understanding, with TAs praised for their support on platforms like Piazza and Slack. Some projects are highlighted as well-designed and enjoyable, especially when students manage their time effectively. However, criticism arises regarding the lectures, which are deemed outdated and too abstract, lacking essential theory and clarity. Many students also express frustration with the demanding projects, which often involve reproducing complex results with inadequate guidance, leading to inconsistent grading experiences. Overall, while the course is challenging and requires significant self-study, those with prior background in machine learning seem to fare better.',
        'spring 2016':
            'The course on reinforcement learning is highly regarded for its challenging content and engaging video lectures that deepen understanding beyond the previous Machine Learning class. Students appreciate the practical experience gained from replicating results from academic papers, although some find the projects overly academic and the assignments abstract. Feedback indicates that the course is rigorous, with difficult homeworks that often contain "tricks," contributing to a heavy workload. While there is a noted lack of instructor involvement compared to the ML class, TAs are responsive and helpful. Overall, students recommend this class for its depth and theory but advise newcomers to prepare for a demanding workload and to approach it with a serious mindset.',
        'fall 2017':
            "Overall, the course offers a rewarding but challenging experience, with projects deemed the most valuable yet time-consuming aspect. Many students noted the need for early starts on assignments due to their complexity and length, with one even mentioning emotional struggles during project work. The TAs received praise for their helpfulness, providing supplemental materials and support through platforms like Slack and Piazza. However, the theoretical nature of the lectures posed difficulties for some, with recommendations to prioritize David Silver's lectures for better comprehension. The final exam was commonly perceived as difficult, requiring extensive knowledge and preparation. Despite these challenges, students appreciated the knowledge gained and expressed enthusiasm for applying reinforcement learning principles in future endeavors.",
        'summer 2017':
            'The course on reinforcement learning has garnered mixed reviews. Positively, students found the material fascinating and appreciated the engaging TAs, particularly praising the second project involving OpenAI Gym’s Lunar Lander as a highlight. The fast-paced teaching style and the challenge of replicating research projects were seen as both daunting and rewarding, fostering significant learning. However, many complained about the overwhelming workload, especially during the summer session, often equating it to taking multiple full-time classes. The lectures were criticized for being vague, math-heavy, and disconnected from assignments, leading to confusion. Additionally, students noted a lack of interaction with the professors and found TA support inconsistent, with many feeling unsupported during critical project phases. Overall, while the course offers valuable content, students advised caution regarding its demanding nature.',
        'spring 2017':
            'The course on reinforcement learning receives mixed feedback from students. Positively, many appreciated the challenging content and practical assignments that solidified their understanding of the theory. Projects, especially those involving OpenAI Gym, were highlighted as enjoyable and educational, despite being time-consuming. Students felt well-supported by the TAs, but expressed disappointment over the professors’ absence. However, the course is heavily geared towards academic papers, with students needing to engage with numerous readings, which some found burdensome and disconnected from practical applications. The fast-paced nature and the high level of mathematics presented barriers for some, leading to feelings of frustration regarding the course structure and relevance to real-world applications. Overall, it’s viewed as rigorous but potentially misaligned with students’ goals.',
        'fall 2016':
            'The course is generally well-received, praised for its engaging content and enjoyable assignments, particularly the use of Open AI gym. It builds on knowledge from Machine Learning (7641) and offers a medium difficulty level. However, some students noted the upgraded difficulty in Fall 2016, with more demanding homework assignments and extensive projects, particularly regarding paper replication and implementing reinforcement learning algorithms in gaming scenarios. While the weekly homework is manageable, the three major projects require significant time investment, often exceeding 40 hours. Overall, the course is considered worthwhile and a fun deep dive into reinforcement learning, though it demands effort similar to that of its predecessor.',
        'fall 2015':
            'The course received high praise for its engaging lectures and insightful projects, which provided unique understanding of the content. Reviewers appreciated the return of pair lecturing by Smoov and Curly, highlighting the interesting subject matter and reduced workload compared to machine learning courses. However, some comments emphasized the importance of approaching assignments efficiently; students who struggled were advised to revisit lectures and readings to find easier solutions. Overall, while the course was well-regarded, there were reminders that understanding the right approach to assignments was critical for success.',
        'summer 2016':
            "The course on Reinforcement Learning received mixed reviews, highlighting engaging lectures and a wealth of fascinating content, particularly praising TAs as responsive and helpful. Students appreciated the final projects for their real-world applications and the opportunity to replicate published research, although they felt the weekly assignments were too easy and sometimes disconnected from the lecture material. Some participants expressed disappointment with the professor's limited interaction, stating that the TAs played a more significant role. While the grading was considered generous, especially in the summer semester's compressed schedule, many wished for more challenging assignments and a better balance between theory and practical application. Overall, the course is recommended for those interested in reinforcement learning, despite some criticisms.",
    },
};
