export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'N/A',
            con: 'The course involves excessive work with tedious assignments, unhelpful TAs and instructor, and focuses on outdated computer vision techniques instead of more relevant neural network content.',
        },
        'spring 2023': {
            pro: 'Some students enjoyed the material and assignments, found lectures fun and informative, and appreciated the efforts of certain TAs who were helpful despite being overwhelmed.',
            con: 'Many reviewers expressed dissatisfaction with the TAs and grading process, mentioning issues such as failures in communication, arbitrary grading, accusations of plagiarism, and a heavy workload that felt unmanageable.',
        },
        'fall 2023': {
            pro: 'The course features good lecture recordings, a detailed walkthrough of fundamentals, demanding assignments that keep students engaged, and a comprehensive syllabus that covers both basic and advanced machine learning techniques. TAs are responsive and helpful, and many students find the assignments interesting and rewarding.',
            con: 'The course content is not up to date, and some examples do not align with modern technology. Lecture videos are outdated, and the workload is heavy, leading to significant time pressures on students, particularly those with full-time jobs. Clarity of assignment instructions and grading errors can also add to the stress.',
        },
        'fall 2022': {
            pro: 'Engaging lectures with high-quality production; good introduction to computer vision topics; rewarding and challenging learning experience.',
            con: 'Course is extremely demanding with a heavy workload; long lectures; tedious projects; delayed TA assistance; confusing instructions.',
        },
        'spring 2022': {
            pro: 'Good course content and lectures covering traditional computer vision methods. Fair grading from TAs, especially for the final project.',
            con: 'Heavy workload, significantly disproportionate to learning value; TAs are largely unresponsive and provide little assistance. Many students reported dropping the class due to its brutality.',
        },
        'fall 2021': {
            pro: 'The course offers high-quality lecture materials that cover interesting and relevant content in computer vision. Some students found the assignments challenging yet educational, allowing for significant learning outcomes.',
            con: 'The course suffers from severe disorganization, unresponsive TAs, buggy assignments, and unclear instructions. Many students reported high levels of frustration due to the excessive workload and challenging parameter tuning without sufficient support.',
        },
        'spring 2021': {
            pro: 'The course is praised for its engaging and informative lectures, as well as its solid, challenging assignments that reinforce learning. Many students highlighted the quality of teaching and the depth of material covered, making it a good introduction to computer vision.',
            con: 'Criticism centers on the high workload, outdated materials, lack of responsiveness from TAs, and poorly structured assignments that lead to confusion. Several students expressed frustration over the lack of support and timely feedback, which greatly affected their learning experience.',
        },
        'fall 2020': {
            pro: 'The course provides a strong foundation in classic computer vision concepts and techniques, with engaging lectures from Professor Bobick. Many students appreciate the hands-on assignments that reinforce learning and the usefulness of provided office hours and supplementary materials.',
            con: "The course suffers from outdated materials, lack of instructor interaction, and inadequate TA support. Many students found the lectures overly long and superficial, and expressed frustration with the course's organization and communication issues.",
        },
        'fall 2019': {
            pro: 'The course offers excellent and detailed video lectures that cover a wide range of computer vision topics and features well-designed, interesting projects that encourage learning and practical coding experience.',
            con: 'The workload is very high, with many challenging assignments and a time-consuming final project; some students also noted grading inconsistencies and required excessive parameter tuning.',
        },
        'spring 2020': {
            pro: 'The course provides a solid understanding of computer vision fundamentals, is well organized, has interesting material, and offers engaging lectures, especially those by Prof. Bobick. Many students appreciate the challenging problem sets and the learning experience they provide.',
            con: 'The course is perceived as very difficult with a heavy workload, requiring significant time investment. Some students found the video lectures excessive, the final projects time-consuming, and a lack of clarity in assignments and grading. There are also concerns about the need for a deep understanding of mathematical concepts that are not sufficiently covered.',
        },
        'spring 2019': {
            pro: 'Well-structured lectures and a lot of learning material. Lectures by Prof. Bobick are highlighted positively. Interesting and challenging assignments that build on each other. Final project is well-received despite its difficulty.',
            con: 'Course is intense with heavy workload and tight deadlines, making it difficult to manage alongside other classes. Lack of TA support and organization issues, including misinformation and late assignment releases. Some assignments require extensive parameter tuning, and grading can be inconsistent.',
        },
        'fall 2018': {
            pro: 'The course features engaging projects and well-structured lectures, providing a solid understanding of computer vision techniques. Students appreciated the active community support through platforms like Slack, and many found it rewarding despite the challenging workload.',
            con: 'The course has a significant time commitment, with many projects requiring extensive tuning and effort. Some students noted that the lectures could be too high-level, and some material may feel outdated given the current emphasis on deep learning.',
        },
        'summer 2018': {
            pro: 'The course is engaging and interesting.',
            con: 'Lectures are rushed, requiring rewinds for better understanding.',
        },
        'spring 2017': {
            pro: 'Course offers great support from TAs, lots of engaging video content, and is well-designed with challenging problem sets that reinforce learning.',
            con: 'Time-consuming with lengthy videos and projects; some assignments require significant parameter tuning, leading to inconsistent workloads.',
        },
        'spring 2018': {
            pro: 'The course offers robust and challenging projects, engaging lecture content, and a strong peer support system through Slack. Students appreciated the hands-on experience with Numpy and OpenCV, and many found the subject matter rewarding despite its difficulty.',
            con: "The course management and TA support were generally poor, with homework returned late and unclear specifications. The professor's limited presence and outdated course material were also criticized, leading to frustration among students.",
        },
        'fall 2017': {
            pro: 'The course offers engaging lectures and interesting projects that enhance understanding of computer vision concepts. Many students found the material valuable and the TAs, particularly during office hours, helpful.',
            con: 'The course is very demanding in terms of workload, with many students reporting overwhelming project requirements and time commitments, especially for the final project. Some reviews noted a lack of instructor interaction and responsiveness on forums.',
        },
        'spring 2016': {
            pro: 'The course features excellent materials and lectures, informative and hands-on projects, supportive TAs, and engaging content that helps students learn complex algorithms and concepts effectively.',
            con: 'The course is extremely challenging, with overwhelming material and time-consuming assignments, leading to significant stress and potential burnout among students.',
        },
        'fall 2016': {
            pro: 'The course content and lectures are well-received, with informative, engaging material that fosters a strong understanding of computer vision and its mathematical foundations. Students appreciate the helpfulness of TAs and community resources like Piazza and Slack. Many found the assignments rewarding and beneficial for skill development.',
            con: "Assignments are often time-consuming, with some requiring excessive hours for completion. The course can feel overwhelming due to the volume of lecture content, and there is little adjustment for grading; students specifically mentioned a lack of grade curve. The final exam's difficulty was considered misaligned with the assignments.",
        },
        'spring 2015': {
            pro: 'The course is interesting and challenging, with informative and engaging lectures. Projects allow students to create fun and functional code related to computer vision.',
            con: 'A strong understanding of relevant math, MATLAB, or Python is necessary, and struggles with these can lead to significant time investment on assignments.',
        },
        'fall 2015': {
            pro: 'The video lectures are interesting, funny, and clear. The course is described as good overall, with great material and rewarding assignments.',
            con: 'The course has a heavy workload, unclear grading requirements, and insufficient TA support. Students noted that foundational knowledge in Python, linear algebra, and computer vision is crucial, and the assignment feedback can be slow.',
        },
    },
};
