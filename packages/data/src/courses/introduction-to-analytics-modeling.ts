export default {
    ...
    reviewSummaries: {
        'fall 2023':
            'The course received mixed reviews, noted for its engaging lectures and excellent instructor, Dr. Joel Sokol, who simplifies complex concepts effectively. TAs were also praised for their responsiveness and helpfulness. However, students found the pacing overwhelming, especially during exam weeks, which led to feelings of stress due to the constant workload of weekly assignments and peer reviews. Many felt the assessments were tricky, poorly aligned with homework, and heavily weighted, raising concerns about grading fairness. Although the course provided a broad overview of analytics, students desired more practice opportunities to solidify their understanding. Overall, while the course was considered a solid introduction to the field, its structure and demands were seen as potentially discouraging for some learners.',
        'summer 2024':
            'The course offers a solid overview of analytical models, valued for its practical approach and real-world applications, especially through case studies. Many students appreciate the supportive TA team, which provides helpful guidance during office hours. However, the course can be challenging, particularly for those without a strong math background, as foundational topics like linear algebra may lead to confusion. While the peer-reviewed assignments allow for collaboration, some students feel that feedback from peers can be inadequate due to their limited experience. Overall, the course is recommended as an introductory step in a degree program, despite some criticisms regarding depth and assignment evaluation.',
        'spring 2024':
