export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course offers excellent content, including lectures, readings, and example code, which provide valuable resources for learning. The structure allows students to succeed if they dedicate adequate time to study each week.',
            con: 'The course may be challenging and requires a significant time commitment, with some students struggling to balance it with personal life, leading to a high-stress learning experience.',
        },
        'fall 2023': {
            pro: 'Course offers a great amount of content with clear explanations and practical applications, including MATLAB examples.',
            con: 'Desire for more understanding of the derivation of formulas from real engineering cases.',
        },
        'summer 2023': {
            pro: 'The course covers interesting and insightful topics in machine learning and statistical analysis, with well-constructed lecture slides and manageable homeworks supported by TAs.',
            con: 'Basic linear algebra and calculus are required, and there may be a preference for R and MATLAB over Python for assignments.',
        },
        'summer 2022': {
            pro: "The course is highly mathematical and intellectually stimulating, with excellent lectures by Professor Paynabar and a wide range of advanced topics covered, transforming students' fear of math into appreciation.",
            con: 'The course is challenging with heavy homework assignments and requires significant effort and independent problem-solving skills.',
        },
        'spring 2023': {
            pro: 'TAs grade leniently, which may help some students pass.',
            con: 'The course is very math-heavy, difficult, and time-consuming, with concerns about its relevance to current industry trends.',
        },
        'fall 2022': {
            pro: 'The course content is highly interesting and provides a solid understanding of key concepts, especially beneficial for those pursuing a data science career.',
            con: 'Course management is poor, with minimal engagement from the professor and inconsistent support from TAs, leading to confusion and frustration among students.',
        },
        'spring 2022': {
            pro: 'The course is well-structured with informative lectures, helpful TAs, and practical assignments that reinforce learning with applicable theories in machine learning.',
            con: 'The course is challenging and requires a solid foundation in linear algebra and multivariate calculus, which may deter some students.',
        },
        'fall 2021': {
            pro: 'Professor Kamran is patient and offers valuable office hours; the course broadens knowledge in analyzing high dimensional data with a comprehensive optimization section.',
            con: 'There are errors in example code provided by the TA, and a significant amount of math is involved.',
        },
        'summer 2021': {
            pro: 'Students enjoyed the course for its in-depth exploration of tools for handling HD data, mathematical rigor, and the flexibility of take-home exams.',
            con: "The removal of two modules in the summer reduced the course's challenge, which some felt compromised its integrity.",
        },
        'spring 2021': {
            pro: 'The course is intellectually challenging and offers a deep dive into advanced mathematical concepts, with strong support from TAs and quality lecture materials. Many students found it to be their best course in the OMSA program, highlighting its engaging content on splines, tensors, and optimization topics.',
            con: 'The pacing of the course can be too quick, leading to stress during homework and exams. Some students struggled with the requirement to switch between Matlab and R, and wished for better resources to strengthen mathematical foundations. Additionally, the office hours scheduling was seen as inadequate.',
        },
        'fall 2020': {
            pro: 'The course has well-curated material with concise weekly videos, helpful homework assignments, approachable teaching assistants, and relevant content for real-life applications in data science. The class is well-structured, and the exams are fair and aligned with the homework.',
            con: 'The course may be challenging for students who lack prior programming experience, a strong background in mathematics, or previous machine learning coursework. The reliance on MATLAB for example codes could also be a drawback for those unfamiliar with it.',
        },
        'summer 2020': {
            pro: 'The course includes interesting topics not covered in other classes and provides a good depth of mathematical content, making it rewarding for those with a strong math background.',
            con: 'The course material may feel outdated, lacks depth in some areas, and frequently relies on example code for assignments, which can diminish true learning and understanding.',
        },
        'spring 2020': {
            pro: 'The course provides challenging content and exposes students to advanced topics like Tensor Decomposition and image processing. Students feel a sense of achievement and gratitude for the learning experience.',
            con: 'The course lacks effective professor engagement and has inconsistent TA support, making it difficult for students to receive help and clarification on course material.',
        },
        'fall 2019': {
            pro: 'The course is described as challenging but rewarding, with knowledgeable TAs and a responsive instructor. Many reviewers appreciated the depth of learning and the volume of new concepts covered.',
            con: "The course is noted for being very hard, with demanding homework and a heavy mathematical load. Some reviewers suggested having prior knowledge in mathematics and recommended taking the course later in one's program.",
        },
        'summer 2019': {
            pro: 'The course dives deep into complex mathematical concepts, particularly in Linear Algebra and Calculus, and offers interesting modules like Image Processing and Regularization. Many students found the material enriching and appreciated the lenient grading for effort put into assignments and discussions.',
            con: 'The course is extremely challenging, with significant mathematical rigor that may overwhelm students lacking strong prior knowledge. Feedback indicated that homework assignments could be vague, and the course could benefit from better instructional clarity, especially regarding example code and notation.',
        },
        'spring 2019': {
            pro: 'The course is praised for its practicality, interesting content, and an excellent professor with clear explanations. Instructors are responsive and grading is lenient for reasonable attempts.',
            con: 'The course is considered very challenging and math-heavy, requiring strong linear algebra/calculus skills. Time management is essential due to the workload, and it is not recommended to take it alongside another class if working full time.',
        },
    },
};
