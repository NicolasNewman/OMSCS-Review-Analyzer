export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: "Enjoyable course, we got to look under the hood of compilers and learn about different optimization techniques as they apply to embedded systems.  The projects were time consuming and interesting.  My only complaint is that due to the nature of the projects they took a long time to grade so we didn't know about 75% of our grade until the week of finals.  But everything was graded fairly and carefully with good feedback so all's well that ends well I suppose.",
            rating: 4,
            difficulty: 4,
            workload: 12,
        },
        ...
        },
        {
            ...
            semester: 'fall 2016',
            review: 'Very good course but not a entry level for a student like me that just start to learn computer science.',
            rating: 2,
            difficulty: 5,
            workload: 28,
        },
        {
            ...
            review: 'very interesting topics. I took the first offering of this class online and as a result some of the assignments/projects were vague in their requirements, but the professor and TAs were very helpful.',
            rating: 4,
            difficulty: 4,
            workload: 17,
        },
        ...
        },
        {
            ...
            semester: 'summer 2016',
            review: 'I agree with most of what has been said about the Summer semester. This is a "1. 0" or "1. 1" version of the class however. The professor and TA\'s were very active and helpful in Piazza. The only frustrating part for me was the homework being so vaguely or inconsistently worded, so the advice of waiting a day or two and reading Piazza very closely I would also second. The grading was fair however, and the homework did become more clear after clarifications via Piazza, so in the scheme of things this isn\'t the end of the world. I would still very much recommend this class if you want to learn more about pipelines, VLIW, etc.',
            rating: 4,
            difficulty: 3,
            workload: 20,
        },
    ...
    reviewSummaries: {
        'fall 2023': {
            pro: 'The head TA Darrell is a positive aspect of the course.',
            con: 'Course content is outdated, lectures are poor, the professor is disengaged, and there are better courses available in the curriculum.',
        },
        'summer 2021': {
            pro: 'The course is challenging yet interesting, with a strong focus on compiler optimizations and real-world applications through projects; the instructor and TAs are supportive and dedicated.',
            con: 'The homework difficulty varies greatly, leading to uneven workloads, and the exam can be stressful as it constitutes a significant portion of the grade.',
        },
        'fall 2021': {
            pro: 'The course is satisfying with loads of learnings and TAs are helpful in clarifying questions.',
            con: "Instructions for projects/homework are mildly unclear, and the final exam's weight distribution is considered too high.",
        },
        'spring 2021': {
            pro: "The course offers a lot of engaging content, with Project 1 and several homeworks enhancing understanding of the material. It's a good choice for those interested in both compiler and embedded systems.",
            con: "The course suffers from underspecification and ambiguous language in assignments. Project 2 is seen as busywork, and the final exam's structure and multiple choice questions can be confusing and poorly constructed.",
        },
        'fall 2020': {
            pro: 'The course is well-structured, with organized and informative lectures. The head TA is praised for improving the autograder, enhancing future student experiences. Many students find the course challenging yet engaging, particularly enjoying the projects and the depth of material covered.',
            con: 'There are issues with TA knowledge and availability, leading to a lack of support during crucial times. Some course materials contain errors, and students often feel unprepared due to insufficient explanation of foundational concepts. Communication with the professor is primarily limited to office hours.',
        },
        'summer 2020': {
            pro: 'The course is well-structured with interesting material on computer architecture and compilers. TAs and the professor are responsive, providing support during the course. Projects and homework are aligned with lectures, enriching learning experiences.',
            con: 'The course can be overwhelming and challenging, especially for those without a strong background in C++ and Python. There are inconsistencies in lectures and homework, and some projects are very time-intensive.',
        },
        'spring 2020': {
            pro: 'The course provides a deep understanding of Embedded Systems Optimization and includes practical projects that enhance learning, such as VLIW scheduling and heuristics development.',
            con: 'The course is not suitable for beginners, with a heavy reliance on prior knowledge and concepts like Graph Theory, which may make it challenging for newcomers.',
        },
        'fall 2019': {
            pro: 'The course is interesting and provides a comprehensive overview of processor architecture and microarchitecture, with well-structured material and enthusiastic teaching. It includes valuable projects and homework that reinforce learning, alongside timely grading and supportive office hours.',
            con: 'The course is time-consuming, with assignments requiring significant effort. There are occasional inaccuracies in lectures, and response times on Piazza can be slow. The overall difficulty is high, not recommended for those without a strong background in low-level concepts.',
        },
        'summer 2018': {
            pro: 'The course effectively covers compiler internals, optimizations in design, and is generally fascinating for those with a strong background in C/C++. Students appreciated the practical applications of theories through projects, and many found the lectures clear and well-organized.',
            con: "Many students reported issues with unclear project descriptions, lack of timely TA responses, and difficulties with the final exam format, which had mistakes and unclear instructions. Additionally, access to the course's online resources was problematic for some, hindering their ability to complete assignments effectively.",
        },
        'summer 2019': {
            pro: 'The professor is knowledgeable and effective, with clear teaching of embedded systems concepts; responsive TAs; engaging projects and fair final exam.',
            con: 'Quizzes and homework are too easy and mostly fill-in-the-blank; second project lacks programming depth; overall focus on academic concepts rather than practical programming.',
        },
        'spring 2019': {
            pro: 'N/A',
            con: 'The course has vague homework, disjointed lectures, slow grading, and outdated material. It is poorly organized and not suitable for those interested in embedded software.',
        },
        'fall 2018': {
            pro: 'The course covers a comprehensive range of topics in computer architecture and compilers, making it a useful survey course. The enthusiasm of Professor Pande, thorough lectures, and helpful TAs are appreciated. Students learn a lot and find the projects engaging, particularly when they have a solid background in C/C++. Some students found it a good transition course for embedded system concepts.',
            con: 'The course is extremely difficult with a high workload, extensive reading, and delayed grading for assignments and projects causing stress. Students expressed dissatisfaction with the clarity of lectures, project group dynamics, exam difficulty, and a lack of timely feedback. Some felt overwhelmed by the material, especially those without strong programming backgrounds.',
        },
        'spring 2018': {
            pro: 'Course material is interesting, with a strong understanding from the professor. Projects are engaging and graded fairly, with good feedback.',
            con: 'Assignments and project descriptions can be unclear, causing confusion. Grading can be slow and tedious, and the course structure may require improvement.',
        },
        'spring 2017': {
            pro: 'The projects were phenomenal.',
            con: 'Lectures were only alright; the course was not focused on embedded systems/software.',
        },
        'fall 2017': {
            pro: 'Course covers compiler optimizations in depth with clear and interesting lectures; projects are challenging yet rewarding and align well with the course content.',
            con: 'The teaching quality in the architecture section is lacking, and TA support is not satisfactory. Additionally, the course title can be misleading as it focuses more on compiler optimizations than programming for embedded systems.',
        },
        'fall 2016': {
            pro: 'The course covers interesting subject matter, and the professor explains concepts well with a generous grading system focused on understanding.',
            con: 'There is inadequate support from some TAs on Piazza, leading to unaddressed questions and issues with assignment accuracy; it may not be suitable for entry-level students.',
        },
        'spring 2016': {
            pro: 'Interesting topics, helpful professor and TAs, video material is nice and concise, and final exam well-produced and evaluative.',
            con: 'Vague assignment requirements, ambitious project expectations, and a significant learning curve for staff.',
        },
        'summer 2016': {
            pro: 'The course provides a solid foundation in compiler optimization and embedded architectures, with active support from TAs and the professor. Assignments are appropriate and manageable, and the overall experience is deemed worthwhile for those interested in the subject matter.',
            con: 'The course title can be misleading as it does not focus on embedded software. Many aspects of the course suffer from errors and inconsistencies, particularly in lecture materials and homework assignments, which can cause confusion.',
        },
    },
};
