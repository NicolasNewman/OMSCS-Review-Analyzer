export default {
    ...
    reviewSummaries: {
        'summer 2024':
            'The course received mixed reviews, with several students appreciating its simplicity and ease, particularly with quizzes and assignments, while finding the final paper/project to be potentially time-consuming if not approached early. However, many expressed dissatisfaction with the overall learning experience, citing a lack of depth in the material and vague assignment expectations that led to confusion. Issues with the grading system were common, as students reported arbitrary point deductions and unclear criteria, resulting in lower-than-expected grades despite high quiz scores. Additionally, delays in feedback left students unable to improve on subsequent assignments. The quality of course materials, such as videos, was criticized for being poor and unhelpful, impacting overall comprehension.',
        'spring 2024':
            'The course INTA 6450 - Data Analytics and Security has received mixed reviews, highlighting both strengths and weaknesses. Positively, students found the course material easy to grasp and appreciated that most coding was provided, making assignments straightforward. The simplicity of project activities and the presence of clear discussion formats were also noted. Conversely, significant concerns were raised regarding the teaching assistants’ grading practices; inconsistencies, vague assignment requirements, and biased evaluations led to frustration. Some students experienced poor communication and slow responses from TAs, with grievances often requiring escalation. The reliance on a single TA for grading also contributed to perceived unfairness. This resulted in a mixed learning experience overall, overshadowed by organizational issues.',
        'summer 2023':
            "The course received mixed reviews from students. On the positive side, many found the lectures engaging and easily comprehensible, praising the professor's delivery and the support of a grading curve that provided some leniency. However, students largely criticized the lack of consistent leadership, attributing their frustrations to the teaching assistants (TAs), who were viewed as overly nitpicky with grading, often misinterpreting syllabus policies. This inconsistency led to poor assessments of students’ content mastery, with severe penalties for subjective issues like verbosity. Additionally, students felt the curriculum was imbalanced, with minimal focus on cybersecurity, urging a need for reevaluation or rebranding of the course.",
        'spring 2023':
            'The course is generally regarded as easy but suffers from significant grading inconsistencies that detract from the learning experience. Positive aspects include straightforward lectures and quizzes that align well with course content. However, many reviews point out that coding assignments are overly simplistic and the lengthy essays feel tedious due to vague requirements. Grading is perceived as arbitrary, largely influenced by the individual TAs, leading to frustrations over unclear deductions and an overall lack of accountability in the grading process. While a curve is applied to final grades, students feel this does not justify the disorganized structure and confusing expectations of the coursework. Several reviewers recommend avoiding this class if possible, citing it as their least enjoyable experience in the program.',
        'summer 2022':
            "The course is noted for its ease and low time commitment, making it manageable alongside other classes. However, many reviews highlight significant issues with grading, particularly dependence on the head TA's subjective judgments, leading to confusion over grade deductions that seem geared toward maintaining a grading curve. Students expressed frustration with the slow release of grades and found the workload excessive and often meaningless, diminishing the overall experience. While some felt that an A was achievable under certain conditions, the overall sentiment suggests that the grading practices and lack of clarity overshadow the course's advantages, prompting regrets from those who enrolled.",
        'spring 2022':
            "The course provides a basic introduction to R or Python that may benefit newcomers, but lacks in-depth content. Regular graded discussions require significant thought, while assessments consist of weekly quizzes and a group project. Success in the group project largely depends on the team dynamics; those fortunate to have a good group find it manageable, but solo work is possible for experienced students. Some reviewed the course as an easy option to pair with more challenging classes, particularly in their final semester. Though some students felt they didn't learn anything new, the professor's involvement was praised, allowing for potential interaction and learning. Overall, while it serves as a flexible and low-pressure course, it may not satisfy those seeking deeper knowledge.",
        'fall 2021':
            "The course received mixed reviews, highlighting both its accessibility and shortcomings in depth. Many students found it easy, benefiting from straightforward quizzes and coding assignments, making it suitable for pairing with more demanding classes. However, there were complaints about disorganized lectures, inadequate explanations on significant topics like regression models, and inconsistent grading quality based on TAs. While some appreciated the professor's involvement and the group final project, perceptions of superficial content and lack of rigorous learning persisted. A few students criticized the course for being a waste of tuition due to its ease and minimal focus on essential topics. Overall, while it's seen as a light option, those seeking substantial knowledge may be disappointed.",
        'summer 2021':
            'The course received mixed reviews from students. Many praised the professor for being active, approachable, and passionate about the subject matter, with live office hour support enhancing their learning experience. Quizzes and discussions were viewed as straightforward, though some noted that grading on projects felt arbitrary due to vague rubrics and inconsistent TA evaluations. Critics expressed frustration with the perceived lack of depth in assignments, labeling them as busywork, and mentioned trick questions in quizzes that seemed designed to increase difficulty unnecessarily. Concerns about the group project and its substantial workload were voiced, alongside dissatisfaction with the grading approach. Despite these criticisms, several students felt they gained valuable insights and completed the course successfully.',
        'spring 2021':
            'The course receives mixed reviews, with many praising its ease and lenient grading. Students appreciate that quizzes are directly from lecture slides, and assignments require minimal effort, often only minor code modifications for programming tasks. However, several reviewers express frustration over the lack of substantial learning, particularly regarding cybersecurity relevance and data science concepts. Group projects can significantly affect individual experiences, leading to varied success based on team dynamics. While the instructor is supportive and the workload is light, those seeking in-depth knowledge or skills may find the course lacking. Overall, it’s a good option for students looking to balance a heavier course load.',
        'fall 2020':
            'The course is perceived as very easy, with minimal projects and lenient grading, making it likely for students to achieve an A simply by attempting the work. Reviewers note that the content mostly serves as a broad overview of analytical methods and tools without deep dives into specific techniques or their application. Many students wished for more relevant content focused on data analytics applied to security. Overall, while it is considered the easiest class in the OMS Cyber - Policy track, the lack of in-depth material and practical implementation may disappoint those seeking more comprehensive knowledge in data analytics.',
    },
};
