export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course is considered easy with simple assignments and quizzes that mostly follow the lecture material, making it approachable for students.',
            con: 'The course suffered from poor execution, unclear grading criteria, outdated materials, delayed feedback, and a perceived lack of valuable learning experiences.',
        },
        'spring 2024': {
            pro: 'The course material is easy to pick up, and projects can be completed using provided Python code, making it straightforward. There are also simple discussion activities during lectures.',
            con: 'Inconsistent grading and vague assignment requirements create frustration. TA responses are slow, and grading can be biased since the same TA grades all work, potentially leading to unfair evaluations.',
        },
        'summer 2023': {
            pro: 'The lectures were easy to watch and understand, with a skilled professor who engaged students effectively.',
            con: 'Poorly led class with inconsistent grading from TAs, nitpicky feedback, and a curriculum lacking sufficient focus on cybersecurity.',
        },
        'spring 2023': {
            pro: "The class is easy and has informative lectures. Quizzes are straightforward and don't require honor lock.",
            con: 'Grading is arbitrary and inconsistent among TAs, leading to frustration. Assignment instructions are vague, and some grading policies make it difficult to receive fair assessments.',
        },
        'summer 2022': {
            pro: 'The course is easy and requires low time commitment, making it easy to pair with other courses.',
            con: 'Grading is inconsistent and heavily dependent on the head TA, leading to unfair mark deductions and delayed grade releases.',
        },
        'spring 2022': {
            pro: 'The course offers a manageable workload with an opportunity to learn basic R or Python and has a supportive group project environment, making it good for pairing with more challenging courses.',
            con: "There is no deep dive into topics, and some students felt they didn't learn anything new, indicating a lack of depth in the course content.",
        },
        'fall 2021': {
            pro: "The course is easy and has helpful resources like office hours and TAs, making it suitable for pairing with a heavier class. Some students enjoyed the professor's involvement and found the final project engaging.",
            con: 'The lectures are disorganized, and the material lacks depth, leading to a superficial learning experience. Grades heavily depend on the TAs, with varying quality, and some students felt the course was a waste of tuition due to its lack of detailed content.',
        },
        'summer 2021': {
            pro: 'The course is easy, with an awesome professor who is very engaged and available for live office hours. Quizzes and discussions are straightforward, and the material is interesting and serves as a good reference for practitioners.',
            con: 'Grading can be inconsistent and arbitrary, with vague rubrics leading to confusion. Many assignments and quizzes are perceived as busywork, and there is criticism towards the arbitrary point deductions by TAs.',
        },
        'spring 2021': {
            pro: 'The course is easy with straightforward quizzes and assignments, mainly effort-based; supportive instructor and helpful TAs, making it good for pairing with more difficult courses.',
            con: 'Many students felt they did not learn much from the class, as it often lacked depth and was heavily focused on group projects, which could vary in experience based on group dynamics.',
        },
        'fall 2020': {
            pro: 'The course is easy with lenient grading, making it likely for students to receive high marks.',
            con: 'The course content lacks depth, focusing mostly on an overview without detailed implementation of analytical techniques.',
        },
    },
};
