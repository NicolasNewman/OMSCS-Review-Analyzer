export default {
    ...
    reviewSummaries: {
        'spring 2024': {
            pro: 'The course provides valuable learning on parallel programming and distributed systems, with rewarding projects that reinforce understanding. The instructional materials and TA support are clear, and grading is fair.',
            con: 'The last project demands significant effort to outperform peers, and exams are challenging despite being open book. The pacing of the final weeks is poorly structured, making it feel rushed.',
        },
        'spring 2023': {
            pro: 'The course offers good lectures and a solid foundation in HPC concepts, theory, and applications. Students appreciated the structure and depth of the material, including useful projects involving popular HPC frameworks.',
            con: 'Significant issues include a confusing final assignment using a niche language called Chapel, inconsistent content density, and a competitive grading system that leads to frustration. The course also has a challenging workload and an atmosphere perceived as overly punitive towards struggling students.',
        },
        'fall 2023': {
            pro: 'The course material is highly regarded, challenging labs are rewarding, and effective evaluations help manage workload. The TAs are responsive, and the course enhances understanding of parallel programming technologies.',
            con: 'Teaching staff are perceived as unhelpful and condescending, engagement in discussions is minimal, and video lectures poorly convey material, assuming prior knowledge without proper resources.',
        },
        'summer 2023': {
            pro: 'The course covers important topics like I/O memory optimization and distributed parallel sorting, and helps improve programming skills and comprehension of complex concepts.',
            con: 'The course material can be overwhelming due to a lot of reading, tricky exams that don’t ask direct questions from lectures, and a fast-paced summer semester structure.',
        },
        'fall 2022': {
            pro: 'N/A',
            con: 'Course has excessive workload, unresponsive and unsupportive instructors, unfair exams, and frequent changes to policy that hinder student success.',
        },
        'summer 2022': {
            pro: 'The course features well-done lectures by Professor Vuduc, is engaging, and provides a generous grading curve. Students find the projects challenging but rewarding, especially after acquiring prior knowledge in related subjects like C programming.',
            con: 'Exams are considered brutal and poorly defined, with students struggling to interpret questions and limited time for answers. Some TAs were reported as unhelpful, and project criteria can sometimes lead to low performance.',
        },
        'spring 2022': {
            pro: 'The course features engaging and well-explained lectures by Professor Vuduc, alongside challenging but manageable labs that emphasize practical skills and project work over exams. Many students appreciate the clear structure and support from TAs.',
            con: 'Students reported issues with quiz quality, exam difficulty, course material clarity, and older papers that may not be easily understood. There are also concerns about errors in video content and insufficient guidance in lab requirements.',
        },
        'fall 2021': {
            pro: 'The course is informative with a solid introduction to C and parallel algorithms, featuring engaging lectures and educational labs that help develop a strong understanding of the material.',
            con: 'There are issues with TA responsiveness, gaps between lectures and labs, and challenges with the exams that could benefit from more structured assignments.',
        },
        'summer 2021': {
            pro: 'The course offers well-structured lectures, useful optional homework assignments for exam preparation, and helpful TAs. Labs provide a good introduction to parallel algorithms with varying difficulty.',
            con: 'Exams are difficult and ambiguous, with a lack of clear grading criteria. The course relies heavily on TAs, which can lead to inconsistencies in grading. The course content is outdated, and there are challenges in accessing materials.',
        },
        'spring 2021': {
            pro: 'The course is well-structured with engaging lectures, and the labs deepen the understanding of key concepts. The quality of instruction is high, with knowledgeable TAs providing support. The content is considered very useful for the software industry, particularly in high-performance computing and parallel algorithms.',
            con: 'The course is extremely difficult and time-consuming, with challenging assignments and exams. Some students reported a lack of helpful feedback from TAs and found the midterms poorly explained. The reliance on optimization within lab work can be frustrating, and the variability in performance metrics on the instructional cluster led to further challenges.',
        },
        'fall 2020': {
            pro: 'The course is well-structured with knowledgeable professors and TAs, interesting projects, high-quality videos, and a strong focus on practical skills in parallel algorithms. Many students found the labs enjoyable and rewarding, particularly the introduction of CUDA work, and the grading system offers leniency with challenging exams.',
            con: 'Exams are noted for being particularly difficult and often feel unrepresentative of the course content. Some students felt stuck during projects and experienced issues with data center stability. The lectures were sometimes criticized for lack of clarity, and communication on platforms like Piazza was less engaging than in other courses.',
        },
        'summer 2020': {
            pro: 'The class seems promising aside from the issues with the VM.',
            con: 'Requires significantly more assembly experience than advertised, and the course VM is outdated.',
        },
        'fall 2017': {
            pro: 'The course is well designed with high-quality lectures and engaging instructors. It provides a good introduction to high-performance computing and covers important topics such as parallelization and cache performance. Students reported that they learned a lot and felt accomplished after completing it.',
            con: 'The course is very challenging, with difficult exams and projects that require significant time and expertise. Many students felt unprepared due to the high level of difficulty, especially for those new to C programming or HPC concepts.',
        },
        'spring 2019': {
            pro: 'The course has excellent material, engaging lectures, and supportive instructors. Grading is lenient, and students recommend it for those interested in parallel algorithms despite the challenging work.',
            con: 'The course is quite difficult, with tough exams and assignments that require a significant amount of effort. Some materials need updates, and the exams are often deemed overly conceptual and challenging.',
        },
        'spring 2018': {
            pro: 'The course offers challenging material that encourages innovative problem-solving, with generous grading and helpful TAs, making it rewarding for engaged students.',
            con: 'The course is time-consuming with difficult exams, limited interactions with the professor, and lacks practical applications, leading to mixed experiences among students.',
        },
        'spring 2017': {
            pro: 'The course is interesting and well-designed, with great lectures, discussions, and instructor interaction. It provides a fulfilling learning experience and covers exciting topics in HPC.',
            con: 'The course is challenging and assignments are difficult, with vague instructions that may cause frustration. The exams are designed to test higher-level understanding, which some students may find hard.',
        },
        'fall 2016': {
            pro: 'The course is highly engaging and offers a rewarding learning experience with challenging material that fosters a deep understanding of High Performance Computing. Professors provide guidance and resources, and the class format encourages success through structured assignments and office hours.',
            con: 'The course is extremely challenging, especially for those without a Computer Science background, requiring significant time commitment and effort. Students suggest prior preparation in C/C++ and parallel algorithms, and some found the workload overwhelming.',
        },
        'fall 2015': {
            pro: "Students found the course engaging and challenging, particularly enjoying the hands-on projects and the instructor's humor. Many felt they learned a lot about HPC algorithms and appreciated the depth of the material.",
            con: "Several students noted that the course is misleadingly titled as 'introductory,' with tough assignments and exams that require advanced knowledge in C/C++, as well as extensive study time. The grading distribution was perceived as harsh.",
        },
        'spring 2016': {
            pro: 'The course is challenging but rewarding, with excellent lectures, active support from the professor and TAs, and valuable learning experiences in high-performance computing.',
            con: 'Assignments and exams are notably difficult and time-consuming, requiring a strong knowledge of C/C++ and careful time management.',
        },
    },
};
