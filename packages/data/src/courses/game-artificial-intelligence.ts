export default {
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: "The course features engaging projects, helpful instructor and TAs, and a well-organized structure that allows for advanced work at one's own pace. Many students appreciated the unique assignments and visual outputs, which aided learning and made the experience enjoyable.",
            con: 'Some students found the course content repetitive, lectures dry, and certain aspects of the course stressful due to limited submissions and inadequate assignment documentation. The exams were also perceived as challenging by some, and the overall enjoyment was affected by comparisons to previous courses.',
        },
        'fall 2023': {
            pro: 'The course features well-designed and engaging assignments that allow for creativity and fun while learning AI concepts. The professor and TAs are helpful, and the projects, especially the tournaments, are highlights. Many students find the course enjoyable and a good introduction to AI.',
            con: 'Lectures tend to be long, dull, and sometimes hard to follow, which can detract from the learning experience. Some students also reported challenges with the limited submission attempts for assignments and felt initial projects could be intimidating for those without prior experience. Overall course difficulty varied, with some finding it easy and others struggling.',
        },
        'summer 2022': {
            pro: 'The course offers engaging assignments, lots of professor and TA support, and is considered fun and relatively easy. It provides flexibility in assignment submissions and exam timing, making it accessible for students with varying levels of programming knowledge.',
            con: 'Some reviews mention that the lectures can be slow and not very captivating, which may lead students to rely more on reading the textbook.',
        },
        'fall 2022': {
            pro: 'The course features an active and responsive professor, interesting assignment topics, and fair exams with ample time for completion.',
            con: 'Lectures are often described as boring and superficial, assignments may lack depth and challenge, and the grading submission system is seen as frustrating.',
        },
        'spring 2022': {
            pro: "The course offers extensive support from the professor and TAs, engaging projects, and opportunities for extra credit. Many students found the projects entertaining and praised the professor's responsiveness to questions.",
            con: 'Lectures are considered boring and numerous, with exams containing a large number of questions that may exceed the material covered. There are also concerns about some students relying too heavily on the professor for help.',
        },
        'fall 2021': {
            pro: 'Students enjoyed the hands-on experience with Unity and appreciated the engaging, practical assignments. The professor was highly praised for being supportive and responsive on Piazza, and the course content was well-structured and informative.',
            con: 'Some students noted discrepancies between exam materials and assignment coverage, and reported that grading could be slow. Additionally, the course required a significant time commitment for certain assignments and had varying difficulty levels.',
        },
        'summer 2021': {
            pro: "The course features engaging and fun assignments, helpful instructor and TAs, and well-structured content. It's suitable for those with a background in game development and provides immediate visual feedback on assignments.",
            con: 'The lectures can be lengthy and somewhat dry, with a high workload that may be overwhelming, especially for summer sessions. There are also issues with grading due to the lack of an auto-grader and confusing exam questions.',
        },
        'spring 2021': {
            pro: 'The course was well run with active involvement from the professor and TAs. It covered interesting content, especially in game AI techniques, and offered helpful assignments, including engaging projects like a dodgeball game and a fuzzy logic racecar.',
            con: 'Some students felt the assignments were too easy and could be more rigorous. The course videos were described as dry and not as polished as other courses, and there was a desire for more coding opportunities in certain areas discussed in lectures.',
        },
    },
};
