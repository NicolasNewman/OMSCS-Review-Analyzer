export default {
    ...
    reviews: [
        ...
        },
        {
            ...
            semester: 'fall 2023',
            review: "The concepts are interesting and the projects are pretty fun. The professor is knowledgeable and good at helping you figure out what's wrong with your code. TA office hours are helpful.\nAlthough you can only submit the assignment twice, good hints and feedback are provided after the first submission. It's enough to help you figure out what's wrong with your code to get a better score with the second submission.\nThe only part that I didn't like is the lectures which are long and dry and sometimes hard to follow.\nOverall, it's a fun class and makes you more understandable with games' slow updates and expensive prices.",
            rating: 5,
            difficulty: 3,
            workload: 14,
        },
        {
            user: 'djYyM55g6cs5rSqUV6QUMg==',
            reviewDate: 'December 9, 2023',
            semester: 'fall 2023',
            review: "This is my first review on OMS Central, even if it is my eighth course in the program. It was my favorite course as well, similar with other people. The right amount of difficulty, mostly fun assignments. The 70/30 percent ratio per assignments/exams, plus a couple of opportunities for extra credit, there is a decent chance to get an A. A few points of what I think is more important based on my experience:\n\nI was worried about the 2 submissions limit for Gradescope. I don't think I used at any assignment more than 1 submission. It makes you more anxious when you click the Submit button, but with local testing and a thorough approach, you should be ok.\nI enjoyed the Race Truck assignment the most, with Prison Dodgeball coming in second. The tournament based on that assignment was a nice touch as well.\nThe lectures, even at 2.0 x speed are sometimes hard to follow.\nThe professor was very responsive on Ed Discussion, especially in the first part of the course (when I think is the most important).\n\nAt the end of the course, I really feel that I learned something and I have a small insight into the game industry. I think this should be the goal of any course in the program: for the student to remain with some knowledge and to have good projects for which the sole purpose is not to give you tens of pages of directions, one more confusing than the other, but to have that spark where you feel you achieved and learned something.\nAnyway, enjoy!",
            rating: 5,
            difficulty: 3,
            workload: 9,
        },
        {
            ...
            semester: 'fall 2023',
            review: "I really enjoyed this class. I have taken several AI classes at this point, and this was a breath of fresh air. The entire point of Game AI is that you have to cut algorithms down, or else the game performance will suffer. Because of that, nothing can be too complicated. Projects were all so fun to work on, they provide tons of starter code and you just fill out the algorithms. They also all have pretty impressive visualization so you can see the changes you make immediately. Lectures are extremely long and usually multiple per week, definitely watch on 2x speed. Lots of lecture material is not covered in assignments but you need it for exams, so don't skip them. Pretty significant curve provided on the midterm, but the curve wasnt released until finals week. Great class, take it if you can!",
            rating: 5,
            difficulty: 3,
            workload: 8,
        },
        {
            ...
            semester: 'fall 2023',
            review: "Overall, this was a fun class that wasn't too challenging. The assignments are fun to work on and there is a TON of support from TAs and the prof directly on the forums. The prof is super helpful usually. The lectures are fine if played at 2x speed. The exams weren't too bad but a little tricky but if you do fine on the assignments you'll be fine. There is an interesting 2 submission limit to encourage more local testing but most assignments it was pretty clear if you would get most of the points. Assignments weren't too challenging and had some cool concepts. I wouldn't say the class was too difficult and makes for a good pair with another class. The prison dodgeball assignment was pretty impressive and you could either go as easy or hard as you wanted, with simple implementations getting most of the points and wild implementations getting all the points for sure. I didn't do anything crazy and got full points. My favorite assignment was the fuzzy logic racing, with fairly simple code you can get some great results that look cool to play.",
            rating: 4,
            difficulty: 2,
            workload: 7,
        },
        {
            user: 'zPiW5zEJYqcfHuRmUK5dcA==',
            reviewDate: 'November 29, 2023',
            semester: 'fall 2023',
            review: "TA and professor engagement on Ed declined after the midterm.\nThe lectures are extremely dull and long. I found five-minute videos on YouTube that taught the content more clearly and interestingly.\nThe exams are less a test of buzzword knowledge and more a test of concept application. Many people score lower than are used to in OMSCS.\nThe assignments are interesting, challenging (depending on your background), and rewarding. The TA team provides one-on-one tutoring with screen share - my favorite feature of any OMSCS course I've taken.\nThis is a good one.",
            rating: 4,
            difficulty: 3,
            workload: 12,
        },
        {
            user: '3N/3LUnj3r9Mano7r+uNTg==',
            reviewDate: 'June 27, 2023',
            semester: 'summer 2022',
            review: "What I like the most about this course is the assignments. They're very well thought, enough code is already provided so students don't spend too much time on implementation details, but enough work to make sure the essence of the materials are captured.  The amount is just right.\nI find the lecture a bit slow and not very captivating / clear, I often end up stop in the middle and just read the book.\nOverall a very good course, especially for summer.",
            rating: 4,
            difficulty: 2,
            workload: 10,
        },
        {
            user: 'BM7EFaJ7ODh553IIRjug1Q==',
            reviewDate: 'May 8, 2023',
            semester: 'spring 2023',
            review: "Really enjoyed this course. Dr. Wilson was very active in EdSTEM, and the TAs hold individual office hours to help if you're struggling with an assignment (for example, you can screen share & they'll give you comments on your code.) This was a huge bonus, as most other office hour formats seemed like an extensive Q&A without a ton of individual guidance on your issue. Shoutout to Oliver for doing an exceptional job.\nThe course itself was laid out in a very organized way, and I benefitted from watching most if not all of the lecture content. Dr. Wilson definitely put some time and thought into his production value & planning when preparing the course material.\nThere were 8 projects, and each one was challenging & left me with a good sense of accomplishment after completing it, but none were so difficult that it was unapproachable. There were only a few where I was stuck enough that I had to make an office hour for a TA to help. I would say this class is well-distributed in terms of workload. It wasn't hard in the beginning, then easy, or vice versa. The projects are also very interactive & provide a unique and fun debugging experience. For example, in the prison dodgeball project, you need to watch your minion's behavior to improve your code.\nAnother nice perk was-- the first half of the class is released all at one time, so you can work ahead if that fits your schedule better. This allowed for a bit more freedom in my personal schedule.\nThis was my 7th class & was definitely at the top of my list in terms of satisfaction. Would recommend it to anyone else thinking about taking it.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        {
            ...
            semester: 'spring 2023',
            review: "Overall, this was a pleasant course that was sometimes interesting, sometimes boring, but never particularly stressful. A lot of the content is repetitive from other AI courses. The highlight of the class is doing all of your assignments in Unity and having a visual output to work with, which creates a more interesting development experience than a typical course, and can be fun to show off to people. Some of the assignments are very rote (for example: implementing A* for hundredth time), while others create room for creativity that can suck you in for way more time than you need to get full credit because they're actually fun (for example: creating an AI dodgeball team). There were 7 assignments in my semester, and they are usually released a few weeks ahead, so you can easily end up with a lot of gaps where you don't have much coursework to do (very ideal for a semester where you might have a lot of travel planned). The assignment files have a lot of work put into them, you could easily leverage them to explore above and beyond the coursework without having to do a lot of your own setup in Unity if you have enough genuine interest.\nThere is a ton of lecture content, roughly 2-4 hours of videos each week. Watching on double speed is ideal--they're slow and at times pretty dry. These lectures cover way more content than the assignments do, and are often only mildly touched on in the exams. The exams are open note and offer a generous allotted time, but are not necessarily a knock it out of the park experience, as the questions are pretty specific and require you to carefully interpret them. I did literally nothing to prepare for them and got low Bs. There is also some opportunity for extra credit here and there. Overall, I ended up with an A in the course.\nThe professor responds to nearly every question on Ed, it feels like he is invested in meeting students where they are at and making sure they succeed.\nIf you are newer to programming, this class might be a little more challenging, but a good early-on course in your degree to learn the ropes of development. If you are very experienced, it'll probably be a breeze but possibly boring.",
            rating: 4,
            difficulty: 3,
            workload: 10,
        },
        {
            user: 'p19PDQCMCANoV503QlqdWQ==',
            reviewDate: 'May 6, 2023',
            semester: 'spring 2023',
            review: 'Overall, this was one of my favorite courses so far in OMSCS. I learned a lot about not just video game development, but also AI algorithms. The projects were interesting.\nHowever, I felt that the exams were made to be pretty tough. Overall got a low A.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2022',
            review: 'This course is a little strange. U cannot submit multiple times for your assignments. What you learn from lectures are different from assignment.\nLectures only teach u about the idea or definition but u need to implement it by yourself. For assignmet, u need to write your own test application to test all the scaniros what will consume a lot of time.\nFor the exam, it is not easy to directly find the answers from lectures. a lot of questions you need to guess.\noverall, it is easy to get grade C and it is hard to get A.',
            rating: 2,
            difficulty: 3,
            workload: 12,
        },
        ...
        },
        {
            ...
            review: "Mostly leaving this review to praise the enormous amount of support one could receive from the professor and TA's.\nI don't believe it is possible to fail in this class if you start early and ask for help when stuck.\nPrior to this course I didn't had exposure to C#, but luckily I'm good with java and C# is basically Microsoft's version of it.\nAssignments are good and keep you entertained, I think on average I spent 10 hrs on average doing them.\nI definitely spent at least 20 hrs working on FSM and 15 hrs on self-driving vehicle, but also there were at least several of assignments where I spent like 5 hrs in total.\nMidterm exam was tough but fair, there was a little curve to make sure that those who performed poorly would get better a grade. Final exam was pretty straightforward, curved grade is not available yet, but I wouldn't expect any curve since most of the students performed much better this time around.\nSo to sum up my experience: If you like video games and want to know more about how they work - I would strongly suggest you take this class. Lots of fun is guaranteed.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        {
            ...
            semester: 'spring 2022',
            review: 'A nice course with active Profs and TAs. I like this course.',
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: 'I really enjoyed this course. It was fun to see a more "practical" and fun side of AI. After taking AI (CS-6601) this course was pretty easy but it was really fun to learn Unity and apply what you learned previously to a fun assignments. FYI I got an A.\nPros\n\nProfessor is really active on the Piazza and answers all questions quickly.\nAssignments are fun and you get plenty of time to do them\n\nCons\n\nNot all the material on the exams are covered by the assignments, so you need to really pay attention to the lectures and keep up with them. I do kinda wish all topics covered had assignments but its just not possible\ngetting grades was kinda slow but I get it , it takes awhile to run on those Unity applications.\n',
            rating: 5,
            difficulty: 2,
            workload: 5,
        },
        {
            ...
            semester: 'fall 2021',
            review: "This was my 9th class in OMSCS and I would say this was among the best I've taken so far.\nThe instructor (Dr.Wilson) is extremely helpful and literally tries to answer every single question on piazza. TAs were very good too.\nI liked the fact that this class uses a game engine (unity) that's widely adopted in the game industry. This definitely gives us hands on experience in a relevant technology and insights into what it's like to be a game dev.\nExams were open book and open internet, but were challenging. Projects were fair without consuming too much time (all took < 15 hours, mostly less than 10 hours for me and I didn't know any C# beforehand) and I liked the fact that we get an opportunity to resubmit an improved solution once grades were out, which allowed to get back 50% of the lost points. One downside is that projects can be all-or-nothing just like in AI4R, but the regrade opportunity alleviated the issue to a reasonable extent.\nOverall I would highly recommend this as a low stress, fun and practical class where you'll learn quite a lot too.",
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
    ...
    reviewSummaries: {
        'spring 2023':
            'The course drew mixed reviews from students. Many appreciated the engaging projects and the support offered by Dr. Wilson and the TAs, with well-structured assignments and ample opportunity for creative exploration. Students found the interactive nature of projects, such as the AI dodgeball team, particularly enjoyable. However, several critiques highlighted issues like overly dry lectures, repetitive content, and a lack of effective documentation for assignments. Some students felt underwhelmed, describing the material as basic and often boring. Despite the generous exam format, a few found the exams challenging. Overall, while the course has valuable elements for aspiring game developers, its execution and delivery left some feeling dissatisfied.',
        'fall 2023':
            'The course on Game AI has garnered mixed reviews from students. Many praised the well-designed and enjoyable assignments, which allowed for deeper engagement with AI concepts through practical applications. Support from TAs and the professor was highlighted as a significant advantage. However, students expressed frustration over lengthy and sometimes disorganized lectures that made content hard to follow. The two-submission limit for assignments led to anxiety, but most felt the provided feedback was sufficient for improvement. While some found the workload manageable, others noted that early projects could be intimidating without prior experience. Overall, despite some drawbacks, many students found the course rewarding and fun, appreciating the balance of challenge and support.',
        'summer 2022':
            'The course receives high praise for its engaging assignments, well-balanced workload, and supportive professor and TA presence, making it enjoyable and accessible, particularly for those interested in video games, AI, or robotics. Students appreciate the option to speed up lectures and the clear connections between course content and assignments. However, some find the lectures slow and less captivating, often opting to read the textbook instead. While the course offers grace periods and re-submission options for assignments, there are mixed feelings about these practices in a graduate setting. Overall, it’s considered a valuable course that effectively covers interesting concepts, especially for those looking to explore robotics within a fun context.',
        'fall 2022':
            "The reviews present a divided view of the Game AI course. On one hand, many students appreciate the professor's active involvement and the interesting content, highlighting the manageable workload, fair exams, and engaging lectures that make it suitable as an elective. However, others criticize the course for its dull lectures, superficial assignments, and poor grading strategy, suggesting that the material lacks depth and does not effectively build on previous AI courses. Common complaints include tedious slide presentations, lack of local test cases, and an overall feeling of being unchallenged. While some found the course enjoyable and easy to navigate, others deemed it largely unhelpful, especially for those with prior experience in AI.",
        'spring 2022':
            'The course receives high praise for the exceptional support from the professor and TAs, with many students highlighting the accessible help available, particularly for those new to C#. The projects are engaging and well-structured, encouraging students to work ahead and providing opportunities for improvement through second chances and extra credit. However, some reviewers noted that the lectures can be dull and lengthy, with exams covering a vast amount of material beyond what was taught. There are mixed feelings about the level of independence expected from students, as some lean heavily on the professor for guidance. Overall, the class is recommended for those interested in video games, balancing fun with meaningful learning experiences.',
        'fall 2021':
            'The course receives high praise for its engaging content and the strong support from Professor Wilson and the TAs, who are noted for their quick responses on Piazza. Many students found the assignments enjoyable and appreciated the chance to work with industry-relevant tools like Unity. The structured format and flexibility with resubmissions were also highlighted positively. However, some reviews pointed out that not all exam materials were covered in assignments, requiring extra attention to lectures. The workload fluctuated significantly, with the second half of the course considered more challenging, and there were comments on a lack of immediate grading feedback. Overall, while the course is deemed enjoyable and educational, it does demand a solid grasp of computational geometry and coding.',
        'summer 2021':
            'The course received high praise for its engaging assignments and effective lecture content that resonates with those interested in game development and AI. Students appreciated the proactive support from Prof. Wilson and TAs, enjoying the slow-paced, structured lectures despite some finding them lengthy and dry. The workload was noted as heavier than advertised, particularly with the compressed summer schedule. However, a lack of autosgrading led to frustration over harsh penalties for minor errors. While many found the assignments rewarding and fun, those without a strong background in AI concepts, C#, or Unity faced challenges, prompting some to drop the course. Overall, the course is recommended for enthusiastic students willing to invest time in preparation.',
        'spring 2021':
            'The course, taught by Dr. Wilson, received positive feedback for its organization and active instructor engagement, with timely assignment grading and clear requirements. Students appreciated the interesting content, particularly regarding game AI techniques, which filled gaps not addressed in other courses. However, some found the lectures dry and the homework assignments relatively easy, wishing for more rigor and deeper coding experiences on specific algorithms. The course videos lacked polish compared to older offerings but were deemed effective. Exams were noted as low-stress, open-resource assessments. Overall, while it offers a lighter workload suitable for less intensive semesters, many anticipate improvements in future iterations to enhance the learning experience further.',
    },
};
