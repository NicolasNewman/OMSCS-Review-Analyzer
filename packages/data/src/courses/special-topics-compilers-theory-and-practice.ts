export default {
    ...
    reviewSummaries: {
        'summer 2024': {
            pro: 'The course offers a solid understanding of compilers with a strong emphasis on both theory and practice. The TAs are highly knowledgeable and enthusiastic, providing quick resolutions to questions and fast grading. The project structure promotes extensive design freedom and immediate feedback.',
            con: 'Some content is outdated, particularly the attribute grammar framework. The final exam weighs too heavily in grading, and it can be challenging. The homework and project require significant time commitment, making the course more demanding than others.',
        },
        'spring 2024': {
            pro: 'The course is worthwhile and offers a fun experience, especially when paired with Software Analysis. The hands-on project of building a compiler allows for creativity and practical application of concepts.',
            con: 'The course is very difficult, with a significant disparity in difficulty between phases. The homework is disconnected from the project and the textbook goes into more depth than needed, making it less useful.',
        },
        'summer 2023': {
            pro: 'The course features interesting content that is highly applicable to software engineering, and TAs are reported to provide clear answers and fair grading. Many students found the course to be a valuable and satisfying learning experience, successfully covering the fundamental concepts of compiler construction.',
            con: 'The course demands a substantial time commitment, often compared to a full-time job, which can be overwhelming. Some reviews noted a lack of depth in covering compiler optimizations and felt that certain course phases were overly focused on simpler topics, with room for improvement in project structure and exam weight.',
        },
        'spring 2023': {
            pro: 'The course effectively covers the fundamentals of compilers, with detailed explanations of DFAs, NFAs, and regular languages. Resources like the Stanford Automata Theory course and YouTube tutorials are helpful for understanding the concepts. It is well-suited for motivated learners, even those without prior exposure to compilers.',
            con: "Lecture quizzes are too simplistic and do not adequately prepare students for difficult homework. Homework deadlines could be released earlier to avoid requiring knowledge weeks in advance. The quality of lecture delivery may affect comprehension, as some students found the professor's accent and explanations frustrating.",
        },
        'fall 2020': {
            pro: 'The course provides a comprehensive understanding of compilers, allowing students to build one from scratch, which enhances practical and theoretical knowledge. It is challenging and rewarding for those genuinely invested in learning.',
            con: "Assignments are lengthy and involve tedious handwritten solutions. The exam's weighting is disproportionate to the coursework, suggesting a need for more focus on practical applications and optimization discussions.",
        },
        'fall 2021': {
            pro: 'The course offers interesting algorithms and the TAs are responsive and helpful.',
            con: 'The course has a heavy workload, with tedious assignments and a challenging project that requires extensive time and effort with little learning efficiency.',
        },
        'summer 2021': {
            pro: 'The course is project-focused and offers valuable insights into how compilers work end-to-end, turning complex concepts into understandable processes. Helpful TAs and useful feedback from the autograder enhance the learning experience.',
            con: 'The workload can be overwhelming due to the complexity of writing a compiler from scratch, and collaboration in group projects may add unnecessary complications. Grading can be strict, and insufficient instructional material on certain topics can hinder understanding.',
        },
        'spring 2021': {
            pro: 'Students appreciate the comprehensive coverage of compiler implementation, the engaging and challenging projects, and the supportive course staff. The course is noted to enhance foundational understanding of compilation theory and practice.',
            con: 'The course is perceived as challenging, particularly for those without a programming or computer science background, due to the short semester and demanding workload. Some students found the project descriptions ambiguous, which added to the difficulty.',
        },
        'spring 2018': {
            pro: 'Practical projects using industry-standard tools help reinforce theoretical concepts, leading to a deep understanding of compiler components.',
            con: 'Professor involvement is low; TAs may be unhelpful, and project descriptions can be unclear or inaccurate, leading to confusion and arbitrary decisions.',
        },
        'fall 2017': {
            pro: 'The course offers good lectures that focus on useful material, along with a comprehensive project that allows students to build an entire compiler. Support from TAs is generally responsive.',
            con: 'The course suffers from vague project specifications, strict grading, and a lack of clarity in homework and lecture material. TAs and the professor often provide insufficient or unclear guidance.',
        },
        'summer 2017': {
            pro: 'The course is well-organized with clear lectures and committed staff. Programming projects are challenging but rewarding, providing a strong understanding of computer science concepts.',
            con: 'Projects require a solid understanding of programming languages (C++ or Java) and can be very difficult without a strong partner. There is also no auto grader, requiring students to create their own tests.',
        },
    },
};
