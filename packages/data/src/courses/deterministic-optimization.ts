export default {
    ...
    reviews: [
        {
            user: '3DzHl3vk7c/JOaoAnMNXRA==',
            reviewDate: 'May 7, 2024',
            semester: 'spring 2023',
            review: "Spring 2024: Despite earning a C in this class, here are several reasons why you might still consider enrolling:\nCons:\n\nGrading Structure: The course heavily relies on multiple-choice exams, with 75% of your grade stemming from just 60 questions. This includes a mid-term (30 questions for 35% of your grade) and a final exam (30 questions for 40% of your grade). Performing poorly on these exams can significantly impact your final grade.\nWorkload: The class requires the completion of 15 weekly homework assignments and peer reviews. Balancing this course with another demanding class might be challenging, depending on your mathematical proficiency.\nCourse Pace: The course quickly surveys various topics in convex optimization, which may not allow for deep exploration into any single area.\nError in lectures: Be prepared to identify and navigate errors in lecture slides, often corrected through Piazza discussion forums.\n\nPros:\nOptimization is a valuable skill across many fields. Completing this course can enhance your confidence in tackling more complex mathematical optimization problems.\nRetake Strategy:\nIf I were to retake this class, I would:\n\nPrioritize Exam Preparation: Utilize practice problems and module knowledge check questions as a primary study tool since the exams closely mirror these examples. Start building cheat sheets based on these and related lecture slides.\nPractice Calculations: Ensure you are adept at solving math problems by hand, as calculators are not permitted during exams.\nFocus Areas for Mid-term: Practice key concepts like linear algebra and calculus by hand—topics include matrix rank, partial derivatives, convex sets, convex functions, and the simplex method.\nPersistence Pays Off: The final exam tends to be easier than the mid-term, so staying committed throughout the course is likely to pay off.\nLeverage Group Study: Engage in a study group or a WhatsApp group to collaboratively work through assignment problems.\nIMO, the Head TA's office hours are really good.\n",
            rating: 4,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2022',
            review: "I am amazed how this course has an average rating >4. This was by far the worst course in my three semesters of OMSA and right up there with one of the worst courses I have taken period. There are so many issues with it, so let me highlight those:\n\n\nCourse content: Lecture videos and slides are chock-full of errors and typos. I understand that the co-instructors cannot update the content for a variety of reasons. However, I am surprised that there was no quality control in place for when the original content was created and uploaded. Given that this is something that hundreds of students would use over many years, a little effort into QCing the content wouldn't have been a complete waste of time and just shows a general lack of apathy towards students.\n\n\nCourse structure: The mismatch between time spent on homeworks vs exams and the grade distribution for each is just daft. You can put in tons of effort for each homework and make a couple of mistakes in the exam and this will completely destroy your grade.\n\n\nCourse Structure around spring/fall break: The course literally makes your life hell in the week leading up to break where you have just 3 days to watch videos, do knowledge checks, and complete the homework. Note, you do this while having a mid-term released in the same week. What's even better is the spring break is a misnomer for this course. We had a homework due on the Saturday of spring break week, so in reality you don't have a break with this course. A little effort into restructuring would have done wonders. Also note, you can skip two homeworks during the semester, but skipping a homework will bite you later as you'll probably be weak in that content. Besides, skipping homework is meant to help you when you have an emergency/illness, etc., not because the course has unreasonable deadlines for part-time students.\n\n\nSyllabus layout: The course keeps jumping from one topic to another and the lectures don't spend any time up front talking about how various topics will be introduced and how they will build on one another. Just seems haphazard.\n\n\nInstruction: In the semester I took the course, the instructor was virtually non-existent, be it office hours, piazza or otherwise. There's no point putting the instructor's name on the course if everything is handled by the TAs. The TAs are generally very good and some of the office hours were extremely well put together.\n\n\nHomework and questions structure: Most of the homework as well as exam questions default to the trick or challenging  variety, before even one can have a firm grasp of the basic concept. The lecture videos often don't have a concrete or detailed enough example and the homework has students working on a corner case problem, so I found myself using other resources to truly develop a basic understanding of various concepts.\n\n\nSadly, this is one of those courses where the old adage \"You get what you pay for\" truly holds.",
            rating: 1,
            difficulty: 4,
            workload: 15,
        },
        {
            ...
            semester: 'spring 2022',
            review: 'The course is HEAVILY theory based on set theory, convex/concave functions, memorization of theory principles, and no calculator/graphing tools available. If you are comfortable with your understanding of matrices to the highest level and can visualize complex functions then this class is for you.',
            rating: 2,
            difficulty: 4,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: "I took this class because I love the subject matter, not because it would be easy. It's definitely not. Homework outcome I was pleased with: I got out exactly the effort I put in and the assignments furthered my understanding very nicely. However, I am terrible on strictly theoretical exams with no cheatsheets. But I knew that going in. I am still glad I took this course.",
            rating: 5,
            difficulty: 4,
            workload: 13,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: "It's a unique course dedicated to optimization concepts, and a good place to learn some mathematical tricks and tools for it. The lectures are phenomenal. I try to take thorough notes. The anxiety you get from studying for the midterm/final which takes up 75% of the course is unreal. It forces you to have a very clear understanding. Very challenging.",
            rating: 5,
            difficulty: 5,
            workload: 90,
        },
        ...
        },
        {
            ...
            semester: 'fall 2021',
            review: "So I've decided to write this review because I've seen a lot of complaints about this course on piazza and here. I think a lot of the complaints are made by people who do not take the prerequisites seriously. You need to be able to do linear algebra and high school math. You need basic calculus. If you are not strong on the stated prerequisite then that's on you, don't complain afterwards that you don't remember how to find the inverse of a 2x2 matrix by hand or differentiate a simple function by hand or you can't remember what the sine curve or exponential curve looks like... That's why prerequisites are listed. Please ensure that you have the prerequisite knowledge before doing a course.\nThis course is like any typical math course. You must UNDERSTAND the theorems and definitions in order to apply them. You are tested on subtleties of those theorems and definitions, and subtlety is key... You must know the conditions under which these theorems hold... otherwise you may try to apply them incorrectly and get the wrong results in real life...or not understand why you are not getting results. This is the same as every math course I've ever taken.\nThe lecture videos are great and I haven't had to do any outside reading to understand them. The homework is also very helpful in building and reinforcing understanding.\nThis is my favourite class of the program so far and I wish there was a part 2 for more advanced topics.",
            rating: 5,
            difficulty: 2,
            workload: 10,
        },
        ...
        },
        {
            ...
            review: 'This is a very well structured and managed course. Lecture videos and content are of high standard.  Only drawback is that the weekly assignments are peer-reviewed. Sometimes, the scores are given without useful comments/feedback.',
            rating: 5,
            difficulty: 3,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'fall 2020',
            review: 'I am reviewing in the last quarter of the semester. This is my favorite course so far in OMSA. It is not easy but can be very rewarding if you follow thoroughly with the lecture and utilize what you have learn into homework, which is lined up well with the lecture. The homework can be challenging in terms of mathematic reasoning, and implementation of concept into practice, but completely doable if you concentrate half day in it.\nThe course is math heavy but it will walk you through the basic mathematics as prerequisite to various useful algorithms in optimization in a nice pace. The lectures and materials are well structured with a good balance of concept and examples. Both professors gave engaging lectures. Exam are closed book this semester but the practice exam will definitely give you a good prep. Strongly recommend previewing the lecture slides before listening to the lecture, which will guarantee a much better learning outcome.',
            rating: 5,
            difficulty: 3,
            workload: 15,
        },
        ...
        },
        {
            ...
            semester: 'fall 2018',
            review: "Course gives a good introduction about optimization.\nHowever, Professors are not at all involved in this course and TA's are not very responsive..\nSo, I will not recommend this class if objective is to learn via discussions/ two way communication..",
            rating: 3,
            difficulty: 3,
            workload: 6,
        },
        ...
        },
        {
            ...
            review: "Took this class Fall 2018 and not Summer 2018.\nWow. This class covered way more material than I expected. The 14 homework assignments (1 every week) were pretty intense, but the good thing is you get to drop two. The 15th homework assignment is just a bonus and is not included in your grade.\nGrading Breakdown:\n\nHomework 25%\nMidterm 35% (90 minutes, 30 MC questions)\nFinal 40% (180 minutes, 30 MC questions)\n\nYou're allowed one 2-sided notes for each test. Fall 2018 class average for the exams were (23.1/30) for midterm and (19.8/30) for final.\nThings I liked about this class:\n\nUses Python (helps develop your Jupyter notebooks skills and also formulating equations in LaTex)\nOptimization is what ML algorithms are doing, so it's very relevant to everything we're learning.\nThere was a decent amount of material that crossed over with concepts from other classes from a more \"optimization\" viewpoint\n\nBad things:\n\nAbsolutely no professor interaction. The two TAs were great at responding to answers, but this is the first class I had where there wasn't a single professor Piazza interaction.\nNo practice midterm/final\nSome of the test questions are just really difficult to get right without more practice from a practice midterm or final. Studying alone isn't sufficient enough to get the right answer. Tests were kind of demoralizing when I thought I did well, but after submitting I did way worse than expected. I think you have to have a truly good understanding of the concepts to apply them to the questions you see on the exam.\nSoo much material... it was hard to remember everything for the exams\nErrors on the midterm. There were several questions that had multiple checkboxes instead of radio buttons and credit wasn't given for questions if the wrong question was also selected. It didn't seem like the test was reviewed after it was published on Canvas. This probably shouldn't be a recurrent problem though.\n\nHave yet to see how generous the curve is.",
            rating: 4,
            difficulty: 4,
            workload: 10,
        },
        ...
        },
        {
            ...
            semester: 'spring 2018',
            review: 'Extremely difficult course. Requires a PhD in math or at least a degree in math. Teachers/TAs know a lot more than you and they assume you know as much as they know. There is no application I know of to work as a data scientist from this course. The course is very theoretical and NOT FUN. The course covers an incredible amount of information. You are tested on material not covered in lecture or covered in such poor detail as to be not covered. There is 30 hours of lecture of extremely difficult material. How are you supposed to learn everything that is taught in this course?',
            rating: 1,
            difficulty: 5,
            workload: 10,
        },
    ...
    reviewSummaries: {
        'spring 2023':
            'The course in convex optimization has a mix of strengths and weaknesses. On the positive side, students acknowledge the valuable optimization skills gained and find weekly homework intellectually stimulating, enhancing their confidence in tackling complex problems. The Head TA’s office hours are also praised. However, significant concerns include a grading structure that heavily weighs two multiple-choice exams, causing stress and penalizing those who struggle with exam performance. The rapid course pace limits deep understanding of topics, and errors in lecture slides can hinder learning. Additionally, the organization and exam scheduling have been criticized for being counterproductive, especially for students with external commitments. Some students felt the course lacked practical application focus, making it challenging for those less inclined toward pure mathematical concepts.',
        'fall 2023':
            'The course presents a mixed experience for students, especially those with a strong math background, particularly in linear algebra, finding it relatively easy yet time-consuming. While some students spent around 10 hours per week, others felt overwhelmed, mainly due to tricky exams that don’t reflect the curved homework grades. Learning concepts via homework and studying previous tests proves essential for success; however, many reviews criticize the disproportionate weight of homework compared to exams, suggesting that the grading should be adjusted to reflect the true learning that occurs in homework. Lectures and assignments can be dry, but students appreciate the depth of knowledge gained in deterministic modeling and optimization despite the grading concerns.',
        'fall 2022':
            'The course offers valuable content on optimization, making it engaging for students, particularly those with a strong math background. Many reviewers appreciated the responsive TA team and the lecture materials, including knowledge checks, which aided their understanding. However, the course is described as fast-paced and intensive, with a demanding workload, as it covers a significant amount of material, including complex concepts. Critics noted the imbalance in grading, where homework accounted for a small portion of the grade, despite requiring less effort compared to midterms and finals. Additionally, some students found the lack of instructional support and real-world applications to be frustrating, suggesting the course is more theoretical than practical. Overall, the course is regarded as beneficial but challenging, particularly for students with weaker math skills.',
        'spring 2022':
            "The course on optimization has received mixed reviews from students. Positively, many appreciated the interesting content and the solid foundation it builds in optimization principles. The availability of resources like Overleaf for assignments and responsive TAs were also highlighted as beneficial. However, several students expressed frustration over the course's fast pace, overwhelming amount of material, and numerous errors in lecture slides that hampered understanding. Issues with the course structure, such as unrealistic homework deadlines, insufficient guidance from the instructor, and a mismatch between homework and exam grading criteria, were significant concerns. Overall, while the material can be engaging for those with a strong math background, many felt it requires more comprehensive preparation and clearer instruction for a better learning experience.",
        'fall 2021':
            "The course has received mixed reviews from students, highlighting both strengths and weaknesses. On the positive side, many praised the excellent lectures, helpful TA support, and the valuable homework assignments that reinforce learning. Students noted that the material is foundational for AI and ML, making it relevant for their future studies. However, the exams were a common point of contention; while they test deep understanding, many felt they were unfairly difficult, often relying on memorization rather than conceptual knowledge. A significant portion of students struggled with the course's grading structure, which heavily weights exams over homework. Overall, while the content is deemed valuable, the exam format and grading policies could use reevaluation to enhance the learning experience.",
        'spring 2021':
            'The course is well-structured, with high-quality lectures that effectively explain complex concepts, although a solid background in mathematics is essential. Many students find the homework engaging but feel the grading distribution is unfair, as weekly assignments contribute only 25% of the final grade, while multiple-choice exams account for 75%. Some reviews highlight issues with inconsistent TA support and unclear feedback on peer-reviewed assignments. Although the exams are described as tricky, they provide valuable practice opportunities. While some students found the course difficult, others felt it was manageable with extra effort. Overall, many recommend the course for its educational value, despite the challenges and grading format.',
        'summer 2021':
            'The reviews for the course highlight a mix of positive and negative experiences. Students appreciate the clarity of the lectures, which effectively break down complex material and aid in understanding the homework. However, there is frustration regarding the grading structure, with 75% of the overall grade based on exams that do not closely reflect homework content, leading to confusion and misalignment in preparation. Many find the course to be heavily math-focused, making it challenging for those who prefer practical applications over theoretical concepts. While some students manage to achieve a passing grade through strategic exam preparation, others feel that the course favors math enthusiasts and may not cater well to those with a weaker math background.',
        'fall 2020':
            'The course on optimization is both challenging and rewarding, requiring a strong background in linear algebra and calculus. Many students emphasize the importance of meeting the stated prerequisites, warning against enrolling without this knowledge. Positive feedback highlights the engaging lectures, thorough materials, and fair grading curve, with several students appreciating the practical application of theory through homework. However, the intensity of homework and the weight of midterm and final exams can feel overwhelming, especially as mistakes carry significant consequences for grades. TAs provide excellent support, although some students find communication and responsiveness lacking. Overall, while the course demands substantial effort, those dedicated to learning math-heavy concepts appreciate its depth and structure.',
        'spring 2020':
            'The course received positive feedback for its well-structured homework questions, which were deemed challenging and practical, alongside effective exam preparation resources like practice midterms and Knowledge Checks. Students praised the teaching quality, particularly highlighting the exceptional involvement of the TAs and the instructor, Dr. Sun. The curriculum was engaging, especially for those with a strong math background, although some found the material challenging after years away from academia. On the downside, students noted inconsistencies in test questions and a lack of textbook reference, which could have aided understanding. Several reviews emphasized that the workload was significantly higher than anticipated, with a recommendation to dedicate 10-15 hours weekly for thorough comprehension.',
        'fall 2019':
            "The course content is generally well-regarded for its relevance and interest, particularly for those in related fields. However, students strongly criticize the exams for being poorly constructed, confusing, and disconnected from homework assignments, leading to frustration. Many feel the heavy emphasis on theoretical concepts, rather than practical applications, diminishes the course's value. The lack of practice tests and recurring issues with slide errors are points of concern. While some appreciated the support from teaching assistants, others found the lectures unengaging and difficult to follow. The increased workload in the second half of the course further complicates study efforts, leaving students wishing for a better balance and deeper engagement with the material.",
        'spring 2019':
            "The course presents intriguing content and enjoyable lectures, but students report significant issues regarding organization and assessment methods. While many appreciated the engaging subject matter and manageable homework load, the lack of instructor and TA engagement was a major drawback. Students found exams to be excessively difficult and poorly aligned with the course material, often feeling discouraged by their performance, which was compounded by logistical problems, such as grading delays. The course's heavy focus on linear algebra requires prior knowledge, leaving some unprepared. Despite its potential, many hope for improvements in feedback mechanisms and exam structure in future iterations to enhance the learning experience. Overall, while the class is recommended for those interested in optimization, a solid math background is essential for success.",
        'spring 2018':
            "The course offers a solid introduction to deterministic optimization, particularly linear programming, and serves as a useful complement to other subjects like random optimization. Many students appreciate the well-structured homework, typically light but occasionally challenging, which encourages early preparation. However, several reviews highlight the course's significant theoretical demands, requiring strong mathematical foundations that some found overwhelming. Critics point to a lack of real-world applications and the difficulty of material not fully covered in lectures. Despite these challenges, those with a genuine interest in the subject found value in the deep exploration of concepts. Overall, while the course has its strengths, its emphasis on theory and the rigor expected may not appeal to everyone.",
        'fall 2018':
            'The course offers a solid introduction to optimization, emphasizing deterministic algorithms and their real-world applications, allowing students to grasp fundamental concepts through relevant homework assignments. However, many reviews highlight a lack of engagement from professors and limited responsiveness from TAs, making it challenging for students seeking interactive discussions. While the homework is generally straightforward and designed to reinforce learning, exams can be tricky, often requiring deeper understanding beyond class coverage. Lectures are described as dry, which may deter some students. Ultimately, while the course is recommended for its practical applications, prospective students should be aware of these drawbacks, especially if they value professor interaction and responsive support.',
        'summer 2018':
            'The course offers a comprehensive exploration of material, particularly focused on Python and optimization, which is relevant to machine learning. However, students found the intense workload of 14 weekly assignments challenging, despite the option to drop two. While TAs were responsive, there was little to no interaction with the professor, which was a notable downside. Test organization was criticized; students felt that midterms and finals did not accurately reflect the coursework, and errors in the midterm reduced fairness. Although the course content was insightful, many felt overwhelmed by the breadth of material and the difficulty of exams, leading to a disconnect between studying and assessment performance. Overall, improvements in test clarity and structure could enhance the course significantly.',
    },
};
