export default {
    ...
    reviewSummaries: {
        'spring 2023': {
            pro: 'The course provides valuable skills in optimization and offers intellectually stimulating homework that enhances understanding of mathematical concepts.',
            con: 'The grading structure is heavily based on two multiple-choice exams, with a high workload and pace that may not allow for deep exploration of topics, and there are errors present in lecture materials.',
        },
        'fall 2023': {
            pro: 'Students learn how to model and optimize deterministic systems effectively, with positive experiences reported in mastering concepts despite some monotonous content.',
            con: 'Homework grading is peer-based and curved, which negatively affects the learning experience and assessment compared to exams, leading to concerns about the balance between homework and exam importance.',
        },
        'fall 2022': {
            pro: 'The course has interesting and valuable content, responsive TA support, and a clear structure with lecture videos and knowledge checks that aid in learning.',
            con: 'The course is heavily focused on self-learning with insufficient teaching materials, has an imbalanced grading scheme favoring exams over homework, and lacks practical application of the material.',
        },
        'spring 2022': {
            pro: 'The course builds a strong foundation in optimization, covers interesting material, and the head TA is responsive and helpful. Weekly homework and ungraded knowledge checks help keep pace.',
            con: 'The course is math-heavy with numerous errors in course materials, overwhelming information load, a mismatch in homework and exam grading, and a lack of instructor support. There are also issues with the course structure and pacing, leading to confusion and difficulty for students.',
        },
        'fall 2021': {
            pro: 'The course features excellent lectures and helpful TAs, with solid homework that reinforces material and is supported by good practice exams. Students appreciate the foundational knowledge gained in optimization, deeming it critical for AI/ML fields.',
            con: "Exams are perceived as unfair and heavily weighted despite substantial homework efforts, leading to frustration. Many students feel unprepared for exam questions, and there are concerns about the course's grading design and the lack of allowed exam aids.",
        },
        'spring 2021': {
            pro: 'The course is well-structured with high-quality lecture videos and engaging professors. Homework assignments effectively reinforce concepts, and there is a broad overview of optimization topics.',
            con: 'The grading system is seen as unfair, with exams worth a disproportionate amount (75%) compared to homework (25%). Some students found the exams tricky and not reflective of the course content, and TA support was inconsistent.',
        },
        'summer 2021': {
            pro: 'The lectures are well-structured and effectively break down the material, aiding in homework preparation.',
            con: 'A significant portion of the grade comes from exams that do not align well with homework, making it difficult for students who focus on application rather than theory.',
        },
        'fall 2020': {
            pro: 'The course is well-structured with engaging lectures, excellent TAs, and a good balance of theory and practical application. Many students appreciated the challenging yet rewarding homework assignments and the thorough mathematical foundation provided.',
            con: 'The course requires a strong background in calculus and linear algebra, which some students found challenging. Additionally, homework assignments and exams can be quite demanding, with high stakes attached to grades that may not feel proportional to the effort put in.',
        },
        'spring 2020': {
            pro: 'The course is excellent, with well-thought-out and challenging homework questions, engaged teaching, and helpful TAs. The curriculum is interesting, especially for those who enjoy math, and the materials provided are strong.',
            con: 'There are occasional errors in the videos, inconsistent test questions, and the workload is significantly higher than what some may expect. Additionally, no textbook is referenced, which could be a drawback for some students.',
        },
        'fall 2019': {
            pro: 'The course content is interesting and relevant, particularly for those in related jobs. There is a grade curve to help mitigate stress about grades, and one of the TAs received praise for being helpful.',
            con: 'Exams are poorly designed and do not align well with homework; many students find them difficult and frustrating. The course is math-heavy and theoretical with a lack of real-life applications. The lectures are described as long and tough to follow, contributing to a feeling of being lost in theory.',
        },
        'spring 2019': {
            pro: 'The course material is interesting and covers a wide range of topics in optimization. Regular homework assignments are helpful for understanding the subject, and the course has practical applications. TAs are responsive and provide good support.',
            con: 'There is a lack of instructor and TA engagement, leading to feelings of disorganization. Exams are considered difficult and unfair, testing material not adequately covered in lectures or homework. Feedback on assignments is often delayed, and the peer grading system is ineffective.',
        },
        'spring 2018': {
            pro: 'The course provides a solid introduction to deterministic optimization, covering a broad range of topics, including linear programming, and offers a good foundation for future learning. Homework is generally light and well-structured, with some enjoyable problem-solving.',
            con: 'The course is extremely difficult and theoretical, requiring a strong math background, and lacks practical applications relevant to data science. Material covered in lectures can be inadequate, with assessments testing on content not thoroughly explained.',
        },
        'fall 2018': {
            pro: 'The course provides a good introduction to optimization concepts and has practical application with relevant homework that enhances understanding.',
            con: 'Professors are not involved, TAs are unresponsive, and lectures can be dry; exams may contain questions requiring deeper understanding not covered in class.',
        },
        'summer 2018': {
            pro: 'The course covers a substantial amount of material, incorporates relevant concepts related to optimization in machine learning, and provides solid homework assignments that facilitate learning.',
            con: "Lack of professor interaction, absence of practice exams, difficult test questions that don't align with homework, and organizational issues with tests detract from the overall experience.",
        },
    },
};
